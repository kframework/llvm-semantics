; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith001772.ll'
...
entry:
  %tmp = load i32* getelementptr inbounds ([5 x i32]* @g_2, i64 0, i64 2), align 8
  ret i32 %tmp
}
...
entry:
  ...
  %tmp10 = load i32* getelementptr inbounds ([5 x i32]* @g_2, i64 0, i64 2), align 8
