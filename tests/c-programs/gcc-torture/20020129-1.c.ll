...
define void @foo(%struct.B* %x, %struct.B* %y) #0 {
  ...
  %3 = load %struct.B*, %struct.B** %1, align 8
  %4 = getelementptr inbounds %struct.B, %struct.B* %3, i32 0, i32 1
  %5 = load %struct.A*, %struct.A** %4, align 8
  %6 = icmp eq %struct.A* %5, null
  br i1 %6, label %7, label %28

; <label>:7                                       ; preds = %0
  %8 = load %struct.B*, %struct.B** %2, align 8
...
; <label>:28                                      ; preds = %27, %0
  %29 = load %struct.B*, %struct.B** %2, align 8
  %30 = getelementptr inbounds %struct.B, %struct.B* %29, i32 0, i32 1
...
; <label>:34                                      ; preds = %28
  %35 = load %struct.B*, %struct.B** %1, align 8
  %36 = getelementptr inbounds %struct.B, %struct.B* %35, i32 0, i32 0
  %37 = getelementptr inbounds %struct.C, %struct.C* %36, i32 0, i32 2
  %38 = load i64, i64* %37, align 8
  %39 = icmp eq i64 %38, -1
  br i1 %39, label %40, label %61

; <label>:40                                      ; preds = %34
  %41 = load %struct.B*, %struct.B** %2, align 8
  %42 = getelementptr inbounds %struct.B, %struct.B* %41, i32 0, i32 0
  %43 = getelementptr inbounds %struct.C, %struct.C* %42, i32 0, i32 2
  %44 = load i64, i64* %43, align 8
  %45 = load %struct.B*, %struct.B** %1, align 8
  %46 = getelementptr inbounds %struct.B, %struct.B* %45, i32 0, i32 0
  %47 = getelementptr inbounds %struct.C, %struct.C* %46, i32 0, i32 2
  store i64 %44, i64* %47, align 8
  %48 = load %struct.B*, %struct.B** %2, align 8
  %49 = getelementptr inbounds %struct.B, %struct.B* %48, i32 0, i32 0
  %50 = getelementptr inbounds %struct.C, %struct.C* %49, i32 0, i32 3
  %51 = load i64, i64* %50, align 8
  %52 = load %struct.B*, %struct.B** %1, align 8
  %53 = getelementptr inbounds %struct.B, %struct.B* %52, i32 0, i32 0
  %54 = getelementptr inbounds %struct.C, %struct.C* %53, i32 0, i32 3
  store i64 %51, i64* %54, align 8
  %55 = load %struct.B*, %struct.B** %2, align 8
  %56 = getelementptr inbounds %struct.B, %struct.B* %55, i32 0, i32 0
  %57 = getelementptr inbounds %struct.C, %struct.C* %56, i32 0, i32 2
  store i64 -1, i64* %57, align 8
  %58 = load %struct.B*, %struct.B** %2, align 8
  %59 = getelementptr inbounds %struct.B, %struct.B* %58, i32 0, i32 0
  %60 = getelementptr inbounds %struct.C, %struct.C* %59, i32 0, i32 3
  store i64 0, i64* %60, align 8
  br label %61

; <label>:61                                      ; preds = %40, %34
  %62 = load %struct.B*, %struct.B** %2, align 8
  %63 = getelementptr inbounds %struct.B, %struct.B* %62, i32 0, i32 0
  %64 = getelementptr inbounds %struct.C, %struct.C* %63, i32 0, i32 2
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  store i32 6, i32* getelementptr inbounds (%struct.B, %struct.B* @y, i32 0, i32 0, i32 0, i32 0), align 4
