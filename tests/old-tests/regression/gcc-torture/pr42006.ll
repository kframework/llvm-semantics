; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/pr42006.c'
...
for.cond:                                         ; preds = %for.inc, %entry
  %tmp = load i32* %p_6.addr, align 4
  %cmp = icmp ult i32 %tmp, 3
...
if.end:                                           ; preds = %for.body
  ...
  %tmp4 = load i32* %p_6.addr, align 4
  %call = call i32 @my_shift(i32 %tmp3, i32 %tmp4)
...
for.inc:                                          ; preds = %if.end6
  %tmp7 = load i32* %p_6.addr, align 4
  %call8 = call i32 @my_add(i32 %tmp7, i32 1)
  store i32 %call8, i32* %p_6.addr, align 4
  br label %for.cond
...
entry:
  ...
  %cmp = icmp ugt i32 %tmp, 100
  br i1 %cmp, label %cond.true, label %cond.false

cond.true:                                        ; preds = %entry
  %tmp1 = load i32* %left.addr, align 4
  br label %cond.end

cond.false:                                       ; preds = %entry
  %tmp2 = load i32* %left.addr, align 4
  %tmp3 = load i32* %right.addr, align 4
  %shr = lshr i32 %tmp2, %tmp3
  br label %cond.end

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %tmp1, %cond.true ], [ %shr, %cond.false ]
  ret i32 %cond
}
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %tmp2, %cond.true ], [ %add, %cond.false ]
  ret i32 %cond
}
