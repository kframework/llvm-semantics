...
define i32 @sec(%struct.defs* %pd0) #0 {
  ...
  %pt = alloca i8*, align 8
  store %struct.defs* %pd0, %struct.defs** %1, align 8
  store i8* getelementptr inbounds ([8 x i8], [8 x i8]* @sec.qs7813, i32 0, i32 0), i8** %ps, align 8
  %2 = load %struct.defs*, %struct.defs** %1, align 8
  %3 = getelementptr inbounds %struct.defs, %struct.defs* %2, i32 0, i32 15
  %4 = getelementptr inbounds [8 x i8], [8 x i8]* %3, i32 0, i32 0
  store i8* %4, i8** %pt, align 8
...
; <label>:16                                      ; preds = %8
  %17 = load i32, i32* %lrc, align 4
  %18 = icmp ne i32 %17, 0
  br i1 %18, label %19, label %29

; <label>:19                                      ; preds = %16
  %20 = load %struct.defs*, %struct.defs** %1, align 8
  %21 = getelementptr inbounds %struct.defs, %struct.defs* %20, i32 0, i32 11
  %22 = load i32, i32* %21, align 4
  %23 = icmp ne i32 %22, 0
  br i1 %23, label %24, label %26

; <label>:24                                      ; preds = %19
  %25 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @sec.s7813er, i32 0, i32 0), i32 1)
  br label %26
...
; <label>:45                                      ; preds = %42
  ...
  %47 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @sec.fl, i32 0, i32 0), i32 %46)
  br label %48
...
; <label>:52                                      ; preds = %49
  ...
  %53 = load i32, i32* %prlc, align 4
  %54 = icmp ne i32 %53, 0
  br i1 %54, label %55, label %58

; <label>:55                                      ; preds = %52
  %56 = load i32, i32* %lrc, align 4
  %57 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @sec.fl, i32 0, i32 0), i32 %56)
  br label %58
...
; <label>:62                                      ; preds = %59
  ...
  %63 = load i32, i32* %prlc, align 4
  %64 = icmp ne i32 %63, 0
  br i1 %64, label %65, label %68

; <label>:65                                      ; preds = %62
  %66 = load i32, i32* %lrc, align 4
  %67 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @sec.fl, i32 0, i32 0), i32 %66)
  br label %68
...
; <label>:81                                      ; preds = %76
  ...
  %82 = load i32, i32* %prlc, align 4
  %83 = icmp ne i32 %82, 0
  br i1 %83, label %84, label %87

; <label>:84                                      ; preds = %81
  %85 = load i32, i32* %lrc, align 4
  %86 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @sec.fl, i32 0, i32 0), i32 %85)
  br label %87
...
; <label>:94                                      ; preds = %91
  ...
  %96 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @sec.fl, i32 0, i32 0), i32 %95)
  br label %97
...
; <label>:101                                     ; preds = %98
  ...
  %102 = load i32, i32* %prlc, align 4
  %103 = icmp ne i32 %102, 0
  br i1 %103, label %104, label %107

; <label>:104                                     ; preds = %101
  %105 = load i32, i32* %lrc, align 4
  %106 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @sec.fl, i32 0, i32 0), i32 %105)
  br label %107
...
; <label>:123                                     ; preds = %120
  ...
  %125 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @sec.fl, i32 0, i32 0), i32 %124)
  br label %126
...
; <label>:130                                     ; preds = %127
  ...
  %131 = load i32, i32* %prlc, align 4
  %132 = icmp ne i32 %131, 0
  br i1 %132, label %133, label %136

; <label>:133                                     ; preds = %130
  %134 = load i32, i32* %lrc, align 4
  %135 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @sec.fl, i32 0, i32 0), i32 %134)
  br label %136
...
; <label>:143                                     ; preds = %140
  ...
  %145 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @sec.fl, i32 0, i32 0), i32 %144)
  br label %146
...
; <label>:159                                     ; preds = %154
  ...
  %160 = load i32, i32* %prlc, align 4
  %161 = icmp ne i32 %160, 0
  br i1 %161, label %162, label %165

; <label>:162                                     ; preds = %159
  %163 = load i32, i32* %lrc, align 4
  %164 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @sec.fl, i32 0, i32 0), i32 %163)
  br label %165
...
; <label>:169                                     ; preds = %166
  ...
  %170 = load i32, i32* %prlc, align 4
  %171 = icmp ne i32 %170, 0
  br i1 %171, label %172, label %175

; <label>:172                                     ; preds = %169
  %173 = load i32, i32* %lrc, align 4
  %174 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @sec.fl, i32 0, i32 0), i32 %173)
  br label %175
...
; <label>:179                                     ; preds = %176
  ...
  %180 = load i32, i32* %prlc, align 4
  %181 = icmp ne i32 %180, 0
  br i1 %181, label %182, label %185

; <label>:182                                     ; preds = %179
  %183 = load i32, i32* %lrc, align 4
  %184 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @sec.fl, i32 0, i32 0), i32 %183)
  br label %185
...
; <label>:186                                     ; preds = %185, %176
  %187 = load i32, i32* %lrc, align 4
  %188 = icmp ne i32 %187, 0
  br i1 %188, label %189, label %199

; <label>:189                                     ; preds = %186
  %190 = load %struct.defs*, %struct.defs** %1, align 8
  %191 = getelementptr inbounds %struct.defs, %struct.defs* %190, i32 0, i32 11
  %192 = load i32, i32* %191, align 4
  %193 = icmp ne i32 %192, 0
  br i1 %193, label %194, label %196

; <label>:194                                     ; preds = %189
  %195 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @sec.s7813er, i32 0, i32 0), i32 2)
  br label %196

; <label>:196                                     ; preds = %194, %189
  %197 = load i32, i32* %rc, align 4
...
; <label>:211                                     ; preds = %206
  store i32 1, i32* %lrc, align 4
  %212 = load i32, i32* %prlc, align 4
  %213 = icmp ne i32 %212, 0
  br i1 %213, label %214, label %217

; <label>:214                                     ; preds = %211
  %215 = load i32, i32* %lrc, align 4
  %216 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @sec.fl, i32 0, i32 0), i32 %215)
  br label %217
...
; <label>:221                                     ; preds = %218
  store i32 2, i32* %lrc, align 4
  %222 = load i32, i32* %prlc, align 4
  %223 = icmp ne i32 %222, 0
  br i1 %223, label %224, label %227

; <label>:224                                     ; preds = %221
  %225 = load i32, i32* %lrc, align 4
  %226 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @sec.fl, i32 0, i32 0), i32 %225)
  br label %227
...
; <label>:234                                     ; preds = %231
  ...
  %236 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @sec.fl, i32 0, i32 0), i32 %235)
  br label %237
...
; <label>:250                                     ; preds = %245
  store i32 4, i32* %lrc, align 4
  %251 = load i32, i32* %prlc, align 4
  %252 = icmp ne i32 %251, 0
  br i1 %252, label %253, label %256

; <label>:253                                     ; preds = %250
  %254 = load i32, i32* %lrc, align 4
  %255 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @sec.fl, i32 0, i32 0), i32 %254)
  br label %256
...
; <label>:260                                     ; preds = %257
  store i32 5, i32* %lrc, align 4
  %261 = load i32, i32* %prlc, align 4
  %262 = icmp ne i32 %261, 0
  br i1 %262, label %263, label %266

; <label>:263                                     ; preds = %260
  %264 = load i32, i32* %lrc, align 4
  %265 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @sec.fl, i32 0, i32 0), i32 %264)
  br label %266
...
; <label>:273                                     ; preds = %270
  ...
  %275 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @sec.fl, i32 0, i32 0), i32 %274)
  br label %276
...
; <label>:290                                     ; preds = %285
  store i32 7, i32* %lrc, align 4
  %291 = load i32, i32* %prlc, align 4
  %292 = icmp ne i32 %291, 0
  br i1 %292, label %293, label %296

; <label>:293                                     ; preds = %290
  %294 = load i32, i32* %lrc, align 4
  %295 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @sec.fl, i32 0, i32 0), i32 %294)
  br label %296
...
; <label>:303                                     ; preds = %300
  ...
  %305 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @sec.fl, i32 0, i32 0), i32 %304)
  br label %306
...
; <label>:310                                     ; preds = %307
  store i32 9, i32* %lrc, align 4
  %311 = load i32, i32* %prlc, align 4
  %312 = icmp ne i32 %311, 0
  br i1 %312, label %313, label %316

; <label>:313                                     ; preds = %310
  %314 = load i32, i32* %lrc, align 4
  %315 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @sec.fl, i32 0, i32 0), i32 %314)
  br label %316
...
; <label>:329                                     ; preds = %324
  store i32 10, i32* %lrc, align 4
  %330 = load i32, i32* %prlc, align 4
  %331 = icmp ne i32 %330, 0
  br i1 %331, label %332, label %335

; <label>:332                                     ; preds = %329
  %333 = load i32, i32* %lrc, align 4
  %334 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @sec.fl, i32 0, i32 0), i32 %333)
  br label %335
...
; <label>:342                                     ; preds = %339
  ...
  %344 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @sec.fl, i32 0, i32 0), i32 %343)
  br label %345
...
; <label>:352                                     ; preds = %349
  ...
  %354 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @sec.fl, i32 0, i32 0), i32 %353)
  br label %355
...
; <label>:356                                     ; preds = %355, %346
  %357 = load i32, i32* %lrc, align 4
  %358 = icmp ne i32 %357, 0
  br i1 %358, label %359, label %369

; <label>:359                                     ; preds = %356
  %360 = load %struct.defs*, %struct.defs** %1, align 8
  %361 = getelementptr inbounds %struct.defs, %struct.defs* %360, i32 0, i32 11
  %362 = load i32, i32* %361, align 4
  %363 = icmp ne i32 %362, 0
  br i1 %363, label %364, label %366

; <label>:364                                     ; preds = %359
  %365 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @sec.s7813er, i32 0, i32 0), i32 4)
  br label %366

; <label>:366                                     ; preds = %364, %359
  %367 = load i32, i32* %rc, align 4
...
; <label>:369                                     ; preds = %366, %356
  ...
  %370 = load i32, i32* %one, align 4
  %371 = icmp ne i32 %370, 0
  br i1 %371, label %372, label %374

; <label>:372                                     ; preds = %369
  %373 = load i32, i32* %zero, align 4
  br label %385

; <label>:374                                     ; preds = %369
  %375 = load i32, i32* %one, align 4
...
; <label>:395                                     ; preds = %392, %389, %385
  %396 = load %struct.defs*, %struct.defs** %1, align 8
  %397 = getelementptr inbounds %struct.defs, %struct.defs* %396, i32 0, i32 11
  %398 = load i32, i32* %397, align 4
  %399 = icmp ne i32 %398, 0
  br i1 %399, label %400, label %402

; <label>:400                                     ; preds = %395
  %401 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @sec.s7813er, i32 0, i32 0), i32 8)
  br label %402

; <label>:402                                     ; preds = %400, %395
  %403 = load i32, i32* %rc, align 4
  %404 = add nsw i32 %403, 8
  store i32 %404, i32* %rc, align 4
  br label %405

; <label>:405                                     ; preds = %402, %392
  %406 = load i32, i32* %one, align 4
  %407 = icmp ne i32 %406, 0
  br i1 %407, label %408, label %410

; <label>:408                                     ; preds = %405
  %409 = load i32, i32* %zero, align 4
  br label %411
...
; <label>:423                                     ; preds = %420, %411
  %424 = load %struct.defs*, %struct.defs** %1, align 8
  %425 = getelementptr inbounds %struct.defs, %struct.defs* %424, i32 0, i32 11
  %426 = load i32, i32* %425, align 4
  %427 = icmp ne i32 %426, 0
  br i1 %427, label %428, label %430

; <label>:428                                     ; preds = %423
  %429 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @sec.s7813er, i32 0, i32 0), i32 16)
  br label %430

; <label>:430                                     ; preds = %428, %423
  %431 = load i32, i32* %rc, align 4
  %432 = add nsw i32 %431, 16
  store i32 %432, i32* %rc, align 4
  br label %433

; <label>:433                                     ; preds = %430, %420
  %434 = load i32, i32* %rc, align 4
  ret i32 %434
}
