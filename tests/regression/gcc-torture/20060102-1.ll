; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20060102-1.c'
...
entry:
  ...
  %call = call i32 @f(i32 %tmp)
  %tmp1 = volatile load i32* @one, align 4
  %sub = sub nsw i32 0, %tmp1
  %call2 = call i32 @f(i32 %sub)
