; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/931004-7.c'
...
define void @f(i32 %n, i8 %x.coerce, i8 %y.coerce, i8 %z.coerce, i64 %l) nounwind uwtable {
entry:
  ...
  store i8 %y.coerce, i8* %coerce.dive1
  %coerce.dive2 = getelementptr %struct.tiny* %z, i32 0, i32 0
  store i8 %z.coerce, i8* %coerce.dive2
...
entry:
  ...
  call void @f(i32 3, i8 %0, i8 %1, i8 %2, i64 123)
