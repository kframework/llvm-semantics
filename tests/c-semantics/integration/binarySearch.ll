...
; <label>:37                                      ; preds = %29
  %38 = load i32* %middle, align 4
  %39 = add nsw i32 %38, 1
  store i32 %39, i32* %3, align 4
  br label %42

; <label>:40                                      ; preds = %29
  %41 = load i32* %middle, align 4
  store i32 %41, i32* %1
  br label %64
...
; <label>:44                                      ; preds = %8
  ...
  %46 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str, i32 0, i32 0), i32 %45)
  %47 = load i32* %origLow, align 4
  store i32 %47, i32* %i, align 4
  br label %48

; <label>:48                                      ; preds = %60, %44
  %49 = load i32* %i, align 4
  %50 = load i32* %origHigh, align 4
...
; <label>:52                                      ; preds = %48
  ...
  %56 = load i32** %2, align 8
  %57 = getelementptr inbounds i32* %56, i64 %55
  %58 = load i32* %57, align 4
  %59 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str1, i32 0, i32 0), i32 %53, i32 %58)
  br label %60
...
define i32 @main() #0 {
  ...
  %2 = load i32* %num_elements, align 4
  %3 = sext i32 %2 to i64
  %4 = mul i64 %3, 4
...
; <label>:7                                       ; preds = %30, %0
  %8 = load i32* %i, align 4
  %9 = load i32* %num_elements, align 4
  %10 = icmp slt i32 %8, %9
...
; <label>:12                                      ; preds = %20, %11
  %13 = call i32 @rand() #3
  %14 = load i32* %num_elements, align 4
  %15 = srem i32 %13, %14
...
; <label>:20                                      ; preds = %12
  ...
  %26 = load i32* %num_elements, align 4
  %27 = sdiv i32 %26, 7
...
; <label>:33                                      ; preds = %7
  %34 = load i32** %a, align 8
  %35 = load i32* %num_elements, align 4
...
; <label>:39                                      ; preds = %36
  %40 = call i32 @rand() #3
  %41 = load i32* %num_elements, align 4
  %42 = srem i32 %40, %41
  ...
  %47 = load i32** %a, align 8
  %48 = load i32* %num_elements, align 4
  %49 = sub nsw i32 %48, 1
  %50 = load i32* %present_val, align 4
  %51 = call i32 @binary_search(i32* %47, i32 0, i32 %49, i32 %50)
  store i32 %51, i32* %found_at, align 4
  %52 = load i32* %present_val, align 4
  %53 = load i32* %found_at, align 4
...
; <label>:59                                      ; preds = %39
  %60 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str2, i32 0, i32 0))
  br label %71

; <label>:61                                      ; preds = %39
  %62 = load i32* %present_val, align 4
  %63 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @.str3, i32 0, i32 0), i32 %62)
  %64 = load i32* %found_at, align 4
  %65 = sext i32 %64 to i64
  %66 = load i32** %a, align 8
  %67 = getelementptr inbounds i32* %66, i64 %65
  %68 = load i32* %67, align 4
  %69 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str4, i32 0, i32 0), i32 %68)
  %70 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([32 x i8]* @.str5, i32 0, i32 0))
  br label %71
