; ModuleID = '/home/grosu/celliso2/c-semantics/tests/unitTests/cq-18-s9.c'
...
@sec.s9er = internal global [9 x i8] c"s9,er%d\0A\00", align 1
@sec.qs9 = internal global [8 x i8] c"s9     \00", align 1
...
entry:
  ...
  store %struct.defs* %pd0, %struct.defs** %pd0.addr, align 8
  store i8* getelementptr inbounds ([8 x i8]* @sec.qs9, i32 0, i32 0), i8** %ps, align 8
  %tmp = load %struct.defs** %pd0.addr, align 8
  %rfs = getelementptr inbounds %struct.defs* %tmp, i32 0, i32 15
  %arraydecay = getelementptr inbounds [8 x i8]* %rfs, i32 0, i32 0
  store i8* %arraydecay, i8** %pt, align 8
...
for.cond:                                         ; preds = %for.inc, %while.end
  ...
  %cmp = icmp slt i32 %tmp5, 2
  br i1 %cmp, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  store i32 2, i32* %k, align 4
  store i32 2, i32* %j, align 4
  store i32 3, i32* %k11, align 4
  store i32 3, i32* %j9, align 4
  %tmp12 = load i32* %j9, align 4
  %cmp13 = icmp ne i32 %tmp12, 3
  br i1 %cmp13, label %if.then, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %for.body
  %tmp14 = load i32* %k11, align 4
  %cmp15 = icmp ne i32 %tmp14, 3
...
for.end:                                          ; preds = %for.cond
  %tmp24 = load i32* %lrc, align 4
  %cmp25 = icmp ne i32 %tmp24, 0
  br i1 %cmp25, label %if.then26, label %if.end33

if.then26:                                        ; preds = %for.end
  %tmp27 = load %struct.defs** %pd0.addr, align 8
  %flgd = getelementptr inbounds %struct.defs* %tmp27, i32 0, i32 11
  %tmp28 = load i32* %flgd, align 4
  %cmp29 = icmp ne i32 %tmp28, 0
  br i1 %cmp29, label %if.then30, label %if.end31

if.then30:                                        ; preds = %if.then26
  %call = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @sec.s9er, i32 0, i32 0), i32 1)
  br label %if.end31
