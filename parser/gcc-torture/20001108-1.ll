; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20001108-1.c'
...
entry:
  ...
  %tmp = load i64* %sum.addr, align 8
  %tmp1 = load i64* %x.addr, align 8
  %mul = mul nsw i64 %tmp, %tmp1
  %tmp2 = load i64* %sum.addr, align 8
  %add = add nsw i64 %tmp2, %mul
  store i64 %add, i64* %sum.addr, align 8
  %tmp3 = load i64* %sum.addr, align 8
  ret i64 %tmp3
}
...
entry:
  ...
  %tmp = load i64* %sum.addr, align 8
  %tmp1 = load i64* %x.addr, align 8
  %mul = mul i64 %tmp, %tmp1
  %tmp2 = load i64* %sum.addr, align 8
  %add = add i64 %tmp2, %mul
  store i64 %add, i64* %sum.addr, align 8
  %tmp3 = load i64* %sum.addr, align 8
  ret i64 %tmp3
}
