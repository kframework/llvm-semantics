; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith001921.c'
...
for.body4:                                        ; preds = %for.cond1
  ...
  %arrayidx = getelementptr inbounds [9 x [1 x i32]]* %l_2, i32 0, i64 %idxprom7
  %arrayidx8 = getelementptr inbounds [1 x i32]* %arrayidx, i32 0, i64 %idxprom
  store i32 1250716243, i32* %arrayidx8, align 4
  br label %for.inc
...
for.end13:                                        ; preds = %for.cond
  %arrayidx14 = getelementptr inbounds [9 x [1 x i32]]* %l_2, i32 0, i64 4
  %arrayidx15 = getelementptr inbounds [1 x i32]* %arrayidx14, i32 0, i64 0
