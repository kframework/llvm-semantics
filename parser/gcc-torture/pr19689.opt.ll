; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/pr19689.ll'
...
entry:
  ...
  %0 = and i32 %conv, 536870911
  %1 = load i32* bitcast (%struct.anon* @f to i32*), align 4
  %2 = and i32 %1, -536870912
  %3 = or i32 %2, %0
  store i32 %3, i32* bitcast (%struct.anon* @f to i32*), align 4
  ret void
}
