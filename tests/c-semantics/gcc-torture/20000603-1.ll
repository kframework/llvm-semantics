...
define double @f(%struct.s1* %a, %struct.s2* %b) #0 {
  ...
  %3 = load %struct.s1** %1, align 8
  %4 = getelementptr inbounds %struct.s1* %3, i32 0, i32 0
  store double 1.000000e+00, double* %4, align 8
  %5 = load %struct.s2** %2, align 8
  %6 = getelementptr inbounds %struct.s2* %5, i32 0, i32 0
...
define i32 @main() #0 {
  ...
  %3 = getelementptr inbounds %struct.s1* %2, i32 0, i32 0
