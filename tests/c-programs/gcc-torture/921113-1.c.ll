...
define void @gitter(i32 %count, %struct.vector_t* %pos, %struct.struct_list* %list, i32* %nww, %struct.vector_t* %limit, float %r) #0 {
  ...
  %7 = load %struct.vector_t*, %struct.vector_t** %5, align 8
  %8 = getelementptr inbounds %struct.vector_t, %struct.vector_t* %7, i64 0
  %9 = getelementptr inbounds %struct.vector_t, %struct.vector_t* %8, i32 0, i32 0
  %10 = load float, float* %9, align 4
  %11 = load %struct.vector_t*, %struct.vector_t** %5, align 8
  %12 = getelementptr inbounds %struct.vector_t, %struct.vector_t* %11, i64 0
  %13 = getelementptr inbounds %struct.vector_t, %struct.vector_t* %12, i32 0, i32 1
  %14 = load float, float* %13, align 4
  call void @f1(float %10, float %14)
  %15 = load %struct.vector_t*, %struct.vector_t** %5, align 8
  %16 = getelementptr inbounds %struct.vector_t, %struct.vector_t* %15, i64 1
  %17 = getelementptr inbounds %struct.vector_t, %struct.vector_t* %16, i32 0, i32 0
  %18 = load float, float* %17, align 4
  %19 = load %struct.vector_t*, %struct.vector_t** %5, align 8
  %20 = getelementptr inbounds %struct.vector_t, %struct.vector_t* %19, i64 1
  %21 = getelementptr inbounds %struct.vector_t, %struct.vector_t* %20, i32 0, i32 1
  %22 = load float, float* %21, align 4
  call void @f2(float %18, float %22)
  %23 = load i32*, i32** %4, align 8
  store i32 0, i32* %23, align 4
  %24 = load %struct.vector_t*, %struct.vector_t** %2, align 8
  %25 = getelementptr inbounds %struct.vector_t, %struct.vector_t* %24, i64 0
  %26 = getelementptr inbounds %struct.vector_t, %struct.vector_t* %25, i32 0, i32 0
...
; <label>:40                                      ; preds = %31
  ...
  %43 = load %struct.struct_list*, %struct.struct_list** %3, align 8
  %44 = getelementptr inbounds %struct.struct_list, %struct.struct_list* %43, i64 0
  %45 = getelementptr inbounds %struct.struct_list, %struct.struct_list* %44, i32 0, i32 0
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  call void @gitter(i32 1, %struct.vector_t* getelementptr inbounds ([1 x %struct.vector_t], [1 x %struct.vector_t]* @pos, i32 0, i32 0), %struct.struct_list* %list, i32* %nww, %struct.vector_t* getelementptr inbounds ([2 x %struct.vector_t], [2 x %struct.vector_t]* @limit, i32 0, i32 0), float 1.000000e+00)
