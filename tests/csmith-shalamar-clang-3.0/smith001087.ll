; ModuleID = '/home/david/src/c-semantics/tests/csmith/smith001087.c'
...
define i64 @func_1() nounwind uwtable {
  %1 = load i32* getelementptr inbounds ([3 x i32]* @g_2, i32 0, i64 2), align 4
  %2 = sext i32 %1 to i64
  ret i64 %2
}
...
define i32 @main(i32 %argc, i8** %argv) nounwind uwtable {
  ...
  %11 = load i32* getelementptr inbounds ([3 x i32]* @g_2, i32 0, i64 2), align 4
