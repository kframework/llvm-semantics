...
define i32 @f() #0 {
  ...
  %1 = load [20 x i32]** @b, align 8
  %2 = getelementptr inbounds [20 x i32]* %1, i64 1
  %3 = getelementptr inbounds [20 x i32]* %2, i32 0, i32 0
...
; <label>:21                                      ; preds = %18
  ...
  %24 = getelementptr inbounds [20 x i32]* getelementptr inbounds ([10 x [20 x i32]]* @a, i32 0, i64 1), i32 0, i64 %23
