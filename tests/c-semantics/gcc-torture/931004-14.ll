...
; <label>:43                                      ; preds = %35
  %44 = getelementptr inbounds %struct.tiny* %x, i32 0, i32 2
...
; <label>:51                                      ; preds = %43
  %52 = getelementptr inbounds %struct.tiny* %x, i32 0, i32 3
...
; <label>:63                                      ; preds = %4
  %64 = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
  %65 = getelementptr inbounds %struct.__va_list_tag* %64, i32 0, i32 0
  %66 = load i32* %65
  %67 = icmp ule i32 %66, 40
  br i1 %67, label %68, label %74

; <label>:68                                      ; preds = %63
  %69 = getelementptr inbounds %struct.__va_list_tag* %64, i32 0, i32 3
  %70 = load i8** %69
  %71 = getelementptr i8* %70, i32 %66
...
; <label>:74                                      ; preds = %63
  %75 = getelementptr inbounds %struct.__va_list_tag* %64, i32 0, i32 2
  %76 = load i8** %75
  %77 = bitcast i8* %76 to i64*
  %78 = getelementptr i8* %76, i32 8
  store i8* %78, i8** %75
  br label %79
