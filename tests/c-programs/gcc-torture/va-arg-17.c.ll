...
; <label>:87                                      ; preds = %82
  ...
  %89 = getelementptr inbounds %struct.__va_list_tag, %struct.__va_list_tag* %88, i32 0, i32 1
  %90 = load i32, i32* %89
...
; <label>:108                                     ; preds = %103
  ...
  %110 = getelementptr inbounds %struct.__va_list_tag, %struct.__va_list_tag* %109, i32 0, i32 1
...
; <label>:129                                     ; preds = %124
  ...
  %131 = getelementptr inbounds %struct.__va_list_tag, %struct.__va_list_tag* %130, i32 0, i32 1
...
; <label>:150                                     ; preds = %145
  ...
  %152 = getelementptr inbounds %struct.__va_list_tag, %struct.__va_list_tag* %151, i32 0, i32 1
...
; <label>:171                                     ; preds = %166
  ...
  %173 = getelementptr inbounds %struct.__va_list_tag, %struct.__va_list_tag* %172, i32 0, i32 1
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  call void (i8*, ...) @vafunction(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str, i32 0, i32 0), double 1.000000e+00, double 2.000000e+00, double 3.000000e+00, double 4.000000e+00, double 5.000000e+00, double 6.000000e+00, double 7.000000e+00, double 8.000000e+00, double 9.000000e+00)
