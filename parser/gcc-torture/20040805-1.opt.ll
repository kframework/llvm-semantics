; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20040805-1.ll'
...
entry:
  ...
  store i32 %tmp, i32* getelementptr inbounds ([2 x i32]* @a, i64 0, i64 1), align 4
  %call = tail call fastcc i32 @bar(i32 100)
  %call5 = tail call fastcc i32 @bar(i32 %tmp)
...
entry:
  ...
  store i32 %inc, i32* getelementptr inbounds ([2 x i32]* @a, i64 0, i64 0), align 4
  ret i32 %x
}
