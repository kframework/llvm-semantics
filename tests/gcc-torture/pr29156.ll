; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/pr29156.c'
...
entry:
  ...
  %tmp = load %struct.test2** %xb.addr, align 8
  %sub = getelementptr inbounds %struct.test2* %tmp, i32 0, i32 1
  %a = getelementptr inbounds %struct.test1* %sub, i32 0, i32 0
  store i32 1, i32* %a, align 4
  %tmp1 = load %struct.test1** %xa.addr, align 8
  %a2 = getelementptr inbounds %struct.test1* %tmp1, i32 0, i32 0
  store i32 8, i32* %a2, align 4
  %tmp3 = load %struct.test2** %xb.addr, align 8
  %sub4 = getelementptr inbounds %struct.test2* %tmp3, i32 0, i32 1
  %a5 = getelementptr inbounds %struct.test1* %sub4, i32 0, i32 0
