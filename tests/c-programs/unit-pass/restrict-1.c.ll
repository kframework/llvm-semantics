...
define internal i64 @foo(%struct.A* %p, %struct.A* %q) #1 {
  %1 = alloca %struct.A, align 4
  %2 = alloca %struct.A*, align 8
  %3 = alloca %struct.A*, align 8
  store %struct.A* %p, %struct.A** %2, align 8
  store %struct.A* %q, %struct.A** %3, align 8
  %4 = getelementptr inbounds %struct.A, %struct.A* %1, i32 0, i32 0
