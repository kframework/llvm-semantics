...
define i32 @bar(%struct.__jmp_buf_tag* %buf, i32 %i) #0 {
  ...
  %6 = load %struct.__jmp_buf_tag*, %struct.__jmp_buf_tag** %2, align 8
...
; <label>:5                                       ; preds = %0
  ...
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.1, i32 0, i32 0), i32 %6)
...
; <label>:11                                      ; preds = %5
  ...
  %13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.1, i32 0, i32 0), i32 %12)
  br label %17

; <label>:14                                      ; preds = %5
  %15 = getelementptr inbounds [1 x %struct.__jmp_buf_tag], [1 x %struct.__jmp_buf_tag]* %buf, i32 0, i32 0
...
; <label>:18                                      ; preds = %0
  %19 = getelementptr inbounds [1 x %struct.__jmp_buf_tag], [1 x %struct.__jmp_buf_tag]* %buf, i32 0, i32 0
