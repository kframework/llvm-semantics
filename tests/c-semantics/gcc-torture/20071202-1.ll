...
define void @foo(%struct.S* %s) #0 {
  ...
  %6 = getelementptr inbounds %struct.S* %5, i32 0, i32 1
  %7 = load i32* %6, align 4
  store i32 %7, i32* %4, align 4
  %8 = getelementptr inbounds %struct.S* %2, i32 0, i32 1
  %9 = load %struct.S** %1, align 8
  %10 = getelementptr inbounds %struct.S* %9, i32 0, i32 0
  %11 = load i32* %10, align 4
  store i32 %11, i32* %8, align 4
  %12 = getelementptr inbounds %struct.S* %2, i32 0, i32 2
  %13 = bitcast [6 x i32]* %12 to i8*
  call void @llvm.memset.p0i8.i64(i8* %13, i8 0, i64 24, i32 4, i1 false)
  %14 = getelementptr inbounds [6 x i32]* %12, i64 0, i64 0
  ...
  %20 = getelementptr inbounds %struct.S* %2, i32 0, i32 3
  %21 = load %struct.S** %1, align 8
  %22 = getelementptr inbounds %struct.S* %21, i32 0, i32 3
...
; <label>:6                                       ; preds = %0
  %7 = getelementptr inbounds %struct.S* %s, i32 0, i32 1
  %8 = load i32* %7, align 4
  %9 = icmp ne i32 %8, 6
  br i1 %9, label %40, label %10

; <label>:10                                      ; preds = %6
  %11 = getelementptr inbounds %struct.S* %s, i32 0, i32 2
  %12 = getelementptr inbounds [6 x i32]* %11, i32 0, i64 0
  %13 = load i32* %12, align 4
  %14 = icmp ne i32 %13, 0
  br i1 %14, label %40, label %15

; <label>:15                                      ; preds = %10
  %16 = getelementptr inbounds %struct.S* %s, i32 0, i32 2
  %17 = getelementptr inbounds [6 x i32]* %16, i32 0, i64 1
...
; <label>:20                                      ; preds = %15
  ...
  %22 = getelementptr inbounds [6 x i32]* %21, i32 0, i64 2
  %23 = load i32* %22, align 4
  %24 = icmp ne i32 %23, 0
  br i1 %24, label %40, label %25

; <label>:25                                      ; preds = %20
  %26 = getelementptr inbounds %struct.S* %s, i32 0, i32 2
  %27 = getelementptr inbounds [6 x i32]* %26, i32 0, i64 3
  %28 = load i32* %27, align 4
  %29 = icmp ne i32 %28, 0
  br i1 %29, label %40, label %30

; <label>:30                                      ; preds = %25
  %31 = getelementptr inbounds %struct.S* %s, i32 0, i32 2
  %32 = getelementptr inbounds [6 x i32]* %31, i32 0, i64 4
  %33 = load i32* %32, align 4
  %34 = icmp ne i32 %33, 0
  br i1 %34, label %40, label %35

; <label>:35                                      ; preds = %30
  %36 = getelementptr inbounds %struct.S* %s, i32 0, i32 2
  %37 = getelementptr inbounds [6 x i32]* %36, i32 0, i64 5
...
; <label>:52                                      ; preds = %46
  %53 = getelementptr inbounds %struct.S* %s, i32 0, i32 3
...
; <label>:58                                      ; preds = %52
  %59 = getelementptr inbounds %struct.S* %s, i32 0, i32 3
...
; <label>:64                                      ; preds = %58
  %65 = getelementptr inbounds %struct.S* %s, i32 0, i32 3
...
; <label>:70                                      ; preds = %64
  %71 = getelementptr inbounds %struct.S* %s, i32 0, i32 3
...
; <label>:76                                      ; preds = %70
  %77 = getelementptr inbounds %struct.S* %s, i32 0, i32 3
...
; <label>:82                                      ; preds = %76
  %83 = getelementptr inbounds %struct.S* %s, i32 0, i32 3
...
; <label>:88                                      ; preds = %82
  %89 = getelementptr inbounds %struct.S* %s, i32 0, i32 3
