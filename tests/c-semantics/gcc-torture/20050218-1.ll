...
; <label>:9                                       ; preds = %5
  ...
  %14 = getelementptr inbounds [16 x i8*]* @a, i32 0, i64 %13
  %15 = load i8** %14, align 8
  %16 = load i64* %i, align 8
  %17 = getelementptr inbounds [16 x i8*]* @a, i32 0, i64 %16
...
; <label>:23                                      ; preds = %9
  ...
  %25 = getelementptr inbounds [16 x i8*]* @a, i32 0, i64 %24
...
define i32 @main() #0 {
  %1 = alloca i32, align 4
  store i32 0, i32* %1
  %2 = call i32 @foo(i8* getelementptr inbounds ([6 x i8]* @.str4, i32 0, i32 0), i8* null, i64 3)
  %3 = icmp ne i32 %2, 0
