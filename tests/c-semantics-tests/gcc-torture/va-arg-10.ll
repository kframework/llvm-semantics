...
entry:
  ...
  %3 = load i8** %format.addr, align 8
  store i8* %3, i8** %formatc, align 8
...
while.cond:                                       ; preds = %if.end7, %if.end
  %6 = load i8** %format.addr, align 8
  %7 = load i8* %6, align 1
  %tobool = icmp ne i8 %7, 0
  br i1 %tobool, label %while.body, label %while.end

while.body:                                       ; preds = %while.cond
  %8 = load i8** %format.addr, align 8
  %incdec.ptr = getelementptr inbounds i8* %8, i32 1
  store i8* %incdec.ptr, i8** %format.addr, align 8
  %9 = load i8* %8, align 1
  %conv2 = sext i8 %9 to i32
  %10 = load %struct.__va_list_tag** %ap.addr, align 8
  %11 = va_arg %struct.__va_list_tag* %10, i32
  %call3 = call i32 @to_hex(i32 %11)
...
while.cond8:                                      ; preds = %if.end18, %while.end
  %12 = load i8** %formatc, align 8
  %13 = load i8* %12, align 1
  %tobool9 = icmp ne i8 %13, 0
  br i1 %tobool9, label %while.body10, label %while.end19

while.body10:                                     ; preds = %while.cond8
  %14 = load i8** %formatc, align 8
  %incdec.ptr11 = getelementptr inbounds i8* %14, i32 1
  store i8* %incdec.ptr11, i8** %formatc, align 8
  %15 = load i8* %14, align 1
  %conv12 = sext i8 %15 to i32
  %arraydecay13 = getelementptr inbounds [1 x %struct.__va_list_tag]* %apc, i32 0, i32 0
  %16 = va_arg %struct.__va_list_tag* %arraydecay13, i32
  %call14 = call i32 @to_hex(i32 %16)
  %cmp15 = icmp ne i32 %conv12, %call14
