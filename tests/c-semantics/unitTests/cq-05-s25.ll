...
; <label>:23                                      ; preds = %13
  ...
  %29 = getelementptr inbounds i8* %28, i64 2
...
; <label>:33                                      ; preds = %23
  ...
  %35 = getelementptr inbounds i8* %34, i64 2
...
; <label>:39                                      ; preds = %33, %23, %13
  ...
  %42 = load %struct.defs** %1, align 8
  %43 = getelementptr inbounds %struct.defs* %42, i32 0, i32 11
  %44 = load i32* %43, align 4
  %45 = icmp ne i32 %44, 0
  br i1 %45, label %46, label %48

; <label>:46                                      ; preds = %39
  %47 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s25er, i32 0, i32 0), i32 1)
  br label %48
...
; <label>:55                                      ; preds = %49
  %56 = load i32* %rc, align 4
  %57 = add nsw i32 %56, 4
  store i32 %57, i32* %rc, align 4
  %58 = load %struct.defs** %1, align 8
  %59 = getelementptr inbounds %struct.defs* %58, i32 0, i32 11
  %60 = load i32* %59, align 4
  %61 = icmp ne i32 %60, 0
  br i1 %61, label %62, label %64

; <label>:62                                      ; preds = %55
  %63 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s25er, i32 0, i32 0), i32 4)
  br label %64
...
; <label>:65                                      ; preds = %64, %49
  %66 = load i8* getelementptr inbounds ([4 x i8]* @.str1, i32 0, i64 1), align 1
...
; <label>:69                                      ; preds = %65
  ...
  %72 = load %struct.defs** %1, align 8
  %73 = getelementptr inbounds %struct.defs* %72, i32 0, i32 11
  %74 = load i32* %73, align 4
  %75 = icmp ne i32 %74, 0
  br i1 %75, label %76, label %78

; <label>:76                                      ; preds = %69
  %77 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s25er, i32 0, i32 0), i32 8)
  br label %78
...
; <label>:115                                     ; preds = %109
  %116 = load i8** %s, align 8
  %117 = getelementptr inbounds i8* %116, i64 6
...
; <label>:121                                     ; preds = %115, %109, %103, %97, %91, %85, %79
  %122 = load i32* %rc, align 4
  %123 = add nsw i32 %122, 16
  store i32 %123, i32* %rc, align 4
  %124 = load %struct.defs** %1, align 8
  %125 = getelementptr inbounds %struct.defs* %124, i32 0, i32 11
  %126 = load i32* %125, align 4
  %127 = icmp ne i32 %126, 0
  br i1 %127, label %128, label %130

; <label>:128                                     ; preds = %121
  %129 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s25er, i32 0, i32 0), i32 16)
  br label %130
...
; <label>:155                                     ; preds = %132
  %156 = load i32* %lrc, align 4
  %157 = icmp ne i32 %156, 0
  br i1 %157, label %158, label %168

; <label>:158                                     ; preds = %155
  %159 = load i32* %rc, align 4
  %160 = add nsw i32 %159, 32
  store i32 %160, i32* %rc, align 4
  %161 = load %struct.defs** %1, align 8
  %162 = getelementptr inbounds %struct.defs* %161, i32 0, i32 11
  %163 = load i32* %162, align 4
  %164 = icmp ne i32 %163, 0
  br i1 %164, label %165, label %167

; <label>:165                                     ; preds = %158
  %166 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s25er, i32 0, i32 0), i32 32)
  br label %167
...
; <label>:9                                       ; preds = %0
  ...
  %11 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds (%struct.defs* @main.d0, i32 0, i32 15, i32 0), i32 %10)
  br label %12
...
; <label>:15                                      ; preds = %12
  %16 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str5, i32 0, i32 0))
  br label %19

; <label>:17                                      ; preds = %12
  %18 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str6, i32 0, i32 0))
  br label %19
