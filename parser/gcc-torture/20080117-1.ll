; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20080117-1.c'
...
entry:
  ...
  %tmp = load %struct.gs_imager_state_s** %pgs.addr, align 8
  %tmp1 = bitcast %struct.gs_imager_state_s* %tmp to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %tmp1, i8* bitcast (%struct.gs_imager_state_s* @gstate_initial to i8*), i64 12, i32 4, i1 false)
  ret void
}
...
entry:
  %tmp = load i32* getelementptr inbounds (%struct.gs_imager_state_s* @gstate_initial, i32 0, i32 0, i32 0), align 4
  ret i32 %tmp
}
