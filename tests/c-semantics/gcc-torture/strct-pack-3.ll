...
define i32 @f(%struct.A* %ap) #0 {
  ...
  %2 = load %struct.A** %1, align 8
  %3 = getelementptr inbounds %struct.A* %2, i32 0, i32 1
  ...
  %8 = sext i16 %7 to i64
  %9 = load %struct.A** %1, align 8
  %10 = getelementptr inbounds %struct.A* %9, i32 0, i32 1
  %11 = getelementptr inbounds [2 x i32]* %10, i32 0, i64 %8
  %12 = load i32* %11, align 2
...
; <label>:21                                      ; preds = %17
  ...
  %24 = load %struct.A** %1, align 8
  %25 = getelementptr inbounds %struct.A* %24, i32 0, i32 1
  %26 = getelementptr inbounds [2 x i32]* %25, i32 0, i64 %23
  %27 = load i32* %26, align 2
...
define i32 @main() #0 {
  ...
  %4 = getelementptr inbounds %struct.A* %a, i32 0, i32 1
