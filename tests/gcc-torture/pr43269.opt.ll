; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/pr43269.ll'
...
entry:
  ...
  %tmp21 = load i32* @g_211, align 4
  %tobool32 = icmp eq i32 %tmp21, -1
  br i1 %tobool32, label %if.else, label %for.end
