...
; <label>:8                                       ; preds = %7, %6
  ...
  %10 = load float** %p, align 8
  call void @bar(float* %10)
  %11 = load float** %p, align 8
