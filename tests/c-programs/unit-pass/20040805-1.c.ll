...
define internal i32 @foo(i32 %x) #1 {
  ...
  store i32 %3, i32* getelementptr inbounds ([2 x i32], [2 x i32]* @a, i32 0, i64 1), align 4
  %4 = load i32, i32* %1, align 4
  %5 = getelementptr inbounds [65536 x i8], [65536 x i8]* %buf, i32 0, i32 0
  %6 = call i32 @bar(i32 %4, i8* %5)
  store i32 %6, i32* %1, align 4
  %7 = load i32, i32* %y, align 4
  %8 = getelementptr inbounds [65536 x i8], [65536 x i8]* %buf, i32 0, i32 0
...
define internal i32 @bar(i32 %x, i8* %b) #1 {
  ...
  %3 = load i32, i32* getelementptr inbounds ([2 x i32], [2 x i32]* @a, i32 0, i64 0), align 4
  %4 = add nsw i32 %3, 1
  store i32 %4, i32* getelementptr inbounds ([2 x i32], [2 x i32]* @a, i32 0, i64 0), align 4
