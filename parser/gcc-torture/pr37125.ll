; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/pr37125.c'
...
entry:
  ...
  %tmp = load i32* %p_45.addr, align 4
  %mul = mul i32 %tmp, -9
...
if.end:                                           ; preds = %entry
  %tmp1 = load i32* %rhs.addr, align 4
