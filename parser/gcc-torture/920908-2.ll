; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/920908-2.c'
...
entry:
  ...
  store i32 %t.coerce, i32* %0
  %arrayidx = getelementptr inbounds [1 x %struct.T]* %s, i32 0, i64 0
  %tmp = bitcast %struct.T* %arrayidx to i8*
  %tmp1 = bitcast %struct.T* %t to i8*
  ...
  %1 = bitcast %struct.T* %arraydecay to i32*
  %2 = load i32* %1, align 4
  %3 = lshr i32 %2, 8
  %bf.clear = and i32 %3, 16777215
