...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %10 = call { i64, i32 } @f()
  store { i64, i32 } %10, { i64, i32 }* %3
  %11 = bitcast { i64, i32 }* %3 to i8*
  %12 = bitcast %struct.S* %2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %12, i8* %11, i64 12, i32 1, i1 false)
  %13 = getelementptr inbounds %struct.S* %2, i32 0, i32 0
  %14 = load i32* %13, align 4
  %15 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0), i32 %14)
  %16 = call { i64, i32 } @f()
  store { i64, i32 } %16, { i64, i32 }* %5
  %17 = bitcast { i64, i32 }* %5 to i8*
  %18 = bitcast %struct.S* %4 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %18, i8* %17, i64 12, i32 1, i1 false)
  %19 = getelementptr inbounds %struct.S* %4, i32 0, i32 1
  %20 = getelementptr inbounds [2 x i32]* %19, i32 0, i64 0
  %21 = load i32* %20, align 4
  %22 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0), i32 %21)
  %23 = call { i64, i32 } @f()
  store { i64, i32 } %23, { i64, i32 }* %7
  ...
  %26 = getelementptr inbounds %struct.S* %6, i32 0, i32 1
  %27 = getelementptr inbounds [2 x i32]* %26, i32 0, i32 0
  %28 = getelementptr inbounds i32* %27, i64 0
  %29 = load i32* %28, align 4
  %30 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0), i32 %29)
  %31 = call { i64, i32 } @f()
  store { i64, i32 } %31, { i64, i32 }* %9
  %32 = bitcast { i64, i32 }* %9 to i8*
  %33 = bitcast %struct.S* %8 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %33, i8* %32, i64 12, i32 1, i1 false)
  %34 = getelementptr inbounds %struct.S* %8, i32 0, i32 1
  %35 = getelementptr inbounds [2 x i32]* %34, i32 0, i32 0
...
define internal { i64, i32 } @f() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %4, i8* %5, i64 12, i32 1, i1 false)
  %6 = load { i64, i32 }* %2
  ret { i64, i32 } %6
}
