...
; <label>:18                                      ; preds = %0
  %19 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @.str, i32 0, i32 0))
  br label %20

; <label>:20                                      ; preds = %18, %0
  %21 = getelementptr inbounds %struct.tiny* %x, i32 0, i32 1
...
; <label>:25                                      ; preds = %20
  %26 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @.str1, i32 0, i32 0))
  br label %27

; <label>:27                                      ; preds = %25, %20
  %28 = getelementptr inbounds %struct.tiny* %x, i32 0, i32 2
...
; <label>:32                                      ; preds = %27
  %33 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @.str2, i32 0, i32 0))
  br label %34

; <label>:34                                      ; preds = %32, %27
  %35 = getelementptr inbounds %struct.tiny* %y, i32 0, i32 0
...
; <label>:39                                      ; preds = %34
  %40 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @.str3, i32 0, i32 0))
  br label %41

; <label>:41                                      ; preds = %39, %34
  %42 = getelementptr inbounds %struct.tiny* %y, i32 0, i32 1
...
; <label>:46                                      ; preds = %41
  %47 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @.str4, i32 0, i32 0))
  br label %48

; <label>:48                                      ; preds = %46, %41
  %49 = getelementptr inbounds %struct.tiny* %y, i32 0, i32 2
...
; <label>:53                                      ; preds = %48
  %54 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @.str5, i32 0, i32 0))
  br label %55

; <label>:55                                      ; preds = %53, %48
  %56 = getelementptr inbounds %struct.tiny* %z, i32 0, i32 0
...
; <label>:60                                      ; preds = %55
  %61 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @.str6, i32 0, i32 0))
  br label %62

; <label>:62                                      ; preds = %60, %55
  %63 = getelementptr inbounds %struct.tiny* %z, i32 0, i32 1
...
; <label>:67                                      ; preds = %62
  %68 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @.str7, i32 0, i32 0))
  br label %69

; <label>:69                                      ; preds = %67, %62
  %70 = getelementptr inbounds %struct.tiny* %z, i32 0, i32 2
...
; <label>:74                                      ; preds = %69
  %75 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @.str8, i32 0, i32 0))
  br label %76

; <label>:76                                      ; preds = %74, %69
  %77 = load i64* %6, align 8
  %78 = icmp ne i64 %77, 123
  br i1 %78, label %79, label %81

; <label>:79                                      ; preds = %76
  %80 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str9, i32 0, i32 0))
  br label %81

; <label>:81                                      ; preds = %79, %76
  %82 = getelementptr inbounds %struct.tiny* %z, i32 0, i32 1
  store i8 77, i8* %82, align 1
  %83 = getelementptr inbounds %struct.tiny* %z, i32 0, i32 1
...
; <label>:87                                      ; preds = %81
  %88 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str10, i32 0, i32 0))
  br label %89
...
define i32 @main() #0 {
  ...
  %5 = alloca i24
  store i32 0, i32* %1
  %6 = getelementptr inbounds [3 x %struct.tiny]* %x, i32 0, i64 0
  %7 = getelementptr inbounds %struct.tiny* %6, i32 0, i32 0
  store i8 10, i8* %7, align 1
  %8 = getelementptr inbounds [3 x %struct.tiny]* %x, i32 0, i64 1
  %9 = getelementptr inbounds %struct.tiny* %8, i32 0, i32 0
  store i8 11, i8* %9, align 1
  %10 = getelementptr inbounds [3 x %struct.tiny]* %x, i32 0, i64 2
  %11 = getelementptr inbounds %struct.tiny* %10, i32 0, i32 0
  store i8 12, i8* %11, align 1
  %12 = getelementptr inbounds [3 x %struct.tiny]* %x, i32 0, i64 0
  %13 = getelementptr inbounds %struct.tiny* %12, i32 0, i32 1
  store i8 20, i8* %13, align 1
  %14 = getelementptr inbounds [3 x %struct.tiny]* %x, i32 0, i64 1
  %15 = getelementptr inbounds %struct.tiny* %14, i32 0, i32 1
  store i8 21, i8* %15, align 1
  %16 = getelementptr inbounds [3 x %struct.tiny]* %x, i32 0, i64 2
  %17 = getelementptr inbounds %struct.tiny* %16, i32 0, i32 1
  store i8 22, i8* %17, align 1
  %18 = getelementptr inbounds [3 x %struct.tiny]* %x, i32 0, i64 0
  %19 = getelementptr inbounds %struct.tiny* %18, i32 0, i32 2
  store i8 30, i8* %19, align 1
  %20 = getelementptr inbounds [3 x %struct.tiny]* %x, i32 0, i64 1
  %21 = getelementptr inbounds %struct.tiny* %20, i32 0, i32 2
  store i8 31, i8* %21, align 1
  %22 = getelementptr inbounds [3 x %struct.tiny]* %x, i32 0, i64 2
  %23 = getelementptr inbounds %struct.tiny* %22, i32 0, i32 2
  store i8 32, i8* %23, align 1
  %24 = getelementptr inbounds [3 x %struct.tiny]* %x, i32 0, i64 0
  %25 = getelementptr inbounds [3 x %struct.tiny]* %x, i32 0, i64 1
  %26 = getelementptr inbounds [3 x %struct.tiny]* %x, i32 0, i64 2
  ...
  %39 = getelementptr inbounds [3 x %struct.tiny]* %x, i32 0, i64 2
  %40 = getelementptr inbounds %struct.tiny* %39, i32 0, i32 1
...
; <label>:44                                      ; preds = %0
  %45 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str11, i32 0, i32 0))
  br label %46

; <label>:46                                      ; preds = %44, %0
  %47 = getelementptr inbounds %struct.tiny* %result, i32 0, i32 1
...
; <label>:51                                      ; preds = %46
  %52 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str12, i32 0, i32 0))
  br label %53

; <label>:53                                      ; preds = %51, %46
  %54 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.str13, i32 0, i32 0))
  ret i32 0
}
