; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith001317.c'
...
for.body4:                                        ; preds = %for.cond1
  ...
  %arrayidx = getelementptr inbounds [8 x [5 x i8]]* %l_2, i32 0, i64 %idxprom7
  %arrayidx8 = getelementptr inbounds [5 x i8]* %arrayidx, i32 0, i64 %idxprom
...
for.end13:                                        ; preds = %for.cond
  %arrayidx14 = getelementptr inbounds [8 x [5 x i8]]* %l_2, i32 0, i64 2
  %arrayidx15 = getelementptr inbounds [5 x i8]* %arrayidx14, i32 0, i64 3
  %tmp16 = load i8* %arrayidx15, align 1
  %conv = sext i8 %tmp16 to i32
  %tmp17 = load i32** %l_3, align 8
  %tmp18 = load i32* %tmp17
  %or = or i32 %tmp18, %conv
  store i32 %or, i32* %tmp17
  %tmp19 = load i32** %l_3, align 8
