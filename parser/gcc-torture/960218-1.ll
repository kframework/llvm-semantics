; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/960218-1.c'
...
entry:
  ...
  store i32 %tmp, i32* @glob, align 4
  ret i32 0
}
...
while.body:                                       ; preds = %while.cond
  ...
  %call = call i32 (...)* bitcast (i32 (i32)* @g to i32 (...)*)(i32 %tmp2)
