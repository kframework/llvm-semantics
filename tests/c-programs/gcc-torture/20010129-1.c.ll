...
define i32 @foo(i8* %a, i64 %b, i32 %c) #0 {
  ...
  %4 = getelementptr inbounds [256 x i8], [256 x i8]* %g, i32 0, i64 0
  store i8 10, i8* %4, align 1
  %5 = getelementptr inbounds [256 x i8], [256 x i8]* %g, i32 0, i64 1
...
; <label>:11                                      ; preds = %6
  %12 = getelementptr inbounds [256 x i8], [256 x i8]* %g, i32 0, i64 0
...
; <label>:16                                      ; preds = %11
  %17 = getelementptr inbounds [256 x i8], [256 x i8]* %g, i32 0, i64 0
...
; <label>:24                                      ; preds = %21
  %25 = getelementptr inbounds [256 x i8], [256 x i8]* %g, i32 0, i32 0
...
; <label>:54                                      ; preds = %50
  %55 = getelementptr inbounds [256 x i8], [256 x i8]* %g, i32 0, i32 0
...
; <label>:63                                      ; preds = %59
  %64 = getelementptr inbounds [256 x i8], [256 x i8]* %g, i32 0, i32 0
...
; <label>:72                                      ; preds = %68
  %73 = getelementptr inbounds [256 x i8], [256 x i8]* %g, i32 0, i32 0
