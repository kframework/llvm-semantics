...
define void @pnorm(%struct.precisionType* %u) #0 {
  ...
  %3 = getelementptr inbounds %struct.precisionType, %struct.precisionType* %2, i32 0, i32 0
  %4 = load i32*, i32** %3, align 8
  store i32* %4, i32** %uPtr, align 8
  br label %5

; <label>:5                                       ; preds = %12, %0
  %6 = load i32*, i32** %uPtr, align 8
...
; <label>:12                                      ; preds = %11
  %13 = load i32*, i32** %uPtr, align 8
  %14 = load %struct.precisionType*, %struct.precisionType** %1, align 8
  %15 = getelementptr inbounds %struct.precisionType, %struct.precisionType* %14, i32 0, i32 0
