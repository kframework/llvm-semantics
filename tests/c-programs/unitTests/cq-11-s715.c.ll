...
define i32 @sec(%struct.defs* %pd0) #0 {
  ...
  store i8* getelementptr inbounds ([8 x i8], [8 x i8]* @sec.qs715, i32 0, i32 0), i8** %ps, align 8
  %2 = load %struct.defs*, %struct.defs** %1, align 8
  %3 = getelementptr inbounds %struct.defs, %struct.defs* %2, i32 0, i32 15
  %4 = getelementptr inbounds [8 x i8], [8 x i8]* %3, i32 0, i32 0
  store i8* %4, i8** %pt, align 8
...
; <label>:30                                      ; preds = %25
  %31 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @sec.s715er, i32 0, i32 0), i32 1)
  br label %32
...
; <label>:42                                      ; preds = %35
  ...
  %44 = getelementptr inbounds %struct.defs, %struct.defs* %43, i32 0, i32 11
  %45 = load i32, i32* %44, align 4
  %46 = icmp ne i32 %45, 0
  br i1 %46, label %47, label %49

; <label>:47                                      ; preds = %42
  %48 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @sec.s715er, i32 0, i32 0), i32 2)
  br label %49
