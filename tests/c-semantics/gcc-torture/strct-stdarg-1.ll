...
; <label>:59                                      ; preds = %51
  %60 = getelementptr inbounds %struct.tiny* %x, i32 0, i32 4
...
; <label>:93                                      ; preds = %87
  %94 = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
...
define i32 @main() #0 {
  ...
  %24 = getelementptr inbounds %struct.tiny* %23, i32 0, i32 3
  store i8 40, i8* %24, align 1
  %25 = getelementptr inbounds [3 x %struct.tiny]* %x, i32 0, i64 1
  %26 = getelementptr inbounds %struct.tiny* %25, i32 0, i32 3
  store i8 41, i8* %26, align 1
  %27 = getelementptr inbounds [3 x %struct.tiny]* %x, i32 0, i64 2
  %28 = getelementptr inbounds %struct.tiny* %27, i32 0, i32 3
  store i8 42, i8* %28, align 1
  %29 = getelementptr inbounds [3 x %struct.tiny]* %x, i32 0, i64 0
  %30 = getelementptr inbounds %struct.tiny* %29, i32 0, i32 4
  store i8 50, i8* %30, align 1
  %31 = getelementptr inbounds [3 x %struct.tiny]* %x, i32 0, i64 1
  %32 = getelementptr inbounds %struct.tiny* %31, i32 0, i32 4
  store i8 51, i8* %32, align 1
  %33 = getelementptr inbounds [3 x %struct.tiny]* %x, i32 0, i64 2
  %34 = getelementptr inbounds %struct.tiny* %33, i32 0, i32 4
  store i8 52, i8* %34, align 1
  %35 = getelementptr inbounds [3 x %struct.tiny]* %x, i32 0, i64 0
  %36 = getelementptr inbounds [3 x %struct.tiny]* %x, i32 0, i64 1
  %37 = getelementptr inbounds [3 x %struct.tiny]* %x, i32 0, i64 2
