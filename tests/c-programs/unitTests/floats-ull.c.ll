...
@.str.1 = private unnamed_addr constant [23 x i8] c"VOLATILE: Messed up &&\00", align 1
@.str.2 = private unnamed_addr constant [13 x i8] c"Messed up ~~\00", align 1
@.str.3 = private unnamed_addr constant [14 x i8] c"Messed up 0.0\00", align 1
...
; <label>:4                                       ; preds = %0
  %5 = call i32 @puts(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i32 0, i32 0))
  br label %6

; <label>:6                                       ; preds = %4, %0
  store i64 9223372036854775807, i64* %innerInt, align 8
  %7 = load i64, i64* %innerInt, align 8
  %8 = uitofp i64 %7 to float
  store float %8, float* %innerFloat, align 4
  %9 = load float, float* %innerFloat, align 4
  ...
  %11 = load i64, i64* %lhs_ull, align 8
  %12 = load i64, i64* %choice1, align 8
  %13 = icmp ne i64 %11, %12
  br i1 %13, label %14, label %20

; <label>:14                                      ; preds = %6
  %15 = load i64, i64* %lhs_ull, align 8
  %16 = load i64, i64* %choice2, align 8
  %17 = icmp ne i64 %15, %16
  br i1 %17, label %18, label %20

; <label>:18                                      ; preds = %14
  %19 = call i32 @puts(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i32 0, i32 0))
  br label %20
...
; <label>:23                                      ; preds = %20
  %24 = call i32 @puts(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.2, i32 0, i32 0))
  br label %25
...
; <label>:28                                      ; preds = %25
  %29 = call i32 @puts(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.3, i32 0, i32 0))
  br label %30
