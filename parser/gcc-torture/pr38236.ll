; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/pr38236.c'
...
if.else:                                          ; preds = %if.end
  %i4 = getelementptr inbounds %struct.X* %y, i32 0, i32 0
  store i32* %i4, i32** %q.addr, align 8
  br label %if.end5

if.end5:                                          ; preds = %if.else, %if.then3
  %tmp6 = load i32** %q.addr, align 8
  store i32 1, i32* %tmp6
  %tmp7 = load %struct.X** %p.addr, align 8
  %i8 = getelementptr inbounds %struct.X* %tmp7, i32 0, i32 0
