...
define i32 @sec(%struct.defs* %pd0) #0 {
  ...
  store %struct.defs* %pd0, %struct.defs** %1, align 8
  store i32 0, i32* %rc, align 4
  store i8* getelementptr inbounds ([8 x i8], [8 x i8]* @sec.qs22, i32 0, i32 0), i8** %ps, align 8
  %2 = load %struct.defs*, %struct.defs** %1, align 8
  %3 = getelementptr inbounds %struct.defs, %struct.defs* %2, i32 0, i32 15
  %4 = getelementptr inbounds [8 x i8], [8 x i8]* %3, i32 0, i32 0
  store i8* %4, i8** %pt, align 8
...
; <label>:13                                      ; preds = %5
  ...
  %15 = load i32, i32* %_, align 4
  %16 = add nsw i32 %14, %15
  %17 = load i32, i32* %_234, align 4
  %18 = add nsw i32 %16, %17
  %19 = load i32, i32* %a234, align 4
...
; <label>:22                                      ; preds = %13
  ...
  %26 = getelementptr inbounds %struct.defs, %struct.defs* %25, i32 0, i32 11
  %27 = load i32, i32* %26, align 4
  %28 = icmp ne i32 %27, 0
  br i1 %28, label %29, label %31

; <label>:29                                      ; preds = %22
  %30 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @sec.s22er, i32 0, i32 0), i32 1)
  br label %31
...
; <label>:36                                      ; preds = %32
  ...
  %38 = add nsw i32 %37, 4
  store i32 %38, i32* %rc, align 4
  %39 = load %struct.defs*, %struct.defs** %1, align 8
  %40 = getelementptr inbounds %struct.defs, %struct.defs* %39, i32 0, i32 11
  %41 = load i32, i32* %40, align 4
  %42 = icmp ne i32 %41, 0
  br i1 %42, label %43, label %45

; <label>:43                                      ; preds = %36
  %44 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @sec.s22er, i32 0, i32 0), i32 4)
  br label %45
