; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/921208-1.c'
...
entry:
  ...
  %tmp1 = load double* %x.addr, align 8
...
entry:
  ...
  %tmp = load double (double)** %f.addr, align 8
  %tmp1 = load double* %a.addr, align 8
  %call = call double %tmp(double %tmp1)
  ret double %call
}
