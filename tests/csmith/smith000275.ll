; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith000275.c'
...
entry:
  %tmp = load i32* getelementptr inbounds ([4 x i32]* @g_2, i32 0, i64 2), align 4
  ret i32 %tmp
}
...
entry:
  ...
  %tmp8 = load i32* getelementptr inbounds ([4 x i32]* @g_2, i32 0, i64 2), align 4
