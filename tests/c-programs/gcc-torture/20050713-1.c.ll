...
define i32 @foo2(i64 %x.coerce0, i32 %x.coerce1, i64 %y.coerce0, i32 %y.coerce1) #0 {
  ...
  %7 = getelementptr { i64, i32 }, { i64, i32 }* %2, i32 0, i32 0
  ...
  %11 = getelementptr inbounds %struct.S, %struct.S* %x, i32 0, i32 0
  %12 = load i32, i32* %11, align 4
  %13 = icmp ne i32 %12, 3
  br i1 %13, label %22, label %14

; <label>:14                                      ; preds = %0
  %15 = getelementptr inbounds %struct.S, %struct.S* %x, i32 0, i32 1
  %16 = load i32, i32* %15, align 4
  %17 = icmp ne i32 %16, 4
  br i1 %17, label %22, label %18

; <label>:18                                      ; preds = %14
  %19 = getelementptr inbounds %struct.S, %struct.S* %x, i32 0, i32 2
...
; <label>:23                                      ; preds = %18
  %24 = getelementptr inbounds %struct.S, %struct.S* %y, i32 0, i32 0
  %25 = load i32, i32* %24, align 4
  %26 = icmp ne i32 %25, 6
  br i1 %26, label %35, label %27

; <label>:27                                      ; preds = %23
  %28 = getelementptr inbounds %struct.S, %struct.S* %y, i32 0, i32 1
  %29 = load i32, i32* %28, align 4
  %30 = icmp ne i32 %29, 7
  br i1 %30, label %35, label %31

; <label>:31                                      ; preds = %27
  %32 = getelementptr inbounds %struct.S, %struct.S* %y, i32 0, i32 2
...
define i32 @foo3(i64 %x.coerce0, i32 %x.coerce1, i64 %y.coerce0, i32 %y.coerce1, i64 %z.coerce0, i32 %z.coerce1) #0 {
  ...
  %14 = getelementptr { i64, i32 }, { i64, i32 }* %3, i32 0, i32 0
  store i64 %z.coerce0, i64* %14
  %15 = getelementptr { i64, i32 }, { i64, i32 }* %3, i32 0, i32 1
  ...
  %20 = getelementptr { i64, i32 }, { i64, i32 }* %4, i32 0, i32 0
  %21 = load i64, i64* %20, align 1
  %22 = getelementptr { i64, i32 }, { i64, i32 }* %4, i32 0, i32 1
  ...
  %26 = getelementptr { i64, i32 }, { i64, i32 }* %5, i32 0, i32 0
  %27 = load i64, i64* %26, align 1
  %28 = getelementptr { i64, i32 }, { i64, i32 }* %5, i32 0, i32 1
  %29 = load i32, i32* %28, align 1
  %30 = call i32 @foo2(i64 %21, i32 %23, i64 %27, i32 %29)
  %31 = getelementptr inbounds %struct.S, %struct.S* %z, i32 0, i32 0
  %32 = load i32, i32* %31, align 4
  %33 = icmp ne i32 %32, 9
  br i1 %33, label %42, label %34

; <label>:34                                      ; preds = %0
  %35 = getelementptr inbounds %struct.S, %struct.S* %z, i32 0, i32 1
  %36 = load i32, i32* %35, align 4
  %37 = icmp ne i32 %36, 10
  br i1 %37, label %42, label %38

; <label>:38                                      ; preds = %34
  %39 = getelementptr inbounds %struct.S, %struct.S* %z, i32 0, i32 2
...
define i32 @bar2(i64 %x.coerce0, i32 %x.coerce1, i64 %y.coerce0, i32 %y.coerce1) #0 {
  ...
  %9 = getelementptr { i64, i32 }, { i64, i32 }* %2, i32 0, i32 0
  store i64 %y.coerce0, i64* %9
  %10 = getelementptr { i64, i32 }, { i64, i32 }* %2, i32 0, i32 1
  ...
  %15 = getelementptr { i64, i32 }, { i64, i32 }* %3, i32 0, i32 0
  %16 = load i64, i64* %15, align 1
  %17 = getelementptr { i64, i32 }, { i64, i32 }* %3, i32 0, i32 1
  ...
  %21 = getelementptr { i64, i32 }, { i64, i32 }* %4, i32 0, i32 0
  %22 = load i64, i64* %21, align 1
  %23 = getelementptr { i64, i32 }, { i64, i32 }* %4, i32 0, i32 1
...
define i32 @bar3(i64 %x.coerce0, i32 %x.coerce1, i64 %y.coerce0, i32 %y.coerce1, i64 %z.coerce0, i32 %z.coerce1) #0 {
  ...
  %5 = alloca { i64, i32 }
  %6 = alloca { i64, i32 }
  %7 = getelementptr { i64, i32 }, { i64, i32 }* %1, i32 0, i32 0
  store i64 %x.coerce0, i64* %7
  %8 = getelementptr { i64, i32 }, { i64, i32 }* %1, i32 0, i32 1
  store i32 %x.coerce1, i32* %8
  %9 = bitcast %struct.S* %x to i8*
  %10 = bitcast { i64, i32 }* %1 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %9, i8* %10, i64 12, i32 8, i1 false)
  %11 = getelementptr { i64, i32 }, { i64, i32 }* %2, i32 0, i32 0
  store i64 %y.coerce0, i64* %11
  %12 = getelementptr { i64, i32 }, { i64, i32 }* %2, i32 0, i32 1
  ...
  %16 = getelementptr { i64, i32 }, { i64, i32 }* %3, i32 0, i32 1
  ...
  %27 = getelementptr { i64, i32 }, { i64, i32 }* %5, i32 0, i32 0
  %28 = load i64, i64* %27, align 1
  %29 = getelementptr { i64, i32 }, { i64, i32 }* %5, i32 0, i32 1
  ...
  %33 = getelementptr { i64, i32 }, { i64, i32 }* %6, i32 0, i32 0
  %34 = load i64, i64* %33, align 1
  %35 = getelementptr { i64, i32 }, { i64, i32 }* %6, i32 0, i32 1
...
define i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %13, i8* %14, i64 12, i32 0, i1 false)
  %15 = getelementptr { i64, i32 }, { i64, i32 }* %2, i32 0, i32 0
  %16 = load i64, i64* %15, align 1
  %17 = getelementptr { i64, i32 }, { i64, i32 }* %2, i32 0, i32 1
  %18 = load i32, i32* %17, align 1
  %19 = bitcast { i64, i32 }* %3 to i8*
  %20 = bitcast %struct.S* %a to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %19, i8* %20, i64 12, i32 0, i1 false)
  %21 = getelementptr { i64, i32 }, { i64, i32 }* %3, i32 0, i32 0
  %22 = load i64, i64* %21, align 1
  %23 = getelementptr { i64, i32 }, { i64, i32 }* %3, i32 0, i32 1
  %24 = load i32, i32* %23, align 1
  ...
  %28 = getelementptr { i64, i32 }, { i64, i32 }* %4, i32 0, i32 0
  %29 = load i64, i64* %28, align 1
  %30 = getelementptr { i64, i32 }, { i64, i32 }* %4, i32 0, i32 1
  ...
  %34 = getelementptr { i64, i32 }, { i64, i32 }* %5, i32 0, i32 0
  %35 = load i64, i64* %34, align 1
  %36 = getelementptr { i64, i32 }, { i64, i32 }* %5, i32 0, i32 1
  ...
  %40 = getelementptr { i64, i32 }, { i64, i32 }* %6, i32 0, i32 0
  %41 = load i64, i64* %40, align 1
  %42 = getelementptr { i64, i32 }, { i64, i32 }* %6, i32 0, i32 1
  ...
  %47 = getelementptr { i64, i32 }, { i64, i32 }* %7, i32 0, i32 0
  %48 = load i64, i64* %47, align 1
  %49 = getelementptr { i64, i32 }, { i64, i32 }* %7, i32 0, i32 1
  ...
  %53 = getelementptr { i64, i32 }, { i64, i32 }* %8, i32 0, i32 0
  %54 = load i64, i64* %53, align 1
  %55 = getelementptr { i64, i32 }, { i64, i32 }* %8, i32 0, i32 1
  ...
  %59 = getelementptr { i64, i32 }, { i64, i32 }* %9, i32 0, i32 0
  %60 = load i64, i64* %59, align 1
  %61 = getelementptr { i64, i32 }, { i64, i32 }* %9, i32 0, i32 1
