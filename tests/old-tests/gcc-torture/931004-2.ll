; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/931004-2.c'
...
vaarg.end:                                        ; preds = %vaarg.in_mem, %vaarg.in_reg
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %tmp4, i8* %tmp5, i64 4, i32 4, i1 false)
  %c = getelementptr inbounds %struct.tiny* %x, i32 0, i32 0
  %tmp6 = load i32* %c, align 4
  %tmp7 = load i32* %i, align 4
  %add = add nsw i32 %tmp7, 10
  %cmp8 = icmp ne i32 %tmp6, %add
...
for.end:                                          ; preds = %for.cond
  ...
  %gp_offset_p13 = getelementptr inbounds %struct.__va_list_tag* %arraydecay12, i32 0, i32 0
...
vaarg.in_reg16:                                   ; preds = %for.end
  %5 = getelementptr inbounds %struct.__va_list_tag* %arraydecay12, i32 0, i32 3
  %reg_save_area17 = load i8** %5
  %6 = getelementptr i8* %reg_save_area17, i32 %gp_offset14
  %7 = bitcast i8* %6 to i64*
  %8 = add i32 %gp_offset14, 8
  store i32 %8, i32* %gp_offset_p13
  br label %vaarg.end22

vaarg.in_mem18:                                   ; preds = %for.end
  %overflow_arg_area_p19 = getelementptr inbounds %struct.__va_list_tag* %arraydecay12, i32 0, i32 2
  %overflow_arg_area20 = load i8** %overflow_arg_area_p19
  %9 = bitcast i8* %overflow_arg_area20 to i64*
...
vaarg.end22:                                      ; preds = %vaarg.in_mem18, %vaarg.in_reg16
  %vaarg.addr23 = phi i64* [ %7, %vaarg.in_reg16 ], [ %9, %vaarg.in_mem18 ]
  %10 = load i64* %vaarg.addr23
  store i64 %10, i64* %x11, align 8
  %tmp24 = load i64* %x11, align 8
  %cmp25 = icmp ne i64 %tmp24, 123
  br i1 %cmp25, label %if.then26, label %if.end27

if.then26:                                        ; preds = %vaarg.end22
  call void @abort() noreturn nounwind
  unreachable

if.end27:                                         ; preds = %vaarg.end22
...
entry:
  ...
  call void (i32, ...)* @f(i32 3, i32 %0, i32 %1, i32 %2, i64 123)
