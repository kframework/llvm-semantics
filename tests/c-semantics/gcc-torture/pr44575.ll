...
; <label>:17                                      ; preds = %8, %8
  ...
  %19 = getelementptr inbounds %struct.__va_list_tag* %18, i32 0, i32 1
  %20 = load i32* %19
...
; <label>:22                                      ; preds = %17
  ...
  %26 = getelementptr i8* %25, i32 16
  %27 = bitcast %struct.S* %2 to { double, double }*
  %28 = bitcast i8* %25 to double*
  %29 = load double* %28
  %30 = getelementptr inbounds { double, double }* %27, i32 0, i32 0
  store double %29, double* %30
  %31 = bitcast i8* %26 to double*
  %32 = load double* %31
  %33 = getelementptr inbounds { double, double }* %27, i32 0, i32 1
...
; <label>:36                                      ; preds = %17
  %37 = getelementptr inbounds %struct.__va_list_tag* %18, i32 0, i32 2
  %38 = load i8** %37
  %39 = bitcast i8* %38 to %struct.S*
  %40 = getelementptr i8* %38, i32 16
  store i8* %40, i8** %37
  br label %41
...
; <label>:45                                      ; preds = %8
  %46 = load i32* @fails, align 4
  %47 = add nsw i32 %46, 1
  store i32 %47, i32* @fails, align 4
  br label %48

; <label>:48                                      ; preds = %45, %41
  %49 = load %struct.S** %p, align 8
  %50 = icmp ne %struct.S* %49, null
  br i1 %50, label %51, label %63

; <label>:51                                      ; preds = %48
  %52 = load %struct.S** %p, align 8
  %53 = getelementptr inbounds %struct.S* %52, i32 0, i32 0
  %54 = getelementptr inbounds [3 x float]* %53, i32 0, i64 2
  %55 = load float* %54, align 4
  %56 = getelementptr inbounds %struct.S* %arg, i32 0, i32 0
  %57 = getelementptr inbounds [3 x float]* %56, i32 0, i64 2
  %58 = load float* %57, align 4
  %59 = fcmp une float %55, %58
  br i1 %59, label %60, label %63

; <label>:60                                      ; preds = %51
  %61 = load i32* @fails, align 4
  %62 = add nsw i32 %61, 1
  store i32 %62, i32* @fails, align 4
  br label %63

; <label>:63                                      ; preds = %60, %51, %48
  %64 = load i32* @fails, align 4
  %65 = icmp ne i32 %64, 0
...
define i32 @main() #0 {
  ...
  %5 = bitcast %struct.S* getelementptr inbounds ([5 x %struct.S]* @a, i32 0, i64 2) to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %4, i8* %5, i64 12, i32 0, i1 false)
  %6 = getelementptr { <2 x float>, float }* %2, i32 0, i32 0
  %7 = load <2 x float>* %6, align 1
  %8 = getelementptr { <2 x float>, float }* %2, i32 0, i32 1
  %9 = load float* %8, align 1
  %10 = bitcast { <2 x float>, float }* %3 to i8*
  %11 = bitcast %struct.S* getelementptr inbounds ([5 x %struct.S]* @a, i32 0, i64 2) to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %10, i8* %11, i64 12, i32 0, i1 false)
  %12 = getelementptr { <2 x float>, float }* %3, i32 0, i32 0
  %13 = load <2 x float>* %12, align 1
  %14 = getelementptr { <2 x float>, float }* %3, i32 0, i32 1
  %15 = load float* %14, align 1
  call void (i32, ...)* @check(i32 1, <2 x float> %7, float %9, <2 x float> %13, float %15)
  %16 = load i32* @fails, align 4
  %17 = icmp ne i32 %16, 0
