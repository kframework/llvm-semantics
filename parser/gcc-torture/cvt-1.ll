; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/cvt-1.c'
...
entry:
  ...
  %tmp = load double* %f.addr, align 8
...
entry:
  ...
  %call3 = call i64 @g2(double %conv2)
...
if.end:                                           ; preds = %entry
  %tmp5 = load i64* %i.addr, align 8
  %conv6 = sitofp i64 %tmp5 to double
  %call7 = call i64 @g2(double %conv6)
