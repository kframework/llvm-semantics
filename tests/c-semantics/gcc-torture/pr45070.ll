...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = getelementptr inbounds %struct.source* %s, i32 0, i32 0
  store i32 0, i32* %2, align 4
  %3 = getelementptr inbounds %struct.source* %s, i32 0, i32 1
  store i32 0, i32* %3, align 4
  %4 = getelementptr inbounds %struct.source* %s, i32 0, i32 2
...
; <label>:8                                       ; preds = %5
  ...
  %10 = getelementptr %struct.packed_ushort* %rv, i32 0, i32 0
  store i16 %9, i16* %10
...
; <label>:13                                      ; preds = %8
  %14 = getelementptr inbounds %struct.packed_ushort* %rv, i32 0, i32 0
...
; <label>:21                                      ; preds = %18
  %22 = getelementptr inbounds %struct.packed_ushort* %rv, i32 0, i32 0
...
define internal i16 @next(%struct.source* %p) #1 {
  ...
  %3 = load %struct.source** %2, align 8
  %4 = getelementptr inbounds %struct.source* %3, i32 0, i32 0
  %5 = load i32* %4, align 4
  %6 = load %struct.source** %2, align 8
  %7 = getelementptr inbounds %struct.source* %6, i32 0, i32 1
  %8 = load i32* %7, align 4
  %9 = icmp sge i32 %5, %8
  br i1 %9, label %10, label %28

; <label>:10                                      ; preds = %0
  %11 = load %struct.source** %2, align 8
  %12 = getelementptr inbounds %struct.source* %11, i32 0, i32 2
  %13 = load i32* %12, align 4
  %14 = icmp ne i32 %13, 0
  br i1 %14, label %15, label %22

; <label>:15                                      ; preds = %10
  %16 = load %struct.source** %2, align 8
  %17 = getelementptr inbounds %struct.source* %16, i32 0, i32 2
  store i32 0, i32* %17, align 4
  %18 = load %struct.source** %2, align 8
  call void @fetch(%struct.source* %18)
  %19 = load %struct.source** %2, align 8
  %20 = call i16 @next(%struct.source* %19)
  %21 = getelementptr %struct.packed_ushort* %1, i32 0, i32 0
  store i16 %20, i16* %21
  br label %32

; <label>:22                                      ; preds = %10
  %23 = load %struct.source** %2, align 8
  %24 = getelementptr inbounds %struct.source* %23, i32 0, i32 2
  store i32 1, i32* %24, align 4
  %25 = getelementptr inbounds %struct.packed_ushort* %rv, i32 0, i32 0
...
; <label>:28                                      ; preds = %0
  %29 = getelementptr inbounds %struct.packed_ushort* %rv, i32 0, i32 0
...
; <label>:32                                      ; preds = %28, %22, %15
  %33 = getelementptr %struct.packed_ushort* %1, i32 0, i32 0
  %34 = load i16* %33
  ret i16 %34
}
...
define internal void @fetch(%struct.source* %p) #1 {
  ...
  %2 = load %struct.source** %1, align 8
  %3 = getelementptr inbounds %struct.source* %2, i32 0, i32 1
