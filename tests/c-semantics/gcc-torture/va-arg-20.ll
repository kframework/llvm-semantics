...
define void @bar(i8 signext %c, i8 signext %d, ...) #0 {
  ...
  %3 = getelementptr inbounds [1 x %struct.__va_list_tag]* %v, i32 0, i32 0
  %4 = bitcast %struct.__va_list_tag* %3 to i8*
  call void @llvm.va_start(i8* %4)
  %5 = getelementptr inbounds [1 x %struct.__va_list_tag]* %v, i32 0, i32 0
  call void @foo(%struct.__va_list_tag* %5)
  %6 = getelementptr inbounds [1 x %struct.__va_list_tag]* %v, i32 0, i32 0
