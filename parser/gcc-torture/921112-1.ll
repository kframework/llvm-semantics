; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/921112-1.c'
...
entry:
  ...
  store i64 %v.coerce, i64* %0
  %tmp = load %union.u** %x.addr, align 8
  %incdec.ptr = getelementptr inbounds %union.u* %tmp, i32 1
  store %union.u* %incdec.ptr, %union.u** %x.addr, align 8
  %tmp1 = bitcast %union.u* %incdec.ptr to i8*
  %tmp2 = bitcast %union.u* %v to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %tmp1, i8* %tmp2, i64 8, i32 8, i1 false)
  ret void
}
...
entry:
  ...
  %tmp = load i32* getelementptr inbounds (%struct.anon* bitcast (%union.u* getelementptr inbounds ([2 x %union.u]* @x, i32 0, i64 1) to %struct.anon*), i32 0, i32 0), align 4
  %cmp = icmp ne i32 %tmp, 1
  br i1 %cmp, label %if.then, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %entry
  %tmp1 = load i32* getelementptr inbounds (%struct.anon* bitcast (%union.u* getelementptr inbounds ([2 x %union.u]* @x, i32 0, i64 1) to %struct.anon*), i32 0, i32 1), align 4
