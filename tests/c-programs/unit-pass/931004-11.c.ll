...
define void @f(i32 %n, i24 %x.coerce, i24 %y.coerce, i24 %z.coerce, i64 %l) #0 {
  ...
  %12 = getelementptr inbounds %struct.tiny, %struct.tiny* %x, i32 0, i32 0
...
; <label>:17                                      ; preds = %0
  %18 = getelementptr inbounds %struct.tiny, %struct.tiny* %x, i32 0, i32 1
...
; <label>:23                                      ; preds = %17
  %24 = getelementptr inbounds %struct.tiny, %struct.tiny* %x, i32 0, i32 2
...
; <label>:47                                      ; preds = %41
  %48 = getelementptr inbounds %struct.tiny, %struct.tiny* %z, i32 0, i32 0
...
; <label>:53                                      ; preds = %47
  %54 = getelementptr inbounds %struct.tiny, %struct.tiny* %z, i32 0, i32 1
...
; <label>:59                                      ; preds = %53
  %60 = getelementptr inbounds %struct.tiny, %struct.tiny* %z, i32 0, i32 2
