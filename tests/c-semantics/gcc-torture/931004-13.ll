...
define void @f(i32 %n, i32 %x.coerce, i32 %y.coerce, i32 %z.coerce, i64 %l) #0 {
  ...
  store i32 %x.coerce, i32* %3, align 1
  %4 = bitcast %struct.tiny* %y to i32*
  store i32 %y.coerce, i32* %4, align 1
  %5 = bitcast %struct.tiny* %z to i32*
  store i32 %z.coerce, i32* %5, align 1
...
; <label>:11                                      ; preds = %0
  %12 = getelementptr inbounds %struct.tiny* %x, i32 0, i32 1
...
; <label>:17                                      ; preds = %11
  %18 = getelementptr inbounds %struct.tiny* %x, i32 0, i32 2
...
; <label>:23                                      ; preds = %17
  %24 = getelementptr inbounds %struct.tiny* %x, i32 0, i32 3
...
; <label>:47                                      ; preds = %41
  %48 = getelementptr inbounds %struct.tiny* %y, i32 0, i32 3
...
; <label>:53                                      ; preds = %47
  %54 = getelementptr inbounds %struct.tiny* %z, i32 0, i32 0
...
; <label>:59                                      ; preds = %53
  %60 = getelementptr inbounds %struct.tiny* %z, i32 0, i32 1
...
; <label>:65                                      ; preds = %59
  %66 = getelementptr inbounds %struct.tiny* %z, i32 0, i32 2
...
; <label>:71                                      ; preds = %65
  %72 = getelementptr inbounds %struct.tiny* %z, i32 0, i32 3
...
define i32 @main() #0 {
  ...
  %15 = getelementptr inbounds %struct.tiny* %14, i32 0, i32 2
  store i8 30, i8* %15, align 1
  %16 = getelementptr inbounds [3 x %struct.tiny]* %x, i32 0, i64 1
  %17 = getelementptr inbounds %struct.tiny* %16, i32 0, i32 2
  store i8 31, i8* %17, align 1
  %18 = getelementptr inbounds [3 x %struct.tiny]* %x, i32 0, i64 2
  %19 = getelementptr inbounds %struct.tiny* %18, i32 0, i32 2
  store i8 32, i8* %19, align 1
  %20 = getelementptr inbounds [3 x %struct.tiny]* %x, i32 0, i64 0
  %21 = getelementptr inbounds %struct.tiny* %20, i32 0, i32 3
  store i8 40, i8* %21, align 1
  %22 = getelementptr inbounds [3 x %struct.tiny]* %x, i32 0, i64 1
  %23 = getelementptr inbounds %struct.tiny* %22, i32 0, i32 3
  store i8 41, i8* %23, align 1
  %24 = getelementptr inbounds [3 x %struct.tiny]* %x, i32 0, i64 2
  %25 = getelementptr inbounds %struct.tiny* %24, i32 0, i32 3
  store i8 42, i8* %25, align 1
  %26 = getelementptr inbounds [3 x %struct.tiny]* %x, i32 0, i64 0
  %27 = getelementptr inbounds [3 x %struct.tiny]* %x, i32 0, i64 1
  %28 = getelementptr inbounds [3 x %struct.tiny]* %x, i32 0, i64 2
