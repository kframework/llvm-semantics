; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/930929-1.c'
...
entry:
  ...
  %sub = sub nsw i32 5, %tmp1
  %sub2 = sub nsw i32 %tmp, %sub
  ret i32 %sub2
}
...
entry:
  ...
  %tmp = load i32* %i.addr, align 4
  %tmp1 = load i32* %i.addr, align 4
  %add = add nsw i32 5, %tmp1
  %add2 = add nsw i32 %tmp, %add
  ret i32 %add2
}
