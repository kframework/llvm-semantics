...
define i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* getelementptr inbounds ([11 x i8]* @main.str, i32 0, i32 0), i64 11, i32 1, i1 false)
  %3 = getelementptr inbounds [11 x i8]* %str, i32 0, i32 0
  %4 = getelementptr inbounds i8* %3, i64 5
