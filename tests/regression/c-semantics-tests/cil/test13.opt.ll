...
define i32 @f(i32* nocapture %b) nounwind uwtable {
entry:
  store i32 33, i32* %b, align 4, !tbaa !0
  %arrayidx1 = getelementptr inbounds i32* %b, i64 2
  store i32 19, i32* %arrayidx1, align 4, !tbaa !0
  ret i32 19
}
