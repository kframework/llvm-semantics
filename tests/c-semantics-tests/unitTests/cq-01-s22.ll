; ModuleID = '/home/david/src/c-semantics/tests/unitTests/cq-01-s22.c'
...
while.end:                                        ; preds = %while.cond
  ...
  %5 = load i32* %_, align 4
  %add = add nsw i32 %4, %5
  %6 = load i32* %_234, align 4
  %add2 = add nsw i32 %add, %6
  %7 = load i32* %a234, align 4
  %add3 = add nsw i32 %add2, %7
  %cmp = icmp ne i32 %add3, 10
  br i1 %cmp, label %if.then, label %if.end7

if.then:                                          ; preds = %while.end
  %8 = load i32* %rc, align 4
  %add4 = add nsw i32 %8, 1
  store i32 %add4, i32* %rc, align 4
  %9 = load %struct.defs** %pd0.addr, align 8
  %flgd = getelementptr inbounds %struct.defs* %9, i32 0, i32 11
  %10 = load i32* %flgd, align 4
...
if.then9:                                         ; preds = %if.end7
  ...
  store i32 %add10, i32* %rc, align 4
  %14 = load %struct.defs** %pd0.addr, align 8
  %flgd11 = getelementptr inbounds %struct.defs* %14, i32 0, i32 11
  %15 = load i32* %flgd11, align 4
  %cmp12 = icmp ne i32 %15, 0
  br i1 %cmp12, label %if.then13, label %if.end15

if.then13:                                        ; preds = %if.then9
  %call14 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s22er, i32 0, i32 0), i32 4)
  br label %if.end15
