...
define i32 @main(i32 %argc, i8** %argv) #0 {
  ...
  %4 = call i32 @atoi(i8* getelementptr inbounds ([3 x i8]* @.str, i32 0, i32 0)) #3
  store i32 %4, i32* %input, align 4
  %5 = load i32* %input, align 4
  %6 = call i32 @sum(i32 %5)
  store i32 %6, i32* %result, align 4
  %7 = load i32* %input, align 4
  %8 = load i32* %result, align 4
  %9 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str1, i32 0, i32 0), i32 %7, i32 %8)
