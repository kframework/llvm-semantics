...
define void @f() #0 {
  ...
  call void @longjmp(%struct.__jmp_buf_tag* getelementptr inbounds ([1 x %struct.__jmp_buf_tag]* @x, i32 0, i32 0), i32 5) #5
  unreachable
                                                  ; No predecessors!
  ret void
}
...
define void @second() #0 {
  %1 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([8 x i8]* @.str1, i32 0, i32 0))
  call void @longjmp(%struct.__jmp_buf_tag* getelementptr inbounds ([1 x %struct.__jmp_buf_tag]* @buf, i32 0, i32 0), i32 1) #5
  unreachable
                                                  ; No predecessors!
  ret void
}
...
define void @first() #0 {
  call void @second()
  %1 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([7 x i8]* @.str2, i32 0, i32 0))
  ret void
}
...
define void @test1() #0 {
  ...
  %1 = call i32 @_setjmp(%struct.__jmp_buf_tag* getelementptr inbounds ([1 x %struct.__jmp_buf_tag]* @x, i32 0, i32 0)) #6
  store i32 %1, i32* %i, align 4
  %2 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str3, i32 0, i32 0))
  %3 = load i32* %i, align 4
  %4 = icmp ne i32 %3, 0
  br i1 %4, label %8, label %5

; <label>:5                                       ; preds = %0
  %6 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @.str4, i32 0, i32 0))
  call void @f()
  %7 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.str5, i32 0, i32 0))
  br label %11

; <label>:8                                       ; preds = %0
  %9 = load i32* %i, align 4
  %10 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @.str6, i32 0, i32 0), i32 %9)
  br label %11

; <label>:11                                      ; preds = %8, %5
  %12 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.str7, i32 0, i32 0))
  ret void
}
...
; Function Attrs: nounwind uwtable
define void @test2() #0 {
  %1 = call i32 @_setjmp(%struct.__jmp_buf_tag* getelementptr inbounds ([1 x %struct.__jmp_buf_tag]* @buf, i32 0, i32 0)) #6
  %2 = icmp ne i32 %1, 0
...
; <label>:4                                       ; preds = %0
  %5 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([7 x i8]* @.str8, i32 0, i32 0))
  br label %6
...
define i32 @test3() #0 {
  ...
  %1 = call i32 @_setjmp(%struct.__jmp_buf_tag* getelementptr inbounds ([1 x %struct.__jmp_buf_tag]* @env, i32 0, i32 0)) #6
  store i32 %1, i32* %res, align 4
  %2 = load i32* %res, align 4
  %3 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([20 x i8]* @.str9, i32 0, i32 0), i32 %2)
...
define void @foo(i8** %data) #0 {
  ...
  %4 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([8 x i8]* @.str10, i32 0, i32 0))
  %5 = load i8*** %1, align 8
  %6 = load i8** %5, align 8
  %7 = call i8* @strcpy(i8* %6, i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0)) #7
  %8 = load i8*** %1, align 8
  %9 = load i8** %8, align 8
  %10 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @.str12, i32 0, i32 0), i8* %9)
  call void @longjmp(%struct.__jmp_buf_tag* getelementptr inbounds ([1 x %struct.__jmp_buf_tag]* @env, i32 0, i32 0), i32 42) #5
  unreachable
                                                  ; No predecessors!
  ret void
}
...
define void @handle(i8* %data) #0 {
  %1 = alloca i8*, align 8
  store i8* %data, i8** %1, align 8
  %2 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str13, i32 0, i32 0))
  %3 = load i8** %1, align 8
  %4 = icmp ne i8* %3, null
...
; <label>:5                                       ; preds = %0
  ...
  %7 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str14, i32 0, i32 0))
  br label %8
