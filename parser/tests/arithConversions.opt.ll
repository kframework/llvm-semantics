; ModuleID = '/home/grosu/celliso2/c-semantics/tests/unitTests/arithConversions.ll'
...
@str = internal constant [17 x i8] c"Good answer in 2\00"
...
entry:
  ...
  %call8 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str6, i64 0, i64 0), i8* getelementptr inbounds ([13 x i8]* @.str10, i64 0, i64 0)) nounwind
  ret i32 0
}
...
entry:
  ...
  %puts.i1 = tail call i32 @puts(i8* getelementptr inbounds ([17 x i8]* @str, i64 0, i64 0)) nounwind
  ...
  %call8.i = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str6, i64 0, i64 0), i8* getelementptr inbounds ([13 x i8]* @.str10, i64 0, i64 0)) nounwind
  ret i32 0
}
