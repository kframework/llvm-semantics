...
%struct.anon = type { [4 x i8], [2 x i8], [2 x i8] }
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = load i32* bitcast (%struct.anon* @s to i32*), align 4
  %3 = and i32 %2, -16
  %4 = or i32 %3, 6
  store i32 %4, i32* bitcast (%struct.anon* @s to i32*), align 4
  %5 = load i32* bitcast (%struct.anon* @s to i32*), align 4
  %6 = and i32 %5, -241
  %7 = or i32 %6, 128
  ...
  %17 = load i32* bitcast (%struct.anon* @s to i32*), align 4
  %18 = and i32 %17, -8380417
  %19 = or i32 %18, 2555904
  store i32 %19, i32* bitcast (%struct.anon* @s to i32*), align 4
  %20 = load i16* bitcast ([2 x i8]* getelementptr inbounds (%struct.anon* @s, i32 0, i32 1) to i16*), align 4
  %21 = and i16 %20, -1024
  %22 = or i16 %21, 619
  store i16 %22, i16* bitcast ([2 x i8]* getelementptr inbounds (%struct.anon* @s, i32 0, i32 1) to i16*), align 4
  ...
  %27 = load i32* bitcast (%struct.anon* @s to i32*), align 4
  %28 = shl i32 %27, 24
  %29 = ashr i32 %28, 28
  ...
  %32 = lshr i32 %31, 8
  %33 = and i32 %32, 1
  %34 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0), i32 %33)
  %35 = load i32* bitcast (%struct.anon* @s to i32*), align 4
  %36 = shl i32 %35, 21
  %37 = ashr i32 %36, 30
  %38 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0), i32 %37)
  %39 = load i32* bitcast (%struct.anon* @s to i32*), align 4
  %40 = shl i32 %39, 19
  %41 = ashr i32 %40, 30
  %42 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0), i32 %41)
  %43 = load i32* bitcast (%struct.anon* @s to i32*), align 4
  %44 = shl i32 %43, 9
  %45 = ashr i32 %44, 22
  %46 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0), i32 %45)
  %47 = load i16* bitcast ([2 x i8]* getelementptr inbounds (%struct.anon* @s, i32 0, i32 1) to i16*), align 4
  %48 = shl i16 %47, 6
  %49 = ashr i16 %48, 6
