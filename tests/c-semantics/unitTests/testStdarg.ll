...
; <label>:13                                      ; preds = %10
  ...
  %15 = getelementptr inbounds %struct.__va_list_tag* %14, i32 0, i32 0
  %16 = load i32* %15
  %17 = icmp ule i32 %16, 40
  br i1 %17, label %18, label %24

; <label>:18                                      ; preds = %13
  %19 = getelementptr inbounds %struct.__va_list_tag* %14, i32 0, i32 3
  %20 = load i8** %19
  %21 = getelementptr i8* %20, i32 %16
...
; <label>:24                                      ; preds = %13
  %25 = getelementptr inbounds %struct.__va_list_tag* %14, i32 0, i32 2
  %26 = load i8** %25
  %27 = bitcast i8* %26 to i32*
  %28 = getelementptr i8* %26, i32 8
  store i8* %28, i8** %25
  br label %29
...
; <label>:5                                       ; preds = %0
  %6 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([15 x i8]* @.str2, i32 0, i32 0))
  store i8* null, i8** %1
  br label %80
...
; <label>:7                                       ; preds = %0
  ...
  %10 = getelementptr inbounds [1 x %struct.__va_list_tag]* %argp, i32 0, i32 0
  %11 = bitcast %struct.__va_list_tag* %10 to i8*
  call void @llvm.va_start(i8* %11)
  br label %12

; <label>:12                                      ; preds = %32, %7
  %13 = getelementptr inbounds [1 x %struct.__va_list_tag]* %argp, i32 0, i32 0
...
; <label>:37                                      ; preds = %28
  %38 = getelementptr inbounds [1 x %struct.__va_list_tag]* %argp, i32 0, i32 0
...
; <label>:46                                      ; preds = %37
  %47 = load i8** %retbuf, align 8
  %48 = load i8** %2, align 8
  %49 = call i8* @strcpy(i8* %47, i8* %48) #2
  %50 = getelementptr inbounds [1 x %struct.__va_list_tag]* %argp, i32 0, i32 0
  %51 = bitcast %struct.__va_list_tag* %50 to i8*
  call void @llvm.va_start(i8* %51)
  br label %52

; <label>:52                                      ; preds = %72, %46
  %53 = getelementptr inbounds [1 x %struct.__va_list_tag]* %argp, i32 0, i32 0
  %54 = getelementptr inbounds %struct.__va_list_tag* %53, i32 0, i32 0
  %55 = load i32* %54
  %56 = icmp ule i32 %55, 40
  br i1 %56, label %57, label %63

; <label>:57                                      ; preds = %52
  %58 = getelementptr inbounds %struct.__va_list_tag* %53, i32 0, i32 3
  %59 = load i8** %58
  %60 = getelementptr i8* %59, i32 %55
...
; <label>:63                                      ; preds = %52
  %64 = getelementptr inbounds %struct.__va_list_tag* %53, i32 0, i32 2
  %65 = load i8** %64
  %66 = bitcast i8* %65 to i8**
  %67 = getelementptr i8* %65, i32 8
  store i8* %67, i8** %64
  br label %68
...
define i32 @testDifferent(i32 %x, ...) #0 {
  ...
  %2 = getelementptr inbounds [1 x %struct.__va_list_tag]* %argp, i32 0, i32 0
  %3 = bitcast %struct.__va_list_tag* %2 to i8*
  call void @llvm.va_start(i8* %3)
  %4 = getelementptr inbounds [1 x %struct.__va_list_tag]* %argp, i32 0, i32 0
...
; <label>:19                                      ; preds = %14, %8
  ...
  %22 = getelementptr inbounds [1 x %struct.__va_list_tag]* %argp, i32 0, i32 0
...
; <label>:37                                      ; preds = %32, %26
  ...
  %40 = getelementptr inbounds [1 x %struct.__va_list_tag]* %argp, i32 0, i32 0
...
; <label>:55                                      ; preds = %50, %44
  ...
  %58 = getelementptr inbounds [1 x %struct.__va_list_tag]* %argp, i32 0, i32 0
...
; <label>:73                                      ; preds = %68, %62
  ...
  %76 = getelementptr inbounds [1 x %struct.__va_list_tag]* %argp, i32 0, i32 0
...
; <label>:80                                      ; preds = %73
  %81 = getelementptr inbounds %struct.__va_list_tag* %76, i32 0, i32 3
  %82 = load i8** %81
  %83 = getelementptr i8* %82, i32 %78
...
; <label>:86                                      ; preds = %73
  %87 = getelementptr inbounds %struct.__va_list_tag* %76, i32 0, i32 2
  %88 = load i8** %87
  %89 = bitcast i8* %88 to i64*
  %90 = getelementptr i8* %88, i32 8
  store i8* %90, i8** %87
  br label %91
...
; <label>:91                                      ; preds = %86, %80
  ...
  %94 = getelementptr inbounds [1 x %struct.__va_list_tag]* %argp, i32 0, i32 0
  %95 = getelementptr inbounds %struct.__va_list_tag* %94, i32 0, i32 1
  %96 = load i32* %95
  %97 = icmp ule i32 %96, 160
  br i1 %97, label %98, label %104

; <label>:98                                      ; preds = %91
  %99 = getelementptr inbounds %struct.__va_list_tag* %94, i32 0, i32 3
  %100 = load i8** %99
  %101 = getelementptr i8* %100, i32 %96
...
; <label>:104                                     ; preds = %91
  %105 = getelementptr inbounds %struct.__va_list_tag* %94, i32 0, i32 2
  %106 = load i8** %105
  %107 = bitcast i8* %106 to double*
  %108 = getelementptr i8* %106, i32 8
  store i8* %108, i8** %105
  br label %109
...
; <label>:109                                     ; preds = %104, %98
  ...
  %112 = getelementptr inbounds [1 x %struct.__va_list_tag]* %argp, i32 0, i32 0
  %113 = getelementptr inbounds %struct.__va_list_tag* %112, i32 0, i32 1
  %114 = load i32* %113
...
; <label>:127                                     ; preds = %122, %116
  ...
  %130 = load double* %y6, align 8
  %131 = fmul double %130, 1.000000e+04
  %132 = fptosi double %131 to i32
  store i32 %132, i32* %y6a, align 4
  %133 = load double* %y7, align 8
  %134 = fmul double %133, 1.000000e+02
  %135 = fptosi double %134 to i32
  store i32 %135, i32* %y7a, align 4
  %136 = getelementptr inbounds [1 x %struct.__va_list_tag]* %argp, i32 0, i32 0
  %137 = getelementptr inbounds %struct.__va_list_tag* %136, i32 0, i32 0
  %138 = load i32* %137
  %139 = icmp ule i32 %138, 40
  br i1 %139, label %140, label %146

; <label>:140                                     ; preds = %127
  %141 = getelementptr inbounds %struct.__va_list_tag* %136, i32 0, i32 3
  %142 = load i8** %141
  %143 = getelementptr i8* %142, i32 %138
...
; <label>:146                                     ; preds = %127
  %147 = getelementptr inbounds %struct.__va_list_tag* %136, i32 0, i32 2
  %148 = load i8** %147
  %149 = bitcast i8* %148 to %struct.s*
  %150 = getelementptr i8* %148, i32 8
  store i8* %150, i8** %147
  br label %151
...
; <label>:151                                     ; preds = %146, %140
  ...
  %155 = load i32* %y1, align 4
  %156 = load i32* %y2, align 4
  %157 = load i32* %y3, align 4
  %158 = load i64* %y4, align 8
  %159 = trunc i64 %158 to i32
  %160 = load i64* %y5, align 8
  %161 = trunc i64 %160 to i32
  %162 = load i32* %y6a, align 4
  %163 = load i32* %y7a, align 4
  %164 = getelementptr inbounds %struct.s* %mys, i32 0, i32 0
  %165 = load i32* %164, align 4
  %166 = getelementptr inbounds %struct.s* %mys, i32 0, i32 1
  %167 = load i32* %166, align 4
  %168 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([36 x i8]* @.str3, i32 0, i32 0), i32 %155, i32 %156, i32 %157, i32 %159, i32 %161, i32 %162, i32 %163, i32 %165, i32 %167)
  %169 = getelementptr inbounds [1 x %struct.__va_list_tag]* %argp, i32 0, i32 0
...
define i32 @main() #0 {
  ...
  %7 = load i8* %mychar, align 1
  %8 = sext i8 %7 to i32
  %9 = load i16* %myshort, align 2
  %10 = sext i16 %9 to i32
  %11 = load float* %myfloat, align 4
  %12 = fpext float %11 to double
  %13 = load double* %mydouble, align 8
