...
; <label>:13                                      ; preds = %5
  ...
  %17 = load i32* %_234, align 4
  %18 = add nsw i32 %16, %17
  %19 = load i32* %a234, align 4
...
; <label>:29                                      ; preds = %22
  %30 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s22er, i32 0, i32 0), i32 1)
  br label %31
...
; <label>:36                                      ; preds = %32
  ...
  %39 = load %struct.defs** %1, align 8
  %40 = getelementptr inbounds %struct.defs* %39, i32 0, i32 11
  %41 = load i32* %40, align 4
  %42 = icmp ne i32 %41, 0
  br i1 %42, label %43, label %45

; <label>:43                                      ; preds = %36
  %44 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s22er, i32 0, i32 0), i32 4)
  br label %45
