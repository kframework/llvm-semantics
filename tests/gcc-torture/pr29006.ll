; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/pr29006.c'
...
entry:
  ...
  %x = getelementptr inbounds %struct.s* %tmp, i32 0, i32 1
...
entry:
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %tmp, i8* getelementptr inbounds (%struct.s* @main.s, i32 0, i32 0), i64 9, i32 1, i1 false)
  call void @foo(%struct.s* %s)
  %x = getelementptr inbounds %struct.s* %s, i32 0, i32 1
