; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/pta-field-2.ll'
...
entry:
  %sub.ptr = getelementptr inbounds i32** %x, i64 -1
  %tmp2 = load i32** %sub.ptr, align 8
...
entry:
  ...
  call void @bar(i32** %q.i) nounwind
