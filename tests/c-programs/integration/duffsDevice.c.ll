...
define i32 @main() #0 {
  ...
  %12 = load i32*, i32** %src, align 8
  store i32* %12, i32** %origSrc, align 8
  %13 = load i32*, i32** %dest, align 8
...
; <label>:40                                      ; preds = %88, %39
  %41 = load i32*, i32** %src, align 8
  %42 = getelementptr inbounds i32, i32* %41, i32 1
  store i32* %42, i32** %src, align 8
  %43 = load i32, i32* %41, align 4
  %44 = load i32*, i32** %dest, align 8
...
; <label>:46                                      ; preds = %33, %40
  %47 = load i32*, i32** %src, align 8
  %48 = getelementptr inbounds i32, i32* %47, i32 1
  store i32* %48, i32** %src, align 8
  %49 = load i32, i32* %47, align 4
  %50 = load i32*, i32** %dest, align 8
...
; <label>:52                                      ; preds = %33, %46
  %53 = load i32*, i32** %src, align 8
  %54 = getelementptr inbounds i32, i32* %53, i32 1
  store i32* %54, i32** %src, align 8
  %55 = load i32, i32* %53, align 4
  %56 = load i32*, i32** %dest, align 8
...
; <label>:58                                      ; preds = %33, %52
  %59 = load i32*, i32** %src, align 8
  %60 = getelementptr inbounds i32, i32* %59, i32 1
  store i32* %60, i32** %src, align 8
  %61 = load i32, i32* %59, align 4
  %62 = load i32*, i32** %dest, align 8
...
; <label>:70                                      ; preds = %33, %64
  %71 = load i32*, i32** %src, align 8
  %72 = getelementptr inbounds i32, i32* %71, i32 1
  store i32* %72, i32** %src, align 8
  %73 = load i32, i32* %71, align 4
  %74 = load i32*, i32** %dest, align 8
...
; <label>:82                                      ; preds = %33, %76
  %83 = load i32*, i32** %src, align 8
  %84 = getelementptr inbounds i32, i32* %83, i32 1
  store i32* %84, i32** %src, align 8
  %85 = load i32, i32* %83, align 4
  %86 = load i32*, i32** %dest, align 8
...
; <label>:98                                      ; preds = %94
  ...
  %102 = load i32*, i32** %origSrc, align 8
  %103 = getelementptr inbounds i32, i32* %102, i64 %101
  %104 = load i32, i32* %103, align 4
  %105 = load i32, i32* %i1, align 4
  %106 = sext i32 %105 to i64
  %107 = load i32*, i32** %origDest, align 8
  %108 = getelementptr inbounds i32, i32* %107, i64 %106
  %109 = load i32, i32* %108, align 4
  %110 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i32 0, i32 0), i32 %99, i32 %104, i32 %109)
  br label %111
