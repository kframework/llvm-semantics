; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/pr40747.c'
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %tmp3, %cond.true ], [ 4, %cond.false ]
  ret i32 %cond
}
