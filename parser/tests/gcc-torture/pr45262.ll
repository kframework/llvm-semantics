; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/pr45262.c'
...
define i32 @bar(i32 %x) nounwind uwtable {
entry:
  %x.addr = alloca i32, align 4
  store i32 %x, i32* %x.addr, align 4
  %tmp = load i32* %x.addr, align 4
...
lor.rhs:                                          ; preds = %entry
  %tmp1 = load i32* %x.addr, align 4
  %sub = sub i32 0, %tmp1
  %shr2 = lshr i32 %sub, 31
  %tobool3 = icmp ne i32 %shr2, 0
  br label %lor.end
