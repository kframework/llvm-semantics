...
; <label>:5                                       ; preds = %2
  store i32* getelementptr inbounds ([10 x i32], [10 x i32]* @array, i32 0, i64 0), i32** %p, align 8
  br label %6

; <label>:6                                       ; preds = %16, %5
  %7 = load i32*, i32** %p, align 8
  %8 = icmp ne i32* %7, getelementptr inbounds ([10 x i32], [10 x i32]* @array, i32 0, i64 9)
