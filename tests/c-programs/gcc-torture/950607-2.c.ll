...
define i32 @f(i64 %basePt.coerce0, i64 %basePt.coerce1, i64 %pt1.coerce0, i64 %pt1.coerce1, i64 %pt2.coerce0, i64 %pt2.coerce1) #0 {
  ...
  %10 = getelementptr { i64, i64 }, { i64, i64 }* %8, i32 0, i32 1
  store i64 %pt2.coerce1, i64* %10
  %11 = getelementptr inbounds %struct.Point, %struct.Point* %pt1, i32 0, i32 0
  %12 = load i64, i64* %11, align 8
  %13 = getelementptr inbounds %struct.Point, %struct.Point* %basePt, i32 0, i32 0
  %14 = load i64, i64* %13, align 8
  %15 = sub nsw i64 %12, %14
  %16 = getelementptr inbounds %struct.Point, %struct.Point* %pt2, i32 0, i32 1
  %17 = load i64, i64* %16, align 8
  %18 = getelementptr inbounds %struct.Point, %struct.Point* %basePt, i32 0, i32 1
  %19 = load i64, i64* %18, align 8
  %20 = sub nsw i64 %17, %19
  %21 = mul nsw i64 %15, %20
  %22 = getelementptr inbounds %struct.Point, %struct.Point* %pt1, i32 0, i32 1
  %23 = load i64, i64* %22, align 8
  %24 = getelementptr inbounds %struct.Point, %struct.Point* %basePt, i32 0, i32 1
  %25 = load i64, i64* %24, align 8
  %26 = sub nsw i64 %23, %25
  %27 = getelementptr inbounds %struct.Point, %struct.Point* %pt2, i32 0, i32 0
  %28 = load i64, i64* %27, align 8
  %29 = getelementptr inbounds %struct.Point, %struct.Point* %basePt, i32 0, i32 0
  %30 = load i64, i64* %29, align 8
  %31 = sub nsw i64 %28, %30
  %32 = mul nsw i64 %26, %31
  %33 = sub nsw i64 %21, %32
  store i64 %33, i64* %vector, align 8
  %34 = load i64, i64* %vector, align 8
...
; <label>:37                                      ; preds = %0
  %38 = load i64, i64* %vector, align 8
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = getelementptr inbounds %struct.Point, %struct.Point* %b, i32 0, i32 0
  store i64 -23250, i64* %2, align 8
  %3 = getelementptr inbounds %struct.Point, %struct.Point* %b, i32 0, i32 1
  store i64 23250, i64* %3, align 8
  %4 = getelementptr inbounds %struct.Point, %struct.Point* %p1, i32 0, i32 0
  store i64 23250, i64* %4, align 8
  %5 = getelementptr inbounds %struct.Point, %struct.Point* %p1, i32 0, i32 1
  store i64 -23250, i64* %5, align 8
  %6 = getelementptr inbounds %struct.Point, %struct.Point* %p2, i32 0, i32 0
  store i64 -23250, i64* %6, align 8
  %7 = getelementptr inbounds %struct.Point, %struct.Point* %p2, i32 0, i32 1
  ...
  %24 = load i32, i32* %answer, align 4
  %25 = icmp ne i32 %24, 1
