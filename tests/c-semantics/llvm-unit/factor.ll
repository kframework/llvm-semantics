...
; <label>:4                                       ; preds = %1
  ...
  %6 = zext i32 %5 to i64
  %7 = getelementptr inbounds [50 x i8]* @plane, i32 0, i64 %6
...
; <label>:11                                      ; preds = %4
  ...
  %14 = getelementptr inbounds [50 x i8]* @plane, i32 0, i64 %13
...
; <label>:23                                      ; preds = %19
  ...
  %26 = getelementptr inbounds [50 x i8]* @plane, i32 0, i64 %25
...
; <label>:35                                      ; preds = %31
  ...
  %38 = getelementptr inbounds [50 x i8]* @plane, i32 0, i64 %37
...
; <label>:47                                      ; preds = %43
  ...
  %50 = getelementptr inbounds [50 x i8]* @plane, i32 0, i64 %49
...
; <label>:59                                      ; preds = %55
  ...
  %62 = getelementptr inbounds [50 x i8]* @plane, i32 0, i64 %61
...
; <label>:71                                      ; preds = %67
  ...
  %74 = getelementptr inbounds [50 x i8]* @plane, i32 0, i64 %73
...
; <label>:83                                      ; preds = %79
  ...
  %86 = getelementptr inbounds [50 x i8]* @plane, i32 0, i64 %85
...
; <label>:91                                      ; preds = %83, %79
  ...
  %94 = getelementptr inbounds [50 x i8]* @plane, i32 0, i64 %93
...
; <label>:7                                       ; preds = %4
  %8 = load i32* %i, align 4
  %9 = zext i32 %8 to i64
  %10 = getelementptr inbounds [50 x i8]* @plane, i32 0, i64 %9
...
; <label>:22                                      ; preds = %4
  %23 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([2 x i8]* @.str1, i32 0, i32 0))
  ret i32 0
}
