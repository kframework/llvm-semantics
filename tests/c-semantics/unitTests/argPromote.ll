...
; Function Attrs: nounwind uwtable
define zeroext i8 @g(i8 signext %x) #0 {
  %1 = alloca i8, align 1
...
define i32 @main() #0 {
  ...
  %3 = call zeroext i8 @g(i8 signext 6)
  %4 = zext i8 %3 to i32
  %5 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0), i32 %4)
  %6 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0), i32 8)
  %7 = load i8* %x, align 1
  %8 = sext i8 %7 to i32
