; ModuleID = '/home/grosu/celliso2/c-semantics/tests/unitTests/cq-05-s25.c'
...
while.end:                                        ; preds = %while.cond
  ...
  %tmp5 = load i8** %s, align 8
  %arrayidx = getelementptr inbounds i8* %tmp5, i64 0
  %tmp6 = load i8* %arrayidx
  %conv = sext i8 %tmp6 to i32
  %tmp7 = load i8** %s, align 8
  %arrayidx8 = getelementptr inbounds i8* %tmp7, i64 1
  %tmp9 = load i8* %arrayidx8
  %conv10 = sext i8 %tmp9 to i32
  %cmp = icmp ne i32 %conv, %conv10
  br i1 %cmp, label %if.then, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %while.end
  %tmp12 = load i8** %s, align 8
  %arrayidx13 = getelementptr inbounds i8* %tmp12, i64 1
  %tmp14 = load i8* %arrayidx13
  %conv15 = sext i8 %tmp14 to i32
  %tmp16 = load i8** %s, align 8
  %arrayidx17 = getelementptr inbounds i8* %tmp16, i64 2
  %tmp18 = load i8* %arrayidx17
  %conv19 = sext i8 %tmp18 to i32
  %cmp20 = icmp ne i32 %conv15, %conv19
  br i1 %cmp20, label %if.then, label %lor.lhs.false22

lor.lhs.false22:                                  ; preds = %lor.lhs.false
  %tmp23 = load i8** %s, align 8
  %arrayidx24 = getelementptr inbounds i8* %tmp23, i64 2
  %tmp25 = load i8* %arrayidx24
  %conv26 = sext i8 %tmp25 to i32
  %cmp27 = icmp ne i32 %conv26, 46
  br i1 %cmp27, label %if.then, label %if.end35

if.then:                                          ; preds = %lor.lhs.false22, %lor.lhs.false, %while.end
  %tmp29 = load i32* %rc, align 4
  %add = add nsw i32 %tmp29, 1
  store i32 %add, i32* %rc, align 4
  %tmp30 = load %struct.defs** %pd0.addr, align 8
  %flgd = getelementptr inbounds %struct.defs* %tmp30, i32 0, i32 11
  %tmp31 = load i32* %flgd, align 4
...
if.end35:                                         ; preds = %if.end, %lor.lhs.false22
  %tmp36 = load i8** %s, align 8
  %arrayidx37 = getelementptr inbounds i8* %tmp36, i64 3
  %tmp38 = load i8* %arrayidx37
  %conv39 = sext i8 %tmp38 to i32
  %cmp40 = icmp ne i32 %conv39, 0
  br i1 %cmp40, label %if.then42, label %if.end53

if.then42:                                        ; preds = %if.end35
  %tmp43 = load i32* %rc, align 4
  %add44 = add nsw i32 %tmp43, 4
  store i32 %add44, i32* %rc, align 4
  %tmp45 = load %struct.defs** %pd0.addr, align 8
  %flgd46 = getelementptr inbounds %struct.defs* %tmp45, i32 0, i32 11
  %tmp47 = load i32* %flgd46, align 4
  %cmp48 = icmp ne i32 %tmp47, 0
  br i1 %cmp48, label %if.then50, label %if.end52

if.then50:                                        ; preds = %if.then42
  %call51 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s25er, i32 0, i32 0), i32 4)
  br label %if.end52
...
if.end53:                                         ; preds = %if.end52, %if.end35
  %tmp54 = load i8* getelementptr inbounds ([4 x i8]* @.str1, i32 0, i64 1)
  %conv55 = sext i8 %tmp54 to i32
  %cmp56 = icmp ne i32 %conv55, 34
  br i1 %cmp56, label %if.then58, label %if.end69

if.then58:                                        ; preds = %if.end53
  %tmp59 = load i32* %rc, align 4
  %add60 = add nsw i32 %tmp59, 8
  store i32 %add60, i32* %rc, align 4
  %tmp61 = load %struct.defs** %pd0.addr, align 8
  %flgd62 = getelementptr inbounds %struct.defs* %tmp61, i32 0, i32 11
  %tmp63 = load i32* %flgd62, align 4
  %cmp64 = icmp ne i32 %tmp63, 0
  br i1 %cmp64, label %if.then66, label %if.end68

if.then66:                                        ; preds = %if.then58
  %call67 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s25er, i32 0, i32 0), i32 8)
  br label %if.end68

if.end68:                                         ; preds = %if.then66, %if.then58
  br label %if.end69

if.end69:                                         ; preds = %if.end68, %if.end53
  store i8* getelementptr inbounds ([8 x i8]* @.str2, i32 0, i32 0), i8** %s, align 8
  %tmp70 = load i8** %s, align 8
  %arrayidx71 = getelementptr inbounds i8* %tmp70, i64 0
...
lor.lhs.false76:                                  ; preds = %if.end69
  %tmp77 = load i8** %s, align 8
  %arrayidx78 = getelementptr inbounds i8* %tmp77, i64 1
  %tmp79 = load i8* %arrayidx78
  %conv80 = sext i8 %tmp79 to i32
  %cmp81 = icmp ne i32 %conv80, 9
  br i1 %cmp81, label %if.then118, label %lor.lhs.false83

lor.lhs.false83:                                  ; preds = %lor.lhs.false76
  %tmp84 = load i8** %s, align 8
  %arrayidx85 = getelementptr inbounds i8* %tmp84, i64 2
  %tmp86 = load i8* %arrayidx85
  %conv87 = sext i8 %tmp86 to i32
  %cmp88 = icmp ne i32 %conv87, 8
  br i1 %cmp88, label %if.then118, label %lor.lhs.false90

lor.lhs.false90:                                  ; preds = %lor.lhs.false83
  %tmp91 = load i8** %s, align 8
  %arrayidx92 = getelementptr inbounds i8* %tmp91, i64 3
  %tmp93 = load i8* %arrayidx92
  %conv94 = sext i8 %tmp93 to i32
  %cmp95 = icmp ne i32 %conv94, 13
  br i1 %cmp95, label %if.then118, label %lor.lhs.false97

lor.lhs.false97:                                  ; preds = %lor.lhs.false90
  %tmp98 = load i8** %s, align 8
  %arrayidx99 = getelementptr inbounds i8* %tmp98, i64 4
  %tmp100 = load i8* %arrayidx99
  %conv101 = sext i8 %tmp100 to i32
  %cmp102 = icmp ne i32 %conv101, 12
  br i1 %cmp102, label %if.then118, label %lor.lhs.false104

lor.lhs.false104:                                 ; preds = %lor.lhs.false97
  %tmp105 = load i8** %s, align 8
  %arrayidx106 = getelementptr inbounds i8* %tmp105, i64 5
  %tmp107 = load i8* %arrayidx106
  %conv108 = sext i8 %tmp107 to i32
  %cmp109 = icmp ne i32 %conv108, 92
  br i1 %cmp109, label %if.then118, label %lor.lhs.false111

lor.lhs.false111:                                 ; preds = %lor.lhs.false104
  %tmp112 = load i8** %s, align 8
  %arrayidx113 = getelementptr inbounds i8* %tmp112, i64 6
  %tmp114 = load i8* %arrayidx113
  %conv115 = sext i8 %tmp114 to i32
  %cmp116 = icmp ne i32 %conv115, 39
  br i1 %cmp116, label %if.then118, label %if.end129

if.then118:                                       ; preds = %lor.lhs.false111, %lor.lhs.false104, %lor.lhs.false97, %lor.lhs.false90, %lor.lhs.false83, %lor.lhs.false76, %if.end69
  %tmp119 = load i32* %rc, align 4
  %add120 = add nsw i32 %tmp119, 16
  store i32 %add120, i32* %rc, align 4
  %tmp121 = load %struct.defs** %pd0.addr, align 8
  %flgd122 = getelementptr inbounds %struct.defs* %tmp121, i32 0, i32 11
  %tmp123 = load i32* %flgd122, align 4
  %cmp124 = icmp ne i32 %tmp123, 0
  br i1 %cmp124, label %if.then126, label %if.end128

if.then126:                                       ; preds = %if.then118
  %call127 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s25er, i32 0, i32 0), i32 16)
  br label %if.end128

if.end128:                                        ; preds = %if.then126, %if.then118
  br label %if.end129

if.end129:                                        ; preds = %if.end128, %lor.lhs.false111
...
for.cond:                                         ; preds = %for.inc, %if.end129
  ...
  %conv131 = sext i32 %tmp130 to i64
  %cmp132 = icmp ult i64 %conv131, 7
  br i1 %cmp132, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %tmp134 = load i32* %j, align 4
  %idxprom = sext i32 %tmp134 to i64
  %tmp135 = load i8** %s, align 8
  %arrayidx136 = getelementptr inbounds i8* %tmp135, i64 %idxprom
  %tmp137 = load i8* %arrayidx136
  %conv138 = sext i8 %tmp137 to i32
  %tmp139 = load i32* %j, align 4
  %idxprom140 = sext i32 %tmp139 to i64
  %tmp141 = load i8** %s2, align 8
  %arrayidx142 = getelementptr inbounds i8* %tmp141, i64 %idxprom140
  %tmp143 = load i8* %arrayidx142
  %conv144 = sext i8 %tmp143 to i32
  %cmp145 = icmp ne i32 %conv138, %conv144
...
if.end148:                                        ; preds = %if.then147, %for.body
  br label %for.inc

for.inc:                                          ; preds = %if.end148
  %tmp149 = load i32* %j, align 4
  %inc = add nsw i32 %tmp149, 1
  store i32 %inc, i32* %j, align 4
  br label %for.cond

for.end:                                          ; preds = %for.cond
  %tmp150 = load i32* %lrc, align 4
  %cmp151 = icmp ne i32 %tmp150, 0
  br i1 %cmp151, label %if.then153, label %if.end164

if.then153:                                       ; preds = %for.end
  %tmp154 = load i32* %rc, align 4
  %add155 = add nsw i32 %tmp154, 32
  store i32 %add155, i32* %rc, align 4
  %tmp156 = load %struct.defs** %pd0.addr, align 8
  %flgd157 = getelementptr inbounds %struct.defs* %tmp156, i32 0, i32 11
  %tmp158 = load i32* %flgd157, align 4
  %cmp159 = icmp ne i32 %tmp158, 0
  br i1 %cmp159, label %if.then161, label %if.end163

if.then161:                                       ; preds = %if.then153
  %call162 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s25er, i32 0, i32 0), i32 32)
  br label %if.end163

if.end163:                                        ; preds = %if.then161, %if.then153
  br label %if.end164

if.end164:                                        ; preds = %if.end163, %for.end
  %tmp165 = load i32* %rc, align 4
  ret i32 %tmp165
}
...
if.then:                                          ; preds = %entry
  ...
  %call5 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds (%struct.defs* @main.d0, i32 0, i32 15, i32 0), i32 %tmp4)
  br label %if.end
...
if.then8:                                         ; preds = %if.end
  %call9 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str5, i32 0, i32 0))
  br label %if.end11

if.else:                                          ; preds = %if.end
  %call10 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str6, i32 0, i32 0))
  br label %if.end11
