...
define void @foo() #0 {
  %1 = load i8** getelementptr inbounds (%struct.barstruct* @x, i32 0, i32 0), align 8
  %2 = icmp ne i8* %1, null
...
; <label>:5                                       ; preds = %0
  ...
  %6 = load %struct.barstruct** %barptr, align 8
  %7 = getelementptr inbounds %struct.barstruct* %6, i64 -1
  store %struct.barstruct* %7, %struct.barstruct** %barptr, align 8
  br label %8

; <label>:8                                       ; preds = %5, %4
  %9 = load %struct.barstruct** %barptr, align 8
  %10 = getelementptr inbounds %struct.barstruct* %9, i32 0, i32 0
  store i8* getelementptr inbounds ([14 x i8]* @.str, i32 0, i32 0), i8** %10, align 8
  call void @foo()
  %11 = load %struct.barstruct** %barptr, align 8
  %12 = getelementptr inbounds %struct.barstruct* %11, i32 0, i32 0
  store i8* getelementptr inbounds ([14 x i8]* @.str, i32 0, i32 0), i8** %12, align 8
  ret void
}
...
define i32 @main() #2 {
  ...
  call void @baz(i32 0)
  %2 = load i8** getelementptr inbounds (%struct.barstruct* @x, i32 0, i32 0), align 8
  %3 = icmp ne i8* %2, null
