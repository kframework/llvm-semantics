...
entry:
  ...
  store i8 54, i8* getelementptr inbounds (%struct.defs* @main.d0, i64 0, i32 15, i64 2), align 2, !tbaa !0
  store i32 538976288, i32* bitcast (i8* getelementptr inbounds (%struct.defs* @main.d0, i64 0, i32 15, i64 3) to i32*), align 1
  ...
  store i32 32, i32* getelementptr inbounds (%struct.defs* @main.d0, i64 0, i32 1), align 4, !tbaa !2
  store i32 16, i32* getelementptr inbounds (%struct.defs* @main.d0, i64 0, i32 2), align 4, !tbaa !2
  store i32 64, i32* getelementptr inbounds (%struct.defs* @main.d0, i64 0, i32 3), align 4, !tbaa !2
  store i32 32, i32* getelementptr inbounds (%struct.defs* @main.d0, i64 0, i32 4), align 4, !tbaa !2
  store i32 32, i32* getelementptr inbounds (%struct.defs* @main.d0, i64 0, i32 5), align 4, !tbaa !2
  store i32 64, i32* getelementptr inbounds (%struct.defs* @main.d0, i64 0, i32 6), align 4, !tbaa !2
  store float 0x3E80000000000000, float* getelementptr inbounds (%struct.defs* @main.d0, i64 0, i32 7), align 4, !tbaa !3
  br label %while.body48.i.i

while.body48.i.i:                                 ; preds = %while.body48.i.i, %entry
  %delta.161.i.i = phi double [ 1.000000e+00, %entry ], [ %phitmp60.i.i, %while.body48.i.i ]
  %add50.i.i = fadd double %delta.161.i.i, 1.000000e+00
  %div52.i.i = fmul double %delta.161.i.i, 5.000000e-01
  %conv53.i.i = fptrunc double %div52.i.i to float
  %phitmp59.i.i = fcmp une double %add50.i.i, 1.000000e+00
  %phitmp60.i.i = fpext float %conv53.i.i to double
  br i1 %phitmp59.i.i, label %while.body48.i.i, label %if.end

if.end:                                           ; preds = %while.body48.i.i
  %conv57.i.i = fmul float %conv53.i.i, 4.000000e+00
  store float %conv57.i.i, float* getelementptr inbounds (%struct.defs* @main.d0, i64 0, i32 8), align 4, !tbaa !3
  store i8 115, i8* getelementptr inbounds (%struct.defs* @main.d0, i64 0, i32 15, i64 0), align 4, !tbaa !0
  store i8 55, i8* getelementptr inbounds (%struct.defs* @main.d0, i64 0, i32 15, i64 1), align 1, !tbaa !0
  store i8 50, i8* getelementptr inbounds (%struct.defs* @main.d0, i64 0, i32 15, i64 2), align 2, !tbaa !0
  store i8 32, i8* getelementptr inbounds (%struct.defs* @main.d0, i64 0, i32 15, i64 3), align 1, !tbaa !0
