...
define i32 @sec(%struct.defs* %pd0) #0 {
  ...
  store %struct.defs* %pd0, %struct.defs** %1, align 8
  store i8* getelementptr inbounds ([8 x i8], [8 x i8]* @sec.qs88, i32 0, i32 0), i8** %ps, align 8
  %2 = load %struct.defs*, %struct.defs** %1, align 8
  %3 = getelementptr inbounds %struct.defs, %struct.defs* %2, i32 0, i32 15
  %4 = getelementptr inbounds [8 x i8], [8 x i8]* %3, i32 0, i32 0
  store i8* %4, i8** %pt, align 8
...
; <label>:13                                      ; preds = %5
  ...
  %14 = load i32*, i32** @metricp, align 8
...
; <label>:17                                      ; preds = %13
  ...
  %19 = getelementptr inbounds %struct.defs, %struct.defs* %18, i32 0, i32 11
  %20 = load i32, i32* %19, align 4
  %21 = icmp ne i32 %20, 0
  br i1 %21, label %22, label %24

; <label>:22                                      ; preds = %17
  %23 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @sec.s88er, i32 0, i32 0), i32 2)
  br label %24

; <label>:24                                      ; preds = %22, %17
  %25 = load i32, i32* %rc, align 4
  %26 = add nsw i32 %25, 2
  store i32 %26, i32* %rc, align 4
  br label %27

; <label>:27                                      ; preds = %24, %13
  %28 = getelementptr inbounds %struct.complex, %struct.complex* %z, i32 0, i32 0
  store double 0.000000e+00, double* %28, align 8
  %29 = getelementptr inbounds %struct.complex, %struct.complex* %z, i32 0, i32 1
  store double 0.000000e+00, double* %29, align 8
  store %struct.complex* %z, %struct.complex** %zp, align 8
  %30 = load %struct.complex*, %struct.complex** %zp, align 8
  %31 = getelementptr inbounds %struct.complex, %struct.complex* %30, i32 0, i32 0
  store double 1.000000e+00, double* %31, align 8
  %32 = load %struct.complex*, %struct.complex** %zp, align 8
  %33 = getelementptr inbounds %struct.complex, %struct.complex* %32, i32 0, i32 1
  store double 1.000000e+00, double* %33, align 8
  %34 = getelementptr inbounds %struct.complex, %struct.complex* %z, i32 0, i32 0
  %35 = load double, double* %34, align 8
  %36 = getelementptr inbounds %struct.complex, %struct.complex* %z, i32 0, i32 1
...
; <label>:40                                      ; preds = %27
  %41 = load %struct.defs*, %struct.defs** %1, align 8
  %42 = getelementptr inbounds %struct.defs, %struct.defs* %41, i32 0, i32 11
  %43 = load i32, i32* %42, align 4
  %44 = icmp ne i32 %43, 0
  br i1 %44, label %45, label %47

; <label>:45                                      ; preds = %40
  %46 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @sec.s88er, i32 0, i32 0), i32 4)
  br label %47

; <label>:47                                      ; preds = %45, %40
  %48 = load i32, i32* %rc, align 4
  %49 = add nsw i32 %48, 4
  store i32 %49, i32* %rc, align 4
  br label %50

; <label>:50                                      ; preds = %47, %27
