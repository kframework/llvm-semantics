; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/struct-aliasing-1.c'
...
entry:
  ...
  %f = getelementptr inbounds %struct.S* %tmp, i32 0, i32 0
  %0 = bitcast float* %f to i32*
  store i32* %0, i32** %q, align 8
  %tmp2 = load i32** %q, align 8
  %tmp3 = load i32* %tmp2
  store i32 %tmp3, i32* %i, align 4
  %tmp4 = load i32** %r.addr, align 8
  store i32 0, i32* %tmp4
  %tmp5 = load i32* %i, align 4
  %tmp6 = load i32** %q, align 8
  %tmp7 = load i32* %tmp6
  %add = add nsw i32 %tmp5, %tmp7
  ret i32 %add
}
