; ModuleID = '/home/grosu/celliso2/c-semantics/tests/unitTests/cq-05-s25.ll'
...
while.cond:                                       ; preds = %while.cond, %entry
  ...
  %incdec.ptr48 = getelementptr %struct.defs* %pd0, i64 0, i32 15, i64 %indvar
  %incdec.ptr7 = getelementptr [8 x i8]* @sec.qs25, i64 0, i64 %indvar
  %tmp2 = load i8* %incdec.ptr7, align 1
  store i8 %tmp2, i8* %incdec.ptr48, align 1
  %tobool = icmp eq i8 %tmp2, 0
  %indvar.next = add i64 %indvar, 1
...
while.cond.i:                                     ; preds = %while.cond.i, %entry
  ...
  %incdec.ptr7.i = getelementptr [8 x i8]* @sec.qs25, i64 0, i64 %indvar.i
  %incdec.ptr48.i = getelementptr %struct.defs* @main.d0, i64 0, i32 15, i64 %indvar.i
  %tmp2.i = load i8* %incdec.ptr7.i, align 1
  store i8 %tmp2.i, i8* %incdec.ptr48.i, align 1
...
if.then:                                          ; preds = %sec.exit
  %call5 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str4, i64 0, i64 0), i8* getelementptr inbounds (%struct.defs* @main.d0, i64 0, i32 15, i64 0), i32 0) nounwind
  br label %if.end
