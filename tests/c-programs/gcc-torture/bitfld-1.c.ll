...
define i32 @main(i32 %argc, i8** %argv) #0 {
  ...
  %14 = urem i32 %12, %13
  %15 = load i32, i32* %unsigned_result, align 4
...
; <label>:18                                      ; preds = %0
  ...
  %21 = urem i32 %19, %20
  %22 = load i32, i32* %unsigned_result, align 4
...
; <label>:25                                      ; preds = %18
  ...
  %32 = srem i32 %26, %31
  %33 = load i32, i32* %signed_result, align 4
...
; <label>:36                                      ; preds = %25
  ...
  %47 = srem i32 %41, %46
  %48 = load i32, i32* %signed_result, align 4
...
; <label>:51                                      ; preds = %36
  ...
  %58 = urem i32 %52, %57
  %59 = load i32, i32* %unsigned_result, align 4
...
; <label>:62                                      ; preds = %51
  ...
  %73 = urem i32 %67, %72
  %74 = load i32, i32* %unsigned_result, align 4
