...
define i32 @main() #0 {
  ...
  %2 = load i8** %pc2, align 8
  store i8 1, i8* %2, align 1
  %3 = load i32** %pi, align 8
  store i32 1, i32* %3, align 4
  %4 = load i32** %pi, align 8
  ...
  %11 = load i8** %pc2, align 8
  %12 = call i32 @f(i8* %11)
  %13 = load i8** %pc2, align 8
  store i8 1, i8* %13, align 1
  %14 = load i32** %pi, align 8
  %15 = load i32* %14, align 4
  %16 = load i8** %pc2, align 8
  %17 = load i8* %16, align 1
  %18 = sext i8 %17 to i32
  %19 = and i32 %18, %15
  %20 = trunc i32 %19 to i8
  store i8 %20, i8* %16, align 1
  %21 = load i8** %pc2, align 8
