...
define void @foobar(i32 %x, i32 %y, i32 %z) #0 {
  ...
  %60 = load %struct.x*, %struct.x** %c, align 8
  ...
  %67 = load %struct.x*, %struct.x** %c, align 8
...
; <label>:86                                      ; preds = %0
  %87 = load %struct.x*, %struct.x** %c, align 8
