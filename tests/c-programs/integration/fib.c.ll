...
define i32 @fastfib(i32 %n) #0 {
  ...
  store i32 %n, i32* %1, align 4
  %2 = getelementptr inbounds [3 x i32], [3 x i32]* %a, i32 0, i32 0
...
; <label>:13                                      ; preds = %7
  ...
  %15 = getelementptr inbounds [3 x i32], [3 x i32]* %a, i32 0, i32 0
  %16 = icmp eq i32* %14, %15
  br i1 %16, label %17, label %26

; <label>:17                                      ; preds = %13
  %18 = getelementptr inbounds [3 x i32], [3 x i32]* %a, i32 0, i32 0
  %19 = getelementptr inbounds i32, i32* %18, i64 1
  %20 = load i32, i32* %19, align 4
  %21 = getelementptr inbounds [3 x i32], [3 x i32]* %a, i32 0, i32 0
...
; <label>:26                                      ; preds = %13
  ...
  %28 = getelementptr inbounds [3 x i32], [3 x i32]* %a, i32 0, i32 0
  %29 = getelementptr inbounds i32, i32* %28, i64 1
  %30 = icmp eq i32* %27, %29
  br i1 %30, label %31, label %39

; <label>:31                                      ; preds = %26
  %32 = getelementptr inbounds [3 x i32], [3 x i32]* %a, i32 0, i32 0
  %33 = load i32, i32* %32, align 4
  %34 = getelementptr inbounds [3 x i32], [3 x i32]* %a, i32 0, i32 0
...
; <label>:39                                      ; preds = %26
  %40 = getelementptr inbounds [3 x i32], [3 x i32]* %a, i32 0, i32 0
  %41 = load i32, i32* %40, align 4
  %42 = getelementptr inbounds [3 x i32], [3 x i32]* %a, i32 0, i32 0
...
; <label>:49                                      ; preds = %48, %10
  ...
  %52 = getelementptr inbounds [3 x i32], [3 x i32]* %a, i32 0, i32 0
  %53 = getelementptr inbounds i32, i32* %52, i64 2
  %54 = icmp ugt i32* %51, %53
  br i1 %54, label %55, label %57

; <label>:55                                      ; preds = %49
  %56 = getelementptr inbounds [3 x i32], [3 x i32]* %a, i32 0, i32 0
...
; <label>:61                                      ; preds = %3
  ...
  %63 = getelementptr inbounds [3 x i32], [3 x i32]* %a, i32 0, i32 0
...
; <label>:12                                      ; preds = %7
  ...
  %14 = load i32, i32* %n0, align 4
  %15 = load i32, i32* %n1, align 4
  %16 = add i32 %14, %15
  store i32 %16, i32* %n1, align 4
  %17 = load i32, i32* %naux, align 4
