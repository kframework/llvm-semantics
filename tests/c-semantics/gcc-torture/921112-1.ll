...
define void @f(%union.u* %x, i64 %v.coerce) #0 {
  ...
  %2 = getelementptr %union.u* %v, i32 0, i32 0
  %3 = bitcast double* %2 to i64*
  store i64 %v.coerce, i64* %3, align 1
  store %union.u* %x, %union.u** %1, align 8
  %4 = load %union.u** %1, align 8
  %5 = getelementptr inbounds %union.u* %4, i32 1
...
define i32 @main() #0 {
  ...
  %2 = load i64* bitcast (%union.u* @v to i64*), align 1
  call void @f(%union.u* getelementptr inbounds ([2 x %union.u]* @x, i32 0, i32 0), i64 %2)
  %3 = load i32* getelementptr inbounds (%struct.anon* bitcast (%union.u* getelementptr inbounds ([2 x %union.u]* @x, i32 0, i64 1) to %struct.anon*), i32 0, i32 0), align 4
  %4 = icmp ne i32 %3, 1
  br i1 %4, label %8, label %5

; <label>:5                                       ; preds = %0
  %6 = load i32* getelementptr inbounds (%struct.anon* bitcast (%union.u* getelementptr inbounds ([2 x %union.u]* @x, i32 0, i64 1) to %struct.anon*), i32 0, i32 1), align 4
  %7 = icmp ne i32 %6, 2
