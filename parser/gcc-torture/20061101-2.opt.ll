; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20061101-2.ll'
...
while.body.i:                                     ; preds = %while.cond.i
  ...
  %conv.i = sext i32 %tmp71.i to i64
  %mul.i = mul nsw i64 %conv.i, 36863
  %cmp.i.i = icmp eq i64 %mul.i, 36863
