...
; <label>:103                                     ; preds = %94, %87, %76
  ...
  %107 = load i8* %t1, align 1
  %108 = sext i8 %107 to i32
  %109 = icmp ne i32 %108, 0
  br i1 %109, label %114, label %110

; <label>:110                                     ; preds = %103
  %111 = load i8* %t2, align 1
...
define void @run_and_display(i64 %niters) #0 {
  ...
  %3 = getelementptr inbounds [80 x i8]* %statelist1, i32 0, i64 40
  store i8 1, i8* %3, align 1
  %4 = getelementptr inbounds [80 x i8]* %statelist1, i32 0, i32 0
  store i8* %4, i8** %statelist, align 8
  %5 = getelementptr inbounds [80 x i8]* %statelist2, i32 0, i32 0
...
; <label>:11                                      ; preds = %6
  %12 = load i8** %statelist, align 8
  call void @print_statelist(i8* %12, i64 80)
  %13 = load i8** %new_statelist, align 8
  %14 = load i8** %statelist, align 8
  %15 = call i8* @apply_rules(i8* %13, i8* %14, i64 80)
  store i8* %15, i8** %statelist, align 8
  %16 = getelementptr inbounds [80 x i8]* %statelist1, i32 0, i32 0
  %17 = icmp eq i8* %15, %16
  br i1 %17, label %18, label %20

; <label>:18                                      ; preds = %11
  %19 = getelementptr inbounds [80 x i8]* %statelist2, i32 0, i32 0
  store i8* %19, i8** %new_statelist, align 8
  br label %22

; <label>:20                                      ; preds = %11
  %21 = getelementptr inbounds [80 x i8]* %statelist1, i32 0, i32 0
