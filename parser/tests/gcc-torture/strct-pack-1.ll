; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/strct-pack-1.c'
...
entry:
  ...
  %tmp = load %struct.TRIAL** %t.addr, align 8
  %s = getelementptr inbounds %struct.TRIAL* %tmp, i32 0, i32 0
  %tmp1 = load i16* %s, align 2
  %conv = sext i16 %tmp1 to i32
  %cmp = icmp ne i32 %conv, 1
  br i1 %cmp, label %if.then, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %entry
  %tmp3 = load %struct.TRIAL** %t.addr, align 8
  %d = getelementptr inbounds %struct.TRIAL* %tmp3, i32 0, i32 1
  %tmp4 = load double* %d, align 2
  %cmp5 = fcmp une double %tmp4, 1.600000e+01
