...
; <label>:9                                       ; preds = %5
  ...
  %14 = getelementptr inbounds float, float* %13, i32 1
...
define i32 @main() #0 {
  ...
  %4 = getelementptr inbounds [4 x i32], [4 x i32]* %r, i32 0, i32 0
  %5 = getelementptr inbounds [4 x float], [4 x float]* %a, i32 0, i32 0
  %6 = getelementptr inbounds [4 x float], [4 x float]* %b, i32 0, i32 0
...
; <label>:10                                      ; preds = %7
  ...
  %13 = getelementptr inbounds [4 x float], [4 x float]* %a, i32 0, i64 %12
  %14 = load float, float* %13, align 4
  %15 = load i32, i32* %i, align 4
  %16 = sext i32 %15 to i64
  %17 = getelementptr inbounds [4 x float], [4 x float]* %b, i32 0, i64 %16
  %18 = load float, float* %17, align 4
  %19 = fcmp oeq float %14, %18
  %20 = zext i1 %19 to i32
  %21 = load i32, i32* %i, align 4
  %22 = sext i32 %21 to i64
  %23 = getelementptr inbounds [4 x i32], [4 x i32]* %r, i32 0, i64 %22
