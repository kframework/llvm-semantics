...
define i32 @sec(%struct.defs* %pd0) #0 {
  ...
  %8 = load %struct.defs** %1, align 8
  %9 = getelementptr inbounds %struct.defs* %8, i32 0, i32 15
  %10 = getelementptr inbounds [8 x i8]* %9, i32 0, i32 0
  store i8* %10, i8** %pt, align 8
  store i32 0, i32* %rc, align 4
  br label %11

; <label>:11                                      ; preds = %18, %0
  %12 = load i8** %ps, align 8
  %13 = getelementptr inbounds i8* %12, i32 1
  store i8* %13, i8** %ps, align 8
  %14 = load i8* %12, align 1
  %15 = load i8** %pt, align 8
...
; <label>:19                                      ; preds = %11
  %20 = load i32** @sec.pint, align 8
  %21 = load i32* %20, align 4
  %22 = icmp ne i32 %21, 5
  br i1 %22, label %23, label %33

; <label>:23                                      ; preds = %19
  %24 = load %struct.defs** %1, align 8
  %25 = getelementptr inbounds %struct.defs* %24, i32 0, i32 11
  %26 = load i32* %25, align 4
  %27 = icmp ne i32 %26, 0
  br i1 %27, label %28, label %30

; <label>:28                                      ; preds = %23
  %29 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s86er, i32 0, i32 0), i32 1)
  br label %30
...
; <label>:33                                      ; preds = %30, %19
  %34 = load i32** %apint, align 8
  %35 = load i32* %34, align 4
  %36 = icmp ne i32 %35, 3
  br i1 %36, label %37, label %47

; <label>:37                                      ; preds = %33
  %38 = load %struct.defs** %1, align 8
  %39 = getelementptr inbounds %struct.defs* %38, i32 0, i32 11
  %40 = load i32* %39, align 4
  %41 = icmp ne i32 %40, 0
  br i1 %41, label %42, label %44

; <label>:42                                      ; preds = %37
  %43 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s86er, i32 0, i32 0), i32 2)
  br label %44

; <label>:44                                      ; preds = %42, %37
  %45 = load i32* %rc, align 4
  %46 = add nsw i32 %45, 2
  store i32 %46, i32* %rc, align 4
  br label %47

; <label>:47                                      ; preds = %44, %33
  %48 = load i32** %rpint, align 8
...
; <label>:56                                      ; preds = %51
  %57 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s86er, i32 0, i32 0), i32 4)
  br label %58
...
; <label>:65                                      ; preds = %62
  ...
  %68 = getelementptr inbounds [10 x i32]* @sec.zero, i32 0, i64 %67
...
; <label>:79                                      ; preds = %76
  %80 = load %struct.defs** %1, align 8
  %81 = getelementptr inbounds %struct.defs* %80, i32 0, i32 11
  %82 = load i32* %81, align 4
  %83 = icmp ne i32 %82, 0
  br i1 %83, label %84, label %86

; <label>:84                                      ; preds = %79
  %85 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s86er, i32 0, i32 0), i32 8)
  br label %86

; <label>:86                                      ; preds = %84, %79
  %87 = load i32* %rc, align 4
  %88 = add nsw i32 %87, 8
...
; <label>:97                                      ; preds = %94
  ...
  %106 = getelementptr inbounds [4 x [3 x float]]* @sec.y1, i32 0, i64 %105
  %107 = getelementptr inbounds [3 x float]* %106, i32 0, i64 %103
  %108 = load float* %107, align 4
  %109 = load i32* %j, align 4
  %110 = sext i32 %109 to i64
  %111 = load i32* %i, align 4
  %112 = sext i32 %111 to i64
  %113 = getelementptr inbounds [4 x [3 x float]]* @sec.y2, i32 0, i64 %112
  %114 = getelementptr inbounds [3 x float]* %113, i32 0, i64 %110
...
; <label>:117                                     ; preds = %97
  ...
  %122 = getelementptr inbounds [4 x [3 x float]]* @sec.y1, i32 0, i64 %121
  %123 = getelementptr inbounds [3 x float]* %122, i32 0, i64 %119
  %124 = load float* %123, align 4
  %125 = load i32* %k, align 4
  %126 = sext i32 %125 to i64
  %127 = getelementptr inbounds [12 x float]* @sec.y0, i32 0, i64 %126
...
; <label>:142                                     ; preds = %139
  %143 = load %struct.defs** %1, align 8
  %144 = getelementptr inbounds %struct.defs* %143, i32 0, i32 11
  %145 = load i32* %144, align 4
  %146 = icmp ne i32 %145, 0
  br i1 %146, label %147, label %149

; <label>:147                                     ; preds = %142
  %148 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s86er, i32 0, i32 0), i32 16)
  br label %149

; <label>:149                                     ; preds = %147, %142
  %150 = load i32* %rc, align 4
...
; <label>:156                                     ; preds = %153
  ...
  %159 = getelementptr inbounds [4 x [3 x float]]* @sec.y3, i32 0, i64 %158
  %160 = getelementptr inbounds [3 x float]* %159, i32 0, i64 0
...
; <label>:171                                     ; preds = %153
  %172 = load i32* %lrc, align 4
  %173 = icmp ne i32 %172, 0
  br i1 %173, label %174, label %184

; <label>:174                                     ; preds = %171
  %175 = load %struct.defs** %1, align 8
  %176 = getelementptr inbounds %struct.defs* %175, i32 0, i32 11
  %177 = load i32* %176, align 4
  %178 = icmp ne i32 %177, 0
  br i1 %178, label %179, label %181

; <label>:179                                     ; preds = %174
  %180 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s86er, i32 0, i32 0), i32 32)
  br label %181

; <label>:181                                     ; preds = %179, %174
  %182 = load i32* %rc, align 4
