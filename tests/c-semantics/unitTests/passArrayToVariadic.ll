...
define i32 @main() #0 {
  ...
  %4 = sext i32 %3 to i64
  %5 = getelementptr inbounds [5 x [3 x i8]]* @code, i32 0, i64 %4
  %6 = getelementptr inbounds [3 x i8]* %5, i32 0, i32 0
  %7 = load i32* %i, align 4
  %8 = load i32* %i, align 4
  %9 = sext i32 %8 to i64
  %10 = getelementptr inbounds [5 x [3 x i8]]* @code, i32 0, i64 %9
  %11 = getelementptr inbounds [3 x i8]* %10, i32 0, i32 0
  %12 = call i64 @strlen(i8* %11) #3
  %13 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str, i32 0, i32 0), i32 %2, i8* %6, i32 %7, i64 %12)
  ret i32 0
}
