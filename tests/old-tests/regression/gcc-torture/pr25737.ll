; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/pr25737.c'
...
entry:
  ...
  %tmp = load %struct.delay_block** getelementptr inbounds (%struct.delay_block* @Timer_Queue, i32 0, i32 0), align 8
  store %struct.delay_block* %tmp, %struct.delay_block** %q, align 8
  %tmp1 = load %struct.delay_block** %d.addr, align 8
  %succ = getelementptr inbounds %struct.delay_block* %tmp1, i32 0, i32 0
  store %struct.delay_block* null, %struct.delay_block** %succ, align 8
  %tmp2 = load %struct.delay_block** getelementptr inbounds (%struct.delay_block* @Timer_Queue, i32 0, i32 0), align 8
  ret %struct.delay_block* %tmp2
}
