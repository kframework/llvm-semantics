; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20001017-2.c'
...
lor.lhs.false:                                    ; preds = %entry
  %tmp2 = load i64** %c.addr, align 8
  %tmp3 = load i64* %tmp2
  %cmp4 = icmp ne i64 %tmp3, 2
...
entry:
  ...
  call void @fn_4parms(i8 zeroext %tmp, i64* %b, i64* %c, i32* %d)
  ret i32 0
}
