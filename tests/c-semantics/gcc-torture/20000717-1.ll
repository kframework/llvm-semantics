...
define i32 @bar(i32 %i, i64 %t.coerce0, i32 %t.coerce1) #0 {
  ...
  %7 = getelementptr inbounds %struct.trio* %t, i32 0, i32 0
  %8 = load i32* %7, align 4
  %9 = getelementptr inbounds %struct.trio* %t, i32 0, i32 1
  %10 = load i32* %9, align 4
  %11 = icmp eq i32 %8, %10
  br i1 %11, label %18, label %12

; <label>:12                                      ; preds = %0
  %13 = getelementptr inbounds %struct.trio* %t, i32 0, i32 0
  %14 = load i32* %13, align 4
  %15 = getelementptr inbounds %struct.trio* %t, i32 0, i32 2
...
define i32 @foo(i64 %t.coerce0, i32 %t.coerce1, i32 %i) #0 {
  ...
  %11 = getelementptr { i64, i32 }* %3, i32 0, i32 0
  %12 = load i64* %11, align 1
  %13 = getelementptr { i64, i32 }* %3, i32 0, i32 1
