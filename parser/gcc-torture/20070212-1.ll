; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20070212-1.c'
...
if.else:                                          ; preds = %entry
  %tmp1 = load %struct.f** %ff.addr, align 8
  %i2 = getelementptr inbounds %struct.f* %tmp1, i32 0, i32 0
  store i32* %i2, i32** %t, align 8
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %tmp3 = load i32** %p.addr, align 8
  store i32 0, i32* %tmp3
  %tmp4 = load i32** %t, align 8
  %tmp5 = load i32* %tmp4
  ret i32 %tmp5
}
