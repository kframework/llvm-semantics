...
define i32 @main() #0 {
  ...
  %9 = getelementptr inbounds [2 x [60 x double]], [2 x [60 x double]]* %y, i32 0, i64 0
  %10 = getelementptr inbounds [60 x double], [60 x double]* %9, i32 0, i64 0
  store double 0.000000e+00, double* %10, align 8
  %11 = getelementptr inbounds [2 x [60 x double]], [2 x [60 x double]]* %y, i32 0, i64 1
  %12 = getelementptr inbounds [60 x double], [60 x double]* %11, i32 0, i64 0
...
; <label>:18                                      ; preds = %13
  ...
  %26 = getelementptr inbounds [2 x [60 x double]], [2 x [60 x double]]* %y, i32 0, i64 0
  %27 = getelementptr inbounds [60 x double], [60 x double]* %26, i32 0, i64 %25
  %28 = load double, double* %27, align 8
  store double %28, double* %y1, align 8
  %29 = load i32, i32* %i, align 4
  %30 = sext i32 %29 to i64
  %31 = getelementptr inbounds [2 x [60 x double]], [2 x [60 x double]]* %y, i32 0, i64 1
  %32 = getelementptr inbounds [60 x double], [60 x double]* %31, i32 0, i64 %30
  %33 = load double, double* %32, align 8
  store double %33, double* %y2, align 8
  %34 = load double, double* %h, align 8
  %35 = load double, double* %y2, align 8
  %36 = fmul double %34, %35
  store double %36, double* %dk11, align 8
  %37 = load double, double* %h, align 8
  %38 = load double, double* %y2, align 8
  ...
  %51 = load double, double* %dk21, align 8
  ...
  %104 = load double, double* %y2, align 8
  %105 = load double, double* %dk23, align 8
  %106 = fadd double %104, %105
  %107 = fmul double %103, %106
  store double %107, double* %dk14, align 8
  %108 = load double, double* %h, align 8
  %109 = load double, double* %y2, align 8
  %110 = load double, double* %dk23, align 8
  %111 = fadd double %109, %110
  %112 = fmul double -5.000000e-01, %111
  %113 = load double, double* %y1, align 8
  %114 = load double, double* %dk13, align 8
  ...
  %128 = getelementptr inbounds [2 x [60 x double]], [2 x [60 x double]]* %y, i32 0, i64 0
  %129 = getelementptr inbounds [60 x double], [60 x double]* %128, i32 0, i64 %127
  %130 = load double, double* %129, align 8
  %131 = load double, double* %dk11, align 8
  %132 = load double, double* %dk12, align 8
  %133 = load double, double* %dk13, align 8
  %134 = fadd double %132, %133
  %135 = fmul double 2.000000e+00, %134
  %136 = fadd double %131, %135
  %137 = load double, double* %dk14, align 8
  ...
  %144 = getelementptr inbounds [2 x [60 x double]], [2 x [60 x double]]* %y, i32 0, i64 0
  %145 = getelementptr inbounds [60 x double], [60 x double]* %144, i32 0, i64 %143
  store double %140, double* %145, align 8
  %146 = load i32, i32* %i, align 4
  %147 = sext i32 %146 to i64
  %148 = getelementptr inbounds [2 x [60 x double]], [2 x [60 x double]]* %y, i32 0, i64 1
  %149 = getelementptr inbounds [60 x double], [60 x double]* %148, i32 0, i64 %147
  %150 = load double, double* %149, align 8
  %151 = load double, double* %dk21, align 8
  %152 = load double, double* %dk22, align 8
  %153 = load double, double* %dk23, align 8
  %154 = fadd double %152, %153
  %155 = fmul double 2.000000e+00, %154
  %156 = fadd double %151, %155
  %157 = load double, double* %dk24, align 8
  ...
  %164 = getelementptr inbounds [2 x [60 x double]], [2 x [60 x double]]* %y, i32 0, i64 1
  %165 = getelementptr inbounds [60 x double], [60 x double]* %164, i32 0, i64 %163
  store double %160, double* %165, align 8
  %166 = load i32, i32* %i, align 4
  %167 = add nsw i32 %166, 1
  %168 = sext i32 %167 to i64
  %169 = getelementptr inbounds [2 x [60 x double]], [2 x [60 x double]]* %y, i32 0, i64 0
  %170 = getelementptr inbounds [60 x double], [60 x double]* %169, i32 0, i64 %168
  ...
  %180 = getelementptr inbounds [2 x [60 x double]], [2 x [60 x double]]* %y, i32 0, i64 0
  %181 = getelementptr inbounds [60 x double], [60 x double]* %180, i32 0, i64 %179
  %182 = load double, double* %181, align 8
  %183 = load double, double* %pi, align 8
  %184 = fmul double 2.000000e+00, %183
  %185 = load i32, i32* %np, align 4
  ...
  %192 = getelementptr inbounds [2 x [60 x double]], [2 x [60 x double]]* %y, i32 0, i64 0
  %193 = getelementptr inbounds [60 x double], [60 x double]* %192, i32 0, i64 %191
...
; <label>:202                                     ; preds = %196, %18
  ...
  %205 = getelementptr inbounds [2 x [60 x double]], [2 x [60 x double]]* %y, i32 0, i64 0
  %206 = getelementptr inbounds [60 x double], [60 x double]* %205, i32 0, i64 %204
  %207 = load double, double* %206, align 8
  %208 = fmul double %207, 1.000000e+04
  %209 = fptosi double %208 to i32
  %210 = load i32, i32* %i, align 4
  %211 = sext i32 %210 to i64
  %212 = getelementptr inbounds [2 x [60 x double]], [2 x [60 x double]]* %y, i32 0, i64 1
  %213 = getelementptr inbounds [60 x double], [60 x double]* %212, i32 0, i64 %211
  %214 = load double, double* %213, align 8
  %215 = fmul double %214, 1.000000e+04
  %216 = fptosi double %215 to i32
  %217 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0), i32 %209, i32 %216)
  br label %218
