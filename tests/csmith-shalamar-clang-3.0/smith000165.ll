; ModuleID = '/home/david/src/c-semantics/tests/csmith/smith000165.c'
...
define signext i8 @func_1() nounwind uwtable {
  %1 = load i32* getelementptr inbounds ([4 x i32]* @g_2, i32 0, i64 1), align 4
  %2 = trunc i32 %1 to i8
  ret i8 %2
}
...
define i32 @main(i32 %argc, i8** %argv) nounwind uwtable {
  ...
  %13 = load i32* getelementptr inbounds ([4 x i32]* @g_2, i32 0, i64 1), align 4
  %14 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str1, i32 0, i32 0), i32 %13)
  %15 = load i32* %1
  ret i32 %15
}
