...
define i32 @main() #0 {
  ...
  %4 = getelementptr inbounds [7 x float], [7 x float]* %2, i64 0, i64 0
  ...
  %7 = getelementptr inbounds float, float* %6, i64 1
  ...
  %11 = getelementptr inbounds [7 x float], [7 x float]* %2, i32 0, i64 3
  %12 = load float, float* %11, align 4
  %13 = bitcast [16 x i8]* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %13, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i32 0, i32 0), i64 16, i32 1, i1 false)
  ...
  store i32* getelementptr inbounds ([2 x i32], [2 x i32]* @main.a, i32 0, i64 0), i32** %r, align 8
  %16 = load i32, i32* getelementptr inbounds ([2 x i32], [2 x i32]* @main.a, i32 0, i64 1), align 4
