...
define { %struct.node*, i32 } @f() #0 {
  ...
  %4 = load { %struct.node*, i32 }, { %struct.node*, i32 }* %3, align 8
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  store %struct.node* @s, %struct.node** getelementptr inbounds (%struct.node, %struct.node* @s, i32 0, i32 0), align 8
  store i32 5, i32* getelementptr inbounds (%struct.node, %struct.node* @s, i32 0, i32 1), align 4
  %3 = call { %struct.node*, i32 } @f()
  %4 = bitcast %struct.node* %2 to { %struct.node*, i32 }*
  %5 = getelementptr { %struct.node*, i32 }, { %struct.node*, i32 }* %4, i32 0, i32 0
  %6 = extractvalue { %struct.node*, i32 } %3, 0
  store %struct.node* %6, %struct.node** %5, align 8
  %7 = getelementptr { %struct.node*, i32 }, { %struct.node*, i32 }* %4, i32 0, i32 1
  %8 = extractvalue { %struct.node*, i32 } %3, 1
  store i32 %8, i32* %7, align 8
  %9 = getelementptr inbounds %struct.node, %struct.node* %2, i32 0, i32 0
