; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20020226-1.c'
...
if.end17:                                         ; preds = %if.end
  ...
  %cmp30 = icmp ne i32 %or29, 19087651
...
if.end33:                                         ; preds = %if.end17
  ...
  %cmp41 = icmp ne i32 %or40, 19087651
...
if.end44:                                         ; preds = %if.end33
  ...
  %cmp55 = icmp ne i32 %or54, 1073742115
...
if.end58:                                         ; preds = %if.end44
  ...
  %cmp64 = icmp ne i32 %or63, 1073742115
...
if.end67:                                         ; preds = %if.end58
  ...
  %cmp78 = icmp ne i64 %or77, -9223372036835687065
...
if.end81:                                         ; preds = %if.end67
  ...
  %cmp87 = icmp ne i64 %or86, -9223372036835687065
...
if.end90:                                         ; preds = %if.end81
  ...
  %cmp101 = icmp ne i64 %or100, 5124095577148911
...
if.end104:                                        ; preds = %if.end90
  ...
  %cmp110 = icmp ne i64 %or109, 5124095577148911
...
if.end113:                                        ; preds = %if.end104
  ...
  %cmp124 = icmp ne i64 %or123, 1311768467750121216
...
if.end127:                                        ; preds = %if.end113
  ...
  %cmp133 = icmp ne i64 %or132, 1311768467750121216
...
if.end163:                                        ; preds = %if.end152
  ...
  %cmp176 = icmp ne i32 %or175, 74561
...
if.end179:                                        ; preds = %if.end163
  ...
  %cmp187 = icmp ne i32 %or186, 74561
...
if.end190:                                        ; preds = %if.end179
  ...
  %cmp201 = icmp ne i32 %or200, 74560
...
if.end204:                                        ; preds = %if.end190
  ...
  %cmp210 = icmp ne i32 %or209, 74560
...
if.end213:                                        ; preds = %if.end204
  ...
  %cmp224 = icmp ne i64 %or223, 4886718336
...
if.end227:                                        ; preds = %if.end213
  ...
  %cmp233 = icmp ne i64 %or232, 4886718336
...
if.end236:                                        ; preds = %if.end227
  ...
  %cmp247 = icmp ne i64 %or246, 1311768467750121216
...
if.end250:                                        ; preds = %if.end236
  ...
  %cmp256 = icmp ne i64 %or255, 1311768467750121216
...
if.end259:                                        ; preds = %if.end250
  ...
  %cmp270 = icmp ne i64 %or269, 5124095577148911
...
if.end273:                                        ; preds = %if.end259
  ...
  %cmp279 = icmp ne i64 %or278, 5124095577148911
