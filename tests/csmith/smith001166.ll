; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith001166.c'
...
entry:
  %tmp = load i32** getelementptr inbounds ([2 x i32*]* @g_2, i32 0, i64 0), align 8
  %tmp1 = volatile load i32*** @g_6, align 8
  store i32* %tmp, i32** %tmp1
  %tmp2 = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 6, i64 3, i64 0), align 4
...
entry:
  ...
  %tmp = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 0, i64 0, i64 0), align 4
  %call1 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str, i32 0, i32 0), i32 %tmp)
  %tmp2 = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 0, i64 1, i64 0), align 4
  %call3 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str1, i32 0, i32 0), i32 %tmp2)
  %tmp4 = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 0, i64 2, i64 0), align 4
  %call5 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str2, i32 0, i32 0), i32 %tmp4)
  %tmp6 = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 0, i64 3, i64 0), align 4
  %call7 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str3, i32 0, i32 0), i32 %tmp6)
  %tmp8 = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 1, i64 0, i64 0), align 4
  %call9 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str4, i32 0, i32 0), i32 %tmp8)
  %tmp10 = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 1, i64 1, i64 0), align 4
  %call11 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str5, i32 0, i32 0), i32 %tmp10)
  %tmp12 = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 1, i64 2, i64 0), align 4
  %call13 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str6, i32 0, i32 0), i32 %tmp12)
  %tmp14 = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 1, i64 3, i64 0), align 4
  %call15 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str7, i32 0, i32 0), i32 %tmp14)
  %tmp16 = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 2, i64 0, i64 0), align 4
  %call17 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str8, i32 0, i32 0), i32 %tmp16)
  %tmp18 = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 2, i64 1, i64 0), align 4
  %call19 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str9, i32 0, i32 0), i32 %tmp18)
  %tmp20 = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 2, i64 2, i64 0), align 4
  %call21 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str10, i32 0, i32 0), i32 %tmp20)
  %tmp22 = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 2, i64 3, i64 0), align 4
  %call23 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str11, i32 0, i32 0), i32 %tmp22)
  %tmp24 = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 3, i64 0, i64 0), align 4
  %call25 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str12, i32 0, i32 0), i32 %tmp24)
  %tmp26 = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 3, i64 1, i64 0), align 4
  %call27 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str13, i32 0, i32 0), i32 %tmp26)
  %tmp28 = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 3, i64 2, i64 0), align 4
  %call29 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str14, i32 0, i32 0), i32 %tmp28)
  %tmp30 = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 3, i64 3, i64 0), align 4
  %call31 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str15, i32 0, i32 0), i32 %tmp30)
  %tmp32 = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 4, i64 0, i64 0), align 4
  %call33 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str16, i32 0, i32 0), i32 %tmp32)
  %tmp34 = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 4, i64 1, i64 0), align 4
  %call35 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str17, i32 0, i32 0), i32 %tmp34)
  %tmp36 = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 4, i64 2, i64 0), align 4
  %call37 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str18, i32 0, i32 0), i32 %tmp36)
  %tmp38 = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 4, i64 3, i64 0), align 4
  %call39 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str19, i32 0, i32 0), i32 %tmp38)
  %tmp40 = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 5, i64 0, i64 0), align 4
  %call41 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str20, i32 0, i32 0), i32 %tmp40)
  %tmp42 = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 5, i64 1, i64 0), align 4
  %call43 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str21, i32 0, i32 0), i32 %tmp42)
  %tmp44 = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 5, i64 2, i64 0), align 4
  %call45 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str22, i32 0, i32 0), i32 %tmp44)
  %tmp46 = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 5, i64 3, i64 0), align 4
  %call47 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str23, i32 0, i32 0), i32 %tmp46)
  %tmp48 = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 6, i64 0, i64 0), align 4
  %call49 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str24, i32 0, i32 0), i32 %tmp48)
  %tmp50 = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 6, i64 1, i64 0), align 4
  %call51 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str25, i32 0, i32 0), i32 %tmp50)
  %tmp52 = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 6, i64 2, i64 0), align 4
  %call53 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str26, i32 0, i32 0), i32 %tmp52)
  %tmp54 = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 6, i64 3, i64 0), align 4
  %call55 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str27, i32 0, i32 0), i32 %tmp54)
  %tmp56 = load i32* getelementptr inbounds ([7 x [4 x [1 x i32]]]* @g_3, i32 0, i64 6, i64 3, i64 0), align 4
  %call57 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str27, i32 0, i32 0), i32 %tmp56)
  %0 = load i32* %retval
  ret i32 %0
}
