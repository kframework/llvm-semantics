...
; <label>:22                                      ; preds = %17
  ...
  %24 = load i8** %cq, align 8
  %25 = icmp eq i8* %23, %24
  br i1 %25, label %33, label %26

; <label>:26                                      ; preds = %22
  %27 = load i8** %cp, align 8
  %28 = load i8** %cq, align 8
...
; <label>:39                                      ; preds = %34
  %40 = load i32* %octets, align 4
  %41 = icmp eq i32 %40, 3
  br i1 %41, label %42, label %45

; <label>:42                                      ; preds = %39, %34
  %43 = load i32* %octets, align 4
  %44 = add nsw i32 %43, 1
  store i32 %44, i32* %octets, align 4
  br label %45

; <label>:45                                      ; preds = %42, %39
  %46 = load i32* %octets, align 4
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = call i64 @root_nfs_parse_addr(i8* getelementptr inbounds ([19 x i8]* @main.addr, i32 0, i32 0))
  store i64 %2, i64* %result, align 8
  %3 = load i64* %result, align 8
