...
; <label>:3                                       ; preds = %23, %0
  %4 = load i32, i32* %x_squared, align 4
...
; <label>:9                                       ; preds = %3
  %10 = load i32, i32* %x_squared, align 4
...
; <label>:23                                      ; preds = %22
  ...
  %27 = mul i32 2, %26
  %28 = sub i32 %27, 1
  %29 = load i32, i32* %x_squared, align 4
  %30 = add i32 %29, %28
...
; <label>:12                                      ; preds = %24, %11
  %13 = load i32, i32* %x, align 4
  %14 = load i32, i32* %sqrt_n, align 4
...
; <label>:10                                      ; preds = %6
  ...
  %13 = load i8*, i8** %is_not_prime, align 8
...
; <label>:17                                      ; preds = %10
  %18 = load i32, i32* %num_primes, align 4
  %19 = add nsw i32 %18, 1
...
; <label>:27                                      ; preds = %23
  ...
  %30 = load i8*, i8** %is_not_prime, align 8
...
; <label>:41                                      ; preds = %6
  %42 = load i32, i32* %num_primes, align 4
  %43 = add nsw i32 %42, 1
...
; <label>:52                                      ; preds = %48
  ...
  %55 = load i8*, i8** %is_not_prime, align 8
...
; <label>:59                                      ; preds = %52
  ...
  %64 = load i16*, i16** @primes, align 8
  %65 = getelementptr inbounds i16, i16* %64, i64 %63
...
define i32 @trial_division_primes(i32 %n) #0 {
  ...
  %6 = fptoui double %5 to i32
  store i32 %6, i32* %sqrt_n, align 4
  %7 = load i16*, i16** @primes, align 8
  store i16* %7, i16** %prime, align 8
  br label %8

; <label>:8                                       ; preds = %32, %0
  %9 = load i16*, i16** %prime, align 8
...
; <label>:13                                      ; preds = %8
  %14 = load i16*, i16** %prime, align 8
  %15 = load i16, i16* %14, align 2
  %16 = zext i16 %15 to i32
  %17 = load i32, i32* %sqrt_n, align 4
