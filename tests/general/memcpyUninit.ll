; ModuleID = '/home/grosu/celliso2/c-semantics/tests/unitTests/memcpyUninit.c'
...
entry:
  ...
  %tmp1 = load %struct.S** %s2, align 8
  %x2 = getelementptr inbounds %struct.S* %tmp1, i32 0, i32 0
