...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  call void @dump_bfd_file(i8* null, i8* null, i8* null, i64 3735928559, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @hello, i32 0, i32 0), i32 514703087)
...
define internal void @dump_bfd_file(i8* %filename, i8* %mode, i8* %target, i64 %vaddr, i8* %buf, i32 %len) #0 {
  ...
  %11 = load %struct.bfd_struct*, %struct.bfd_struct** %obfd, align 8
  %12 = call %struct.asection_struct* @bfd_make_section_anyway(%struct.bfd_struct* %11, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i32 0, i32 0))
  store %struct.asection_struct* %12, %struct.asection_struct** %osection, align 8
  %13 = load %struct.bfd_struct*, %struct.bfd_struct** %obfd, align 8
  %14 = load %struct.asection_struct*, %struct.asection_struct** %osection, align 8
  %15 = load i32, i32* %6, align 4
  %16 = sext i32 %15 to i64
  %17 = call i32 @bfd_set_section_size(%struct.bfd_struct* %13, %struct.asection_struct* %14, i64 %16)
  %18 = load i64, i64* %4, align 8
  %19 = load %struct.asection_struct*, %struct.asection_struct** %osection, align 8
  %20 = getelementptr inbounds %struct.asection_struct, %struct.asection_struct* %19, i32 0, i32 2
  store i64 %18, i64* %20, align 8
  %21 = load %struct.asection_struct*, %struct.asection_struct** %osection, align 8
  %22 = getelementptr inbounds %struct.asection_struct, %struct.asection_struct* %21, i32 0, i32 1
  store i64 %18, i64* %22, align 8
  %23 = load %struct.asection_struct*, %struct.asection_struct** %osection, align 8
  %24 = bitcast %struct.asection_struct* %23 to i8*
  %25 = load i8, i8* %24, align 8
  %26 = and i8 %25, -2
  %27 = or i8 %26, 1
  store i8 %27, i8* %24, align 8
  %28 = load %struct.asection_struct*, %struct.asection_struct** %osection, align 8
  %29 = getelementptr inbounds %struct.asection_struct, %struct.asection_struct* %28, i32 0, i32 3
  store i32 0, i32* %29, align 4
  %30 = load %struct.bfd_struct*, %struct.bfd_struct** %obfd, align 8
  %31 = load %struct.asection_struct*, %struct.asection_struct** %osection, align 8
  %32 = call i32 @bfd_set_section_flags(%struct.bfd_struct* %30, %struct.asection_struct* %31, i32 515)
  %33 = load %struct.asection_struct*, %struct.asection_struct** %osection, align 8
  %34 = getelementptr inbounds %struct.asection_struct, %struct.asection_struct* %33, i32 0, i32 4
  store i32 0, i32* %34, align 4
  %35 = load %struct.bfd_struct*, %struct.bfd_struct** %obfd, align 8
  %36 = load %struct.asection_struct*, %struct.asection_struct** %osection, align 8
