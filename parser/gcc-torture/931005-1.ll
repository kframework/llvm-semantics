; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/931005-1.c'
...
entry:
  ...
  store i8 %tmp, i8* %x1, align 1
  %tmp2 = bitcast %struct.T* %retval to i8*
  %tmp3 = bitcast %struct.T* %s1a to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %tmp2, i8* %tmp3, i64 1, i32 1, i1 false)
  %coerce.dive4 = getelementptr %struct.T* %retval, i32 0, i32 0
  %0 = load i8* %coerce.dive4
  ret i8 %0
}
