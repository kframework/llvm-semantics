; ModuleID = '/home/david/src/c-semantics/tests/unitTests/cq-06-s26.c'
...
entry:
  ...
  %flgm = getelementptr inbounds %struct.defs* %1, i32 0, i32 10
  %2 = load i32* %flgm, align 4
  %cmp = icmp ne i32 %2, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %3 = load %struct.defs** %pd0.addr, align 8
  %cbits = getelementptr inbounds %struct.defs* %3, i32 0, i32 0
  %4 = load i32* %cbits, align 4
  %call1 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @sec.s, i32 0, i32 0), i32 %4, i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0))
  %5 = load %struct.defs** %pd0.addr, align 8
  %ibits = getelementptr inbounds %struct.defs* %5, i32 0, i32 1
  %6 = load i32* %ibits, align 4
  %call2 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @sec.s, i32 0, i32 0), i32 %6, i8* getelementptr inbounds ([4 x i8]* @.str1, i32 0, i32 0))
  %7 = load %struct.defs** %pd0.addr, align 8
  %sbits = getelementptr inbounds %struct.defs* %7, i32 0, i32 2
  %8 = load i32* %sbits, align 4
  %call3 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @sec.s, i32 0, i32 0), i32 %8, i8* getelementptr inbounds ([6 x i8]* @.str2, i32 0, i32 0))
  %9 = load %struct.defs** %pd0.addr, align 8
  %lbits = getelementptr inbounds %struct.defs* %9, i32 0, i32 3
  %10 = load i32* %lbits, align 4
  %call4 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @sec.s, i32 0, i32 0), i32 %10, i8* getelementptr inbounds ([5 x i8]* @.str3, i32 0, i32 0))
  %11 = load %struct.defs** %pd0.addr, align 8
  %ubits = getelementptr inbounds %struct.defs* %11, i32 0, i32 4
  %12 = load i32* %ubits, align 4
  %call5 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @sec.s, i32 0, i32 0), i32 %12, i8* getelementptr inbounds ([9 x i8]* @.str4, i32 0, i32 0))
  %13 = load %struct.defs** %pd0.addr, align 8
  %fbits = getelementptr inbounds %struct.defs* %13, i32 0, i32 5
  %14 = load i32* %fbits, align 4
  %call6 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @sec.s, i32 0, i32 0), i32 %14, i8* getelementptr inbounds ([6 x i8]* @.str5, i32 0, i32 0))
  %15 = load %struct.defs** %pd0.addr, align 8
  %dbits = getelementptr inbounds %struct.defs* %15, i32 0, i32 6
  %16 = load i32* %dbits, align 4
  %call7 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @sec.s, i32 0, i32 0), i32 %16, i8* getelementptr inbounds ([7 x i8]* @.str6, i32 0, i32 0))
  %17 = load %struct.defs** %pd0.addr, align 8
  %fprec = getelementptr inbounds %struct.defs* %17, i32 0, i32 7
  %18 = load float* %fprec, align 4
  %conv = fpext float %18 to double
  %call8 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([64 x i8]* @sec.s2, i32 0, i32 0), double %conv, i8* getelementptr inbounds ([6 x i8]* @.str5, i32 0, i32 0))
  %19 = load %struct.defs** %pd0.addr, align 8
  %dprec = getelementptr inbounds %struct.defs* %19, i32 0, i32 8
  %20 = load float* %dprec, align 4
  %conv9 = fpext float %20 to double
  %call10 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([64 x i8]* @sec.s2, i32 0, i32 0), double %conv9, i8* getelementptr inbounds ([7 x i8]* @.str6, i32 0, i32 0))
  br label %if.end
...
if.then:                                          ; preds = %entry
  ...
  %call1 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str7, i32 0, i32 0), i8* getelementptr inbounds (%struct.defs* @main.d0, i32 0, i32 15, i32 0), i32 %4)
  br label %if.end
...
if.then3:                                         ; preds = %if.end
  %call4 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str8, i32 0, i32 0))
  br label %if.end6

if.else:                                          ; preds = %if.end
  %call5 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str9, i32 0, i32 0))
  br label %if.end6
