; ModuleID = '/home/grosu/celliso2/c-semantics/tests/unitTests/cq-20-s714-g.c'
...
if.end53:                                         ; preds = %if.end52, %if.end36
  ...
  %conv56 = sext i16 %tmp55 to i32
  %sh_prom = trunc i64 %tmp54 to i32
  %shl57 = shl i32 %conv56, %sh_prom
  %conv58 = trunc i32 %shl57 to i16
  store i16 %conv58, i16* %sl, align 2
  %tmp59 = load i16* %sl, align 2
  %conv60 = sext i16 %tmp59 to i32
  %cmp61 = icmp ne i32 %conv60, 20
...
if.end87:                                         ; preds = %if.end86, %if.end70
  ...
  %shl91 = shl i32 %tmp90, %conv89
  store i32 %shl91, i32* %il, align 4
  %tmp92 = load i32* %il, align 4
  %cmp93 = icmp ne i32 %tmp92, 20
...
if.end102:                                        ; preds = %if.end101, %if.end87
  ...
  %shl106 = shl i32 %tmp105, %conv104
  store i32 %shl106, i32* %il, align 4
  %tmp107 = load i32* %il, align 4
  %cmp108 = icmp ne i32 %tmp107, 20
...
if.end117:                                        ; preds = %if.end116, %if.end102
  ...
  %shl120 = shl i32 %tmp119, %tmp118
  store i32 %shl120, i32* %il, align 4
  %tmp121 = load i32* %il, align 4
  %cmp122 = icmp ne i32 %tmp121, 20
...
if.end131:                                        ; preds = %if.end130, %if.end117
  ...
  %sh_prom134 = trunc i64 %tmp132 to i32
  %shl135 = shl i32 %tmp133, %sh_prom134
  store i32 %shl135, i32* %il, align 4
  %tmp136 = load i32* %il, align 4
  %cmp137 = icmp ne i32 %tmp136, 20
  br i1 %cmp137, label %if.then139, label %if.end146

if.then139:                                       ; preds = %if.end131
  store i32 309, i32* %lrc, align 4
  %tmp140 = load i32* %prlc, align 4
  %tobool141 = icmp ne i32 %tmp140, 0
  br i1 %tobool141, label %if.then142, label %if.end145

if.then142:                                       ; preds = %if.then139
  %tmp143 = load i32* %lrc, align 4
  %call144 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @sec.f, i32 0, i32 0), i32 %tmp143)
  br label %if.end145
...
if.end146:                                        ; preds = %if.end145, %if.end131
  store i32 5, i32* %il, align 4
  store i32 2, i32* %ur, align 4
  %tmp147 = load i32* %ur, align 4
  %tmp148 = load i32* %il, align 4
  %shl149 = shl i32 %tmp148, %tmp147
  store i32 %shl149, i32* %il, align 4
  %tmp150 = load i32* %il, align 4
  %cmp151 = icmp ne i32 %tmp150, 20
  br i1 %cmp151, label %if.then153, label %if.end160

if.then153:                                       ; preds = %if.end146
  store i32 310, i32* %lrc, align 4
  %tmp154 = load i32* %prlc, align 4
  %tobool155 = icmp ne i32 %tmp154, 0
  br i1 %tobool155, label %if.then156, label %if.end159

if.then156:                                       ; preds = %if.then153
  %tmp157 = load i32* %lrc, align 4
  %call158 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @sec.f, i32 0, i32 0), i32 %tmp157)
  br label %if.end159

if.end159:                                        ; preds = %if.then156, %if.then153
  br label %if.end160

if.end160:                                        ; preds = %if.end159, %if.end146
  store i64 5, i64* %ll, align 8
  store i8 2, i8* %cr, align 1
  %tmp161 = load i8* %cr, align 1
  %conv162 = sext i8 %tmp161 to i32
  %tmp163 = load i64* %ll, align 8
  %sh_prom164 = zext i32 %conv162 to i64
  %shl165 = shl i64 %tmp163, %sh_prom164
  store i64 %shl165, i64* %ll, align 8
  %tmp166 = load i64* %ll, align 8
  %cmp167 = icmp ne i64 %tmp166, 20
...
if.end176:                                        ; preds = %if.end175, %if.end160
  ...
  %conv178 = sext i16 %tmp177 to i32
  %tmp179 = load i64* %ll, align 8
  %sh_prom180 = zext i32 %conv178 to i64
  %shl181 = shl i64 %tmp179, %sh_prom180
  store i64 %shl181, i64* %ll, align 8
  %tmp182 = load i64* %ll, align 8
  %cmp183 = icmp ne i64 %tmp182, 20
  br i1 %cmp183, label %if.then185, label %if.end192

if.then185:                                       ; preds = %if.end176
  store i32 312, i32* %lrc, align 4
  %tmp186 = load i32* %prlc, align 4
  %tobool187 = icmp ne i32 %tmp186, 0
  br i1 %tobool187, label %if.then188, label %if.end191

if.then188:                                       ; preds = %if.then185
  %tmp189 = load i32* %lrc, align 4
  %call190 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @sec.f, i32 0, i32 0), i32 %tmp189)
  br label %if.end191

if.end191:                                        ; preds = %if.then188, %if.then185
  br label %if.end192

if.end192:                                        ; preds = %if.end191, %if.end176
  store i64 5, i64* %ll, align 8
  store i32 2, i32* %ir, align 4
  %tmp193 = load i32* %ir, align 4
  %tmp194 = load i64* %ll, align 8
  %sh_prom195 = zext i32 %tmp193 to i64
  %shl196 = shl i64 %tmp194, %sh_prom195
  store i64 %shl196, i64* %ll, align 8
  %tmp197 = load i64* %ll, align 8
  %cmp198 = icmp ne i64 %tmp197, 20
...
if.end207:                                        ; preds = %if.end206, %if.end192
  store i64 5, i64* %ll, align 8
  store i64 2, i64* %lr, align 8
  %tmp208 = load i64* %lr, align 8
  %tmp209 = load i64* %ll, align 8
  %shl210 = shl i64 %tmp209, %tmp208
  store i64 %shl210, i64* %ll, align 8
  %tmp211 = load i64* %ll, align 8
  %cmp212 = icmp ne i64 %tmp211, 20
...
if.end221:                                        ; preds = %if.end220, %if.end207
  store i64 5, i64* %ll, align 8
  store i32 2, i32* %ur, align 4
  %tmp222 = load i32* %ur, align 4
  %tmp223 = load i64* %ll, align 8
  %sh_prom224 = zext i32 %tmp222 to i64
  %shl225 = shl i64 %tmp223, %sh_prom224
  store i64 %shl225, i64* %ll, align 8
  %tmp226 = load i64* %ll, align 8
  %cmp227 = icmp ne i64 %tmp226, 20
...
if.end236:                                        ; preds = %if.end235, %if.end221
  ...
  store i8 2, i8* %cr, align 1
  %tmp237 = load i8* %cr, align 1
  %conv238 = sext i8 %tmp237 to i32
  %tmp239 = load i32* %ul, align 4
  %shl240 = shl i32 %tmp239, %conv238
  store i32 %shl240, i32* %ul, align 4
  %tmp241 = load i32* %ul, align 4
  %cmp242 = icmp ne i32 %tmp241, 20
  br i1 %cmp242, label %if.then244, label %if.end251

if.then244:                                       ; preds = %if.end236
  store i32 316, i32* %lrc, align 4
  %tmp245 = load i32* %prlc, align 4
  %tobool246 = icmp ne i32 %tmp245, 0
  br i1 %tobool246, label %if.then247, label %if.end250

if.then247:                                       ; preds = %if.then244
  %tmp248 = load i32* %lrc, align 4
  %call249 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @sec.f, i32 0, i32 0), i32 %tmp248)
  br label %if.end250
...
if.end251:                                        ; preds = %if.end250, %if.end236
  store i32 5, i32* %ul, align 4
  store i16 2, i16* %sr, align 2
  %tmp252 = load i16* %sr, align 2
  %conv253 = sext i16 %tmp252 to i32
  %tmp254 = load i32* %ul, align 4
  %shl255 = shl i32 %tmp254, %conv253
  store i32 %shl255, i32* %ul, align 4
  %tmp256 = load i32* %ul, align 4
  %cmp257 = icmp ne i32 %tmp256, 20
...
if.end266:                                        ; preds = %if.end265, %if.end251
  store i32 5, i32* %ul, align 4
  store i32 2, i32* %ir, align 4
  %tmp267 = load i32* %ir, align 4
  %tmp268 = load i32* %ul, align 4
  %shl269 = shl i32 %tmp268, %tmp267
  store i32 %shl269, i32* %ul, align 4
  %tmp270 = load i32* %ul, align 4
  %cmp271 = icmp ne i32 %tmp270, 20
...
if.end280:                                        ; preds = %if.end279, %if.end266
  store i32 5, i32* %ul, align 4
  store i64 2, i64* %lr, align 8
  %tmp281 = load i64* %lr, align 8
  %tmp282 = load i32* %ul, align 4
  %sh_prom283 = trunc i64 %tmp281 to i32
  %shl284 = shl i32 %tmp282, %sh_prom283
  store i32 %shl284, i32* %ul, align 4
  %tmp285 = load i32* %ul, align 4
  %cmp286 = icmp ne i32 %tmp285, 20
...
if.end295:                                        ; preds = %if.end294, %if.end280
  ...
  %shl298 = shl i32 %tmp297, %tmp296
  store i32 %shl298, i32* %ul, align 4
  %tmp299 = load i32* %ul, align 4
  %cmp300 = icmp ne i32 %tmp299, 20
...
if.end413:                                        ; preds = %if.end412, %if.end395
  ...
  %and418 = and i32 %conv417, %conv415
  %conv419 = trunc i32 %and418 to i16
  store i16 %conv419, i16* %sl, align 2
  %tmp420 = load i16* %sl, align 2
  %conv421 = sext i16 %tmp420 to i32
  %cmp422 = icmp ne i32 %conv421, 8
...
if.end431:                                        ; preds = %if.end430, %if.end413
  ...
  %and435 = and i32 %conv434, %tmp432
  %conv436 = trunc i32 %and435 to i16
  store i16 %conv436, i16* %sl, align 2
  %tmp437 = load i16* %sl, align 2
  %conv438 = sext i16 %tmp437 to i32
  %cmp439 = icmp ne i32 %conv438, 8
...
if.end448:                                        ; preds = %if.end447, %if.end431
  ...
  %and452 = and i64 %conv451, %tmp449
  %conv453 = trunc i64 %and452 to i16
  store i16 %conv453, i16* %sl, align 2
  %tmp454 = load i16* %sl, align 2
  %conv455 = sext i16 %tmp454 to i32
  %cmp456 = icmp ne i32 %conv455, 8
...
if.end465:                                        ; preds = %if.end464, %if.end448
  ...
  %and469 = and i32 %conv468, %tmp466
  %conv470 = trunc i32 %and469 to i16
  store i16 %conv470, i16* %sl, align 2
  %tmp471 = load i16* %sl, align 2
  %conv472 = sext i16 %tmp471 to i32
  %cmp473 = icmp ne i32 %conv472, 8
...
if.end482:                                        ; preds = %if.end481, %if.end465
  ...
  %and486 = and i32 %tmp485, %conv484
  store i32 %and486, i32* %il, align 4
  %tmp487 = load i32* %il, align 4
  %cmp488 = icmp ne i32 %tmp487, 8
...
if.end497:                                        ; preds = %if.end496, %if.end482
  ...
  %and501 = and i32 %tmp500, %conv499
  store i32 %and501, i32* %il, align 4
  %tmp502 = load i32* %il, align 4
  %cmp503 = icmp ne i32 %tmp502, 8
...
if.end512:                                        ; preds = %if.end511, %if.end497
  ...
  %and515 = and i32 %tmp514, %tmp513
  store i32 %and515, i32* %il, align 4
  %tmp516 = load i32* %il, align 4
  %cmp517 = icmp ne i32 %tmp516, 8
...
if.end526:                                        ; preds = %if.end525, %if.end512
  ...
  %and530 = and i64 %conv529, %tmp527
  %conv531 = trunc i64 %and530 to i32
  store i32 %conv531, i32* %il, align 4
  %tmp532 = load i32* %il, align 4
  %cmp533 = icmp ne i32 %tmp532, 8
...
if.end542:                                        ; preds = %if.end541, %if.end526
  ...
  %and545 = and i32 %tmp544, %tmp543
  store i32 %and545, i32* %il, align 4
  %tmp546 = load i32* %il, align 4
  %cmp547 = icmp ne i32 %tmp546, 8
...
if.end556:                                        ; preds = %if.end555, %if.end542
  ...
  %and560 = and i64 %tmp559, %conv558
  store i64 %and560, i64* %ll, align 8
  %tmp561 = load i64* %ll, align 8
  %cmp562 = icmp ne i64 %tmp561, 8
...
if.end571:                                        ; preds = %if.end570, %if.end556
  ...
  %and575 = and i64 %tmp574, %conv573
  store i64 %and575, i64* %ll, align 8
  %tmp576 = load i64* %ll, align 8
  %cmp577 = icmp ne i64 %tmp576, 8
...
if.end586:                                        ; preds = %if.end585, %if.end571
  ...
  %and590 = and i64 %tmp589, %conv588
  store i64 %and590, i64* %ll, align 8
  %tmp591 = load i64* %ll, align 8
  %cmp592 = icmp ne i64 %tmp591, 8
...
if.end601:                                        ; preds = %if.end600, %if.end586
  ...
  %and604 = and i64 %tmp603, %tmp602
  store i64 %and604, i64* %ll, align 8
  %tmp605 = load i64* %ll, align 8
  %cmp606 = icmp ne i64 %tmp605, 8
...
if.end615:                                        ; preds = %if.end614, %if.end601
  ...
  %and619 = and i64 %tmp618, %conv617
  store i64 %and619, i64* %ll, align 8
  %tmp620 = load i64* %ll, align 8
  %cmp621 = icmp ne i64 %tmp620, 8
...
if.end630:                                        ; preds = %if.end629, %if.end615
  ...
  %and634 = and i32 %tmp633, %conv632
  store i32 %and634, i32* %ul, align 4
  %tmp635 = load i32* %ul, align 4
  %cmp636 = icmp ne i32 %tmp635, 8
...
if.end645:                                        ; preds = %if.end644, %if.end630
  ...
  %and649 = and i32 %tmp648, %conv647
  store i32 %and649, i32* %ul, align 4
  %tmp650 = load i32* %ul, align 4
  %cmp651 = icmp ne i32 %tmp650, 8
...
if.end660:                                        ; preds = %if.end659, %if.end645
  ...
  %and663 = and i32 %tmp662, %tmp661
  store i32 %and663, i32* %ul, align 4
  %tmp664 = load i32* %ul, align 4
  %cmp665 = icmp ne i32 %tmp664, 8
...
if.end674:                                        ; preds = %if.end673, %if.end660
  ...
  %and678 = and i64 %conv677, %tmp675
  %conv679 = trunc i64 %and678 to i32
  store i32 %conv679, i32* %ul, align 4
  %tmp680 = load i32* %ul, align 4
  %cmp681 = icmp ne i32 %tmp680, 8
...
if.end690:                                        ; preds = %if.end689, %if.end674
  ...
  %and693 = and i32 %tmp692, %tmp691
  store i32 %and693, i32* %ul, align 4
  %tmp694 = load i32* %ul, align 4
  %cmp695 = icmp ne i32 %tmp694, 8
...
if.end704:                                        ; preds = %if.end703, %if.end690
  store i8 12, i8* %cl, align 1
  store i8 10, i8* %cr, align 1
  %tmp705 = load i8* %cr, align 1
  %conv706 = sext i8 %tmp705 to i32
  %tmp707 = load i8* %cl, align 1
  %conv708 = sext i8 %tmp707 to i32
  %xor = xor i32 %conv708, %conv706
  %conv709 = trunc i32 %xor to i8
  store i8 %conv709, i8* %cl, align 1
  %tmp710 = load i8* %cl, align 1
  %conv711 = sext i8 %tmp710 to i32
  %cmp712 = icmp ne i32 %conv711, 6
  br i1 %cmp712, label %if.then714, label %if.end721

if.then714:                                       ; preds = %if.end704
  store i32 346, i32* %lrc, align 4
  %tmp715 = load i32* %prlc, align 4
  %tobool716 = icmp ne i32 %tmp715, 0
  br i1 %tobool716, label %if.then717, label %if.end720

if.then717:                                       ; preds = %if.then714
  %tmp718 = load i32* %lrc, align 4
  %call719 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @sec.f, i32 0, i32 0), i32 %tmp718)
  br label %if.end720

if.end720:                                        ; preds = %if.then717, %if.then714
  br label %if.end721

if.end721:                                        ; preds = %if.end720, %if.end704
  store i8 12, i8* %cl, align 1
  store i16 10, i16* %sr, align 2
  %tmp722 = load i16* %sr, align 2
  %conv723 = sext i16 %tmp722 to i32
  %tmp724 = load i8* %cl, align 1
  %conv725 = sext i8 %tmp724 to i32
  %xor726 = xor i32 %conv725, %conv723
  %conv727 = trunc i32 %xor726 to i8
  store i8 %conv727, i8* %cl, align 1
  %tmp728 = load i8* %cl, align 1
  %conv729 = sext i8 %tmp728 to i32
  %cmp730 = icmp ne i32 %conv729, 6
  br i1 %cmp730, label %if.then732, label %if.end739

if.then732:                                       ; preds = %if.end721
  store i32 347, i32* %lrc, align 4
  %tmp733 = load i32* %prlc, align 4
  %tobool734 = icmp ne i32 %tmp733, 0
  br i1 %tobool734, label %if.then735, label %if.end738

if.then735:                                       ; preds = %if.then732
  %tmp736 = load i32* %lrc, align 4
  %call737 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @sec.f, i32 0, i32 0), i32 %tmp736)
  br label %if.end738

if.end738:                                        ; preds = %if.then735, %if.then732
  br label %if.end739

if.end739:                                        ; preds = %if.end738, %if.end721
  store i8 12, i8* %cl, align 1
  store i32 10, i32* %ir, align 4
  %tmp740 = load i32* %ir, align 4
  %tmp741 = load i8* %cl, align 1
  %conv742 = sext i8 %tmp741 to i32
  %xor743 = xor i32 %conv742, %tmp740
  %conv744 = trunc i32 %xor743 to i8
  store i8 %conv744, i8* %cl, align 1
  %tmp745 = load i8* %cl, align 1
  %conv746 = sext i8 %tmp745 to i32
  %cmp747 = icmp ne i32 %conv746, 6
  br i1 %cmp747, label %if.then749, label %if.end756

if.then749:                                       ; preds = %if.end739
  store i32 348, i32* %lrc, align 4
  %tmp750 = load i32* %prlc, align 4
  %tobool751 = icmp ne i32 %tmp750, 0
  br i1 %tobool751, label %if.then752, label %if.end755

if.then752:                                       ; preds = %if.then749
  %tmp753 = load i32* %lrc, align 4
  %call754 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @sec.f, i32 0, i32 0), i32 %tmp753)
  br label %if.end755

if.end755:                                        ; preds = %if.then752, %if.then749
  br label %if.end756

if.end756:                                        ; preds = %if.end755, %if.end739
  store i8 12, i8* %cl, align 1
  store i64 10, i64* %lr, align 8
  %tmp757 = load i64* %lr, align 8
  %tmp758 = load i8* %cl, align 1
  %conv759 = sext i8 %tmp758 to i64
  %xor760 = xor i64 %conv759, %tmp757
  %conv761 = trunc i64 %xor760 to i8
  store i8 %conv761, i8* %cl, align 1
  %tmp762 = load i8* %cl, align 1
  %conv763 = sext i8 %tmp762 to i32
  %cmp764 = icmp ne i32 %conv763, 6
  br i1 %cmp764, label %if.then766, label %if.end773

if.then766:                                       ; preds = %if.end756
  store i32 349, i32* %lrc, align 4
  %tmp767 = load i32* %prlc, align 4
  %tobool768 = icmp ne i32 %tmp767, 0
  br i1 %tobool768, label %if.then769, label %if.end772

if.then769:                                       ; preds = %if.then766
  %tmp770 = load i32* %lrc, align 4
  %call771 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @sec.f, i32 0, i32 0), i32 %tmp770)
  br label %if.end772

if.end772:                                        ; preds = %if.then769, %if.then766
  br label %if.end773

if.end773:                                        ; preds = %if.end772, %if.end756
  store i8 12, i8* %cl, align 1
  store i32 10, i32* %ur, align 4
  %tmp774 = load i32* %ur, align 4
  %tmp775 = load i8* %cl, align 1
  %conv776 = sext i8 %tmp775 to i32
  %xor777 = xor i32 %conv776, %tmp774
  %conv778 = trunc i32 %xor777 to i8
  store i8 %conv778, i8* %cl, align 1
  %tmp779 = load i8* %cl, align 1
  %conv780 = sext i8 %tmp779 to i32
  %cmp781 = icmp ne i32 %conv780, 6
  br i1 %cmp781, label %if.then783, label %if.end790

if.then783:                                       ; preds = %if.end773
...
if.end790:                                        ; preds = %if.end789, %if.end773
