...
; <label>:6                                       ; preds = %27, %5
  ...
  %12 = getelementptr inbounds [5 x i8], [5 x i8]* @bytes, i32 0, i64 %11
  store i8 %9, i8* %12, align 1
  %13 = load i64, i64* %o, align 8
  %14 = lshr i64 %13, 7
  store i64 %14, i64* %o, align 8
  %15 = load i64, i64* %o, align 8
  %16 = icmp ne i64 %15, 0
...
; <label>:17                                      ; preds = %6
  ...
  %20 = getelementptr inbounds [5 x i8], [5 x i8]* @bytes, i32 0, i64 %19
...
define i32 @main() #0 {
  ...
  %2 = load i8, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @bytes, i32 0, i64 0), align 1
  %3 = zext i8 %2 to i32
  %4 = icmp ne i32 %3, 136
  br i1 %4, label %9, label %5

; <label>:5                                       ; preds = %0
  %6 = load i8, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @bytes, i32 0, i64 1), align 1
  %7 = zext i8 %6 to i32
  %8 = icmp ne i32 %7, 7
