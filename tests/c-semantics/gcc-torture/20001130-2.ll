...
define internal i8* @output_25() #0 {
  %1 = alloca i8*, align 8
  %2 = load i32* @which_alternative, align 4
...
; <label>:3                                       ; preds = %0
  store i8* getelementptr inbounds ([10 x i8]* @.str, i32 0, i32 0), i8** %1
  br label %9
...
; <label>:6                                       ; preds = %0
  store i8* getelementptr inbounds ([9 x i8]* @.str1, i32 0, i32 0), i8** %1
  br label %9

; <label>:7                                       ; preds = %0
  store i8* getelementptr inbounds ([9 x i8]* @.str2, i32 0, i32 0), i8** %1
  br label %9
