...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = getelementptr inbounds [4 x float], [4 x float]* %x, i32 0, i32 0
...
; <label>:5                                       ; preds = %2
  ...
  %11 = getelementptr inbounds [16 x float], [16 x float]* @foo.t16, i32 0, i64 %10
...
; <label>:18                                      ; preds = %15
  ...
  %24 = getelementptr inbounds [16 x float], [16 x float]* @foo.t16, i32 0, i64 %23
  %25 = load float, float* %24, align 4
  %26 = load float, float* %temp, align 4
  %27 = fmul float %25, %26
  %28 = load i32, i32* %k, align 4
  %29 = sext i32 %28 to i64
  %30 = getelementptr inbounds [4 x float], [4 x float]* @foo.tmp, i32 0, i64 %29
...
; <label>:38                                      ; preds = %2
  %39 = load float, float* getelementptr inbounds ([4 x float], [4 x float]* @foo.tmp, i32 0, i64 0), align 4
  %40 = load float*, float** %1, align 8
  %41 = getelementptr inbounds float, float* %40, i64 0
  store float %39, float* %41, align 4
  %42 = load float, float* getelementptr inbounds ([4 x float], [4 x float]* @foo.tmp, i32 0, i64 1), align 4
  %43 = load float*, float** %1, align 8
  %44 = getelementptr inbounds float, float* %43, i64 1
  store float %42, float* %44, align 4
  %45 = load float, float* getelementptr inbounds ([4 x float], [4 x float]* @foo.tmp, i32 0, i64 2), align 4
  %46 = load float*, float** %1, align 8
  %47 = getelementptr inbounds float, float* %46, i64 2
  store float %45, float* %47, align 4
  %48 = load float, float* getelementptr inbounds ([4 x float], [4 x float]* @foo.tmp, i32 0, i64 3), align 4
  %49 = load float*, float** %1, align 8
