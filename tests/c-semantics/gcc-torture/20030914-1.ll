...
; <label>:6                                       ; preds = %3
  ...
  %8 = sext i32 %7 to i64
  %9 = getelementptr inbounds %struct.s* %pb, i32 0, i32 0
  %10 = getelementptr inbounds [16 x i32]* %9, i32 0, i64 %8
  %11 = load i32* %10, align 4
  %12 = sitofp i32 %11 to x86_fp80
  %13 = load x86_fp80* %2, align 16
...
; <label>:5                                       ; preds = %2
  ...
  %9 = sext i32 %8 to i64
  %10 = getelementptr inbounds %struct.s* %x, i32 0, i32 0
  %11 = getelementptr inbounds [16 x i32]* %10, i32 0, i64 %9
