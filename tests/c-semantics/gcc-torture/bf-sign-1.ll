...
define i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* getelementptr inbounds ({ i8, i8, [2 x i8] }* @main.x, i32 0, i32 0), i64 4, i32 4, i1 false)
