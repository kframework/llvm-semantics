...
define void @dummy(%struct.__va_list_tag* %vap) #0 {
  ...
  %2 = load %struct.__va_list_tag** %1, align 8
...
; <label>:6                                       ; preds = %0
  %7 = getelementptr inbounds %struct.__va_list_tag* %2, i32 0, i32 3
  %8 = load i8** %7
...
; <label>:12                                      ; preds = %0
  %13 = getelementptr inbounds %struct.__va_list_tag* %2, i32 0, i32 2
  %14 = load i8** %13
  %15 = bitcast i8* %14 to i32*
  %16 = getelementptr i8* %14, i32 8
  store i8* %16, i8** %13
  br label %17
...
define void @test(i32 %fmt, ...) #0 {
  ...
  %3 = getelementptr inbounds %struct.ScanfState* %2, i32 0, i32 1
  %4 = getelementptr inbounds [1 x %struct.__va_list_tag]* %3, i32 0, i32 0
  %5 = bitcast %struct.__va_list_tag* %4 to i8*
  call void @llvm.va_start(i8* %5)
  %6 = load %struct.ScanfState** %statep, align 8
  %7 = getelementptr inbounds %struct.ScanfState* %6, i32 0, i32 1
  %8 = getelementptr inbounds [1 x %struct.__va_list_tag]* %7, i32 0, i32 0
  call void @dummy(%struct.__va_list_tag* %8)
  %9 = load %struct.ScanfState** %statep, align 8
  %10 = getelementptr inbounds %struct.ScanfState* %9, i32 0, i32 1
  %11 = getelementptr inbounds [1 x %struct.__va_list_tag]* %10, i32 0, i32 0
  %12 = bitcast %struct.__va_list_tag* %11 to i8*
  call void @llvm.va_end(i8* %12)
  %13 = getelementptr inbounds %struct.ScanfState* %state, i32 0, i32 1
  %14 = getelementptr inbounds [1 x %struct.__va_list_tag]* %13, i32 0, i32 0
  %15 = bitcast %struct.__va_list_tag* %14 to i8*
  call void @llvm.va_start(i8* %15)
  %16 = getelementptr inbounds %struct.ScanfState* %state, i32 0, i32 1
  %17 = getelementptr inbounds [1 x %struct.__va_list_tag]* %16, i32 0, i32 0
  call void @dummy(%struct.__va_list_tag* %17)
  %18 = getelementptr inbounds %struct.ScanfState* %state, i32 0, i32 1
  %19 = getelementptr inbounds [1 x %struct.__va_list_tag]* %18, i32 0, i32 0
