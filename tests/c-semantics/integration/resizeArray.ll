...
; <label>:8                                       ; preds = %0
  %9 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str, i32 0, i32 0))
  store i32 1, i32* %1
  br label %79
...
; <label>:23                                      ; preds = %11
  %24 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([23 x i8]* @.str1, i32 0, i32 0))
  store i32 0, i32* %i, align 4
  br label %25
...
; <label>:28                                      ; preds = %25
  ...
  %32 = load i32** %a, align 8
  %33 = getelementptr inbounds i32* %32, i64 %31
  %34 = load i32* %33, align 4
  %35 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str2, i32 0, i32 0), i32 %29, i32 %34)
  br label %36
...
; <label>:45                                      ; preds = %39
  %46 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([23 x i8]* @.str3, i32 0, i32 0))
  store i32 1, i32* %1
  br label %79
...
; <label>:60                                      ; preds = %48
  %61 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str4, i32 0, i32 0))
  store i32 0, i32* %i, align 4
  br label %62
...
; <label>:65                                      ; preds = %62
  ...
  %72 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str2, i32 0, i32 0), i32 %66, i32 %71)
  br label %73
