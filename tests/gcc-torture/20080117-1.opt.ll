; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20080117-1.ll'
...
entry:
  %tmp1 = bitcast %struct.gs_imager_state_s* %pgs to i8*
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* %tmp1, i8* bitcast (%struct.gs_imager_state_s* @gstate_initial to i8*), i64 12, i32 4, i1 false)
  ret void
}
