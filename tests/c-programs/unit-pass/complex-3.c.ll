...
define <2 x float> @f(float %a, float %b) #0 {
  ...
  %5 = getelementptr inbounds %struct.complex, %struct.complex* %c, i32 0, i32 0
  store float %4, float* %5, align 4
  %6 = load float, float* %3, align 4
  %7 = getelementptr inbounds %struct.complex, %struct.complex* %c, i32 0, i32 1
...
define i32 @main() #0 {
  ...
  store <2 x float> %2, <2 x float>* %3, align 4
  %4 = getelementptr inbounds %struct.complex, %struct.complex* %z, i32 0, i32 0
...
; <label>:8                                       ; preds = %0
  %9 = getelementptr inbounds %struct.complex, %struct.complex* %z, i32 0, i32 1
