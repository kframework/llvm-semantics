; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20030105-1.c'
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [8 x i32]* @foo.a, i32 0, i64 %idxprom
