...
define i32 @main(i32 %argc, i8** %argv) #0 {
  ...
  %5 = getelementptr inbounds [2 x i32], [2 x i32]* %zz, i32 0, i32 0
  call void @silly(i32* %5)
  %6 = getelementptr inbounds [2 x i32], [2 x i32]* %zz, i32 0, i64 1
  %7 = load i32, i32* %6, align 4
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i32 0, i32 0), i32 %7)
  ret i32 0
}
