...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  store i32 (i32)* @f, i32 (i32)** %fp, align 8
  %3 = load i32 (i32)*, i32 (i32)** %fp, align 8
  %4 = load i32, i32* getelementptr inbounds (%struct.t, %struct.t* @s, i32 0, i32 0), align 4
  %5 = call i32 %3(i32 %4)
  %6 = getelementptr %struct.t, %struct.t* %2, i32 0, i32 0
  store i32 %5, i32* %6, align 4
  %7 = getelementptr inbounds %struct.t, %struct.t* %2, i32 0, i32 0
  %8 = load i32, i32* %7, align 4
  %9 = load i32, i32* getelementptr inbounds (%struct.t, %struct.t* @s, i32 0, i32 0), align 4
  %10 = add nsw i32 %8, %9
  ret i32 %10
}
