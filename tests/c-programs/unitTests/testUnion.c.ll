...
@.str.2 = private unnamed_addr constant [25 x i8] c"This S has type FLOATS.\0A\00", align 1
@.str.3 = private unnamed_addr constant [48 x i8] c"s->u.s_floats[0] != - s->u.s_floats[1]: %f, %f\0A\00", align 1
@.str.4 = private unnamed_addr constant [25 x i8] c"This S has type DOUBLE.\0A\00", align 1
@.str.5 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@.str.6 = private unnamed_addr constant [26 x i8] c"s->u.s_double is off: %f\0A\00", align 1
...
; <label>:5                                       ; preds = %0
  ...
  %15 = getelementptr inbounds [2 x i32], [2 x i32]* %14, i32 0, i64 1
  %16 = load i32, i32* %15, align 4
  %17 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i32 0, i32 0), i32 %11, i32 %16)
  br label %90

; <label>:18                                      ; preds = %0
  %19 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.2, i32 0, i32 0))
  ...
  %23 = getelementptr inbounds [2 x float], [2 x float]* %22, i32 0, i64 0
  ...
  %34 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i32 0, i32 0), i32 %26, i32 %33)
  ...
  %38 = getelementptr inbounds [2 x float], [2 x float]* %37, i32 0, i64 0
  ...
  %43 = getelementptr inbounds [2 x float], [2 x float]* %42, i32 0, i64 1
...
; <label>:47                                      ; preds = %18
  ...
  %57 = getelementptr inbounds [2 x float], [2 x float]* %56, i32 0, i64 1
  %58 = load float, float* %57, align 4
  %59 = fsub float -0.000000e+00, %58
  %60 = fpext float %59 to double
  %61 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.3, i32 0, i32 0), double %53, double %60)
  br label %62
...
; <label>:63                                      ; preds = %0
  %64 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.4, i32 0, i32 0))
...
; <label>:77                                      ; preds = %63
  %78 = load %struct.S*, %struct.S** %1, align 8
...
; <label>:83                                      ; preds = %77, %63
  ...
  %88 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.6, i32 0, i32 0), double %87)
  br label %89
...
define i32 @main() #0 {
  ...
  %2 = getelementptr inbounds [3 x %struct.S], [3 x %struct.S]* %esses, i32 0, i64 0
  %3 = getelementptr inbounds %struct.S, %struct.S* %2, i32 0, i32 0
  store i32 0, i32* %3, align 4
  %4 = getelementptr inbounds [3 x %struct.S], [3 x %struct.S]* %esses, i32 0, i64 0
  ...
  %8 = getelementptr inbounds [3 x %struct.S], [3 x %struct.S]* %esses, i32 0, i64 0
  %9 = getelementptr inbounds %struct.S, %struct.S* %8, i32 0, i32 1
  %10 = bitcast %union.anon* %9 to [2 x i32]*
  %11 = getelementptr inbounds [2 x i32], [2 x i32]* %10, i32 0, i64 1
  store i32 -2123456789, i32* %11, align 4
  %12 = getelementptr inbounds [3 x %struct.S], [3 x %struct.S]* %esses, i32 0, i64 1
  %13 = getelementptr inbounds %struct.S, %struct.S* %12, i32 0, i32 0
  store i32 1, i32* %13, align 4
  %14 = getelementptr inbounds [3 x %struct.S], [3 x %struct.S]* %esses, i32 0, i64 1
  %15 = getelementptr inbounds %struct.S, %struct.S* %14, i32 0, i32 1
  %16 = bitcast %union.anon* %15 to [2 x float]*
  %17 = getelementptr inbounds [2 x float], [2 x float]* %16, i32 0, i64 0
  store float 0x400921FB60000000, float* %17, align 4
  %18 = getelementptr inbounds [3 x %struct.S], [3 x %struct.S]* %esses, i32 0, i64 1
  %19 = getelementptr inbounds %struct.S, %struct.S* %18, i32 0, i32 1
  %20 = bitcast %union.anon* %19 to [2 x float]*
  %21 = getelementptr inbounds [2 x float], [2 x float]* %20, i32 0, i64 1
  store float 0xC00921FB60000000, float* %21, align 4
  %22 = getelementptr inbounds [3 x %struct.S], [3 x %struct.S]* %esses, i32 0, i64 2
  %23 = getelementptr inbounds %struct.S, %struct.S* %22, i32 0, i32 0
  store i32 2, i32* %23, align 4
  %24 = getelementptr inbounds [3 x %struct.S], [3 x %struct.S]* %esses, i32 0, i64 2
  ...
  %27 = getelementptr inbounds [3 x %struct.S], [3 x %struct.S]* %esses, i32 0, i64 1
...
; <label>:30                                      ; preds = %38, %0
  ...
  %32 = load i32, i32* %numEsses, align 4
...
; <label>:34                                      ; preds = %30
  ...
  %37 = getelementptr inbounds [3 x %struct.S], [3 x %struct.S]* %esses, i32 0, i64 %36
