; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith001423.c'
...
for.body12:                                       ; preds = %for.cond9
  ...
  %arrayidx = getelementptr inbounds [3 x [9 x [3 x [1 x i16]]]]* %l_5, i32 0, i64 %idxprom19
  %arrayidx20 = getelementptr inbounds [9 x [3 x [1 x i16]]]* %arrayidx, i32 0, i64 %idxprom17
  %arrayidx21 = getelementptr inbounds [3 x [1 x i16]]* %arrayidx20, i32 0, i64 %idxprom15
...
for.cond36:                                       ; preds = %for.inc45, %for.end35
  ...
  %cmp38 = icmp ne i32 %tmp37, 29
  br i1 %cmp38, label %for.body39, label %for.end47

for.body39:                                       ; preds = %for.cond36
  %arrayidx40 = getelementptr inbounds [3 x [9 x [3 x [1 x i16]]]]* %l_5, i32 0, i64 2
  %arrayidx41 = getelementptr inbounds [9 x [3 x [1 x i16]]]* %arrayidx40, i32 0, i64 3
  %arrayidx42 = getelementptr inbounds [3 x [1 x i16]]* %arrayidx41, i32 0, i64 0
  %arrayidx43 = getelementptr inbounds [1 x i16]* %arrayidx42, i32 0, i64 0
  %tmp44 = load i16* %arrayidx43, align 2
  %tobool = icmp ne i16 %tmp44, 0
...
for.inc45:                                        ; preds = %if.end
  ...
  %call = call i32 @safe_sub_func_int32_t_s_s(i32 %tmp46, i32 2)
  store i32 %call, i32* @g_2, align 4
  br label %for.cond36

for.end47:                                        ; preds = %if.then, %for.cond36
