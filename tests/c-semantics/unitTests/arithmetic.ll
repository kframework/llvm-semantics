...
define i32 @main() #0 {
  ...
  %2 = load i8* %scl, align 1
  %3 = sext i8 %2 to i32
  %4 = icmp slt i32 %3, 0
  br i1 %4, label %7, label %5

; <label>:5                                       ; preds = %0
  %6 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @.str, i32 0, i32 0))
  br label %7

; <label>:7                                       ; preds = %5, %0
  %8 = load i16* %sil, align 2
  %9 = sext i16 %8 to i32
  %10 = icmp slt i32 %9, 0
...
; <label>:13                                      ; preds = %11, %7
  %14 = load i32* %il, align 4
  %15 = icmp slt i32 %14, 0
  br i1 %15, label %18, label %16

; <label>:16                                      ; preds = %13
  %17 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @.str2, i32 0, i32 0))
  br label %18

; <label>:18                                      ; preds = %16, %13
  %19 = load i64* %lil, align 8
  %20 = icmp slt i64 %19, 0
  br i1 %20, label %23, label %21

; <label>:21                                      ; preds = %18
  %22 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @.str3, i32 0, i32 0))
  br label %23

; <label>:23                                      ; preds = %21, %18
  %24 = load i64* %llil, align 8
  %25 = icmp slt i64 %24, 0
  br i1 %25, label %28, label %26

; <label>:26                                      ; preds = %23
  %27 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @.str4, i32 0, i32 0))
  br label %28
