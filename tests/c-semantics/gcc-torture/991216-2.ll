...
; <label>:34                                      ; preds = %4
  ...
  %36 = getelementptr inbounds %struct.__va_list_tag* %35, i32 0, i32 0
  %37 = load i32* %36
  %38 = icmp ule i32 %37, 40
  br i1 %38, label %39, label %45

; <label>:39                                      ; preds = %34
  %40 = getelementptr inbounds %struct.__va_list_tag* %35, i32 0, i32 3
  %41 = load i8** %40
  %42 = getelementptr i8* %41, i32 %37
...
; <label>:45                                      ; preds = %34
  %46 = getelementptr inbounds %struct.__va_list_tag* %35, i32 0, i32 2
  %47 = load i8** %46
  %48 = bitcast i8* %47 to i64*
  %49 = getelementptr i8* %47, i32 8
  store i8* %49, i8** %46
  br label %50
...
; <label>:55                                      ; preds = %50
  ...
  %57 = getelementptr inbounds %struct.__va_list_tag* %56, i32 0, i32 0
  %58 = load i32* %57
  %59 = icmp ule i32 %58, 40
  br i1 %59, label %60, label %66

; <label>:60                                      ; preds = %55
  %61 = getelementptr inbounds %struct.__va_list_tag* %56, i32 0, i32 3
  %62 = load i8** %61
  %63 = getelementptr i8* %62, i32 %58
...
; <label>:66                                      ; preds = %55
  %67 = getelementptr inbounds %struct.__va_list_tag* %56, i32 0, i32 2
  %68 = load i8** %67
  %69 = bitcast i8* %68 to i32*
  %70 = getelementptr i8* %68, i32 8
  store i8* %70, i8** %67
  br label %71
...
; <label>:76                                      ; preds = %71
  %77 = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
