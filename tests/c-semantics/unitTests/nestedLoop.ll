...
; <label>:10                                      ; preds = %7
  ...
  %13 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([16 x i8]* @.str, i32 0, i32 0), i32 %11, i32 %12)
  ...
  %25 = getelementptr inbounds [4 x [3 x i32]]* %y1, i32 0, i64 %24
  %26 = getelementptr inbounds [3 x i32]* %25, i32 0, i64 %22
