...
@str10 = private unnamed_addr constant [9 x i8] c"\0AFailed.\00"
...
setupTable.exit:                                  ; preds = %while.body48.i
  ...
  %1 = load i32* %flgm, align 4, !tbaa !2
  %cmp = icmp eq i32 %1, 0
  br i1 %cmp, label %if.end, label %if.then

if.then:                                          ; preds = %setupTable.exit
  %call1 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @sec.s, i64 0, i64 0), i32 8, i8* getelementptr inbounds ([5 x i8]* @.str, i64 0, i64 0)) nounwind
  %2 = load i32* %ibits.i, align 4, !tbaa !2
  %call2 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @sec.s, i64 0, i64 0), i32 %2, i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0)) nounwind
  %3 = load i32* %sbits.i, align 4, !tbaa !2
  %call3 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @sec.s, i64 0, i64 0), i32 %3, i8* getelementptr inbounds ([6 x i8]* @.str2, i64 0, i64 0)) nounwind
  %4 = load i32* %lbits.i, align 4, !tbaa !2
  %call4 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @sec.s, i64 0, i64 0), i32 %4, i8* getelementptr inbounds ([5 x i8]* @.str3, i64 0, i64 0)) nounwind
  %5 = load i32* %ubits.i, align 4, !tbaa !2
  %call5 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @sec.s, i64 0, i64 0), i32 %5, i8* getelementptr inbounds ([9 x i8]* @.str4, i64 0, i64 0)) nounwind
  %6 = load i32* %fbits.i, align 4, !tbaa !2
  %call6 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @sec.s, i64 0, i64 0), i32 %6, i8* getelementptr inbounds ([6 x i8]* @.str5, i64 0, i64 0)) nounwind
  %7 = load i32* %dbits.i, align 4, !tbaa !2
  %call7 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @sec.s, i64 0, i64 0), i32 %7, i8* getelementptr inbounds ([7 x i8]* @.str6, i64 0, i64 0)) nounwind
  %8 = load float* %fprec.i, align 4, !tbaa !3
  %conv = fpext float %8 to double
  %call8 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([64 x i8]* @sec.s2, i64 0, i64 0), double %conv, i8* getelementptr inbounds ([6 x i8]* @.str5, i64 0, i64 0)) nounwind
  %9 = load float* %dprec.i, align 4, !tbaa !3
  %conv9 = fpext float %9 to double
  %call10 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([64 x i8]* @sec.s2, i64 0, i64 0), double %conv9, i8* getelementptr inbounds ([7 x i8]* @.str6, i64 0, i64 0)) nounwind
  br label %if.end

if.end:                                           ; preds = %setupTable.exit, %if.then
  ret i32 0
}
...
if.then:                                          ; preds = %entry
  %call1 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str7, i64 0, i64 0), i8* getelementptr inbounds (%struct.defs* @main.d0, i64 0, i32 15, i64 0), i32 %call) nounwind
...
if.else:                                          ; preds = %if.end
  %puts7 = tail call i32 @puts(i8* getelementptr inbounds ([9 x i8]* @str10, i64 0, i64 0))
  br label %if.end6
