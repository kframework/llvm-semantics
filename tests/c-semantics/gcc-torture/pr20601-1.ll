...
; <label>:8                                       ; preds = %0
  %9 = load i32* getelementptr inbounds ([5 x i32]* @a, i32 0, i64 4), align 4
  %10 = icmp ne i32 %9, 0
...
; <label>:49                                      ; preds = %43
  ...
  store i8** %51, i8*** getelementptr inbounds (%struct.T* @t, i32 0, i32 2), align 8
...
define internal i32 @setup1(i32 %x) #3 {
  ...
  %2 = call i8* @baz(i8* getelementptr inbounds (%struct.T* @t, i32 0, i32 1, i32 0), i32 4096)
  %3 = icmp ne i8* %2, null
  br i1 %3, label %6, label %4

; <label>:4                                       ; preds = %0
  %5 = call i8* @baz(i8* getelementptr inbounds (%struct.T* @t, i32 0, i32 1, i32 0), i32 4096)
  br label %6
...
; <label>:10                                      ; preds = %6
  ...
  %14 = load i8** getelementptr inbounds (%struct.T* @t, i32 0, i32 0), align 8
  %15 = icmp ne i8* %14, null
  br i1 %15, label %16, label %25

; <label>:16                                      ; preds = %10
  %17 = load i8** getelementptr inbounds (%struct.T* @t, i32 0, i32 0), align 8
...
; <label>:21                                      ; preds = %16
  %22 = load i8** getelementptr inbounds (%struct.T* @t, i32 0, i32 0), align 8
...
; <label>:29                                      ; preds = %35, %26
  %30 = load i8*** %i, align 8
  %31 = load i8** %30, align 8
  %32 = load i8*** %h, align 8
