; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/pr41917.c'
...
cond.false:                                       ; preds = %entry
  ...
  %rem = urem i32 %tmp3, %tmp4
  br label %cond.end

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %tmp2, %cond.true ], [ %rem, %cond.false ]
  store i32 %cond, i32* %b, align 4
  %tmp5 = load i32* %b, align 4
  %tmp6 = load i32* %c, align 4
  %cmp7 = icmp ne i32 %tmp5, %tmp6
