; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith000983.c'
...
entry:
  %tmp = load i16* getelementptr inbounds ([3 x i16]* @g_2, i32 0, i64 1), align 2
...
entry:
  ...
  %tmp = load i16* getelementptr inbounds ([3 x i16]* @g_2, i32 0, i64 0), align 2
  %conv = zext i16 %tmp to i32
  %call1 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str, i32 0, i32 0), i32 %conv)
  %tmp2 = load i16* getelementptr inbounds ([3 x i16]* @g_2, i32 0, i64 1), align 2
  %conv3 = zext i16 %tmp2 to i32
  %call4 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str1, i32 0, i32 0), i32 %conv3)
  %tmp5 = load i16* getelementptr inbounds ([3 x i16]* @g_2, i32 0, i64 2), align 2
  %conv6 = zext i16 %tmp5 to i32
  %call7 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str2, i32 0, i32 0), i32 %conv6)
  %tmp8 = load i16* getelementptr inbounds ([3 x i16]* @g_2, i32 0, i64 1), align 2
  %conv9 = zext i16 %tmp8 to i32
  %call10 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str1, i32 0, i32 0), i32 %conv9)
  %0 = load i32* %retval
  ret i32 %0
}
