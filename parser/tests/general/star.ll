; ModuleID = '/home/grosu/celliso2/c-semantics/tests/unitTests/star.c'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64"
target triple = "x86_64-unknown-linux-gnu"

@main.x = internal unnamed_addr constant [5 x i32] [i32 1, i32 2, i32 3, i32 0, i32 0], align 16
...
entry:
  ...
  %tmp = bitcast [5 x i32]* %x to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %tmp, i8* bitcast ([5 x i32]* @main.x to i8*), i64 20, i32 16, i1 false)
...
entry:
  ...
  %arrayidx = getelementptr inbounds i32* %tmp, i64 1
