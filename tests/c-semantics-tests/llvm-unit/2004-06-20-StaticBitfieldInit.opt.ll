...
entry:
  ...
  %1 = lshr i32 %0, 5
  %bf.clear1 = and i32 %1, 63
  %2 = lshr i32 %0, 11
  %bf.clear2 = and i32 %2, 31
  %call = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str, i64 0, i64 0), i32 %bf.clear, i32 %bf.clear1, i32 %bf.clear2) nounwind
  ret i32 0
}
