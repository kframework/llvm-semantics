; ModuleID = '/home/grosu/celliso2/c-semantics/tests/integration/sumn.c'
...
entry:
  ...
  %tmp = load i32* %input, align 4
  %call1 = call i32 @sum(i32 %tmp)
  store i32 %call1, i32* %result, align 4
  %tmp2 = load i32* %input, align 4
  %tmp3 = load i32* %result, align 4
  %call4 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str1, i32 0, i32 0), i32 %tmp2, i32 %tmp3)
  %tmp5 = load i32* %result, align 4
  ret i32 %tmp5
}
