...
; <label>:21                                      ; preds = %18
  %22 = load i64* %p, align 8
  %23 = load i64* %s, align 8
  %24 = sub nsw i64 %22, %23
  %25 = icmp slt i64 %24, 0
  br i1 %25, label %26, label %29

; <label>:26                                      ; preds = %21
  %27 = load i64* %s, align 8
  %28 = sub nsw i64 0, %27
  br label %30
...
; <label>:30                                      ; preds = %29, %26
  ...
  %32 = load i64* %q, align 8
  %33 = load i64* %s, align 8
  %34 = sub nsw i64 %32, %33
  %35 = icmp slt i64 %34, 0
  br i1 %35, label %36, label %39

; <label>:36                                      ; preds = %30
  %37 = load i64* %s, align 8
  %38 = sub nsw i64 0, %37
  br label %41

; <label>:39                                      ; preds = %30
  %40 = load i64* %q, align 8
  br label %41
...
; <label>:59                                      ; preds = %55
  %60 = load i8* %3, align 1
  %61 = zext i8 %60 to i64
  %62 = getelementptr inbounds [5 x %struct.a_struct]* @an_array, i32 0, i64 %61
  store %struct.a_struct* %62, %struct.a_struct** @a_ptr, align 8
  %63 = load i64* %r, align 8
  %64 = trunc i64 %63 to i8
  %65 = load %struct.a_struct** @a_ptr, align 8
  %66 = getelementptr inbounds %struct.a_struct* %65, i32 0, i32 0
