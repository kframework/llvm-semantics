; ModuleID = '/home/david/src/c-semantics/tests/unitTests/cq-04-s244.c'
...
while.end:                                        ; preds = %while.cond
  ...
  %arrayidx = getelementptr inbounds [8 x double]* %a, i32 0, i64 0
  store double 1.250000e+03, double* %arrayidx, align 8
  %arrayidx2 = getelementptr inbounds [8 x double]* %a, i32 0, i64 1
  store double 1.250000e+03, double* %arrayidx2, align 8
  %arrayidx3 = getelementptr inbounds [8 x double]* %a, i32 0, i64 2
  store double 1.250000e+03, double* %arrayidx3, align 8
  %arrayidx4 = getelementptr inbounds [8 x double]* %a, i32 0, i64 3
  store double 1.250000e+03, double* %arrayidx4, align 8
  %arrayidx5 = getelementptr inbounds [8 x double]* %a, i32 0, i64 4
  store double 1.250000e+03, double* %arrayidx5, align 8
  %arrayidx6 = getelementptr inbounds [8 x double]* %a, i32 0, i64 5
  store double 1.250000e+03, double* %arrayidx6, align 8
  %arrayidx7 = getelementptr inbounds [8 x double]* %a, i32 0, i64 6
  store double 1.250000e+03, double* %arrayidx7, align 8
  %arrayidx8 = getelementptr inbounds [8 x double]* %a, i32 0, i64 7
  store double 1.250000e+03, double* %arrayidx8, align 8
  store i32 0, i32* %lrc, align 4
  store i32 0, i32* %j, align 4
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx9 = getelementptr inbounds [8 x double]* %a, i32 0, i64 %idxprom
  %6 = load double* %arrayidx9, align 8
  %7 = load i32* %j, align 4
  %add = add nsw i32 %7, 1
  %idxprom10 = sext i32 %add to i64
  %arrayidx11 = getelementptr inbounds [8 x double]* %a, i32 0, i64 %idxprom10
  %8 = load double* %arrayidx11, align 8
  %cmp12 = fcmp une double %6, %8
...
if.then14:                                        ; preds = %for.end
  %11 = load %struct.defs** %pd0.addr, align 8
  %flgd = getelementptr inbounds %struct.defs* %11, i32 0, i32 11
  %12 = load i32* %flgd, align 4
  %cmp15 = icmp ne i32 %12, 0
  br i1 %cmp15, label %if.then16, label %if.end17

if.then16:                                        ; preds = %if.then14
  %call = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @sec.s244er, i32 0, i32 0), i32 1)
  br label %if.end17

if.end17:                                         ; preds = %if.then16, %if.then14
  %13 = load i32* %rc, align 4
  %add18 = add nsw i32 %13, 1
  store i32 %add18, i32* %rc, align 4
  br label %if.end19

if.end19:                                         ; preds = %if.end17, %for.end
