; ModuleID = '/home/david/src/c-semantics/tests/csmith/smith000936.c'
...
; <label>:4                                       ; preds = %1
  ...
  %6 = sext i32 %5 to i64
  %7 = getelementptr inbounds [2 x i32*]* %l_2, i32 0, i64 %6
...
; <label>:11                                      ; preds = %1
  ...
  %12 = load i32* getelementptr inbounds ([9 x i32]* @g_3, i32 0, i64 8), align 4
