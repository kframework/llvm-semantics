; ModuleID = '/home/david/src/c-semantics/tests/csmith/smith001460.c'
...
define i64 @func_1() nounwind uwtable {
  ...
  store i32 %9, i32* %6
  %10 = load i32* getelementptr inbounds ([3 x [3 x i32]]* @g_6, i32 0, i64 0, i64 1), align 4
...
define i32 @main(i32 %argc, i8** %argv) nounwind uwtable {
  ...
  %4 = call i64 @func_1()
  %5 = load i32* getelementptr inbounds ([3 x [3 x i32]]* @g_6, i32 0, i64 0, i64 0), align 4
  %6 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str, i32 0, i32 0), i32 %5)
  %7 = load i32* getelementptr inbounds ([3 x [3 x i32]]* @g_6, i32 0, i64 0, i64 1), align 4
  %8 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str1, i32 0, i32 0), i32 %7)
  %9 = load i32* getelementptr inbounds ([3 x [3 x i32]]* @g_6, i32 0, i64 0, i64 2), align 4
  %10 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str2, i32 0, i32 0), i32 %9)
  %11 = load i32* getelementptr inbounds ([3 x [3 x i32]]* @g_6, i32 0, i64 1, i64 0), align 4
  %12 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str3, i32 0, i32 0), i32 %11)
  %13 = load i32* getelementptr inbounds ([3 x [3 x i32]]* @g_6, i32 0, i64 1, i64 1), align 4
  %14 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str4, i32 0, i32 0), i32 %13)
  %15 = load i32* getelementptr inbounds ([3 x [3 x i32]]* @g_6, i32 0, i64 1, i64 2), align 4
  %16 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str5, i32 0, i32 0), i32 %15)
  %17 = load i32* getelementptr inbounds ([3 x [3 x i32]]* @g_6, i32 0, i64 2, i64 0), align 4
  %18 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str6, i32 0, i32 0), i32 %17)
  %19 = load i32* getelementptr inbounds ([3 x [3 x i32]]* @g_6, i32 0, i64 2, i64 1), align 4
  %20 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str7, i32 0, i32 0), i32 %19)
  %21 = load i32* getelementptr inbounds ([3 x [3 x i32]]* @g_6, i32 0, i64 2, i64 2), align 4
  %22 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str8, i32 0, i32 0), i32 %21)
  %23 = load i32* getelementptr inbounds ([3 x [3 x i32]]* @g_6, i32 0, i64 0, i64 1), align 4
  %24 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str1, i32 0, i32 0), i32 %23)
  %25 = load i32* %1
  ret i32 %25
}
