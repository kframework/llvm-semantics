...
; <label>:464                                     ; preds = %455
  ...
  %465 = load i32* %prlc, align 4
  %466 = icmp ne i32 %465, 0
  br i1 %466, label %467, label %470

; <label>:467                                     ; preds = %464
  %468 = load i32* %lrc, align 4
  %469 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @sec.f, i32 0, i32 0), i32 %468)
  br label %470
...
; <label>:471                                     ; preds = %470, %455
  store i32 5, i32* %il, align 4
  store i8 2, i8* %cr, align 1
  %472 = load i8* %cr, align 1
  %473 = sext i8 %472 to i32
  %474 = load i32* %il, align 4
  %475 = ashr i32 %474, %473
  store i32 %475, i32* %il, align 4
  %476 = load i32* %il, align 4
  %477 = icmp ne i32 %476, 1
  br i1 %477, label %478, label %485

; <label>:478                                     ; preds = %471
  store i32 281, i32* %lrc, align 4
  %479 = load i32* %prlc, align 4
  %480 = icmp ne i32 %479, 0
  br i1 %480, label %481, label %484

; <label>:481                                     ; preds = %478
  %482 = load i32* %lrc, align 4
  %483 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @sec.f, i32 0, i32 0), i32 %482)
  br label %484
...
; <label>:485                                     ; preds = %484, %471
  store i32 5, i32* %il, align 4
  store i16 2, i16* %sr, align 2
  %486 = load i16* %sr, align 2
  %487 = sext i16 %486 to i32
  %488 = load i32* %il, align 4
  %489 = ashr i32 %488, %487
  store i32 %489, i32* %il, align 4
  %490 = load i32* %il, align 4
  %491 = icmp ne i32 %490, 1
  br i1 %491, label %492, label %499

; <label>:492                                     ; preds = %485
  store i32 282, i32* %lrc, align 4
  %493 = load i32* %prlc, align 4
  %494 = icmp ne i32 %493, 0
  br i1 %494, label %495, label %498

; <label>:495                                     ; preds = %492
  %496 = load i32* %lrc, align 4
  %497 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @sec.f, i32 0, i32 0), i32 %496)
  br label %498
...
; <label>:499                                     ; preds = %498, %485
  store i32 5, i32* %il, align 4
  store i32 2, i32* %ir, align 4
  %500 = load i32* %ir, align 4
  %501 = load i32* %il, align 4
  %502 = ashr i32 %501, %500
  store i32 %502, i32* %il, align 4
  %503 = load i32* %il, align 4
  %504 = icmp ne i32 %503, 1
  br i1 %504, label %505, label %512

; <label>:505                                     ; preds = %499
  store i32 283, i32* %lrc, align 4
  %506 = load i32* %prlc, align 4
  %507 = icmp ne i32 %506, 0
  br i1 %507, label %508, label %511

; <label>:508                                     ; preds = %505
  %509 = load i32* %lrc, align 4
  %510 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @sec.f, i32 0, i32 0), i32 %509)
  br label %511
...
; <label>:512                                     ; preds = %511, %499
  store i32 5, i32* %il, align 4
  store i64 2, i64* %lr, align 8
  %513 = load i64* %lr, align 8
  %514 = load i32* %il, align 4
...
; <label>:665                                     ; preds = %664, %651
  ...
  %669 = load i32* %ul, align 4
  %670 = icmp ne i32 %669, 1
  br i1 %670, label %671, label %678

; <label>:671                                     ; preds = %665
  store i32 295, i32* %lrc, align 4
  %672 = load i32* %prlc, align 4
  %673 = icmp ne i32 %672, 0
  br i1 %673, label %674, label %677

; <label>:674                                     ; preds = %671
  %675 = load i32* %lrc, align 4
  %676 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @sec.f, i32 0, i32 0), i32 %675)
  br label %677
...
; <label>:678                                     ; preds = %677, %665
  store i8 5, i8* %cl, align 1
  store i8 2, i8* %cr, align 1
  %679 = load i8* %cr, align 1
  %680 = sext i8 %679 to i32
  %681 = load i8* %cl, align 1
  %682 = sext i8 %681 to i32
  %683 = shl i32 %682, %680
  %684 = trunc i32 %683 to i8
  store i8 %684, i8* %cl, align 1
  %685 = load i8* %cl, align 1
...
; <label>:688                                     ; preds = %678
  ...
  %689 = load i32* %prlc, align 4
  %690 = icmp ne i32 %689, 0
  br i1 %690, label %691, label %694

; <label>:691                                     ; preds = %688
  %692 = load i32* %lrc, align 4
  %693 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @sec.f, i32 0, i32 0), i32 %692)
  br label %694
...
; <label>:695                                     ; preds = %694, %678
  store i8 5, i8* %cl, align 1
  store i16 2, i16* %sr, align 2
  %696 = load i16* %sr, align 2
  %697 = sext i16 %696 to i32
  %698 = load i8* %cl, align 1
  %699 = sext i8 %698 to i32
  %700 = shl i32 %699, %697
  %701 = trunc i32 %700 to i8
  store i8 %701, i8* %cl, align 1
  %702 = load i8* %cl, align 1
...
; <label>:705                                     ; preds = %695
  ...
  %706 = load i32* %prlc, align 4
  %707 = icmp ne i32 %706, 0
  br i1 %707, label %708, label %711

; <label>:708                                     ; preds = %705
  %709 = load i32* %lrc, align 4
  %710 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @sec.f, i32 0, i32 0), i32 %709)
  br label %711
...
; <label>:721                                     ; preds = %712
  ...
  %722 = load i32* %prlc, align 4
  %723 = icmp ne i32 %722, 0
  br i1 %723, label %724, label %727

; <label>:724                                     ; preds = %721
  %725 = load i32* %lrc, align 4
  %726 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @sec.f, i32 0, i32 0), i32 %725)
  br label %727
...
; <label>:738                                     ; preds = %728
  ...
  %739 = load i32* %prlc, align 4
  %740 = icmp ne i32 %739, 0
  br i1 %740, label %741, label %744

; <label>:741                                     ; preds = %738
  %742 = load i32* %lrc, align 4
  %743 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @sec.f, i32 0, i32 0), i32 %742)
  br label %744
...
; <label>:754                                     ; preds = %745
  ...
  %755 = load i32* %prlc, align 4
  %756 = icmp ne i32 %755, 0
  br i1 %756, label %757, label %760

; <label>:757                                     ; preds = %754
  %758 = load i32* %lrc, align 4
  %759 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @sec.f, i32 0, i32 0), i32 %758)
  br label %760
...
; <label>:761                                     ; preds = %760, %745
  %762 = load i32* %lrc, align 4
  %763 = icmp ne i32 %762, 0
  br i1 %763, label %764, label %772

; <label>:764                                     ; preds = %761
  store i32 1, i32* %rc, align 4
  %765 = load %struct.defs** %1, align 8
  %766 = getelementptr inbounds %struct.defs* %765, i32 0, i32 11
  %767 = load i32* %766, align 4
  %768 = icmp ne i32 %767, 0
  br i1 %768, label %769, label %771

; <label>:769                                     ; preds = %764
  %770 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @sec.s714er, i32 0, i32 0), i32 1)
  br label %771
