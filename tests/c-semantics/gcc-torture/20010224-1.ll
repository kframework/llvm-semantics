...
define void @ba_compute_psd(i16 signext %start) #0 {
  ...
  %5 = sext i16 %4 to i64
  %6 = getelementptr inbounds [6 x i16]* @masktab, i32 0, i64 %5
  %7 = load i16* %6, align 2
  %8 = sext i16 %7 to i32
  store i32 %8, i32* %k, align 4
  %9 = load i32* %j, align 4
  %10 = sext i32 %9 to i64
  %11 = getelementptr inbounds [6 x i16]* @psd, i32 0, i64 %10
  %12 = load i16* %11, align 2
  %13 = load i32* %k, align 4
  %14 = sext i32 %13 to i64
  %15 = getelementptr inbounds [6 x i16]* @bndpsd, i32 0, i64 %14
...
; <label>:24                                      ; preds = %19
  ...
  %27 = getelementptr inbounds [6 x i16]* @bndpsd, i32 0, i64 %26
  %28 = load i32* %j, align 4
  %29 = sext i32 %28 to i64
  %30 = getelementptr inbounds [6 x i16]* @psd, i32 0, i64 %29
  %31 = call signext i16 @logadd(i16* %27, i16* %30)
  %32 = load i32* %k, align 4
  %33 = sext i32 %32 to i64
  %34 = getelementptr inbounds [6 x i16]* @bndpsd, i32 0, i64 %33
...
define i32 @main() #0 {
  ...
  %2 = load i16* getelementptr inbounds ([6 x i16]* @bndpsd, i32 0, i64 1), align 2
  %3 = sext i16 %2 to i32
  %4 = icmp ne i32 %3, 140
