...
entry:
  %0 = load i8* getelementptr inbounds (%struct.a* @a1.x, i32 0, i32 0), align 1
  %conv = sext i8 %0 to i32
  %1 = load i8* getelementptr inbounds (%struct.a* @a1.y, i32 0, i32 0), align 1
...
land.rhs:                                         ; preds = %entry
  %2 = load i8* getelementptr inbounds (%struct.a* @a1.x, i32 0, i32 1), align 1
  %conv3 = sext i8 %2 to i32
  %3 = load i8* getelementptr inbounds (%struct.a* @a1.y, i32 0, i32 1), align 1
...
entry:
  %0 = load i8* getelementptr inbounds (%struct.a* @a2.x, i32 0, i32 0), align 1
  %conv = sext i8 %0 to i32
  %1 = load i8* getelementptr inbounds (%struct.a* @a2.y, i32 0, i32 0), align 1
  %conv1 = sext i8 %1 to i32
  %cmp = icmp eq i32 %conv, %conv1
  br i1 %cmp, label %land.rhs, label %land.end

land.rhs:                                         ; preds = %entry
  %2 = load i8* getelementptr inbounds (%struct.a* @a2.x, i32 0, i32 1), align 1
  %conv3 = sext i8 %2 to i32
  %and = and i32 %conv3, -65
  %3 = load i8* getelementptr inbounds (%struct.a* @a2.y, i32 0, i32 1), align 1
  %conv4 = sext i8 %3 to i32
...
entry:
  %0 = load i8* getelementptr inbounds (%struct.a* @a3.x, i32 0, i32 0), align 1
  %conv = sext i8 %0 to i32
  %and = and i32 %conv, -9
  %1 = load i8* getelementptr inbounds (%struct.a* @a3.y, i32 0, i32 0), align 1
  %conv1 = sext i8 %1 to i32
...
land.rhs:                                         ; preds = %entry
  %2 = load i8* getelementptr inbounds (%struct.a* @a3.x, i32 0, i32 1), align 1
  %conv4 = sext i8 %2 to i32
  %and5 = and i32 %conv4, -65
  %3 = load i8* getelementptr inbounds (%struct.a* @a3.y, i32 0, i32 1), align 1
...
entry:
  %0 = load i16* getelementptr inbounds (%struct.b* @b1.x, i32 0, i32 2), align 2
  %conv = sext i16 %0 to i32
  %1 = load i16* getelementptr inbounds (%struct.b* @b1.y, i32 0, i32 2), align 2
...
land.rhs:                                         ; preds = %entry
  %2 = load i16* getelementptr inbounds (%struct.b* @b1.x, i32 0, i32 1), align 2
  %conv3 = sext i16 %2 to i32
  %3 = load i16* getelementptr inbounds (%struct.b* @b1.y, i32 0, i32 1), align 2
...
entry:
  %0 = load i16* getelementptr inbounds (%struct.b* @b2.x, i32 0, i32 2), align 2
  %conv = sext i16 %0 to i32
  %1 = load i16* getelementptr inbounds (%struct.b* @b2.y, i32 0, i32 2), align 2
  %conv1 = sext i16 %1 to i32
  %cmp = icmp eq i32 %conv, %conv1
  br i1 %cmp, label %land.rhs, label %land.end

land.rhs:                                         ; preds = %entry
  %2 = load i16* getelementptr inbounds (%struct.b* @b2.x, i32 0, i32 1), align 2
  %conv3 = sext i16 %2 to i32
  %and = and i32 %conv3, -65
  %3 = load i16* getelementptr inbounds (%struct.b* @b2.y, i32 0, i32 1), align 2
  %conv4 = sext i16 %3 to i32
  %cmp5 = icmp eq i32 %and, %conv4
  br label %land.end
...
entry:
  %0 = load i16* getelementptr inbounds (%struct.b* @b3.x, i32 0, i32 2), align 2
  %conv = sext i16 %0 to i32
  %and = and i32 %conv, -9
  %1 = load i16* getelementptr inbounds (%struct.b* @b3.y, i32 0, i32 2), align 2
  %conv1 = sext i16 %1 to i32
  %and2 = and i32 %conv1, -33
  %cmp = icmp eq i32 %and, %and2
  br i1 %cmp, label %land.rhs, label %land.end
...
land.rhs:                                         ; preds = %entry
  %2 = load i16* getelementptr inbounds (%struct.b* @b3.x, i32 0, i32 1), align 2
  %conv4 = sext i16 %2 to i32
  %and5 = and i32 %conv4, -65
  %3 = load i16* getelementptr inbounds (%struct.b* @b3.y, i32 0, i32 1), align 2
...
entry:
  %0 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @c1.x to i32*), align 16
  %1 = lshr i32 %0, 18
  %bf.clear = and i32 %1, 16383
  %2 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @c1.y to i32*), align 16
  %3 = lshr i32 %2, 18
...
land.rhs:                                         ; preds = %entry
  %4 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @c1.x to i32*), align 16
  %5 = lshr i32 %4, 4
  %bf.clear2 = and i32 %5, 16383
  %6 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @c1.y to i32*), align 16
  %7 = lshr i32 %6, 4
...
entry:
  %0 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @c2.x to i32*), align 16
  %1 = lshr i32 %0, 18
  %bf.clear = and i32 %1, 16383
  %2 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @c2.y to i32*), align 16
  %3 = lshr i32 %2, 18
  %bf.clear1 = and i32 %3, 16383
...
land.rhs:                                         ; preds = %entry
  %4 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @c2.x to i32*), align 16
  %5 = lshr i32 %4, 4
  %bf.clear2 = and i32 %5, 16383
  %and = and i32 %bf.clear2, -65
  %6 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @c2.y to i32*), align 16
  %7 = lshr i32 %6, 4
  %bf.clear3 = and i32 %7, 16383
...
entry:
  %0 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @c3.x to i32*), align 16
  %1 = lshr i32 %0, 18
  %bf.clear = and i32 %1, 16383
  %and = and i32 %bf.clear, -9
  %2 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @c3.y to i32*), align 16
  %3 = lshr i32 %2, 18
  %bf.clear1 = and i32 %3, 16383
...
land.rhs:                                         ; preds = %entry
  %4 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @c3.x to i32*), align 16
  %5 = lshr i32 %4, 4
  %bf.clear3 = and i32 %5, 16383
  %and4 = and i32 %bf.clear3, -65
  %6 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @c3.y to i32*), align 16
  %7 = lshr i32 %6, 4
...
entry:
  %0 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @d1.x to i32*), align 16
  %bf.clear = and i32 %0, 16383
  %1 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @d1.y to i32*), align 16
...
land.rhs:                                         ; preds = %entry
  %2 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @d1.x to i32*), align 16
  %3 = lshr i32 %2, 14
  %bf.clear2 = and i32 %3, 16383
  %4 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @d1.y to i32*), align 16
  %5 = lshr i32 %4, 14
  %bf.clear3 = and i32 %5, 16383
  %cmp4 = icmp eq i32 %bf.clear2, %bf.clear3
  br label %land.end
...
entry:
  %0 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @d2.x to i32*), align 16
  %bf.clear = and i32 %0, 16383
  %1 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @d2.y to i32*), align 16
  %bf.clear1 = and i32 %1, 16383
  %cmp = icmp eq i32 %bf.clear, %bf.clear1
  br i1 %cmp, label %land.rhs, label %land.end

land.rhs:                                         ; preds = %entry
  %2 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @d2.x to i32*), align 16
  %3 = lshr i32 %2, 14
  %bf.clear2 = and i32 %3, 16383
  %and = and i32 %bf.clear2, -65
  %4 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @d2.y to i32*), align 16
  %5 = lshr i32 %4, 14
  %bf.clear3 = and i32 %5, 16383
  %cmp4 = icmp eq i32 %and, %bf.clear3
  br label %land.end
...
entry:
  %0 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @d3.x to i32*), align 16
  %bf.clear = and i32 %0, 16383
  %and = and i32 %bf.clear, -9
  %1 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @d3.y to i32*), align 16
  %bf.clear1 = and i32 %1, 16383
  %and2 = and i32 %bf.clear1, -33
  %cmp = icmp eq i32 %and, %and2
  br i1 %cmp, label %land.rhs, label %land.end
...
land.rhs:                                         ; preds = %entry
  %2 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @d3.x to i32*), align 16
  %3 = lshr i32 %2, 14
  %bf.clear3 = and i32 %3, 16383
  %and4 = and i32 %bf.clear3, -65
  %4 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @d3.y to i32*), align 16
  %5 = lshr i32 %4, 14
...
entry:
  %0 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @e1.x to i32*), align 16
  %1 = lshr i32 %0, 18
  %bf.clear = and i32 %1, 16383
  %2 = shl i32 %bf.clear, 18
  %bf.val.sext = ashr i32 %2, 18
  %3 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @e1.y to i32*), align 16
  %4 = lshr i32 %3, 18
...
land.rhs:                                         ; preds = %entry
  %6 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @e1.x to i32*), align 16
  %7 = lshr i32 %6, 4
  %bf.clear3 = and i32 %7, 16383
  %8 = shl i32 %bf.clear3, 18
  %bf.val.sext4 = ashr i32 %8, 18
  %9 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @e1.y to i32*), align 16
  %10 = lshr i32 %9, 4
...
entry:
  %0 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @e2.x to i32*), align 16
  %1 = lshr i32 %0, 18
  %bf.clear = and i32 %1, 16383
  %2 = shl i32 %bf.clear, 18
  %bf.val.sext = ashr i32 %2, 18
  %3 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @e2.y to i32*), align 16
  %4 = lshr i32 %3, 18
  %bf.clear1 = and i32 %4, 16383
  %5 = shl i32 %bf.clear1, 18
  %bf.val.sext2 = ashr i32 %5, 18
...
land.rhs:                                         ; preds = %entry
  %6 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @e2.x to i32*), align 16
  %7 = lshr i32 %6, 4
  %bf.clear3 = and i32 %7, 16383
  %8 = shl i32 %bf.clear3, 18
  %bf.val.sext4 = ashr i32 %8, 18
  %and = and i32 %bf.val.sext4, -65
  %9 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @e2.y to i32*), align 16
  %10 = lshr i32 %9, 4
  %bf.clear5 = and i32 %10, 16383
  %11 = shl i32 %bf.clear5, 18
  %bf.val.sext6 = ashr i32 %11, 18
...
entry:
  %0 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @e3.x to i32*), align 16
  %1 = lshr i32 %0, 18
  %bf.clear = and i32 %1, 16383
  %2 = shl i32 %bf.clear, 18
  %bf.val.sext = ashr i32 %2, 18
  %and = and i32 %bf.val.sext, -9
  %3 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @e3.y to i32*), align 16
  %4 = lshr i32 %3, 18
  %bf.clear1 = and i32 %4, 16383
  %5 = shl i32 %bf.clear1, 18
  %bf.val.sext2 = ashr i32 %5, 18
...
land.rhs:                                         ; preds = %entry
  %6 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @e3.x to i32*), align 16
  %7 = lshr i32 %6, 4
  %bf.clear4 = and i32 %7, 16383
  %8 = shl i32 %bf.clear4, 18
  %bf.val.sext5 = ashr i32 %8, 18
  %and6 = and i32 %bf.val.sext5, -65
  %9 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @e3.y to i32*), align 16
  %10 = lshr i32 %9, 4
...
entry:
  %0 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @e4.x to i32*), align 16
  %1 = lshr i32 %0, 18
  %bf.clear = and i32 %1, 16383
  %2 = shl i32 %bf.clear, 18
  %bf.val.sext = ashr i32 %2, 18
...
land.rhs:                                         ; preds = %entry
  %3 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @e4.x to i32*), align 16
  %4 = lshr i32 %3, 4
  %bf.clear1 = and i32 %4, 16383
  %5 = shl i32 %bf.clear1, 18
  %bf.val.sext2 = ashr i32 %5, 18
...
entry:
  %0 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @f1.x to i32*), align 16
  %bf.clear = and i32 %0, 16383
  %1 = shl i32 %bf.clear, 18
  %bf.val.sext = ashr i32 %1, 18
  %2 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @f1.y to i32*), align 16
...
land.rhs:                                         ; preds = %entry
  %4 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @f1.x to i32*), align 16
  %5 = lshr i32 %4, 14
  %bf.clear3 = and i32 %5, 16383
  %6 = shl i32 %bf.clear3, 18
  %bf.val.sext4 = ashr i32 %6, 18
  %7 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @f1.y to i32*), align 16
  %8 = lshr i32 %7, 14
...
entry:
  %0 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @f2.x to i32*), align 16
  %bf.clear = and i32 %0, 16383
  %1 = shl i32 %bf.clear, 18
  %bf.val.sext = ashr i32 %1, 18
  %2 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @f2.y to i32*), align 16
  %bf.clear1 = and i32 %2, 16383
  %3 = shl i32 %bf.clear1, 18
  %bf.val.sext2 = ashr i32 %3, 18
  %cmp = icmp eq i32 %bf.val.sext, %bf.val.sext2
...
land.rhs:                                         ; preds = %entry
  %4 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @f2.x to i32*), align 16
  %5 = lshr i32 %4, 14
  %bf.clear3 = and i32 %5, 16383
  %6 = shl i32 %bf.clear3, 18
  %bf.val.sext4 = ashr i32 %6, 18
  %and = and i32 %bf.val.sext4, -65
  %7 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @f2.y to i32*), align 16
  %8 = lshr i32 %7, 14
  %bf.clear5 = and i32 %8, 16383
  %9 = shl i32 %bf.clear5, 18
  %bf.val.sext6 = ashr i32 %9, 18
...
entry:
  %0 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @f3.x to i32*), align 16
  %bf.clear = and i32 %0, 16383
  %1 = shl i32 %bf.clear, 18
  %bf.val.sext = ashr i32 %1, 18
  %and = and i32 %bf.val.sext, -9
  %2 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @f3.y to i32*), align 16
  %bf.clear1 = and i32 %2, 16383
  %3 = shl i32 %bf.clear1, 18
  %bf.val.sext2 = ashr i32 %3, 18
  %and3 = and i32 %bf.val.sext2, -33
...
land.rhs:                                         ; preds = %entry
  %4 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @f3.x to i32*), align 16
  %5 = lshr i32 %4, 14
  %bf.clear4 = and i32 %5, 16383
  %6 = shl i32 %bf.clear4, 18
  %bf.val.sext5 = ashr i32 %6, 18
  %and6 = and i32 %bf.val.sext5, -65
  %7 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @f3.y to i32*), align 16
  %8 = lshr i32 %7, 14
...
entry:
  %0 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @f4.x to i32*), align 16
  %bf.clear = and i32 %0, 16383
  %1 = shl i32 %bf.clear, 18
  %bf.val.sext = ashr i32 %1, 18
  %cmp = icmp eq i32 %bf.val.sext, 0
...
land.rhs:                                         ; preds = %entry
  %2 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @f4.x to i32*), align 16
  %3 = lshr i32 %2, 14
  %bf.clear1 = and i32 %3, 16383
...
entry:
  %0 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @g1.x to i32*), align 16
  %1 = lshr i32 %0, 18
  %bf.clear = and i32 %1, 16383
  %2 = shl i32 %bf.clear, 18
  %bf.val.sext = ashr i32 %2, 18
  %3 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @g1.y to i32*), align 16
  %4 = lshr i32 %3, 14
  %bf.clear1 = and i32 %4, 16383
  %5 = shl i32 %bf.clear1, 18
  %bf.val.sext2 = ashr i32 %5, 18
...
land.rhs:                                         ; preds = %entry
  %6 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @g1.x to i32*), align 16
  %7 = lshr i32 %6, 4
  %bf.clear3 = and i32 %7, 16383
  %8 = shl i32 %bf.clear3, 18
  %bf.val.sext4 = ashr i32 %8, 18
  %9 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @g1.y to i32*), align 16
...
entry:
  %0 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @g2.x to i32*), align 16
  %1 = lshr i32 %0, 18
  %bf.clear = and i32 %1, 16383
  %2 = shl i32 %bf.clear, 18
  %bf.val.sext = ashr i32 %2, 18
  %3 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @g2.y to i32*), align 16
  %4 = lshr i32 %3, 14
  %bf.clear1 = and i32 %4, 16383
  %5 = shl i32 %bf.clear1, 18
  %bf.val.sext2 = ashr i32 %5, 18
...
land.rhs:                                         ; preds = %entry
  %6 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @g2.x to i32*), align 16
  %7 = lshr i32 %6, 4
  %bf.clear3 = and i32 %7, 16383
  %8 = shl i32 %bf.clear3, 18
  %bf.val.sext4 = ashr i32 %8, 18
  %and = and i32 %bf.val.sext4, -65
  %9 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @g2.y to i32*), align 16
  %bf.clear5 = and i32 %9, 16383
  %10 = shl i32 %bf.clear5, 18
  %bf.val.sext6 = ashr i32 %10, 18
  %cmp7 = icmp eq i32 %and, %bf.val.sext6
...
entry:
  %0 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @g3.x to i32*), align 16
  %1 = lshr i32 %0, 18
  %bf.clear = and i32 %1, 16383
  %2 = shl i32 %bf.clear, 18
  %bf.val.sext = ashr i32 %2, 18
  %and = and i32 %bf.val.sext, -9
  %3 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @g3.y to i32*), align 16
  %4 = lshr i32 %3, 14
  %bf.clear1 = and i32 %4, 16383
  %5 = shl i32 %bf.clear1, 18
  %bf.val.sext2 = ashr i32 %5, 18
...
land.rhs:                                         ; preds = %entry
  %6 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @g3.x to i32*), align 16
  %7 = lshr i32 %6, 4
  %bf.clear4 = and i32 %7, 16383
  %8 = shl i32 %bf.clear4, 18
  %bf.val.sext5 = ashr i32 %8, 18
  %and6 = and i32 %bf.val.sext5, -65
  %9 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @g3.y to i32*), align 16
...
entry:
  %0 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @g4.x to i32*), align 16
  %1 = lshr i32 %0, 18
  %bf.clear = and i32 %1, 16383
  %2 = shl i32 %bf.clear, 18
  %bf.val.sext = ashr i32 %2, 18
  %and = and i32 %bf.val.sext, 240
  %3 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @g4.y to i32*), align 16
  %4 = lshr i32 %3, 14
  %bf.clear1 = and i32 %4, 16383
  %5 = shl i32 %bf.clear1, 18
  %bf.val.sext2 = ashr i32 %5, 18
...
land.rhs:                                         ; preds = %entry
  %6 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @g4.x to i32*), align 16
  %7 = lshr i32 %6, 4
  %bf.clear4 = and i32 %7, 16383
  %8 = shl i32 %bf.clear4, 18
  %bf.val.sext5 = ashr i32 %8, 18
  %and6 = and i32 %bf.val.sext5, 240
  %9 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @g4.y to i32*), align 16
  %bf.clear7 = and i32 %9, 16383
  %10 = shl i32 %bf.clear7, 18
  %bf.val.sext8 = ashr i32 %10, 18
...
entry:
  %0 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @g5.x to i32*), align 16
  %1 = lshr i32 %0, 18
  %bf.clear = and i32 %1, 16383
  %2 = shl i32 %bf.clear, 18
  %bf.val.sext = ashr i32 %2, 18
  %and = and i32 %bf.val.sext, 3840
  %3 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @g5.y to i32*), align 16
  %4 = lshr i32 %3, 14
  %bf.clear1 = and i32 %4, 16383
  %5 = shl i32 %bf.clear1, 18
  %bf.val.sext2 = ashr i32 %5, 18
...
land.rhs:                                         ; preds = %entry
  %6 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @g5.x to i32*), align 16
  %7 = lshr i32 %6, 4
  %bf.clear4 = and i32 %7, 16383
  %8 = shl i32 %bf.clear4, 18
  %bf.val.sext5 = ashr i32 %8, 18
  %and6 = and i32 %bf.val.sext5, 3840
  %9 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @g5.y to i32*), align 16
  %bf.clear7 = and i32 %9, 16383
  %10 = shl i32 %bf.clear7, 18
  %bf.val.sext8 = ashr i32 %10, 18
...
entry:
  %0 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @g6.x to i32*), align 16
  %1 = lshr i32 %0, 18
  %bf.clear = and i32 %1, 16383
  %2 = shl i32 %bf.clear, 18
  %bf.val.sext = ashr i32 %2, 18
  %and = and i32 %bf.val.sext, 1023
  %3 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @g6.y to i32*), align 16
  %4 = lshr i32 %3, 14
  %bf.clear1 = and i32 %4, 16383
  %5 = shl i32 %bf.clear1, 18
  %bf.val.sext2 = ashr i32 %5, 18
...
land.rhs:                                         ; preds = %entry
  %6 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @g6.x to i32*), align 16
  %7 = lshr i32 %6, 4
  %bf.clear4 = and i32 %7, 16383
  %8 = shl i32 %bf.clear4, 18
  %bf.val.sext5 = ashr i32 %8, 18
  %and6 = and i32 %bf.val.sext5, 1023
  %9 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @g6.y to i32*), align 16
  %bf.clear7 = and i32 %9, 16383
  %10 = shl i32 %bf.clear7, 18
  %bf.val.sext8 = ashr i32 %10, 18
...
entry:
  %0 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @g7.x to i32*), align 16
  %1 = lshr i32 %0, 18
  %bf.clear = and i32 %1, 16383
  %2 = shl i32 %bf.clear, 18
  %bf.val.sext = ashr i32 %2, 18
  %and = and i32 %bf.val.sext, 16368
  %3 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @g7.y to i32*), align 16
  %4 = lshr i32 %3, 14
  %bf.clear1 = and i32 %4, 16383
  %5 = shl i32 %bf.clear1, 18
  %bf.val.sext2 = ashr i32 %5, 18
...
land.rhs:                                         ; preds = %entry
  %6 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @g7.x to i32*), align 16
  %7 = lshr i32 %6, 4
  %bf.clear4 = and i32 %7, 16383
  %8 = shl i32 %bf.clear4, 18
  %bf.val.sext5 = ashr i32 %8, 18
  %and6 = and i32 %bf.val.sext5, 16368
  %9 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @g7.y to i32*), align 16
  %bf.clear7 = and i32 %9, 16383
  %10 = shl i32 %bf.clear7, 18
  %bf.val.sext8 = ashr i32 %10, 18
...
entry:
  %0 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @h1.x to i32*), align 16
  %bf.clear = and i32 %0, 16383
  %1 = shl i32 %bf.clear, 18
  %bf.val.sext = ashr i32 %1, 18
  %2 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @h1.y to i32*), align 16
  %3 = lshr i32 %2, 4
  %bf.clear1 = and i32 %3, 16383
  %4 = shl i32 %bf.clear1, 18
  %bf.val.sext2 = ashr i32 %4, 18
...
land.rhs:                                         ; preds = %entry
  %5 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @h1.x to i32*), align 16
  %6 = lshr i32 %5, 14
  %bf.clear3 = and i32 %6, 16383
  %7 = shl i32 %bf.clear3, 18
  %bf.val.sext4 = ashr i32 %7, 18
  %8 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @h1.y to i32*), align 16
  %9 = lshr i32 %8, 18
  %bf.clear5 = and i32 %9, 16383
  %10 = shl i32 %bf.clear5, 18
  %bf.val.sext6 = ashr i32 %10, 18
...
entry:
  %0 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @h2.x to i32*), align 16
  %bf.clear = and i32 %0, 16383
  %1 = shl i32 %bf.clear, 18
  %bf.val.sext = ashr i32 %1, 18
  %2 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @h2.y to i32*), align 16
  %3 = lshr i32 %2, 4
  %bf.clear1 = and i32 %3, 16383
  %4 = shl i32 %bf.clear1, 18
  %bf.val.sext2 = ashr i32 %4, 18
...
land.rhs:                                         ; preds = %entry
  %5 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @h2.x to i32*), align 16
  %6 = lshr i32 %5, 14
  %bf.clear3 = and i32 %6, 16383
  %7 = shl i32 %bf.clear3, 18
  %bf.val.sext4 = ashr i32 %7, 18
  %and = and i32 %bf.val.sext4, -65
  %8 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @h2.y to i32*), align 16
  %9 = lshr i32 %8, 18
  %bf.clear5 = and i32 %9, 16383
  %10 = shl i32 %bf.clear5, 18
  %bf.val.sext6 = ashr i32 %10, 18
...
entry:
  %0 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @h3.x to i32*), align 16
  %bf.clear = and i32 %0, 16383
  %1 = shl i32 %bf.clear, 18
  %bf.val.sext = ashr i32 %1, 18
  %and = and i32 %bf.val.sext, -9
  %2 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @h3.y to i32*), align 16
  %3 = lshr i32 %2, 4
  %bf.clear1 = and i32 %3, 16383
  %4 = shl i32 %bf.clear1, 18
  %bf.val.sext2 = ashr i32 %4, 18
...
land.rhs:                                         ; preds = %entry
  %5 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @h3.x to i32*), align 16
  %6 = lshr i32 %5, 14
  %bf.clear4 = and i32 %6, 16383
  %7 = shl i32 %bf.clear4, 18
  %bf.val.sext5 = ashr i32 %7, 18
  %and6 = and i32 %bf.val.sext5, -65
  %8 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @h3.y to i32*), align 16
  %9 = lshr i32 %8, 18
  %bf.clear7 = and i32 %9, 16383
  %10 = shl i32 %bf.clear7, 18
  %bf.val.sext8 = ashr i32 %10, 18
...
entry:
  %0 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @h4.x to i32*), align 16
  %bf.clear = and i32 %0, 16383
  %1 = shl i32 %bf.clear, 18
  %bf.val.sext = ashr i32 %1, 18
  %and = and i32 %bf.val.sext, 240
  %2 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @h4.y to i32*), align 16
  %3 = lshr i32 %2, 4
  %bf.clear1 = and i32 %3, 16383
  %4 = shl i32 %bf.clear1, 18
  %bf.val.sext2 = ashr i32 %4, 18
...
land.rhs:                                         ; preds = %entry
  %5 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @h4.x to i32*), align 16
  %6 = lshr i32 %5, 14
  %bf.clear4 = and i32 %6, 16383
  %7 = shl i32 %bf.clear4, 18
  %bf.val.sext5 = ashr i32 %7, 18
  %and6 = and i32 %bf.val.sext5, 240
  %8 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @h4.y to i32*), align 16
  %9 = lshr i32 %8, 18
  %bf.clear7 = and i32 %9, 16383
  %10 = shl i32 %bf.clear7, 18
  %bf.val.sext8 = ashr i32 %10, 18
...
entry:
  %0 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @h5.x to i32*), align 16
  %bf.clear = and i32 %0, 16383
  %1 = shl i32 %bf.clear, 18
  %bf.val.sext = ashr i32 %1, 18
  %and = and i32 %bf.val.sext, 3840
  %2 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @h5.y to i32*), align 16
  %3 = lshr i32 %2, 4
  %bf.clear1 = and i32 %3, 16383
  %4 = shl i32 %bf.clear1, 18
  %bf.val.sext2 = ashr i32 %4, 18
...
land.rhs:                                         ; preds = %entry
  %5 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @h5.x to i32*), align 16
  %6 = lshr i32 %5, 14
  %bf.clear4 = and i32 %6, 16383
  %7 = shl i32 %bf.clear4, 18
  %bf.val.sext5 = ashr i32 %7, 18
  %and6 = and i32 %bf.val.sext5, 3840
  %8 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @h5.y to i32*), align 16
  %9 = lshr i32 %8, 18
  %bf.clear7 = and i32 %9, 16383
  %10 = shl i32 %bf.clear7, 18
  %bf.val.sext8 = ashr i32 %10, 18
...
entry:
  %0 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @h6.x to i32*), align 16
  %bf.clear = and i32 %0, 16383
  %1 = shl i32 %bf.clear, 18
  %bf.val.sext = ashr i32 %1, 18
  %and = and i32 %bf.val.sext, 1023
  %2 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @h6.y to i32*), align 16
  %3 = lshr i32 %2, 4
  %bf.clear1 = and i32 %3, 16383
  %4 = shl i32 %bf.clear1, 18
  %bf.val.sext2 = ashr i32 %4, 18
...
land.rhs:                                         ; preds = %entry
  %5 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @h6.x to i32*), align 16
  %6 = lshr i32 %5, 14
  %bf.clear4 = and i32 %6, 16383
  %7 = shl i32 %bf.clear4, 18
  %bf.val.sext5 = ashr i32 %7, 18
  %and6 = and i32 %bf.val.sext5, 1023
  %8 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @h6.y to i32*), align 16
  %9 = lshr i32 %8, 18
  %bf.clear7 = and i32 %9, 16383
  %10 = shl i32 %bf.clear7, 18
  %bf.val.sext8 = ashr i32 %10, 18
...
entry:
  %0 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @h7.x to i32*), align 16
  %bf.clear = and i32 %0, 16383
  %1 = shl i32 %bf.clear, 18
  %bf.val.sext = ashr i32 %1, 18
  %and = and i32 %bf.val.sext, 16368
  %2 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @h7.y to i32*), align 16
  %3 = lshr i32 %2, 4
  %bf.clear1 = and i32 %3, 16383
  %4 = shl i32 %bf.clear1, 18
  %bf.val.sext2 = ashr i32 %4, 18
...
land.rhs:                                         ; preds = %entry
  %5 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @h7.x to i32*), align 16
  %6 = lshr i32 %5, 14
  %bf.clear4 = and i32 %6, 16383
  %7 = shl i32 %bf.clear4, 18
  %bf.val.sext5 = ashr i32 %7, 18
  %and6 = and i32 %bf.val.sext5, 16368
  %8 = load i32* bitcast ({ i8, i8, i8, i8, [12 x i8] }* @h7.y to i32*), align 16
  %9 = lshr i32 %8, 18
  %bf.clear7 = and i32 %9, 16383
  %10 = shl i32 %bf.clear7, 18
  %bf.val.sext8 = ashr i32 %10, 18
