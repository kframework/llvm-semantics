...
; <label>:3                                       ; preds = %10, %0
  ...
  %5 = getelementptr inbounds %struct.s* %2, i32 0, i32 0
...
; <label>:11                                      ; preds = %3
  %12 = load %struct.s** %p, align 8
  %13 = load %struct.s** %q, align 8
  %14 = icmp eq %struct.s* %12, %13
  br i1 %14, label %15, label %20

; <label>:15                                      ; preds = %11
  %16 = load %struct.s** %q, align 8
  %17 = getelementptr inbounds %struct.s* %16, i32 0, i32 0
