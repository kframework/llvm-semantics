; ModuleID = '/home/grosu/celliso2/c-semantics/tests/unitTests/cq-14-s7813.ll'
...
while.cond:                                       ; preds = %while.cond, %entry
  ...
  %incdec.ptr638 = getelementptr %struct.defs* %pd0, i64 0, i32 15, i64 %indvar
  %incdec.ptr37 = getelementptr [8 x i8]* @sec.qs7813, i64 0, i64 %indvar
  %tmp4 = load i8* %incdec.ptr37, align 1
  store i8 %tmp4, i8* %incdec.ptr638, align 1
  %tobool = icmp eq i8 %tmp4, 0
  %indvar.next = add i64 %indvar, 1
  br i1 %tobool, label %if.end396, label %while.cond

if.end396:                                        ; preds = %while.cond
  ret i32 0
}
...
while.cond.i:                                     ; preds = %while.cond.i, %entry
  ...
  %incdec.ptr37.i = getelementptr [8 x i8]* @sec.qs7813, i64 0, i64 %indvar.i
  %incdec.ptr638.i = getelementptr %struct.defs* @main.d0, i64 0, i32 15, i64 %indvar.i
  %tmp4.i = load i8* %incdec.ptr37.i, align 1
  store i8 %tmp4.i, i8* %incdec.ptr638.i, align 1
