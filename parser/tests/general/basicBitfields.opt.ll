; ModuleID = '/home/grosu/celliso2/c-semantics/tests/unitTests/basicBitfields.ll'
...
entry:
  store i32 7, i32* getelementptr inbounds (%struct.anon* @s, i64 0, i32 1), align 4
  ...
  %tmp = load i32* getelementptr inbounds (%struct.anon* @s, i64 0, i32 1), align 4
  %call5 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i64 0, i64 0), i32 %tmp) nounwind
  ret i32 0
}
