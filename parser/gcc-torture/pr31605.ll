; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/pr31605.c'
...
entry:
  ...
  %tmp1 = load i32* %len.addr, align 4
  %add = add i32 %tmp, %tmp1
  %rem = urem i32 %add, 8
  %sub = sub i32 %rem, 8
  store i32 %sub, i32* %cur_bitshift, align 4
  %tmp2 = load i32* %cur_bitshift, align 4
  %cmp = icmp sgt i32 %tmp2, -8
