; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20040629-1.ll'
...
entry:
  ...
  %2 = and i32 %0, -64
  %3 = or i32 %1, %2
  store i32 %3, i32* bitcast (%struct.anon* @b to i32*), align 4
  ret void
}
...
entry:
  ...
  %add1 = shl i32 %x, 17
  %1 = add i32 %0, %add1
  store i32 %1, i32* bitcast (%struct.anon* @b to i32*), align 4
  ret void
}
...
entry:
  ...
  %2 = and i32 %0, -32
  %3 = or i32 %1, %2
  store i32 %3, i32* bitcast (%0* @c to i32*), align 4
  ret void
}
...
entry:
  ...
  %add1 = shl i32 %x, 6
  %1 = add i32 %0, %add1
  store i32 %1, i32* bitcast (%0* @c to i32*), align 4
  ret void
}
...
entry:
  ...
  %2 = and i32 %0, -65536
  %3 = or i32 %1, %2
  store i32 %3, i32* bitcast (%1* @d to i32*), align 4
  ret void
}
...
entry:
  ...
  %add1 = shl i32 %x, 24
  %1 = add i32 %0, %add1
  store i32 %1, i32* bitcast (%1* @d to i32*), align 4
  ret void
}
...
entry:
  ...
  %1 = or i32 %x, -32
  %2 = and i32 %0, %1
  store i32 %2, i32* bitcast (%0* @c to i32*), align 4
  ret void
}
...
entry:
  ...
  %1 = or i32 %x, -65536
  %2 = and i32 %0, %1
  store i32 %2, i32* bitcast (%1* @d to i32*), align 4
  ret void
}
...
entry:
  ...
  %4 = and i32 %0, -33
  %5 = or i32 %3, %4
  store i32 %5, i32* bitcast (%0* @c to i32*), align 4
  ret void
}
...
entry:
  ...
  %5 = or i32 %3, %4
  store i32 %5, i32* bitcast (%1* @d to i32*), align 4
  ret void
}
...
if.end644:
  store i32 560051, i32* bitcast (%struct.anon* @b to i32*), align 4
  store i32 -2147483595, i32* bitcast (%0* @c to i32*), align 4
  store i32 -1147377476, i32* bitcast (%1* @d to i32*), align 4
  ret i32 0
}
