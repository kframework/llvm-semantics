...
@.str.2 = private unnamed_addr constant [11 x i8] c"double %d\0A\00", align 1
...
@.str.6 = private unnamed_addr constant [21 x i8] c"QuadWord { %d, %d }\0A\00", align 1
@.str.7 = private unnamed_addr constant [29 x i8] c"LargeS { %d, %d, 0x%d, %d }\0A\00", align 1
...
define void @test(i8* %fmt, ...) #0 {
  ...
  %5 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %aq, i32 0, i32 0
...
; <label>:36                                      ; preds = %31, %25
  ...
  %40 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), i8* %39)
  br label %214
...
; <label>:57                                      ; preds = %52, %46
  ...
  %61 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i32 0, i32 0), i32 %60)
  br label %214

; <label>:62                                      ; preds = %15
  %63 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
  %64 = getelementptr inbounds %struct.__va_list_tag, %struct.__va_list_tag* %63, i32 0, i32 1
  %65 = load i32, i32* %64
...
; <label>:78                                      ; preds = %73, %67
  ...
  %83 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.2, i32 0, i32 0), i32 %82)
  br label %214

; <label>:84                                      ; preds = %15
  %85 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
...
; <label>:100                                     ; preds = %95, %89
  ...
  %103 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.3, i32 0, i32 0), i64 %102)
  br label %214

; <label>:104                                     ; preds = %15
  %105 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
...
; <label>:120                                     ; preds = %115, %109
  ...
  %126 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.4, i32 0, i32 0), i32 %125)
  br label %214

; <label>:127                                     ; preds = %15
  %128 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
  %129 = getelementptr inbounds %struct.__va_list_tag, %struct.__va_list_tag* %128, i32 0, i32 0
  %130 = load i32, i32* %129
  %131 = icmp ule i32 %130, 40
  br i1 %131, label %132, label %138

; <label>:132                                     ; preds = %127
  %133 = getelementptr inbounds %struct.__va_list_tag, %struct.__va_list_tag* %128, i32 0, i32 3
  %134 = load i8*, i8** %133
...
; <label>:138                                     ; preds = %127
  %139 = getelementptr inbounds %struct.__va_list_tag, %struct.__va_list_tag* %128, i32 0, i32 2
  %140 = load i8*, i8** %139
...
; <label>:143                                     ; preds = %138, %132
  ...
  %147 = getelementptr inbounds %struct.DWordS_struct, %struct.DWordS_struct* %dw, i32 0, i32 0
  %148 = load i32, i32* %147, align 4
  %149 = getelementptr inbounds %struct.DWordS_struct, %struct.DWordS_struct* %dw, i32 0, i32 1
  %150 = load i8, i8* %149, align 1
  %151 = sext i8 %150 to i32
  %152 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.5, i32 0, i32 0), i32 %148, i32 %151)
  br label %214

; <label>:153                                     ; preds = %15
  %154 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
  %155 = getelementptr inbounds %struct.__va_list_tag, %struct.__va_list_tag* %154, i32 0, i32 0
  %156 = load i32, i32* %155
  %157 = icmp ule i32 %156, 40
  %158 = getelementptr inbounds %struct.__va_list_tag, %struct.__va_list_tag* %154, i32 0, i32 1
...
; <label>:162                                     ; preds = %153
  %163 = getelementptr inbounds %struct.__va_list_tag, %struct.__va_list_tag* %154, i32 0, i32 3
  %164 = load i8*, i8** %163
  %165 = bitcast %struct.QuadWordS_struct* %2 to { i32, double }*
  %166 = getelementptr i8, i8* %164, i32 %156
  %167 = getelementptr i8, i8* %164, i32 %159
  %168 = bitcast i8* %166 to i32*
  %169 = load i32, i32* %168
  %170 = getelementptr inbounds { i32, double }, { i32, double }* %165, i32 0, i32 0
  store i32 %169, i32* %170
  %171 = bitcast i8* %167 to double*
  %172 = load double, double* %171
  %173 = getelementptr inbounds { i32, double }, { i32, double }* %165, i32 0, i32 1
...
; <label>:177                                     ; preds = %153
  %178 = getelementptr inbounds %struct.__va_list_tag, %struct.__va_list_tag* %154, i32 0, i32 2
  %179 = load i8*, i8** %178
  %180 = bitcast i8* %179 to %struct.QuadWordS_struct*
  %181 = getelementptr i8, i8* %179, i32 16
  store i8* %181, i8** %178
  br label %182
...
; <label>:182                                     ; preds = %177, %162
  ...
  %186 = getelementptr inbounds %struct.QuadWordS_struct, %struct.QuadWordS_struct* %qw, i32 0, i32 0
  %187 = load i32, i32* %186, align 4
  %188 = getelementptr inbounds %struct.QuadWordS_struct, %struct.QuadWordS_struct* %qw, i32 0, i32 1
  %189 = load double, double* %188, align 8
  %190 = fmul double 1.000000e+04, %189
  %191 = fptosi double %190 to i32
  %192 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.6, i32 0, i32 0), i32 %187, i32 %191)
  br label %214

; <label>:193                                     ; preds = %15
  %194 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
  %195 = getelementptr inbounds %struct.__va_list_tag, %struct.__va_list_tag* %194, i32 0, i32 2
  %196 = load i8*, i8** %195
  %197 = bitcast i8* %196 to %struct.LargeS_struct*
  %198 = getelementptr i8, i8* %196, i32 32
  store i8* %198, i8** %195
  ...
  %201 = getelementptr inbounds %struct.LargeS_struct, %struct.LargeS_struct* %ls, i32 0, i32 0
  %202 = load i32, i32* %201, align 4
  %203 = getelementptr inbounds %struct.LargeS_struct, %struct.LargeS_struct* %ls, i32 0, i32 1
  %204 = load double, double* %203, align 8
  %205 = fmul double 1.000000e+04, %204
  %206 = fptosi double %205 to i32
  %207 = getelementptr inbounds %struct.LargeS_struct, %struct.LargeS_struct* %ls, i32 0, i32 2
  %208 = load %struct.DWordS_struct*, %struct.DWordS_struct** %207, align 8
  %209 = icmp ne %struct.DWordS_struct* %208, null
  %210 = zext i1 %209 to i32
  %211 = getelementptr inbounds %struct.LargeS_struct, %struct.LargeS_struct* %ls, i32 0, i32 3
  %212 = load i32, i32* %211, align 4
  %213 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.7, i32 0, i32 0), i32 %202, i32 %206, i32 %210, i32 %212)
  br label %214
...
; <label>:215                                     ; preds = %11
  %216 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
...
define i32 @main() #0 {
  ...
  call void (i8*, ...) @test(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.13, i32 0, i32 0), i64 %9, i32 %12, double %14, %struct.LargeS_struct* byval align 8 %ls)
  ret i32 0
}
