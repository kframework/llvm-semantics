; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/vrp-7.c'
...
entry:
  ...
  %0 = shl i32 %bf.value, 31
  %bf.reload.sext = ashr i32 %0, 31
  %1 = and i32 %bf.value, 1
  %2 = load i32* bitcast (%struct.T* @t to i32*), align 4
  %3 = and i32 %2, -2
  %4 = or i32 %3, %1
  store i32 %4, i32* bitcast (%struct.T* @t to i32*), align 4
  ret void
}
