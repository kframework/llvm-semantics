; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/pr41317.c'
...
entry:
  ...
  %tmp = load %struct.B** %p.addr, align 8
  %0 = bitcast %struct.B* %tmp to %struct.A*
  %i = getelementptr inbounds %struct.A* %0, i32 0, i32 0
