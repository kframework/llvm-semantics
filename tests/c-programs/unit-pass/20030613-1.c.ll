...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = getelementptr inbounds %struct.CS, %struct.CS* %x, i32 0, i32 0
  store i64 -7, i64* %2, align 8
  %3 = getelementptr inbounds %struct.CS, %struct.CS* %x, i32 0, i32 1
...
define internal i32 @c5p(i64 %x.coerce0, i64 %x.coerce1) #0 {
  ...
  %44 = getelementptr inbounds %struct.CS, %struct.CS* %b, i32 0, i32 0
  %45 = load i64, i64* %44, align 8
  %46 = getelementptr inbounds %struct.CS, %struct.CS* %b, i32 0, i32 1
...
define internal { i64, i64 } @CCID(i64 %x.coerce0, i64 %x.coerce1) #0 {
  ...
  %5 = getelementptr inbounds %struct.CS, %struct.CS* %x, i32 0, i32 0
  %6 = load i64, i64* %5, align 8
  %7 = getelementptr inbounds %struct.CS, %struct.CS* %a, i32 0, i32 0
  store i64 %6, i64* %7, align 8
  %8 = getelementptr inbounds %struct.CS, %struct.CS* %x, i32 0, i32 1
  %9 = load i64, i64* %8, align 8
  %10 = getelementptr inbounds %struct.CS, %struct.CS* %a, i32 0, i32 1
