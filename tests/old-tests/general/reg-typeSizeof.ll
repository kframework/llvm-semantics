; ModuleID = '/home/grosu/celliso2/c-semantics/tests/unitTests/reg-typeSizeof.c'
...
entry:
  ...
  %tmp = bitcast %struct.qsortArgs* %.compoundliteral to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* bitcast (%struct.qsortArgs* @a1 to i8*), i8* %tmp, i64 16, i32 8, i1 false)
...
for.body:                                         ; preds = %for.cond
  ...
  %call = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0), i32 %tmp5)
  br label %for.inc
