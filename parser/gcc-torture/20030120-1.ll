; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20030120-1.c'
...
entry:
  ...
  %tmp = load i64* %w.addr, align 8
  %and = and i64 %tmp, 4294901760
  %cmp = icmp eq i64 %and, 0
  br i1 %cmp, label %if.then, label %if.end4

if.then:                                          ; preds = %entry
  %tmp1 = load i64* %w.addr, align 8
  %cmp2 = icmp eq i64 %tmp1, 0
