; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith000314.ll'
...
entry:
  %tmp4 = load i8* getelementptr inbounds ([8 x i8]* @g_3, i64 0, i64 5), align 1
...
entry:
  %tmp = load i8* getelementptr inbounds ([8 x i8]* @g_3, i64 0, i64 0), align 1
  %conv = sext i8 %tmp to i32
  %call1 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str, i64 0, i64 0), i32 %conv) nounwind
  %tmp2 = load i8* getelementptr inbounds ([8 x i8]* @g_3, i64 0, i64 1), align 1
  ...
  %tmp5 = load i8* getelementptr inbounds ([8 x i8]* @g_3, i64 0, i64 2), align 1
  ...
  %tmp8 = load i8* getelementptr inbounds ([8 x i8]* @g_3, i64 0, i64 3), align 1
  ...
  %tmp11 = load i8* getelementptr inbounds ([8 x i8]* @g_3, i64 0, i64 4), align 1
  ...
  %tmp14 = load i8* getelementptr inbounds ([8 x i8]* @g_3, i64 0, i64 5), align 1
  ...
  %tmp17 = load i8* getelementptr inbounds ([8 x i8]* @g_3, i64 0, i64 6), align 1
  ...
  %tmp20 = load i8* getelementptr inbounds ([8 x i8]* @g_3, i64 0, i64 7), align 1
