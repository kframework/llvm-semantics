...
define i32 @bla(%struct.test1* %xa, %struct.test2* %xb) #0 {
  ...
  %3 = load %struct.test2** %2, align 8
  %4 = getelementptr inbounds %struct.test2* %3, i32 0, i32 1
  %5 = getelementptr inbounds %struct.test1* %4, i32 0, i32 0
  store i32 1, i32* %5, align 4
  %6 = load %struct.test1** %1, align 8
  %7 = getelementptr inbounds %struct.test1* %6, i32 0, i32 0
  store i32 8, i32* %7, align 4
  %8 = load %struct.test2** %2, align 8
  %9 = getelementptr inbounds %struct.test2* %8, i32 0, i32 1
  %10 = getelementptr inbounds %struct.test1* %9, i32 0, i32 0
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = getelementptr inbounds %struct.test2* %pom, i32 0, i32 1
