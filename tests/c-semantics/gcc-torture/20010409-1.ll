...
define void @test(i8* %x, i32* %y) #0 {
  ...
  %3 = load i32* getelementptr inbounds ([1 x %struct.B]* @d, i32 0, i32 0, i32 1), align 4
  %4 = sext i32 %3 to i64
  %5 = load %struct.A*** getelementptr inbounds ([1 x %struct.B]* @d, i32 0, i32 0, i32 0), align 8
  %6 = getelementptr inbounds %struct.A** %5, i64 %4
  %7 = load %struct.A** %6, align 8
  call void @foo(%struct.A* %7, i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i32 200)
  %8 = load i8** %1, align 8
  ...
  %15 = call %struct.A* @bar(i8* %8, i32 %11, i32 %14, i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i32 201)
  %16 = load i32* getelementptr inbounds ([1 x %struct.B]* @d, i32 0, i32 0, i32 1), align 4
  %17 = sext i32 %16 to i64
  %18 = load %struct.A*** getelementptr inbounds ([1 x %struct.B]* @d, i32 0, i32 0, i32 0), align 8
  %19 = getelementptr inbounds %struct.A** %18, i64 %17
  store %struct.A* %15, %struct.A** %19, align 8
  %20 = load i32* getelementptr inbounds ([1 x %struct.B]* @d, i32 0, i32 0, i32 1), align 4
  %21 = sext i32 %20 to i64
  %22 = load %struct.A*** getelementptr inbounds ([1 x %struct.B]* @d, i32 0, i32 0, i32 0), align 8
  %23 = getelementptr inbounds %struct.A** %22, i64 %21
  %24 = load %struct.A** %23, align 8
...
; <label>:30                                      ; preds = %0
  ...
  %33 = load i32* getelementptr inbounds ([1 x %struct.B]* @d, i32 0, i32 0, i32 1), align 4
  %34 = sext i32 %33 to i64
  %35 = load %struct.A*** getelementptr inbounds ([1 x %struct.B]* @d, i32 0, i32 0, i32 0), align 8
  %36 = getelementptr inbounds %struct.A** %35, i64 %34
  %37 = load %struct.A** %36, align 8
