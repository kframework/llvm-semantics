; ModuleID = '/home/david/src/c-semantics/tests/csmith/smith000275.c'
...
define i32 @func_1() nounwind uwtable {
  %1 = load i32* getelementptr inbounds ([4 x i32]* @g_2, i32 0, i64 2), align 4
  ret i32 %1
}
...
define i32 @main(i32 %argc, i8** %argv) nounwind uwtable {
  ...
  %13 = load i32* getelementptr inbounds ([4 x i32]* @g_2, i32 0, i64 2), align 4
