; ModuleID = '/home/grosu/celliso2/c-semantics/tests/unitTests/cq-04-s244.c'
...
while.end:                                        ; preds = %while.cond
  ...
  %arrayidx5 = getelementptr inbounds [8 x double]* %a, i32 0, i64 1
  store double 1.250000e+03, double* %arrayidx5, align 8
  %arrayidx6 = getelementptr inbounds [8 x double]* %a, i32 0, i64 2
  store double 1.250000e+03, double* %arrayidx6, align 8
  %arrayidx7 = getelementptr inbounds [8 x double]* %a, i32 0, i64 3
  store double 1.250000e+03, double* %arrayidx7, align 8
  %arrayidx8 = getelementptr inbounds [8 x double]* %a, i32 0, i64 4
  store double 1.250000e+03, double* %arrayidx8, align 8
  %arrayidx9 = getelementptr inbounds [8 x double]* %a, i32 0, i64 5
  store double 1.250000e+03, double* %arrayidx9, align 8
  %arrayidx10 = getelementptr inbounds [8 x double]* %a, i32 0, i64 6
  store double 1.250000e+03, double* %arrayidx10, align 8
  %arrayidx11 = getelementptr inbounds [8 x double]* %a, i32 0, i64 7
...
for.end:                                          ; preds = %for.cond
  %tmp22 = load i32* %lrc, align 4
  %cmp23 = icmp ne i32 %tmp22, 0
  br i1 %cmp23, label %if.then24, label %if.end32

if.then24:                                        ; preds = %for.end
  %tmp25 = load %struct.defs** %pd0.addr, align 8
  %flgd = getelementptr inbounds %struct.defs* %tmp25, i32 0, i32 11
...
if.end29:                                         ; preds = %if.then28, %if.then24
  ...
  store i32 %add31, i32* %rc, align 4
  br label %if.end32

if.end32:                                         ; preds = %if.end29, %for.end
  %tmp33 = load i32* %rc, align 4
  ret i32 %tmp33
}
