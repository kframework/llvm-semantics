; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith000551.c'
...
entry:
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %tmp, i8* bitcast (%0* @g_2 to i8*), i64 44, i32 4, i1 false)
  ret void
}
...
entry:
  ...
  %tmp1 = load i16* getelementptr inbounds (%struct.S1* bitcast (%0* @g_2 to %struct.S1*), i32 0, i32 0), align 2
  %conv = sext i16 %tmp1 to i32
  %call = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str, i32 0, i32 0), i32 %conv)
  %tmp2 = volatile load i16* getelementptr inbounds (%struct.S1* bitcast (%0* @g_2 to %struct.S1*), i32 0, i32 1), align 2
  %conv3 = sext i16 %tmp2 to i32
  %call4 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str1, i32 0, i32 0), i32 %conv3)
  %tmp5 = load i32* getelementptr inbounds (%struct.S1* bitcast (%0* @g_2 to %struct.S1*), i32 0, i32 2), align 4
  %call6 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str2, i32 0, i32 0), i32 %tmp5)
  %tmp7 = load i32* getelementptr inbounds (%struct.S1* bitcast (%0* @g_2 to %struct.S1*), i32 0, i32 3), align 4
  %call8 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str3, i32 0, i32 0), i32 %tmp7)
  %tmp9 = load i16* getelementptr inbounds (%struct.S1* bitcast (%0* @g_2 to %struct.S1*), i32 0, i32 4, i32 0), align 2
  %conv10 = sext i16 %tmp9 to i32
  %call11 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str4, i32 0, i32 0), i32 %conv10)
  %tmp12 = load i32* getelementptr inbounds (%struct.S1* bitcast (%0* @g_2 to %struct.S1*), i32 0, i32 4, i32 1), align 4
  %call13 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str5, i32 0, i32 0), i32 %tmp12)
  %tmp14 = volatile load i8* getelementptr inbounds (%struct.S1* bitcast (%0* @g_2 to %struct.S1*), i32 0, i32 4, i32 2), align 1
  %conv15 = sext i8 %tmp14 to i32
  %call16 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str6, i32 0, i32 0), i32 %conv15)
  %tmp17 = load i16* getelementptr inbounds (%struct.S1* bitcast (%0* @g_2 to %struct.S1*), i32 0, i32 5, i32 0), align 2
  %conv18 = sext i16 %tmp17 to i32
  %call19 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str7, i32 0, i32 0), i32 %conv18)
  %tmp20 = load i32* getelementptr inbounds (%struct.S1* bitcast (%0* @g_2 to %struct.S1*), i32 0, i32 5, i32 1), align 4
  %call21 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str8, i32 0, i32 0), i32 %tmp20)
  %tmp22 = volatile load i8* getelementptr inbounds (%struct.S1* bitcast (%0* @g_2 to %struct.S1*), i32 0, i32 5, i32 2), align 1
  %conv23 = sext i8 %tmp22 to i32
  %call24 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str9, i32 0, i32 0), i32 %conv23)
  %tmp25 = load i8* getelementptr inbounds (%struct.S1* bitcast (%0* @g_2 to %struct.S1*), i32 0, i32 6), align 1
  %conv26 = sext i8 %tmp25 to i32
  %call27 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str10, i32 0, i32 0), i32 %conv26)
  %tmp28 = volatile load i32* getelementptr inbounds (%struct.S1* bitcast (%0* @g_2 to %struct.S1*), i32 0, i32 7), align 4
  %call29 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str11, i32 0, i32 0), i32 %tmp28)
  %0 = load i32* %retval
  ret i32 %0
}
