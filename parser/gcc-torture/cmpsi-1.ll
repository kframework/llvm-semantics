; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/cmpsi-1.c'
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %tmp2 = load i64* %x.addr, align 8
  %sub = sub i64 %tmp2, %tmp1
  store i64 %sub, i64* %x.addr, align 8
  %tmp3 = load i64* %x.addr, align 8
  %cmp4 = icmp ult i64 %tmp3, -9223372036854775808
  br i1 %cmp4, label %if.then5, label %if.end6
...
if.end6:                                          ; preds = %if.end
  %tmp7 = load i64* %x.addr, align 8
  %conv = trunc i64 %tmp7 to i32
  ret i32 %conv
}
