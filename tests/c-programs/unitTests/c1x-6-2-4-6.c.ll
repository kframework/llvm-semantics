...
@.str.1 = private unnamed_addr constant [9 x i8] c"2i = %d\0A\00", align 1
@.str.2 = private unnamed_addr constant [9 x i8] c"3i = %d\0A\00", align 1
...
; <label>:4                                       ; preds = %1
  %5 = load i32*, i32** %p, align 8
  %6 = load i32, i32* %5, align 4
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i32 0, i32 0), i32 %6)
  br label %8
