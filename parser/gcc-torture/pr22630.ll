; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/pr22630.c'
...
entry:
  ...
  %tmp = load i32** %r.addr, align 8
  store i32* %tmp, i32** %q, align 8
  store i32* %tmp, i32** %p, align 8
  %tmp1 = load i32** %p, align 8
  %tobool = icmp ne i32* %tmp1, null
