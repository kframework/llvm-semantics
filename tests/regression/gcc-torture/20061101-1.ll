; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20061101-1.c'
...
if.end:                                           ; preds = %if.then, %while.body
  ...
  %tmp8 = load i32* %bcount.addr, align 4
  %mul = mul nsw i32 %tmp7, %tmp8
