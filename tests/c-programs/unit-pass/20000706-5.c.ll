...
; <label>:6                                       ; preds = %0
  %7 = load %struct.baz*, %struct.baz** @c, align 8
...
; <label>:11                                      ; preds = %6
  %12 = load %struct.baz*, %struct.baz** @c, align 8
  %13 = getelementptr inbounds %struct.baz, %struct.baz* %12, i32 0, i32 2
...
define i32 @main() #0 {
  ...
  %2 = alloca { i64, i32 }
  store i32 0, i32* %1
  %3 = getelementptr inbounds %struct.baz, %struct.baz* %a, i32 0, i32 0
  store i32 1, i32* %3, align 4
  %4 = getelementptr inbounds %struct.baz, %struct.baz* %a, i32 0, i32 1
  store i32 2, i32* %4, align 4
  %5 = getelementptr inbounds %struct.baz, %struct.baz* %a, i32 0, i32 2
