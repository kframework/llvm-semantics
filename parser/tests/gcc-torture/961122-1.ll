; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/961122-1.c'
...
entry:
  ...
  %tmp = load i64* @acc, align 8
  %cmp = icmp ne i64 %tmp, 281474976710656
...
if.end:                                           ; preds = %entry
  ...
  %tmp1 = load i64* @acc, align 8
  %cmp2 = icmp ne i64 %tmp1, 281470681743360
