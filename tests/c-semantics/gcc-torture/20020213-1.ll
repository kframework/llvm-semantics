...
define void @foo() #0 {
  %1 = load float* getelementptr inbounds (%struct.A* @a, i32 0, i32 0), align 4
  %2 = call i32 @bar(float %1)
  store i32 %2, i32* getelementptr inbounds (%struct.A* @a, i32 0, i32 1), align 4
...
; <label>:7                                       ; preds = %0
  %8 = load i32* getelementptr inbounds (%struct.A* @a, i32 0, i32 1), align 4
  br label %12
...
; <label>:12                                      ; preds = %9, %7
  %13 = phi i32 [ %8, %7 ], [ %11, %9 ]
  store i32 %13, i32* getelementptr inbounds (%struct.A* @a, i32 0, i32 1), align 4
  %14 = load i32* getelementptr inbounds (%struct.A* @a, i32 0, i32 1), align 4
