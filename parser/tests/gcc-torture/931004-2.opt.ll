; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/931004-2.ll'
...
for.end:                                          ; preds = %for.cond
  br i1 %fits_in_gp, label %vaarg.in_reg16, label %vaarg.in_mem18

vaarg.in_reg16:                                   ; preds = %for.end
  %reg_save_area17 = load i8** %0, align 16
  %7 = sext i32 %gp_offset to i64
  %8 = getelementptr i8* %reg_save_area17, i64 %7
...
vaarg.end22:                                      ; preds = %vaarg.in_mem18, %vaarg.in_reg16
  %vaarg.addr23.in = phi i8* [ %8, %vaarg.in_reg16 ], [ %overflow_arg_area20, %vaarg.in_mem18 ]
  %vaarg.addr23 = bitcast i8* %vaarg.addr23.in to i64*
  %10 = load i64* %vaarg.addr23, align 8
  %cmp25 = icmp eq i64 %10, 123
...
entry:
  tail call void (i32, ...)* @f(i32 3, i32 10, i32 11, i32 12, i64 123)
