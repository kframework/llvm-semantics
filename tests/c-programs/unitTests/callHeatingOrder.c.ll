...
define i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* getelementptr inbounds (%struct.anon, %struct.anon* @main.x11, i32 0, i32 0, i32 0), i64 2, i32 1, i1 false)
  %3 = getelementptr inbounds %struct.anon, %struct.anon* %x11, i32 0, i32 0
