; ModuleID = '/home/david/src/c-semantics/tests/gcc-torture/931004-6.c'
...
vaarg.end:                                        ; preds = %vaarg.in_mem, %vaarg.in_reg
  ...
  %vaarg.addr.0 = bitcast i8* %vaarg.addr.in to i16*
  %tmp = load i16* %vaarg.addr.0, align 2
...
if.end:                                           ; preds = %vaarg.end
  %vaarg.addr.1 = getelementptr inbounds i8* %vaarg.addr.in, i64 2
  %4 = bitcast i8* %vaarg.addr.1 to i16*
  %tmp19 = load i16* %4, align 2
  %conv5 = sext i16 %tmp19 to i32
