; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/980506-2.c'
...
entry:
  ...
  %tmp = load i32** %ip, align 8
  store i32 0, i32* %tmp
  %tmp2 = load %struct.anon** %sp, align 8
  %i3 = getelementptr inbounds %struct.anon* %tmp2, i32 0, i32 0
