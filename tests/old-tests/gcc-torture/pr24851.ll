; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/pr24851.c'
...
entry:
  ...
  %tmp = load i32** %q, align 8
  %arrayidx1 = getelementptr inbounds i32* %tmp, i64 -1
  store i32* %arrayidx1, i32** %p, align 8
  %tmp2 = load i32** %p, align 8
  %arrayidx3 = getelementptr inbounds [10 x i32]* %a, i32 0, i64 9
  %cmp = icmp uge i32* %tmp2, %arrayidx3
