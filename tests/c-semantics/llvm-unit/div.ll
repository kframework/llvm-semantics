...
define i32 @main(i32 %argc, i8** %argv) #0 {
  ...
  %5 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str, i32 0, i32 0), i32 %4)
  ...
  %25 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([23 x i8]* @.str10, i32 0, i32 0), i32 %24)
  %26 = call i32 @uDivTest12(i32 42, i32 3)
  %27 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([23 x i8]* @.str11, i32 0, i32 0), i32 %26)
  %28 = call i32 @uDivTest13(i32 42, i32 3)
  %29 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([23 x i8]* @.str12, i32 0, i32 0), i32 %28)
  %30 = call i32 @uDivTest14(i32 42, i32 3)
  %31 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([23 x i8]* @.str13, i32 0, i32 0), i32 %30)
  %32 = call i32 @uDivTest15(i32 42, i32 3)
  %33 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([23 x i8]* @.str14, i32 0, i32 0), i32 %32)
  %34 = call i32 @uDivTest16(i32 42, i32 3)
  %35 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([23 x i8]* @.str15, i32 0, i32 0), i32 %34)
  %36 = call i32 @uDivTest17(i32 42, i32 3)
  %37 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([23 x i8]* @.str16, i32 0, i32 0), i32 %36)
  ret i32 0
}
