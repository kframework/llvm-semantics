...
entry:
  ...
  %0 = load i8** %a_message.addr, align 8
  %call = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([20 x i8]* @.str, i32 0, i32 0), i8* %0)
  ret void
}
...
entry:
  ...
  store i8* %a_message, i8** %a_message.addr, align 8
  %0 = load i8** %a_message.addr, align 8
  %call = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([19 x i8]* @.str1, i32 0, i32 0), i8* %0)
  ret void
}
...
entry:
  ...
  %0 = load void (i8*)** @say, align 8
  call void %0(i8* getelementptr inbounds ([5 x i8]* @.str2, i32 0, i32 0))
  store void (i8*)* @say_soft, void (i8*)** @say, align 8
  %1 = load void (i8*)** @say, align 8
  call void %1(i8* getelementptr inbounds ([17 x i8]* @.str3, i32 0, i32 0))
  ret i32 0
}
