...
; <label>:20                                      ; preds = %15, %9
  ...
  %24 = getelementptr inbounds %struct.T* %X, i32 0, i32 0
...
; <label>:44                                      ; preds = %39, %33
  ...
  %48 = getelementptr inbounds %struct.T* %X, i32 0, i32 0
...
; <label>:52                                      ; preds = %44
  ...
  %57 = getelementptr %struct.T* %1, i32 0, i32 0
  %58 = load i32* %57
  ret i32 %58
}
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %3 = getelementptr inbounds %struct.T* %X, i32 0, i32 0
  store i32 10, i32* %3, align 4
  %4 = getelementptr inbounds %struct.T* %Y, i32 0, i32 0
  store i32 20, i32* %4, align 4
  %5 = getelementptr %struct.T* %X, i32 0, i32 0
  %6 = load i32* %5
  %7 = getelementptr %struct.T* %Y, i32 0, i32 0
  %8 = load i32* %7
  %9 = call i32 (i32, ...)* @f(i32 2, i32 %6, i32 %8)
  %10 = getelementptr %struct.T* %2, i32 0, i32 0
  store i32 %9, i32* %10
