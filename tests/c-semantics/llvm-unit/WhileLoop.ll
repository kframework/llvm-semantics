...
define void @foo(%struct.__jmp_buf_tag* %buf, i32 %i) #0 {
  ...
  %4 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([16 x i8]* @.str, i32 0, i32 0), i32 %3)
  %5 = load %struct.__jmp_buf_tag** %1, align 8
...
; <label>:6                                       ; preds = %2
  %7 = getelementptr inbounds [1 x %struct.__jmp_buf_tag]* %buf, i32 0, i32 0
...
; <label>:10                                      ; preds = %6
  ...
  %12 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str1, i32 0, i32 0), i32 %11)
  br label %16

; <label>:13                                      ; preds = %6
  %14 = getelementptr inbounds [1 x %struct.__jmp_buf_tag]* %buf, i32 0, i32 0
