; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/va-arg-19.c'
...
if.end47:                                         ; preds = %vaarg.end43
  ...
  %gp_offset_p49 = getelementptr inbounds %struct.__va_list_tag* %arraydecay48, i32 0, i32 0
  %gp_offset50 = load i32* %gp_offset_p49
...
vaarg.in_reg52:                                   ; preds = %if.end47
  ...
  %25 = getelementptr i8* %reg_save_area53, i32 %gp_offset50
  %26 = bitcast i8* %25 to i32*
  %27 = add i32 %gp_offset50, 8
  store i32 %27, i32* %gp_offset_p49
...
vaarg.in_mem54:                                   ; preds = %if.end47
  ...
  %28 = bitcast i8* %overflow_arg_area56 to i32*
...
vaarg.end58:                                      ; preds = %vaarg.in_mem54, %vaarg.in_reg52
  %vaarg.addr59 = phi i32* [ %26, %vaarg.in_reg52 ], [ %28, %vaarg.in_mem54 ]
  %29 = load i32* %vaarg.addr59
  %cmp60 = icmp ne i32 %29, 5
...
vaarg.in_reg67:                                   ; preds = %if.end62
  ...
  %31 = getelementptr i8* %reg_save_area68, i32 %gp_offset65
  %32 = bitcast i8* %31 to i32*
  %33 = add i32 %gp_offset65, 8
  store i32 %33, i32* %gp_offset_p64
...
vaarg.in_mem69:                                   ; preds = %if.end62
  ...
  %34 = bitcast i8* %overflow_arg_area71 to i32*
...
vaarg.end73:                                      ; preds = %vaarg.in_mem69, %vaarg.in_reg67
  %vaarg.addr74 = phi i32* [ %32, %vaarg.in_reg67 ], [ %34, %vaarg.in_mem69 ]
  %35 = load i32* %vaarg.addr74
  %cmp75 = icmp ne i32 %35, 6
...
if.end77:                                         ; preds = %vaarg.end73
  ...
  %gp_offset_p79 = getelementptr inbounds %struct.__va_list_tag* %arraydecay78, i32 0, i32 0
  %gp_offset80 = load i32* %gp_offset_p79
...
vaarg.in_reg82:                                   ; preds = %if.end77
  ...
  %37 = getelementptr i8* %reg_save_area83, i32 %gp_offset80
  %38 = bitcast i8* %37 to i32*
  %39 = add i32 %gp_offset80, 8
  store i32 %39, i32* %gp_offset_p79
...
vaarg.in_mem84:                                   ; preds = %if.end77
  ...
  %40 = bitcast i8* %overflow_arg_area86 to i32*
...
vaarg.end88:                                      ; preds = %vaarg.in_mem84, %vaarg.in_reg82
  %vaarg.addr89 = phi i32* [ %38, %vaarg.in_reg82 ], [ %40, %vaarg.in_mem84 ]
  %41 = load i32* %vaarg.addr89
  %cmp90 = icmp ne i32 %41, 7
...
if.end92:                                         ; preds = %vaarg.end88
  ...
  %gp_offset_p94 = getelementptr inbounds %struct.__va_list_tag* %arraydecay93, i32 0, i32 0
  %gp_offset95 = load i32* %gp_offset_p94
...
vaarg.in_reg97:                                   ; preds = %if.end92
  ...
  %43 = getelementptr i8* %reg_save_area98, i32 %gp_offset95
  %44 = bitcast i8* %43 to i32*
  %45 = add i32 %gp_offset95, 8
  store i32 %45, i32* %gp_offset_p94
...
vaarg.in_mem99:                                   ; preds = %if.end92
  ...
  %46 = bitcast i8* %overflow_arg_area101 to i32*
...
vaarg.end103:                                     ; preds = %vaarg.in_mem99, %vaarg.in_reg97
  %vaarg.addr104 = phi i32* [ %44, %vaarg.in_reg97 ], [ %46, %vaarg.in_mem99 ]
  %47 = load i32* %vaarg.addr104
  %cmp105 = icmp ne i32 %47, 8
...
if.end107:                                        ; preds = %vaarg.end103
  ...
  %gp_offset_p109 = getelementptr inbounds %struct.__va_list_tag* %arraydecay108, i32 0, i32 0
  %gp_offset110 = load i32* %gp_offset_p109
...
vaarg.in_reg112:                                  ; preds = %if.end107
  ...
  %49 = getelementptr i8* %reg_save_area113, i32 %gp_offset110
  %50 = bitcast i8* %49 to i32*
  %51 = add i32 %gp_offset110, 8
  store i32 %51, i32* %gp_offset_p109
...
vaarg.in_mem114:                                  ; preds = %if.end107
  ...
  %52 = bitcast i8* %overflow_arg_area116 to i32*
...
vaarg.end118:                                     ; preds = %vaarg.in_mem114, %vaarg.in_reg112
  %vaarg.addr119 = phi i32* [ %50, %vaarg.in_reg112 ], [ %52, %vaarg.in_mem114 ]
  %53 = load i32* %vaarg.addr119
  %cmp120 = icmp ne i32 %53, 9
