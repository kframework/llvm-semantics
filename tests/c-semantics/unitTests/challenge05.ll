...
define i32 @main() #0 {
  ...
  %3 = load i32 (i32)** %fp, align 8
  %4 = load i32* getelementptr inbounds (%struct.t* @s, i32 0, i32 0)
  %5 = call i32 %3(i32 %4)
  %6 = getelementptr %struct.t* %2, i32 0, i32 0
  store i32 %5, i32* %6
  %7 = getelementptr inbounds %struct.t* %2, i32 0, i32 0
  %8 = load i32* %7, align 4
  %9 = load i32* getelementptr inbounds (%struct.t* @s, i32 0, i32 0), align 4
  %10 = add nsw i32 %8, %9
  ret i32 %10
}
