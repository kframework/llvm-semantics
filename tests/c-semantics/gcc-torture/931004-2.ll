...
; <label>:38                                      ; preds = %4
  ...
  %40 = getelementptr inbounds %struct.__va_list_tag* %39, i32 0, i32 0
  %41 = load i32* %40
  %42 = icmp ule i32 %41, 40
  br i1 %42, label %43, label %49

; <label>:43                                      ; preds = %38
  %44 = getelementptr inbounds %struct.__va_list_tag* %39, i32 0, i32 3
  %45 = load i8** %44
  %46 = getelementptr i8* %45, i32 %41
...
; <label>:49                                      ; preds = %38
  %50 = getelementptr inbounds %struct.__va_list_tag* %39, i32 0, i32 2
  %51 = load i8** %50
  %52 = bitcast i8* %51 to i64*
  %53 = getelementptr i8* %51, i32 8
  store i8* %53, i8** %50
  br label %54
...
; <label>:60                                      ; preds = %54
  %61 = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
