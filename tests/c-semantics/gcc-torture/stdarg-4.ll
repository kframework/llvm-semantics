...
define void @f1(i32 %i, ...) #0 {
  ...
  %6 = load %struct.__va_list_tag** %1, align 8
  %7 = getelementptr inbounds %struct.__va_list_tag* %6, i32 0, i32 1
  %8 = load i32* %7
...
; <label>:21                                      ; preds = %16, %10
  ...
  %25 = load %struct.__va_list_tag** %1, align 8
...
; <label>:40                                      ; preds = %35, %29
  ...
  %45 = load %struct.__va_list_tag** %1, align 8
  %46 = getelementptr inbounds %struct.__va_list_tag* %45, i32 0, i32 1
  %47 = load i32* %46
...
f1i.exit:                                         ; preds = %49, %55
  ...
  %61 = load double* %60
  %62 = load i64* @x, align 8
  %63 = sitofp i64 %62 to double
  %64 = fadd double %63, %61
  %65 = fptosi double %64 to i64
  store i64 %65, i64* @x, align 8
  %66 = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
...
define void @f2(i32 %i, ...) #0 {
  ...
  %7 = load %struct.__va_list_tag** %2, align 8
...
; <label>:22                                      ; preds = %17, %11
  ...
  %26 = load %struct.__va_list_tag** %2, align 8
...
; <label>:41                                      ; preds = %36, %30
  ...
  %43 = load i64* %42
  %44 = load i64* @y, align 8
  %45 = add nsw i64 %44, %43
  store i64 %45, i64* @y, align 8
  %46 = load %struct.__va_list_tag** %2, align 8
  %47 = getelementptr inbounds %struct.__va_list_tag* %46, i32 0, i32 1
  %48 = load i32* %47
...
; <label>:61                                      ; preds = %56, %50
  ...
  %69 = load %struct.__va_list_tag** %1, align 8
  %70 = getelementptr inbounds %struct.__va_list_tag* %69, i32 0, i32 1
  %71 = load i32* %70
  %72 = icmp ule i32 %71, 160
  br i1 %72, label %73, label %79

; <label>:73                                      ; preds = %61
  %74 = getelementptr inbounds %struct.__va_list_tag* %69, i32 0, i32 3
  %75 = load i8** %74
  %76 = getelementptr i8* %75, i32 %71
...
; <label>:79                                      ; preds = %61
  %80 = getelementptr inbounds %struct.__va_list_tag* %69, i32 0, i32 2
  %81 = load i8** %80
  %82 = bitcast i8* %81 to double*
  %83 = getelementptr i8* %81, i32 8
  store i8* %83, i8** %80
  br label %84
...
; <label>:84                                      ; preds = %79, %73
  ...
  %88 = load %struct.__va_list_tag** %1, align 8
  %89 = getelementptr inbounds %struct.__va_list_tag* %88, i32 0, i32 0
  %90 = load i32* %89
  %91 = icmp ule i32 %90, 40
  br i1 %91, label %92, label %98

; <label>:92                                      ; preds = %84
  %93 = getelementptr inbounds %struct.__va_list_tag* %88, i32 0, i32 3
  %94 = load i8** %93
  %95 = getelementptr i8* %94, i32 %90
...
; <label>:98                                      ; preds = %84
  %99 = getelementptr inbounds %struct.__va_list_tag* %88, i32 0, i32 2
  %100 = load i8** %99
  %101 = bitcast i8* %100 to i64*
  %102 = getelementptr i8* %100, i32 8
  store i8* %102, i8** %99
  br label %103
...
; <label>:103                                     ; preds = %98, %92
  ...
  %105 = load i64* %104
  %106 = load i64* @x, align 8
  %107 = add nsw i64 %106, %105
  store i64 %107, i64* @x, align 8
  %108 = load %struct.__va_list_tag** %1, align 8
  %109 = getelementptr inbounds %struct.__va_list_tag* %108, i32 0, i32 1
  %110 = load i32* %109
  %111 = icmp ule i32 %110, 160
  br i1 %111, label %112, label %118

; <label>:112                                     ; preds = %103
  %113 = getelementptr inbounds %struct.__va_list_tag* %108, i32 0, i32 3
  %114 = load i8** %113
  %115 = getelementptr i8* %114, i32 %110
...
; <label>:118                                     ; preds = %103
  %119 = getelementptr inbounds %struct.__va_list_tag* %108, i32 0, i32 2
  %120 = load i8** %119
  %121 = bitcast i8* %120 to double*
  %122 = getelementptr i8* %120, i32 8
  store i8* %122, i8** %119
  br label %f2i.exit
...
f2i.exit:                                         ; preds = %112, %118
  ...
  %129 = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
...
; <label>:53                                      ; preds = %46
  %54 = getelementptr inbounds %struct.__va_list_tag* %49, i32 0, i32 3
  %55 = load i8** %54
  %56 = getelementptr i8* %55, i32 %51
...
; <label>:59                                      ; preds = %46
  %60 = getelementptr inbounds %struct.__va_list_tag* %49, i32 0, i32 2
  %61 = load i8** %60
  %62 = bitcast i8* %61 to i64*
  %63 = getelementptr i8* %61, i32 8
  store i8* %63, i8** %60
  br label %64
...
; <label>:64                                      ; preds = %59, %53
  ...
  %68 = load i64* %arg0, align 8
  %69 = load i64* %arg1, align 8
...
; <label>:87                                      ; preds = %82, %76
  ...
  %90 = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
  %91 = getelementptr inbounds %struct.__va_list_tag* %90, i32 0, i32 0
  %92 = load i32* %91
  %93 = icmp ule i32 %92, 40
  br i1 %93, label %94, label %100

; <label>:94                                      ; preds = %87
  %95 = getelementptr inbounds %struct.__va_list_tag* %90, i32 0, i32 3
  %96 = load i8** %95
  %97 = getelementptr i8* %96, i32 %92
...
; <label>:100                                     ; preds = %87
  %101 = getelementptr inbounds %struct.__va_list_tag* %90, i32 0, i32 2
  %102 = load i8** %101
  %103 = bitcast i8* %102 to i64*
  %104 = getelementptr i8* %102, i32 8
  store i8* %104, i8** %101
  br label %105
...
; <label>:105                                     ; preds = %100, %94
  ...
  %108 = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
  %109 = getelementptr inbounds %struct.__va_list_tag* %108, i32 0, i32 0
  %110 = load i32* %109
...
; <label>:123                                     ; preds = %118, %112
  ...
  %127 = load i64* %arg0, align 8
  %128 = load i64* %arg1, align 8
  %129 = load i64* %arg2, align 8
...
; <label>:131                                     ; preds = %0
  ...
  %133 = getelementptr inbounds %struct.__va_list_tag* %132, i32 0, i32 0
  %134 = load i32* %133
...
; <label>:147                                     ; preds = %142, %136
  ...
  %150 = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
  %151 = getelementptr inbounds %struct.__va_list_tag* %150, i32 0, i32 0
  %152 = load i32* %151
  %153 = icmp ule i32 %152, 40
  br i1 %153, label %154, label %160

; <label>:154                                     ; preds = %147
  %155 = getelementptr inbounds %struct.__va_list_tag* %150, i32 0, i32 3
  %156 = load i8** %155
  %157 = getelementptr i8* %156, i32 %152
...
; <label>:160                                     ; preds = %147
  %161 = getelementptr inbounds %struct.__va_list_tag* %150, i32 0, i32 2
  %162 = load i8** %161
  %163 = bitcast i8* %162 to i64*
  %164 = getelementptr i8* %162, i32 8
  store i8* %164, i8** %161
  br label %165
...
; <label>:165                                     ; preds = %160, %154
  ...
  %169 = getelementptr inbounds %struct.__va_list_tag* %168, i32 0, i32 0
  %170 = load i32* %169
  %171 = icmp ule i32 %170, 40
  br i1 %171, label %172, label %178

; <label>:172                                     ; preds = %165
  %173 = getelementptr inbounds %struct.__va_list_tag* %168, i32 0, i32 3
  %174 = load i8** %173
  %175 = getelementptr i8* %174, i32 %170
...
; <label>:178                                     ; preds = %165
  %179 = getelementptr inbounds %struct.__va_list_tag* %168, i32 0, i32 2
  %180 = load i8** %179
  %181 = bitcast i8* %180 to i64*
  %182 = getelementptr i8* %180, i32 8
  store i8* %182, i8** %179
  br label %183
...
; <label>:183                                     ; preds = %178, %172
  ...
  %186 = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
  %187 = getelementptr inbounds %struct.__va_list_tag* %186, i32 0, i32 0
  %188 = load i32* %187
  %189 = icmp ule i32 %188, 40
  br i1 %189, label %190, label %196

; <label>:190                                     ; preds = %183
  %191 = getelementptr inbounds %struct.__va_list_tag* %186, i32 0, i32 3
  %192 = load i8** %191
  %193 = getelementptr i8* %192, i32 %188
...
; <label>:196                                     ; preds = %183
  %197 = getelementptr inbounds %struct.__va_list_tag* %186, i32 0, i32 2
  %198 = load i8** %197
  %199 = bitcast i8* %198 to i64*
  %200 = getelementptr i8* %198, i32 8
  store i8* %200, i8** %197
  br label %201
...
; <label>:201                                     ; preds = %196, %190
  ...
  %205 = load i64* %arg0, align 8
  %206 = load i64* %arg1, align 8
  %207 = load i64* %arg2, align 8
  %208 = load i64* %arg3, align 8
...
; <label>:211                                     ; preds = %201, %123, %64, %24, %5
  %212 = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
  %213 = bitcast %struct.__va_list_tag* %212 to i8*
  call void @llvm.va_end(i8* %213)
  %214 = load i64* %t, align 8
  ret i64 %214
}
...
; <label>:6                                       ; preds = %0
  ...
  %8 = getelementptr inbounds %struct.__va_list_tag* %7, i32 0, i32 1
  %9 = load i32* %8
...
; <label>:26                                      ; preds = %0
  ...
  %28 = getelementptr inbounds %struct.__va_list_tag* %27, i32 0, i32 1
  %29 = load i32* %28
...
; <label>:69                                      ; preds = %61, %22
  ...
  %71 = load %struct.__va_list_tag** %1, align 8
  %72 = getelementptr inbounds %struct.__va_list_tag* %71, i32 0, i32 1
  %73 = load i32* %72
...
; <label>:86                                      ; preds = %81, %75
  ...
  %90 = load %struct.__va_list_tag** %1, align 8
  %91 = getelementptr inbounds %struct.__va_list_tag* %90, i32 0, i32 0
  %92 = load i32* %91
  %93 = icmp ule i32 %92, 40
  br i1 %93, label %94, label %100
...
; <label>:105                                     ; preds = %100, %94
  %106 = phi i64* [ %98, %94 ], [ %103, %100 ]
  %107 = load i64* %106
  %108 = load i64* @x, align 8
  %109 = add nsw i64 %108, %107
  store i64 %109, i64* @x, align 8
  %110 = load %struct.__va_list_tag** %1, align 8
  %111 = getelementptr inbounds %struct.__va_list_tag* %110, i32 0, i32 1
  %112 = load i32* %111
...
f1i.exit:                                         ; preds = %114, %120
  ...
  %126 = load double* %125
  %127 = load i64* @x, align 8
  %128 = sitofp i64 %127 to double
  %129 = fadd double %128, %126
  %130 = fptosi double %129 to i64
  store i64 %130, i64* @x, align 8
  %131 = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
