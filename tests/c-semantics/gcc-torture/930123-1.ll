...
define i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* getelementptr inbounds ([2 x i8]* @main.a, i32 0, i32 0), i64 2, i32 1, i1 false)
  call void @f(i32* %s)
...
; <label>:7                                       ; preds = %6, %5
  ...
  %10 = getelementptr inbounds [2 x i8]* %a, i32 0, i64 0
  store i8 %9, i8* %10, align 1
  %11 = load i32* %c, align 4
  %12 = sext i32 %11 to i64
  %13 = getelementptr inbounds [2 x i8]* %a, i32 0, i64 %12
