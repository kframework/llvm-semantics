...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %3 = getelementptr inbounds %struct.qsortArgs, %struct.qsortArgs* %2, i32 0, i32 0
  store i32* getelementptr inbounds ([4 x i32], [4 x i32]* @a, i32 0, i32 0), i32** %3, align 8
  %4 = getelementptr inbounds %struct.qsortArgs, %struct.qsortArgs* %2, i32 0, i32 1
  store i32* getelementptr inbounds (i32, i32* getelementptr inbounds ([4 x i32], [4 x i32]* @a, i32 0, i32 0), i64 4), i32** %4, align 8
...
; <label>:10                                      ; preds = %6
  ...
  %13 = getelementptr inbounds [4 x i32], [4 x i32]* @a, i32 0, i64 %12
