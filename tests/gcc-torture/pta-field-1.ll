; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/pta-field-1.c'
...
entry:
  ...
  %0 = bitcast i32** %tmp to %struct.Foo*
  store %struct.Foo* %0, %struct.Foo** %f, align 8
  %tmp1 = load %struct.Foo** %f, align 8
  %q = getelementptr inbounds %struct.Foo* %tmp1, i32 0, i32 1
