...
entry:
  ...
  %0 = bitcast %struct.type* %q to { i32*, i64 }*
  %1 = getelementptr { i32*, i64 }* %0, i32 0, i32 0
  store i32* %q.coerce0, i32** %1
  %2 = getelementptr { i32*, i64 }* %0, i32 0, i32 1
...
entry:
  ...
  %3 = load i32** getelementptr ({ i32*, i64 }* bitcast (%struct.type* @t to { i32*, i64 }*), i32 0, i32 0), align 1
  %4 = load i64* getelementptr ({ i32*, i64 }* bitcast (%struct.type* @t to { i32*, i64 }*), i32 0, i32 1), align 1
