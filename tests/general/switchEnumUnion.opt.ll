; ModuleID = '/home/grosu/celliso2/c-semantics/tests/unitTests/switchEnumUnion.ll'
...
entry:
  ...
  %bf.field.offs = getelementptr i8* %call, i64 16
  %0 = bitcast i8* %bf.field.offs to i32*
  store i32 222, i32* %0, align 8
