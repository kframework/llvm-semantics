; ModuleID = '/home/david/src/c-semantics/tests/csmith/smith001624.c'
...
; <label>:4                                       ; preds = %1
  ...
  %6 = sext i32 %5 to i64
  %7 = getelementptr inbounds [4 x i32*]* %l_3, i32 0, i64 %6
  store i32* getelementptr inbounds ([7 x i32]* @g_4, i32 0, i64 6), i32** %7, align 8
  br label %8
...
; <label>:11                                      ; preds = %1
  ...
  store i32 %12, i32* getelementptr inbounds ([7 x i32]* @g_4, i32 0, i64 0), align 4
  %13 = load i32* getelementptr inbounds ([7 x i32]* @g_4, i32 0, i64 3), align 4
