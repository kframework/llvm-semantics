; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/990127-2.c'
...
entry:
  ...
  %tmp = load double* %x.addr, align 8
  %mul = fmul double %tmp, 1.000000e+02
  %tmp1 = load double* %y.addr, align 8
  %div = fdiv double %mul, %tmp1
  store double %div, double* %result2, align 8
  %tmp2 = load double* %result1, align 8
  %tmp3 = load double* %result2, align 8
  call void @fpEq(double %tmp2, double %tmp3)
  ret void
}
