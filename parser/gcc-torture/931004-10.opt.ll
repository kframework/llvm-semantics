; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/931004-10.ll'
...
vaarg.end:                                        ; preds = %vaarg.in_mem, %vaarg.in_reg
  ...
  %tmp1 = zext i16 %6 to i32
  %sext = shl i32 %tmp1, 24
...
if.end:                                           ; preds = %vaarg.end
  ...
  %sext5 = shl nuw i32 %tmp4, 24
  %conv11 = ashr exact i32 %sext5, 24
...
entry:
  tail call void (i32, ...)* @f(i32 3, i16 5130, i16 5387, i16 5644, i64 123)
