...
@.str.1 = private unnamed_addr constant [12 x i8] c"(%d,%d) is \00", align 1
@.str.2 = private unnamed_addr constant [5 x i8] c"not \00", align 1
@.str.3 = private unnamed_addr constant [23 x i8] c"within [%d,%d; %d,%d]\0A\00", align 1
...
define i64 @addpoint(i64 %p1.coerce, i64 %p2.coerce) #0 {
  ...
  store i64 %p1.coerce, i64* %2, align 8
  %3 = bitcast %struct.point* %p2 to i64*
  store i64 %p2.coerce, i64* %3, align 8
  %4 = getelementptr inbounds %struct.point, %struct.point* %p2, i32 0, i32 0
  %5 = load i32, i32* %4, align 4
  %6 = getelementptr inbounds %struct.point, %struct.point* %p1, i32 0, i32 0
  %7 = load i32, i32* %6, align 4
  %8 = add nsw i32 %7, %5
  store i32 %8, i32* %6, align 4
  %9 = getelementptr inbounds %struct.point, %struct.point* %p2, i32 0, i32 1
  %10 = load i32, i32* %9, align 4
  %11 = getelementptr inbounds %struct.point, %struct.point* %p1, i32 0, i32 1
...
define { i64, i64 } @canonrect(i64 %r.coerce0, i64 %r.coerce1) #0 {
  ...
  %5 = getelementptr inbounds %struct.rect, %struct.rect* %r, i32 0, i32 0
  %6 = getelementptr inbounds %struct.point, %struct.point* %5, i32 0, i32 0
  %7 = load i32, i32* %6, align 4
  %8 = getelementptr inbounds %struct.rect, %struct.rect* %r, i32 0, i32 1
...
; <label>:12                                      ; preds = %0
  %13 = getelementptr inbounds %struct.rect, %struct.rect* %r, i32 0, i32 0
  %14 = getelementptr inbounds %struct.point, %struct.point* %13, i32 0, i32 0
  %15 = load i32, i32* %14, align 4
  br label %20

; <label>:16                                      ; preds = %0
  %17 = getelementptr inbounds %struct.rect, %struct.rect* %r, i32 0, i32 1
...
; <label>:20                                      ; preds = %16, %12
  ...
  %22 = getelementptr inbounds %struct.rect, %struct.rect* %temp, i32 0, i32 0
  %23 = getelementptr inbounds %struct.point, %struct.point* %22, i32 0, i32 0
  store i32 %21, i32* %23, align 4
  %24 = getelementptr inbounds %struct.rect, %struct.rect* %r, i32 0, i32 0
  %25 = getelementptr inbounds %struct.point, %struct.point* %24, i32 0, i32 1
  %26 = load i32, i32* %25, align 4
  %27 = getelementptr inbounds %struct.rect, %struct.rect* %r, i32 0, i32 1
...
; <label>:31                                      ; preds = %20
  %32 = getelementptr inbounds %struct.rect, %struct.rect* %r, i32 0, i32 0
  %33 = getelementptr inbounds %struct.point, %struct.point* %32, i32 0, i32 1
  %34 = load i32, i32* %33, align 4
  br label %39

; <label>:35                                      ; preds = %20
  %36 = getelementptr inbounds %struct.rect, %struct.rect* %r, i32 0, i32 1
...
; <label>:39                                      ; preds = %35, %31
  ...
  %41 = getelementptr inbounds %struct.rect, %struct.rect* %temp, i32 0, i32 0
  %42 = getelementptr inbounds %struct.point, %struct.point* %41, i32 0, i32 1
  store i32 %40, i32* %42, align 4
  %43 = getelementptr inbounds %struct.rect, %struct.rect* %r, i32 0, i32 0
  %44 = getelementptr inbounds %struct.point, %struct.point* %43, i32 0, i32 0
  %45 = load i32, i32* %44, align 4
  %46 = getelementptr inbounds %struct.rect, %struct.rect* %r, i32 0, i32 1
...
; <label>:50                                      ; preds = %39
  %51 = getelementptr inbounds %struct.rect, %struct.rect* %r, i32 0, i32 0
  %52 = getelementptr inbounds %struct.point, %struct.point* %51, i32 0, i32 0
  %53 = load i32, i32* %52, align 4
  br label %58

; <label>:54                                      ; preds = %39
  %55 = getelementptr inbounds %struct.rect, %struct.rect* %r, i32 0, i32 1
...
; <label>:58                                      ; preds = %54, %50
  ...
  %60 = getelementptr inbounds %struct.rect, %struct.rect* %temp, i32 0, i32 1
  %61 = getelementptr inbounds %struct.point, %struct.point* %60, i32 0, i32 0
  store i32 %59, i32* %61, align 4
  %62 = getelementptr inbounds %struct.rect, %struct.rect* %r, i32 0, i32 0
  %63 = getelementptr inbounds %struct.point, %struct.point* %62, i32 0, i32 1
  %64 = load i32, i32* %63, align 4
  %65 = getelementptr inbounds %struct.rect, %struct.rect* %r, i32 0, i32 1
...
; <label>:69                                      ; preds = %58
  %70 = getelementptr inbounds %struct.rect, %struct.rect* %r, i32 0, i32 0
  %71 = getelementptr inbounds %struct.point, %struct.point* %70, i32 0, i32 1
  %72 = load i32, i32* %71, align 4
  br label %77

; <label>:73                                      ; preds = %58
  %74 = getelementptr inbounds %struct.rect, %struct.rect* %r, i32 0, i32 1
...
; <label>:77                                      ; preds = %73, %69
  ...
  %79 = getelementptr inbounds %struct.rect, %struct.rect* %temp, i32 0, i32 1
  ...
  %84 = load { i64, i64 }, { i64, i64 }* %83, align 4
  ret { i64, i64 } %84
}
...
define i64 @makepoint(i32 %x, i32 %y) #0 {
  ...
  %5 = getelementptr inbounds %struct.point, %struct.point* %p, i32 0, i32 0
  store i32 %4, i32* %5, align 4
  %6 = load i32, i32* %3, align 4
  %7 = getelementptr inbounds %struct.point, %struct.point* %p, i32 0, i32 1
...
define { i64, i64 } @makerect(i64 %p1.coerce, i64 %p2.coerce) #0 {
  ...
  %3 = bitcast %struct.point* %p2 to i64*
  store i64 %p2.coerce, i64* %3, align 8
  %4 = getelementptr inbounds %struct.rect, %struct.rect* %r, i32 0, i32 0
  ...
  %7 = getelementptr inbounds %struct.rect, %struct.rect* %r, i32 0, i32 1
  ...
  %22 = load { i64, i64 }, { i64, i64 }* %21, align 4
  ret { i64, i64 } %22
}
...
define i32 @ptinrect(i64 %p.coerce, i64 %r.coerce0, i64 %r.coerce1) #0 {
  ...
  store i64 %p.coerce, i64* %1, align 8
  %2 = bitcast %struct.rect* %r to { i64, i64 }*
  %3 = getelementptr { i64, i64 }, { i64, i64 }* %2, i32 0, i32 0
  store i64 %r.coerce0, i64* %3
  %4 = getelementptr { i64, i64 }, { i64, i64 }* %2, i32 0, i32 1
  ...
  %7 = getelementptr inbounds %struct.rect, %struct.rect* %r, i32 0, i32 0
...
; <label>:11                                      ; preds = %0
  %12 = getelementptr inbounds %struct.point, %struct.point* %p, i32 0, i32 0
  %13 = load i32, i32* %12, align 4
  %14 = getelementptr inbounds %struct.rect, %struct.rect* %r, i32 0, i32 1
...
; <label>:18                                      ; preds = %11
  %19 = getelementptr inbounds %struct.point, %struct.point* %p, i32 0, i32 1
  %20 = load i32, i32* %19, align 4
  %21 = getelementptr inbounds %struct.rect, %struct.rect* %r, i32 0, i32 0
...
; <label>:25                                      ; preds = %18
  %26 = getelementptr inbounds %struct.point, %struct.point* %p, i32 0, i32 1
  %27 = load i32, i32* %26, align 4
  %28 = getelementptr inbounds %struct.rect, %struct.rect* %r, i32 0, i32 1
...
define void @odd(i24 %y.coerce) #0 {
  ...
  %2 = getelementptr %struct.odd, %struct.odd* %y, i32 0, i32 0
  store i24 %y.coerce, i24* %1, align 4
  %3 = bitcast i24* %1 to i8*
  %4 = bitcast [3 x i8]* %2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %4, i8* %3, i64 3, i32 4, i1 false)
  ...
  %7 = getelementptr inbounds %struct.odd, %struct.odd* %x, i32 0, i32 0
  %8 = getelementptr inbounds [3 x i8], [3 x i8]* %7, i32 0, i32 0
...
; <label>:42                                      ; preds = %38
  ...
  %45 = getelementptr inbounds [4 x %struct.point], [4 x %struct.point]* %pts, i32 0, i64 %44
  %46 = getelementptr inbounds %struct.point, %struct.point* %45, i32 0, i32 0
  %47 = load i32, i32* %46, align 4
  %48 = load i32, i32* %i, align 4
  %49 = sext i32 %48 to i64
  %50 = getelementptr inbounds [4 x %struct.point], [4 x %struct.point]* %pts, i32 0, i64 %49
  %51 = getelementptr inbounds %struct.point, %struct.point* %50, i32 0, i32 0
  %52 = load i32, i32* %51, align 4
  %53 = load i32, i32* %i, align 4
  %54 = sext i32 %53 to i64
  %55 = getelementptr inbounds [4 x %struct.point], [4 x %struct.point]* %pts, i32 0, i64 %54
  ...
  %64 = getelementptr inbounds %struct.point, %struct.point* %6, i32 0, i32 1
  %65 = load i32, i32* %64, align 4
  %66 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i32 0, i32 0), i32 %47, i32 %65)
...
; <label>:78                                      ; preds = %76, %42
  %79 = getelementptr inbounds %struct.rect, %struct.rect* %screen, i32 0, i32 0
  %80 = getelementptr inbounds %struct.point, %struct.point* %79, i32 0, i32 0
  %81 = load i32, i32* %80, align 4
  %82 = getelementptr inbounds %struct.rect, %struct.rect* %screen, i32 0, i32 0
  %83 = getelementptr inbounds %struct.point, %struct.point* %82, i32 0, i32 1
  %84 = load i32, i32* %83, align 4
  %85 = getelementptr inbounds %struct.rect, %struct.rect* %screen, i32 0, i32 1
  %86 = getelementptr inbounds %struct.point, %struct.point* %85, i32 0, i32 0
  %87 = load i32, i32* %86, align 4
  %88 = getelementptr inbounds %struct.rect, %struct.rect* %screen, i32 0, i32 1
  %89 = getelementptr inbounds %struct.point, %struct.point* %88, i32 0, i32 1
  %90 = load i32, i32* %89, align 4
  %91 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.3, i32 0, i32 0), i32 %81, i32 %84, i32 %87, i32 %90)
  br label %92
...
; <label>:95                                      ; preds = %38
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %96, i8* getelementptr inbounds (%struct.odd, %struct.odd* @y, i32 0, i32 0, i32 0), i64 3, i32 1, i1 false)
  %97 = load i24, i24* %8, align 1
