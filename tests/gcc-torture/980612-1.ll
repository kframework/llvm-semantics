; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/980612-1.c'
...
entry:
  ...
  %tmp = load %struct.fd** %f, align 8
  %b = getelementptr inbounds %struct.fd* %tmp, i32 0, i32 1
  store i8 %conv, i8* %b, align 1
  %tmp2 = load %struct.fd** %f, align 8
  %a = getelementptr inbounds %struct.fd* %tmp2, i32 0, i32 0
  %tmp3 = load i8* %a, align 1
  %conv4 = zext i8 %tmp3 to i32
  %and = and i32 %conv4, 127
  %and5 = and i32 %and, -17
  %cmp = icmp sle i32 %and5, 2
