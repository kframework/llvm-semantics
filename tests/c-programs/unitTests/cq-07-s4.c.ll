...
define i32 @sec(%struct.defs* %pd0) #0 {
  ...
  store i32 0, i32* %rc, align 4
  store i8* getelementptr inbounds ([8 x i8], [8 x i8]* @sec.qs4, i32 0, i32 0), i8** %ps, align 8
...
; <label>:29                                      ; preds = %24
  %30 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @sec.s4er, i32 0, i32 0), i32 1)
  br label %31
...
; <label>:46                                      ; preds = %39
  %47 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @sec.s4er, i32 0, i32 0), i32 2)
  br label %48
...
; <label>:50                                      ; preds = %65, %49
  ...
  %53 = load %struct.defs*, %struct.defs** %1, align 8
  %54 = getelementptr inbounds %struct.defs, %struct.defs* %53, i32 0, i32 0
...
; <label>:59                                      ; preds = %50
  ...
  %62 = and i32 %60, %61
  store i32 %62, i32* %mask, align 4
  %63 = load i32, i32* %target, align 4
  %64 = lshr i32 %63, 1
  store i32 %64, i32* %target, align 4
  br label %65
...
; <label>:74                                      ; preds = %71, %68
  ...
  %76 = add nsw i32 %75, 8
  store i32 %76, i32* %rc, align 4
  %77 = load %struct.defs*, %struct.defs** %1, align 8
  %78 = getelementptr inbounds %struct.defs, %struct.defs* %77, i32 0, i32 11
  %79 = load i32, i32* %78, align 4
  %80 = icmp ne i32 %79, 0
  br i1 %80, label %81, label %83

; <label>:81                                      ; preds = %74
  %82 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @sec.s4er, i32 0, i32 0), i32 8)
  br label %83
