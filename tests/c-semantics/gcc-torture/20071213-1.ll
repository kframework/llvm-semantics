...
; <label>:24                                      ; preds = %20
  %25 = load %struct.__va_list_tag** %2, align 8
...
; <label>:46                                      ; preds = %0
  %47 = load %struct.__va_list_tag** %2, align 8
  %48 = getelementptr inbounds %struct.__va_list_tag* %47, i32 0, i32 0
  %49 = load i32* %48
  %50 = icmp ule i32 %49, 40
  br i1 %50, label %51, label %57

; <label>:51                                      ; preds = %46
  %52 = getelementptr inbounds %struct.__va_list_tag* %47, i32 0, i32 3
  %53 = load i8** %52
  %54 = getelementptr i8* %53, i32 %49
...
; <label>:57                                      ; preds = %46
  %58 = getelementptr inbounds %struct.__va_list_tag* %47, i32 0, i32 2
  %59 = load i8** %58
  %60 = bitcast i8* %59 to i32*
  %61 = getelementptr i8* %59, i32 8
  store i8* %61, i8** %58
  br label %62
...
; <label>:66                                      ; preds = %62
  %67 = load %struct.__va_list_tag** %2, align 8
