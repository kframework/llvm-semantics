...
define i32 @main() #0 {
  ...
  %2 = load double, double* %ty, align 8
  %3 = fcmp olt double %2, 0.000000e+00
  br i1 %3, label %4, label %7

; <label>:4                                       ; preds = %0
  %5 = load double, double* %ty, align 8
  %6 = fsub double -0.000000e+00, %5
  store double %6, double* %ty, align 8
  br label %7

; <label>:7                                       ; preds = %4, %0
  %8 = load double, double* %tx, align 8
  %9 = load double, double* %ty, align 8
...
; <label>:13                                      ; preds = %7
  %14 = load double, double* %ty, align 8
  br label %15

; <label>:15                                      ; preds = %13, %11
  %16 = phi double [ %12, %11 ], [ %14, %13 ]
  store double %16, double* %d, align 8
  %17 = load double, double* %ty, align 8
