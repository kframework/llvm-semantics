; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith001207.ll'
...
entry:
  volatile store i32 -21, i32* getelementptr inbounds ([8 x i32]* @g_2, i64 0, i64 3), align 4
  %tmp = volatile load i32* getelementptr inbounds ([8 x i32]* @g_2, i64 0, i64 3), align 4
  %cmp = icmp sgt i32 %tmp, 0
  br i1 %cmp, label %for.body, label %return

for.body:                                         ; preds = %entry
  %tmp1 = volatile load i32* getelementptr inbounds ([8 x i32]* @g_2, i64 0, i64 0), align 16
  br label %return

return:                                           ; preds = %entry, %for.body
  %storemerge = phi i32 [ %tmp1, %for.body ], [ -435483414, %entry ]
  ret i32 %storemerge
}
...
entry:
  volatile store i32 -21, i32* getelementptr inbounds ([8 x i32]* @g_2, i64 0, i64 3), align 4
  %tmp.i = volatile load i32* getelementptr inbounds ([8 x i32]* @g_2, i64 0, i64 3), align 4
  %cmp.i = icmp sgt i32 %tmp.i, 0
  br i1 %cmp.i, label %for.body.i, label %func_1.exit

for.body.i:                                       ; preds = %entry
  %tmp1.i = volatile load i32* getelementptr inbounds ([8 x i32]* @g_2, i64 0, i64 0), align 16
...
func_1.exit:                                      ; preds = %entry, %for.body.i
  ...
  %tmp16 = volatile load i32* getelementptr inbounds ([8 x i32]* @g_2, i64 0, i64 3), align 4
