...
define i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* getelementptr inbounds ([15 x i8]* @main.title, i32 0, i32 0), i64 15, i32 1, i1 false)
  %3 = getelementptr inbounds [15 x i8]* %title, i32 0, i32 0
