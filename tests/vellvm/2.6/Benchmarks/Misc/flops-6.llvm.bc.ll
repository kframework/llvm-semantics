...
@.str3 = private constant [36 x i8] c"     6   %13.4lf  %10.4lf  %10.4lf\0A\00", align 1 ; <[36 x i8]*> [#uses=1]
...
bb:                                               ; preds = %bb, %entry
  ...
  %5 = fmul double %4, 0x3E3596BF8CE7631D         ; <double> [#uses=3]
  ...
  %32 = fmul double %31, %19                      ; <double> [#uses=1]
...
bb2:                                              ; preds = %bb
  ...
  %35 = fadd double %34, 0x3FE0006C7BD33F94       ; <double> [#uses=1]
  %36 = fmul double %35, 0x3E3596BF8CE7631D       ; <double> [#uses=1]
  %37 = fdiv double %36, 2.000000e+00             ; <double> [#uses=1]
  %38 = fadd double %37, -2.500000e-01            ; <double> [#uses=1]
