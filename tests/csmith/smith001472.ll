; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith001472.c'
...
entry:
  ...
  %call1 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([19 x i8]* @.str, i32 0, i32 0), i32 25368)
