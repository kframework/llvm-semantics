; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/string-opt-17.ll'
...
entry:
  %tmp = load i64* @check2.r, align 8
  %cmp = icmp eq i64 %tmp, 5
...
entry:
  %tmp.i = load i64* @check2.r, align 8
  %cmp.i = icmp eq i64 %tmp.i, 5
...
check2.exit:                                      ; preds = %entry
  %inc.i = add i64 %tmp.i, 1
  store i64 %inc.i, i64* @check2.r, align 8
  %add.ptr = getelementptr inbounds [10 x i8]* @.str, i64 0, i64 %inc.i
  %call1 = tail call i8* @strcpy(i8* %s, i8* %add.ptr) nounwind
  ret void
}
...
if.end:                                           ; preds = %lor.lhs.false
  %tmp.i.i = load i64* @check2.r, align 8
  %cmp.i.i = icmp eq i64 %tmp.i.i, 5
...
test2.exit:                                       ; preds = %if.end
  %inc.i.i = add i64 %tmp.i.i, 1
  store i64 %inc.i.i, i64* @check2.r, align 8
  %add.ptr.i = getelementptr inbounds [10 x i8]* @.str, i64 0, i64 %inc.i.i
  %call1.i = call i8* @strcpy(i8* %arraydecay, i8* %add.ptr.i) nounwind
