; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith000613.c'
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [8 x i64]* %l_2, i32 0, i64 %idxprom
...
for.end:                                          ; preds = %for.cond
  %arrayidx3 = getelementptr inbounds [8 x i64]* %l_2, i32 0, i64 2
  %tmp4 = load i64* %arrayidx3, align 8
  %tmp5 = load i32** %l_5, align 8
  %tmp6 = load i32* %tmp5
  %conv = sext i32 %tmp6 to i64
  %xor = xor i64 %conv, %tmp4
  %conv7 = trunc i64 %xor to i32
  store i32 %conv7, i32* %tmp5
  %tmp8 = load i32** %l_5, align 8
  %tmp9 = load i32* %tmp8
  ret i32 %tmp9
}
