; ModuleID = './2007-04-10-BitfieldTest.c'
...
define i32 @main(i32 %argc, i8** %argv) #0 {
  ...
  %4 = bitcast %union.u* %uu to i64*
  store i64 82351535429844991, i64* %4, align 8
  %5 = bitcast %union.u* %uu to %struct.anon*
  %6 = bitcast %struct.anon* %5 to i64*
