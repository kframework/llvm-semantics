...
@.compoundliteral.1 = internal global %struct.A { i32 3, i32 4 }
@.compoundliteral.2 = internal global %struct.B { %struct.A* @.compoundliteral, %struct.A* @.compoundliteral.1 }
@.compoundliteral.3 = internal global %struct.A { i32 5, i32 6 }
@e = global %struct.C { %struct.B* @.compoundliteral.2, %struct.A* @.compoundliteral.3 }, align 8
