...
define void @testVaCopyArg(i8* %fmt, ...) #0 {
  ...
  %4 = getelementptr inbounds [1 x %struct.__va_list_tag]* %aq, i32 0, i32 0
  ...
  %8 = getelementptr inbounds [1 x %struct.__va_list_tag]* %aq, i32 0, i32 0
...
; <label>:23                                      ; preds = %18, %12
  ...
  %27 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @.str, i32 0, i32 0), i8* %26)
  ret void
}
