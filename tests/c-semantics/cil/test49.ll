...
define i32 @f() #0 {
  ...
  %2 = getelementptr inbounds %struct.fun* %1, i32 0, i32 0
  store i32 11, i32* %2, align 4
  store i32 12, i32* getelementptr inbounds (%struct.fun* @d, i32 0, i32 0), align 4
  %3 = load %struct.fun** @c, align 8
  %4 = getelementptr inbounds %struct.fun* %3, i32 0, i32 0
  %5 = load i32* %4, align 4
  %6 = load i32* getelementptr inbounds (%struct.fun* @d, i32 0, i32 0), align 4
  %7 = add nsw i32 %5, %6
  ret i32 %7
}
