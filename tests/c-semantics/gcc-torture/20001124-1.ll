...
define internal i32 @do_isofs_readdir(%struct.inode* %inode, %struct.file* %filp) #0 {
  ...
  %4 = load %struct.inode** %2, align 8
  %5 = getelementptr inbounds %struct.inode* %4, i32 0, i32 1
  %6 = load %struct.super_block** %5, align 8
  %7 = getelementptr inbounds %struct.super_block* %6, i32 0, i32 0
  %8 = load i32* %7, align 4
  store i32 %8, i32* %bufsize, align 4
  %9 = load %struct.inode** %2, align 8
  %10 = getelementptr inbounds %struct.inode* %9, i32 0, i32 1
  %11 = load %struct.super_block** %10, align 8
  %12 = getelementptr inbounds %struct.super_block* %11, i32 0, i32 1
  %13 = load i8* %12, align 1
  store i8 %13, i8* %bufbits, align 1
  store i8* null, i8** %bh, align 8
  %14 = load %struct.file** %3, align 8
  %15 = getelementptr inbounds %struct.file* %14, i32 0, i32 0
  %16 = load i64* %15, align 8
  %17 = load %struct.inode** %2, align 8
  %18 = getelementptr inbounds %struct.inode* %17, i32 0, i32 0
...
; <label>:22                                      ; preds = %0
  %23 = load %struct.file** %3, align 8
  %24 = getelementptr inbounds %struct.file* %23, i32 0, i32 0
  %25 = load i64* %24, align 8
  %26 = load i32* %bufsize, align 4
  %27 = sub nsw i32 %26, 1
  %28 = sext i32 %27 to i64
  %29 = and i64 %25, %28
  %30 = trunc i64 %29 to i32
  store i32 %30, i32* %offset, align 4
  %31 = load %struct.file** %3, align 8
  %32 = getelementptr inbounds %struct.file* %31, i32 0, i32 0
  %33 = load i64* %32, align 8
  %34 = load i8* %bufbits, align 1
  %35 = zext i8 %34 to i32
  %36 = zext i32 %35 to i64
  %37 = ashr i64 %33, %36
  %38 = trunc i64 %37 to i32
  store i32 %38, i32* %block, align 4
  %39 = load %struct.inode** %2, align 8
  %40 = getelementptr inbounds %struct.inode* %39, i32 0, i32 1
  %41 = load %struct.super_block** %40, align 8
  %42 = getelementptr inbounds %struct.super_block* %41, i32 0, i32 2
  %43 = load i32* %42, align 4
  store i32 %43, i32* %hs, align 4
  br label %44

; <label>:44                                      ; preds = %90, %22
  %45 = load %struct.file** %3, align 8
  %46 = getelementptr inbounds %struct.file* %45, i32 0, i32 0
  %47 = load i64* %46, align 8
  %48 = load %struct.inode** %2, align 8
  %49 = getelementptr inbounds %struct.inode* %48, i32 0, i32 0
  %50 = load i64* %49, align 8
  %51 = icmp slt i64 %47, %50
  br i1 %51, label %52, label %95

; <label>:52                                      ; preds = %44
  %53 = load i8** %bh, align 8
  %54 = icmp ne i8* %53, null
  br i1 %54, label %58, label %55

; <label>:55                                      ; preds = %52
  %56 = load i32* %block, align 4
  %57 = call i8* @isofs_bread(i32 %56)
  store i8* %57, i8** %bh, align 8
  br label %58

; <label>:58                                      ; preds = %55, %52
  %59 = load i32* %block, align 4
  %60 = load i8* %bufbits, align 1
  %61 = zext i8 %60 to i32
  %62 = shl i32 %59, %61
  %63 = load i32* %hs, align 4
  %64 = add i32 %63, %62
  store i32 %64, i32* %hs, align 4
  %65 = load i32* %hs, align 4
  %66 = icmp eq i32 %65, 0
  br i1 %66, label %67, label %72

; <label>:67                                      ; preds = %58
  %68 = load %struct.file** %3, align 8
  %69 = getelementptr inbounds %struct.file* %68, i32 0, i32 0
...
; <label>:72                                      ; preds = %67, %58
  %73 = load i32* %offset, align 4
  %74 = load i32* %bufsize, align 4
  %75 = icmp uge i32 %73, %74
  br i1 %75, label %76, label %81

; <label>:76                                      ; preds = %72
  %77 = load i32* %bufsize, align 4
  %78 = sub nsw i32 %77, 1
...
; <label>:81                                      ; preds = %76, %72
  %82 = load i8** %bh, align 8
  %83 = load i8* %82, align 1
  %84 = icmp ne i8 %83, 0
  br i1 %84, label %85, label %90

; <label>:85                                      ; preds = %81
  %86 = load %struct.file** %3, align 8
  %87 = getelementptr inbounds %struct.file* %86, i32 0, i32 0
