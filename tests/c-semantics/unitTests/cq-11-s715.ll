...
; Function Attrs: nounwind uwtable
define i32 @s715f(i32 %x, i32 %y, i32 %z) #0 {
  %1 = alloca i32, align 4
  %2 = alloca i32, align 4
...
; <label>:30                                      ; preds = %25
  %31 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @sec.s715er, i32 0, i32 0), i32 1)
  br label %32

; <label>:32                                      ; preds = %30, %25
  %33 = load i32* %rc, align 4
  %34 = add nsw i32 %33, 1
  store i32 %34, i32* %rc, align 4
  br label %35
...
; <label>:35                                      ; preds = %32, %13
  ...
  %40 = call i32 @s715f(i32 %36, i32 %38, i32 %39)
  %41 = icmp ne i32 %40, 5
  br i1 %41, label %42, label %52

; <label>:42                                      ; preds = %35
  %43 = load %struct.defs** %1, align 8
  %44 = getelementptr inbounds %struct.defs* %43, i32 0, i32 11
  %45 = load i32* %44, align 4
  %46 = icmp ne i32 %45, 0
  br i1 %46, label %47, label %49

; <label>:47                                      ; preds = %42
  %48 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @sec.s715er, i32 0, i32 0), i32 2)
  br label %49
