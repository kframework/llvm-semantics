...
define %union.tree_node* @foo(%union.tree_node* %p, i32 %i) #0 {
  ...
  %4 = sext i32 %3 to i64
  %5 = load %union.tree_node** %1, align 8
  %6 = bitcast %union.tree_node* %5 to %struct.tree_vec*
  %7 = getelementptr inbounds %struct.tree_vec* %6, i32 0, i32 2
  %8 = getelementptr inbounds [1 x %union.tree_node*]* %7, i32 0, i64 %4
  store %union.tree_node* null, %union.tree_node** %8, align 8
  %9 = load %union.tree_node** %1, align 8
  %10 = bitcast %union.tree_node* %9 to %struct.tree_vec*
  %11 = getelementptr inbounds %struct.tree_vec* %10, i32 0, i32 2
  %12 = getelementptr inbounds [1 x %union.tree_node*]* %11, i32 0, i64 1
  store %union.tree_node** %12, %union.tree_node*** %q, align 8
  %13 = load %union.tree_node*** %q, align 8
  store %union.tree_node* @global, %union.tree_node** %13, align 8
  %14 = load i32* %2, align 4
  %15 = sext i32 %14 to i64
  %16 = load %union.tree_node** %1, align 8
  %17 = bitcast %union.tree_node* %16 to %struct.tree_vec*
  %18 = getelementptr inbounds %struct.tree_vec* %17, i32 0, i32 2
  %19 = getelementptr inbounds [1 x %union.tree_node*]* %18, i32 0, i64 %15
  %20 = load %union.tree_node** %19, align 8
...
define i32 @main() #1 {
  ...
  %4 = load %union.tree_node** %p, align 8
