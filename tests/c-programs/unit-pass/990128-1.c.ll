...
; <label>:6                                       ; preds = %3
  ...
  %8 = sext i32 %7 to i64
  %9 = getelementptr inbounds [10 x %struct.s], [10 x %struct.s]* @sss, i32 0, i64 %8
  ...
  %12 = load %struct.s*, %struct.s** %next, align 8
