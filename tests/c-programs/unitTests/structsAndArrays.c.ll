...
define void @foo(%struct.S* %s) #0 {
  ...
  %7 = load %struct.S*, %struct.S** %1, align 8
  ...
  %11 = load %struct.S*, %struct.S** %1, align 8
  %12 = getelementptr inbounds %struct.S, %struct.S* %11, i32 0, i32 2
  %13 = getelementptr inbounds [6 x i32], [6 x i32]* %12, i32 0, i64 0
  ...
  %23 = getelementptr inbounds [6 x i32], [6 x i32]* %22, i32 0, i64 2
  %24 = load i32, i32* %23, align 4
  %25 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i32 %24)
  %26 = load %struct.S*, %struct.S** %1, align 8
  %27 = getelementptr inbounds %struct.S, %struct.S* %26, i32 0, i32 2
  %28 = getelementptr inbounds [6 x i32], [6 x i32]* %27, i32 0, i64 3
  %29 = load i32, i32* %28, align 4
  %30 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i32 %29)
  %31 = load %struct.S*, %struct.S** %1, align 8
  %32 = getelementptr inbounds %struct.S, %struct.S* %31, i32 0, i32 2
  %33 = getelementptr inbounds [6 x i32], [6 x i32]* %32, i32 0, i64 4
  ...
  %38 = getelementptr inbounds [6 x i32], [6 x i32]* %37, i32 0, i64 5
  ...
  %46 = load %struct.S*, %struct.S** %1, align 8
  ...
  %53 = getelementptr inbounds %struct.S, %struct.S* %52, i32 0, i32 3
  ...
  %82 = load %struct.S*, %struct.S** %1, align 8
  ...
  %88 = load %struct.S*, %struct.S** %1, align 8
  ...
  %95 = getelementptr inbounds %struct.S, %struct.S* %2, i32 0, i32 0
  %96 = load %struct.S*, %struct.S** %1, align 8
  %97 = getelementptr inbounds %struct.S, %struct.S* %96, i32 0, i32 1
  %98 = load i32, i32* %97, align 4
  store i32 %98, i32* %95, align 4
  %99 = getelementptr inbounds %struct.S, %struct.S* %2, i32 0, i32 1
  ...
  %103 = getelementptr inbounds %struct.S, %struct.S* %2, i32 0, i32 2
  %104 = bitcast [6 x i32]* %103 to i8*
  call void @llvm.memset.p0i8.i64(i8* %104, i8 0, i64 24, i32 4, i1 false)
  %105 = getelementptr inbounds [6 x i32], [6 x i32]* %103, i64 0, i64 0
  %106 = getelementptr inbounds i32, i32* %105, i64 1
  %107 = getelementptr inbounds i32, i32* %106, i64 1
  %108 = getelementptr inbounds i32, i32* %107, i64 1
  %109 = getelementptr inbounds i32, i32* %108, i64 1
  %110 = getelementptr inbounds i32, i32* %109, i64 1
  %111 = getelementptr inbounds %struct.S, %struct.S* %2, i32 0, i32 3
  %112 = load %struct.S*, %struct.S** %1, align 8
...
define i32 @main() #0 {
  ...
  %6 = getelementptr inbounds %struct.S, %struct.S* %s, i32 0, i32 1
  %7 = load i32, i32* %6, align 4
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i32 %7)
  %9 = getelementptr inbounds %struct.S, %struct.S* %s, i32 0, i32 2
  %10 = getelementptr inbounds [6 x i32], [6 x i32]* %9, i32 0, i64 0
  %11 = load i32, i32* %10, align 4
  %12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i32 %11)
  %13 = getelementptr inbounds %struct.S, %struct.S* %s, i32 0, i32 2
  %14 = getelementptr inbounds [6 x i32], [6 x i32]* %13, i32 0, i64 1
  %15 = load i32, i32* %14, align 4
  %16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i32 %15)
  %17 = getelementptr inbounds %struct.S, %struct.S* %s, i32 0, i32 2
  %18 = getelementptr inbounds [6 x i32], [6 x i32]* %17, i32 0, i64 2
  %19 = load i32, i32* %18, align 4
  %20 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i32 %19)
  %21 = getelementptr inbounds %struct.S, %struct.S* %s, i32 0, i32 2
  %22 = getelementptr inbounds [6 x i32], [6 x i32]* %21, i32 0, i64 3
  %23 = load i32, i32* %22, align 4
  %24 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i32 %23)
  %25 = getelementptr inbounds %struct.S, %struct.S* %s, i32 0, i32 2
  ...
  %29 = getelementptr inbounds %struct.S, %struct.S* %s, i32 0, i32 2
  %30 = getelementptr inbounds [6 x i32], [6 x i32]* %29, i32 0, i64 5
  %31 = load i32, i32* %30, align 4
  %32 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i32 %31)
  %33 = getelementptr inbounds %struct.S, %struct.S* %s, i32 0, i32 3
  ...
  %37 = getelementptr inbounds %struct.S, %struct.S* %s, i32 0, i32 3
  %38 = getelementptr inbounds %struct.T, %struct.T* %37, i32 0, i32 1
  %39 = getelementptr inbounds [8 x i32], [8 x i32]* %38, i32 0, i64 0
  ...
  %44 = getelementptr inbounds [8 x i32], [8 x i32]* %43, i32 0, i64 1
