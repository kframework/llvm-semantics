; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith000055.ll'
...
entry:
  store i32 -1795268810, i32* getelementptr inbounds ([8 x i32]* @g_4, i64 0, i64 6), align 8
  %tmp1 = load i32* getelementptr inbounds ([8 x i32]* @g_4, i64 0, i64 3), align 4
...
entry:
  ...
  %tmp16 = load i32* getelementptr inbounds ([8 x i32]* @g_4, i64 0, i64 6), align 8
  %call17 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str6, i64 0, i64 0), i32 %tmp16) nounwind
  ret i32 0
}
