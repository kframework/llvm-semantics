...
; <label>:5                                       ; preds = %2
  ...
  %7 = sext i32 %6 to i64
  %8 = getelementptr inbounds [256 x i32], [256 x i32]* %x, i32 0, i64 %7
...
; <label>:12                                      ; preds = %2
  %13 = getelementptr inbounds [256 x i32], [256 x i32]* %x, i32 0, i32 0
  call void @f(i32* %13)
  store i32 0, i32* %i, align 4
  br label %14
...
; <label>:17                                      ; preds = %14
  ...
  %20 = getelementptr inbounds [256 x i32], [256 x i32]* %x, i32 0, i64 %19
