...
define void @p1(i32, double, i32, double %d1, i32 %i, double, i64 %l, double %d2) #0 {
  ...
  %31 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str, i32 0, i32 0), i32 %14, i32 %17, i32 %19, i32 %22, i32 %23, i32 %26, i64 %27, i32 %30)
  ret void
}
...
define void @p2(i8 signext %c, float %f1, i16 signext %s, double %d1, i32 %i, float %f2, i64 %l, double %d2) #0 {
  ...
  %27 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str, i32 0, i32 0), i32 %10, i32 %13, i32 %15, i32 %18, i32 %19, i32 %22, i64 %23, i32 %26)
  ret void
}
