; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith000055.c'
...
entry:
  ...
  %tmp = load i32** %l_3, align 8
  store i32 -1795268810, i32* %tmp
  %tmp1 = load i32* getelementptr inbounds ([8 x i32]* @g_4, i32 0, i64 3), align 4
...
entry:
  ...
  %tmp16 = load i32* getelementptr inbounds ([8 x i32]* @g_4, i32 0, i64 6), align 4
  %call17 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str6, i32 0, i32 0), i32 %tmp16)
  %0 = load i32* %retval
  ret i32 %0
}
