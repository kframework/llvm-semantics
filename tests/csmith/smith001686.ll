; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith001686.c'
...
for.body4:                                        ; preds = %for.cond1
  ...
  %arrayidx = getelementptr inbounds [2 x [9 x i32*]]* %l_2, i32 0, i64 %idxprom7
...
for.end13:                                        ; preds = %for.cond
  %arrayidx14 = getelementptr inbounds [2 x [9 x i32*]]* %l_2, i32 0, i64 0
  ...
  %tmp18 = load i32* getelementptr inbounds ([3 x i32]* @g_5, i32 0, i64 1), align 4
...
entry:
  ...
  %tmp = load i32* getelementptr inbounds ([3 x i32]* @g_5, i32 0, i64 0), align 4
  %call1 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str, i32 0, i32 0), i32 %tmp)
  %tmp2 = load i32* getelementptr inbounds ([3 x i32]* @g_5, i32 0, i64 1), align 4
  %call3 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str1, i32 0, i32 0), i32 %tmp2)
  %tmp4 = load i32* getelementptr inbounds ([3 x i32]* @g_5, i32 0, i64 2), align 4
  %call5 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str2, i32 0, i32 0), i32 %tmp4)
  %tmp6 = load i32* getelementptr inbounds ([3 x i32]* @g_5, i32 0, i64 1), align 4
  %call7 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str1, i32 0, i32 0), i32 %tmp6)
  %0 = load i32* %retval
  ret i32 %0
}
