...
; <label>:5                                       ; preds = %2
  ...
  %13 = getelementptr inbounds %struct.list_el* %12, i32 0, i32 1
  store %struct.list_el* %11, %struct.list_el** %13, align 8
  %14 = load %struct.list_el** %curr, align 8
