; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/pr46019.c'
...
for.body:                                         ; preds = %for.cond
  %tmp1 = load i64* %l, align 8
  %tmp2 = load i32* %n, align 4
  %sh_prom = zext i32 %tmp2 to i64
  %shl = shl i64 8589934592, %sh_prom
  %div = udiv i64 %tmp1, %shl
  %tmp3 = load i32* %n, align 4
  %shr = ashr i32 512, %tmp3
  %conv = sext i32 %shr to i64
  %cmp4 = icmp ne i64 %div, %conv
