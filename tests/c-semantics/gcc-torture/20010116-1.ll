...
define void @find(%struct.Data* %first, %struct.Data* %last) #0 {
  ...
  %3 = load %struct.Data** %2, align 8
  %4 = load %struct.Data** %1, align 8
...
define i32 @main() #0 {
  ...
  %1 = getelementptr inbounds [4 x %struct.Data]* %DataList, i32 0, i32 0
  %2 = getelementptr inbounds %struct.Data* %1, i64 0
  %3 = getelementptr inbounds [4 x %struct.Data]* %DataList, i32 0, i32 0
  %4 = getelementptr inbounds %struct.Data* %3, i64 4
