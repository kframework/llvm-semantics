...
define void @die(i64 %arg.coerce) #0 {
  ...
  store i64 %arg.coerce, i64* %1, align 1
...
; <label>:6                                       ; preds = %5
  ...
  %9 = sext i32 %7 to i64
  %10 = getelementptr inbounds [1 x %struct.blah]* %buf, i32 0, i64 %9
...
; <label>:13                                      ; preds = %2
  %14 = getelementptr inbounds [1 x %struct.blah]* %buf, i32 0, i64 0
  %15 = getelementptr inbounds %struct.blah* %14, i32 0, i32 0
