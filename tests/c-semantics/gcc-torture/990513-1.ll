...
define void @foo(i32* %BM_tab, i32 %j) #0 {
  ...
  %5 = getelementptr inbounds i32* %4, i64 256
  store i32* %5, i32** %1, align 8
  br label %6

; <label>:6                                       ; preds = %10, %0
  %7 = load i32** %BM_tab_base, align 8
...
define i32 @main() #0 {
  ...
  %3 = getelementptr inbounds [256 x i32]* %BM_tab, i32 0, i32 0
  call void @foo(i32* %3, i32 6)
  %4 = getelementptr inbounds [256 x i32]* %BM_tab, i32 0, i64 0
