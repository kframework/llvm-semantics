...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = getelementptr inbounds %struct.data* %d, i32 0, i32 2
...
define internal i32 @callback(i8* %d) #0 {
  ...
  %5 = getelementptr inbounds %struct.data* %4, i32 0, i32 2
  %6 = load i32* %5, align 4
  %7 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0), i32 %6)
  %8 = load %struct.data** %iter_data, align 8
  %9 = getelementptr inbounds %struct.data* %8, i32 0, i32 2
