...
define void @foo(i8 %a.coerce) #0 {
  ...
  %1 = getelementptr %struct.A* %a, i32 0, i32 0
  %2 = bitcast [1 x i8]* %1 to i8*
  store i8 %a.coerce, i8* %2, align 1
  %3 = getelementptr inbounds %struct.A* %a, i32 0, i32 0
  %4 = getelementptr inbounds [1 x i8]* %3, i32 0, i64 0
  %5 = load i8* %4, align 1
  %6 = sext i8 %5 to i32
  %7 = icmp ne i32 %6, 97
...
; <label>:5                                       ; preds = %2
  ...
  %7 = sext i32 %6 to i64
  %8 = getelementptr inbounds %struct.A* %a, i32 0, i32 0
  %9 = getelementptr inbounds [1 x i8]* %8, i32 0, i64 %7
...
; <label>:13                                      ; preds = %2
  %14 = getelementptr %struct.A* %a, i32 0, i32 0
