; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/960321-1.ll'
...
entry:
  %tmp1.i = load i8* getelementptr inbounds ([10 x i8]* @a, i64 0, i64 0), align 1
  %cmp = icmp eq i8 %tmp1.i, 100
