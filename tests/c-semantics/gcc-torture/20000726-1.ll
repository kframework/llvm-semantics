...
define void @adjust_xy(i16* %x, i16* %y) #0 {
  ...
  %3 = load i16* getelementptr inbounds (%struct.adjust_template* @adjust, i32 0, i32 0), align 2
  %4 = sext i16 %3 to i32
  %5 = load i16** %1, align 8
  %6 = load i16* %5, align 2
  %7 = sext i16 %6 to i32
  %8 = mul nsw i32 %4, %7
  %9 = load i16* getelementptr inbounds (%struct.adjust_template* @adjust, i32 0, i32 1), align 2
  ...
  %15 = add nsw i32 %8, %14
  %16 = load i16* getelementptr inbounds (%struct.adjust_template* @adjust, i32 0, i32 2), align 2
