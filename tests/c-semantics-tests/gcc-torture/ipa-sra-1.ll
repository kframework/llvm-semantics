; ModuleID = '/home/david/src/c-semantics/tests/gcc-torture/ipa-sra-1.c'
...
if.then:                                          ; preds = %entry
  %1 = load %struct.bovid** %cow.addr, align 8
  %red = getelementptr inbounds %struct.bovid* %1, i32 0, i32 0
  %2 = load float* %red, align 4
