; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20030920-1.c'
...
entry:
  ...
  store i8* %tmp, i8** %c, align 8
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %tmp1 = load i8** %c, align 8
  %tmp2 = load i8* %tmp1
  %tobool = icmp ne i8 %tmp2, 0
  br i1 %tobool, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %tmp3 = load i8** %c, align 8
  %tmp4 = load i8* %tmp3
