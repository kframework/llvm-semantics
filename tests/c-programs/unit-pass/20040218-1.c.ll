...
define i32 @main() #1 {
  ...
  %4 = getelementptr inbounds [2 x i64], [2 x i64]* %y, i32 0, i32 0
  %5 = call i64 @xb(i64* %4)
  %6 = icmp ne i64 %5, 16255
  br i1 %6, label %16, label %7

; <label>:7                                       ; preds = %0
  %8 = getelementptr inbounds [2 x i64], [2 x i64]* %y, i32 0, i32 0
  %9 = call i64 @xw(i64* %8)
  %10 = icmp ne i64 %9, 81535
  br i1 %10, label %16, label %11

; <label>:11                                      ; preds = %7
  %12 = getelementptr inbounds [2 x i16], [2 x i16]* %yw, i32 0, i32 0
