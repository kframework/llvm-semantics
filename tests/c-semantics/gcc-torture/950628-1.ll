...
define i48 @g() #0 {
  ...
  %2 = alloca i48
  %3 = getelementptr inbounds %struct.T* %now, i32 0, i32 0
  store i8 1, i8* %3, align 1
  %4 = getelementptr inbounds %struct.T* %now, i32 0, i32 1
  store i8 2, i8* %4, align 1
  %5 = getelementptr inbounds %struct.T* %now, i32 0, i32 2
  store i8 3, i8* %5, align 1
  %6 = getelementptr inbounds %struct.T* %now, i32 0, i32 3
...
define i48 @f() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %7, i8* %6, i64 6, i32 1, i1 false)
...
define i32 @main() #0 {
  ...
  %13 = getelementptr inbounds %struct.T* %2, i32 0, i32 0
...
; <label>:17                                      ; preds = %0
  ...
  %21 = getelementptr inbounds %struct.T* %4, i32 0, i32 1
...
; <label>:25                                      ; preds = %17
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %28, i8* %27, i64 6, i32 1, i1 false)
  %29 = getelementptr inbounds %struct.T* %6, i32 0, i32 2
...
; <label>:33                                      ; preds = %25
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %36, i8* %35, i64 6, i32 1, i1 false)
  %37 = getelementptr inbounds %struct.T* %8, i32 0, i32 3
