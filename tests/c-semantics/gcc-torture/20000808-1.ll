...
define void @f(i64 %p0.coerce0, i64 %p0.coerce1, i64 %p1.coerce0, i64 %p1.coerce1, i64 %p2.coerce0, i64 %p2.coerce1, %struct.Point* byval align 8 %p3, %struct.Point* byval align 8 %p4, %struct.Point* byval align 8 %p5) #0 {
  ...
  %10 = getelementptr inbounds %struct.Point* %p0, i32 0, i32 0
  %11 = load i64* %10, align 8
  %12 = icmp ne i64 %11, 0
  br i1 %12, label %57, label %13

; <label>:13                                      ; preds = %0
  %14 = getelementptr inbounds %struct.Point* %p0, i32 0, i32 1
  %15 = load i64* %14, align 8
  %16 = icmp ne i64 %15, 1
  br i1 %16, label %57, label %17

; <label>:17                                      ; preds = %13
  %18 = getelementptr inbounds %struct.Point* %p1, i32 0, i32 0
  %19 = load i64* %18, align 8
  %20 = icmp ne i64 %19, -1
  br i1 %20, label %57, label %21

; <label>:21                                      ; preds = %17
  %22 = getelementptr inbounds %struct.Point* %p1, i32 0, i32 1
  %23 = load i64* %22, align 8
  %24 = icmp ne i64 %23, 0
  br i1 %24, label %57, label %25

; <label>:25                                      ; preds = %21
  %26 = getelementptr inbounds %struct.Point* %p2, i32 0, i32 0
  %27 = load i64* %26, align 8
  %28 = icmp ne i64 %27, 1
  br i1 %28, label %57, label %29

; <label>:29                                      ; preds = %25
  %30 = getelementptr inbounds %struct.Point* %p2, i32 0, i32 1
  %31 = load i64* %30, align 8
  %32 = icmp ne i64 %31, -1
  br i1 %32, label %57, label %33

; <label>:33                                      ; preds = %29
  %34 = getelementptr inbounds %struct.Point* %p3, i32 0, i32 0
  %35 = load i64* %34, align 8
  %36 = icmp ne i64 %35, -1
  br i1 %36, label %57, label %37

; <label>:37                                      ; preds = %33
  %38 = getelementptr inbounds %struct.Point* %p3, i32 0, i32 1
  %39 = load i64* %38, align 8
  %40 = icmp ne i64 %39, 1
  br i1 %40, label %57, label %41

; <label>:41                                      ; preds = %37
  %42 = getelementptr inbounds %struct.Point* %p4, i32 0, i32 0
  %43 = load i64* %42, align 8
  %44 = icmp ne i64 %43, 0
  br i1 %44, label %57, label %45

; <label>:45                                      ; preds = %41
  %46 = getelementptr inbounds %struct.Point* %p4, i32 0, i32 1
  %47 = load i64* %46, align 8
  %48 = icmp ne i64 %47, -1
  br i1 %48, label %57, label %49

; <label>:49                                      ; preds = %45
  %50 = getelementptr inbounds %struct.Point* %p5, i32 0, i32 0
  %51 = load i64* %50, align 8
  %52 = icmp ne i64 %51, 1
  br i1 %52, label %57, label %53

; <label>:53                                      ; preds = %49
  %54 = getelementptr inbounds %struct.Point* %p5, i32 0, i32 1
...
define void @foo() #0 {
  ...
  call void @bar()
  %1 = getelementptr inbounds %struct.Point* %p0, i32 0, i32 0
  store i64 0, i64* %1, align 8
  %2 = getelementptr inbounds %struct.Point* %p0, i32 0, i32 1
  store i64 1, i64* %2, align 8
  %3 = getelementptr inbounds %struct.Point* %p1, i32 0, i32 0
  store i64 -1, i64* %3, align 8
  %4 = getelementptr inbounds %struct.Point* %p1, i32 0, i32 1
  store i64 0, i64* %4, align 8
  %5 = getelementptr inbounds %struct.Point* %p2, i32 0, i32 0
  store i64 1, i64* %5, align 8
  %6 = getelementptr inbounds %struct.Point* %p2, i32 0, i32 1
  store i64 -1, i64* %6, align 8
  %7 = getelementptr inbounds %struct.Point* %p3, i32 0, i32 0
  store i64 -1, i64* %7, align 8
  %8 = getelementptr inbounds %struct.Point* %p3, i32 0, i32 1
  store i64 1, i64* %8, align 8
  %9 = getelementptr inbounds %struct.Point* %p4, i32 0, i32 0
  store i64 0, i64* %9, align 8
  %10 = getelementptr inbounds %struct.Point* %p4, i32 0, i32 1
  store i64 -1, i64* %10, align 8
  %11 = getelementptr inbounds %struct.Point* %p5, i32 0, i32 0
  store i64 1, i64* %11, align 8
  %12 = getelementptr inbounds %struct.Point* %p5, i32 0, i32 1
