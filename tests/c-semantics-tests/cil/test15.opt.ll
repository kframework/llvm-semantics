...
entry:
  store i32 2, i32* getelementptr inbounds (%struct.anon* @x, i64 0, i32 1), align 4, !tbaa !0
  store i32 2, i32* getelementptr inbounds (%struct.anon* @x, i64 0, i32 0), align 4, !tbaa !0
  %tobool = icmp eq i32 %argc, 0
  br i1 %tobool, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  store i32 4, i32* getelementptr inbounds (%struct.anon* @x, i64 0, i32 1), align 4, !tbaa !0
  br label %if.end
