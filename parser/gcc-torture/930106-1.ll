; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/930106-1.c'
...
entry:
  ...
  %tmp = load double* %f1, align 8
  %tmp3 = load double* %f2, align 8
  %add = fadd double %tmp, %tmp3
  %tmp4 = load double* %f3, align 8
  %add5 = fadd double %add, %tmp4
