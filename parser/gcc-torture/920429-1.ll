; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/920429-1.c'
...
entry:
  ...
  %tmp = load i8** %p0, align 8
  %call = call i8* @f(i8* %tmp)
  store i8* %call, i8** %p1, align 8
  %tmp1 = load i8** %p0, align 8
  %add.ptr = getelementptr inbounds i8* %tmp1, i64 1
  %tmp2 = load i8** %p1, align 8
  %cmp = icmp ne i8* %add.ptr, %tmp2
