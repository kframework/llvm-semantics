...
; <label>:23                                      ; preds = %18, %12
  ...
  %27 = getelementptr inbounds %struct.s, %struct.s* %va_values, i32 0, i32 0
  %28 = load i32, i32* %27, align 4
  %29 = icmp ne i32 %28, 43690
  br i1 %29, label %34, label %30

; <label>:30                                      ; preds = %23
  %31 = getelementptr inbounds %struct.s, %struct.s* %va_values, i32 0, i32 1
...
; <label>:35                                      ; preds = %30
  %36 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %va, i32 0, i32 0
...
; <label>:57                                      ; preds = %51
  %58 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %va, i32 0, i32 0
...
; <label>:73                                      ; preds = %68, %62
  ...
  %77 = getelementptr inbounds %struct.s, %struct.s* %va_values, i32 0, i32 0
  %78 = load i32, i32* %77, align 4
  %79 = icmp ne i32 %78, 65535
  br i1 %79, label %84, label %80

; <label>:80                                      ; preds = %73
  %81 = getelementptr inbounds %struct.s, %struct.s* %va_values, i32 0, i32 1
...
; <label>:85                                      ; preds = %80
  %86 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %va, i32 0, i32 0
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = getelementptr inbounds %struct.s, %struct.s* %a, i32 0, i32 0
  store i32 43690, i32* %2, align 4
  %3 = getelementptr inbounds %struct.s, %struct.s* %a, i32 0, i32 1
