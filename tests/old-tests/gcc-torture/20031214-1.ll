; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20031214-1.c'
...
cond.false:                                       ; preds = %for.body
  ...
  %arrayidx8 = getelementptr inbounds [2 x i32]* getelementptr inbounds (%struct.anon* @g, i32 0, i32 1), i32 0, i64 %idxprom7
  %tmp9 = load i32* %arrayidx8, align 4
  br label %cond.end

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %tmp5, %cond.true ], [ %tmp9, %cond.false ]
