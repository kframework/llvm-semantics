; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/990531-1.c'
...
entry:
  ...
  %tmp = load i64* %inWord.addr, align 8
  %word = bitcast %union.anon* %data to i64*
  store i64 %tmp, i64* %word, align 8
  %tmp1 = load i32* %reg.addr, align 4
  %idxprom = sext i32 %tmp1 to i64
  %byte = bitcast %union.anon* %data to [4 x i8]*
  %arrayidx = getelementptr inbounds [4 x i8]* %byte, i32 0, i64 %idxprom
  store i8 0, i8* %arrayidx, align 1
  %word2 = bitcast %union.anon* %data to i64*
  %tmp3 = load i64* %word2, align 8
  ret i64 %tmp3
}
