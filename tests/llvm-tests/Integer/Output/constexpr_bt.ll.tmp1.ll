...
@S2c = constant %SType { i33 1, { float, { i8 } } { float 2.000000e+00, { i8 } { i8 3 } }, i64 4 }
@S3c = constant %SAType { i33 1, { [2 x float], i64 } { [2 x float] [float 2.000000e+00, float 3.000000e+00], i64 4 } }
