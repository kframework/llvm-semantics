...
for.cond:                                         ; preds = %if.end16, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc, %if.end16 ]
...
if.end:                                           ; preds = %vaarg.end
  ...
  %tmp31 = load i8* %6, align 1
  %conv5 = sext i8 %tmp31 to i32
...
if.end16:                                         ; preds = %if.end10
  %conv17 = sext i8 %tmp33 to i32
  %add18 = add nsw i32 %i.0, 40
  %cmp19 = icmp eq i32 %conv17, %add18
  %inc = add nsw i32 %i.0, 1
  br i1 %cmp19, label %for.cond, label %if.then21
