...
; <label>:13                                      ; preds = %5
  ...
  %14 = load i32** @metricp, align 8
  store i32 3, i32* %14, align 4
  %15 = load i32* %distance, align 4
  %16 = icmp ne i32 %15, 3
  br i1 %16, label %17, label %27

; <label>:17                                      ; preds = %13
  %18 = load %struct.defs** %1, align 8
  %19 = getelementptr inbounds %struct.defs* %18, i32 0, i32 11
  %20 = load i32* %19, align 4
  %21 = icmp ne i32 %20, 0
  br i1 %21, label %22, label %24

; <label>:22                                      ; preds = %17
  %23 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s88er, i32 0, i32 0), i32 2)
  br label %24
...
; <label>:27                                      ; preds = %24, %13
  %28 = getelementptr inbounds %struct.complex* %z, i32 0, i32 0
  store double 0.000000e+00, double* %28, align 8
  %29 = getelementptr inbounds %struct.complex* %z, i32 0, i32 1
  store double 0.000000e+00, double* %29, align 8
  store %struct.complex* %z, %struct.complex** %zp, align 8
  %30 = load %struct.complex** %zp, align 8
  %31 = getelementptr inbounds %struct.complex* %30, i32 0, i32 0
  store double 1.000000e+00, double* %31, align 8
  %32 = load %struct.complex** %zp, align 8
  %33 = getelementptr inbounds %struct.complex* %32, i32 0, i32 1
  store double 1.000000e+00, double* %33, align 8
  %34 = getelementptr inbounds %struct.complex* %z, i32 0, i32 0
  %35 = load double* %34, align 8
  %36 = getelementptr inbounds %struct.complex* %z, i32 0, i32 1
...
; <label>:40                                      ; preds = %27
  %41 = load %struct.defs** %1, align 8
  %42 = getelementptr inbounds %struct.defs* %41, i32 0, i32 11
  %43 = load i32* %42, align 4
  %44 = icmp ne i32 %43, 0
  br i1 %44, label %45, label %47

; <label>:45                                      ; preds = %40
  %46 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s88er, i32 0, i32 0), i32 4)
  br label %47

; <label>:47                                      ; preds = %45, %40
  %48 = load i32* %rc, align 4
  %49 = add nsw i32 %48, 4
