...
define void @xlate(i8* %in, i32 %phase) #0 {
  ...
  %15 = getelementptr inbounds [3 x i8]* %out, i32 0, i64 0
  ...
  %28 = getelementptr inbounds [3 x i8]* %out, i32 0, i64 1
  ...
  %41 = getelementptr inbounds [3 x i8]* %out, i32 0, i64 2
...
; <label>:42                                      ; preds = %56, %0
  ...
  %46 = getelementptr inbounds [4 x i32]* @nbytes, i32 0, i64 %45
...
; <label>:49                                      ; preds = %42
  ...
  %52 = getelementptr inbounds [3 x i8]* %out, i32 0, i64 %51
...
; <label>:11                                      ; preds = %8
  %12 = getelementptr inbounds [4 x i8]* %in, i32 0, i32 0
  %13 = load i32* %phase, align 4
  call void @xlate(i8* %12, i32 %13)
  br label %41

; <label>:14                                      ; preds = %8
  %15 = load i32* %c, align 4
  %16 = call i8* @strchr(i8* getelementptr inbounds ([65 x i8]* @b64, i32 0, i32 0), i32 %15) #3
...
; <label>:19                                      ; preds = %14
  ...
  %26 = getelementptr inbounds [4 x i8]* %in, i32 0, i64 %25
  store i8 %23, i8* %26, align 1
  %27 = load i32* %phase, align 4
  %28 = add nsw i32 %27, 1
  %29 = srem i32 %28, 4
  store i32 %29, i32* %phase, align 4
  %30 = load i32* %phase, align 4
  %31 = icmp eq i32 %30, 0
  br i1 %31, label %32, label %39

; <label>:32                                      ; preds = %19
  %33 = getelementptr inbounds [4 x i8]* %in, i32 0, i32 0
  %34 = load i32* %phase, align 4
  call void @xlate(i8* %33, i32 %34)
  %35 = getelementptr inbounds [4 x i8]* %in, i32 0, i64 3
  store i8 0, i8* %35, align 1
  %36 = getelementptr inbounds [4 x i8]* %in, i32 0, i64 2
  store i8 0, i8* %36, align 1
  %37 = getelementptr inbounds [4 x i8]* %in, i32 0, i64 1
  store i8 0, i8* %37, align 1
  %38 = getelementptr inbounds [4 x i8]* %in, i32 0, i64 0
