...
; <label>:13                                      ; preds = %10, %7
  ...
  %16 = load %struct.foo*, %struct.foo** %1, align 8
  %17 = getelementptr inbounds %struct.foo, %struct.foo* %16, i32 0, i32 0
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = getelementptr inbounds %struct.foo, %struct.foo* %k, i32 0, i32 0
  store i32 0, i32* %2, align 4
  %3 = getelementptr inbounds %struct.foo, %struct.foo* %k, i32 0, i32 1
