...
; <label>:12                                      ; preds = %8
  ...
  %14 = getelementptr inbounds %struct.__va_list_tag* %13, i32 0, i32 1
  %15 = load i32* %14
...
; <label>:33                                      ; preds = %28
  ...
  %35 = getelementptr inbounds %struct.__va_list_tag* %34, i32 0, i32 1
  %36 = load i32* %35
...
; <label>:54                                      ; preds = %49
  ...
  %56 = getelementptr inbounds %struct.__va_list_tag* %55, i32 0, i32 1
  %57 = load i32* %56
  %58 = icmp ule i32 %57, 160
  br i1 %58, label %59, label %65

; <label>:59                                      ; preds = %54
  %60 = getelementptr inbounds %struct.__va_list_tag* %55, i32 0, i32 3
  %61 = load i8** %60
  %62 = getelementptr i8* %61, i32 %57
...
; <label>:65                                      ; preds = %54
  %66 = getelementptr inbounds %struct.__va_list_tag* %55, i32 0, i32 2
  %67 = load i8** %66
  %68 = bitcast i8* %67 to double*
  %69 = getelementptr i8* %67, i32 8
  store i8* %69, i8** %66
  br label %70
...
; <label>:75                                      ; preds = %70
  %76 = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
  %77 = getelementptr inbounds %struct.__va_list_tag* %76, i32 0, i32 1
  %78 = load i32* %77
...
; <label>:96                                      ; preds = %91
  %97 = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
  %98 = getelementptr inbounds %struct.__va_list_tag* %97, i32 0, i32 1
  %99 = load i32* %98
  %100 = icmp ule i32 %99, 160
  br i1 %100, label %101, label %107

; <label>:101                                     ; preds = %96
  %102 = getelementptr inbounds %struct.__va_list_tag* %97, i32 0, i32 3
  %103 = load i8** %102
  %104 = getelementptr i8* %103, i32 %99
...
; <label>:107                                     ; preds = %96
  %108 = getelementptr inbounds %struct.__va_list_tag* %97, i32 0, i32 2
  %109 = load i8** %108
  %110 = bitcast i8* %109 to double*
  %111 = getelementptr i8* %109, i32 8
  store i8* %111, i8** %108
  br label %112
...
; <label>:117                                     ; preds = %112
  %118 = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
  %119 = getelementptr inbounds %struct.__va_list_tag* %118, i32 0, i32 1
  %120 = load i32* %119
  %121 = icmp ule i32 %120, 160
  br i1 %121, label %122, label %128

; <label>:122                                     ; preds = %117
  %123 = getelementptr inbounds %struct.__va_list_tag* %118, i32 0, i32 3
  %124 = load i8** %123
  %125 = getelementptr i8* %124, i32 %120
...
; <label>:128                                     ; preds = %117
  %129 = getelementptr inbounds %struct.__va_list_tag* %118, i32 0, i32 2
  %130 = load i8** %129
  %131 = bitcast i8* %130 to double*
  %132 = getelementptr i8* %130, i32 8
  store i8* %132, i8** %129
  br label %133
...
; <label>:138                                     ; preds = %133
  %139 = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
  %140 = getelementptr inbounds %struct.__va_list_tag* %139, i32 0, i32 1
  %141 = load i32* %140
  %142 = icmp ule i32 %141, 160
  br i1 %142, label %143, label %149

; <label>:143                                     ; preds = %138
  %144 = getelementptr inbounds %struct.__va_list_tag* %139, i32 0, i32 3
  %145 = load i8** %144
  %146 = getelementptr i8* %145, i32 %141
...
; <label>:149                                     ; preds = %138
  %150 = getelementptr inbounds %struct.__va_list_tag* %139, i32 0, i32 2
  %151 = load i8** %150
  %152 = bitcast i8* %151 to double*
  %153 = getelementptr i8* %151, i32 8
  store i8* %153, i8** %150
  br label %154
...
; <label>:159                                     ; preds = %154
  %160 = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
  %161 = getelementptr inbounds %struct.__va_list_tag* %160, i32 0, i32 1
  %162 = load i32* %161
  %163 = icmp ule i32 %162, 160
  br i1 %163, label %164, label %170

; <label>:164                                     ; preds = %159
  %165 = getelementptr inbounds %struct.__va_list_tag* %160, i32 0, i32 3
  %166 = load i8** %165
  %167 = getelementptr i8* %166, i32 %162
...
; <label>:170                                     ; preds = %159
  %171 = getelementptr inbounds %struct.__va_list_tag* %160, i32 0, i32 2
  %172 = load i8** %171
  %173 = bitcast i8* %172 to double*
  %174 = getelementptr i8* %172, i32 8
  store i8* %174, i8** %171
  br label %175
...
; <label>:180                                     ; preds = %175
  %181 = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
  %182 = getelementptr inbounds %struct.__va_list_tag* %181, i32 0, i32 1
  %183 = load i32* %182
  %184 = icmp ule i32 %183, 160
  br i1 %184, label %185, label %191

; <label>:185                                     ; preds = %180
  %186 = getelementptr inbounds %struct.__va_list_tag* %181, i32 0, i32 3
  %187 = load i8** %186
  %188 = getelementptr i8* %187, i32 %183
...
; <label>:191                                     ; preds = %180
  %192 = getelementptr inbounds %struct.__va_list_tag* %181, i32 0, i32 2
  %193 = load i8** %192
  %194 = bitcast i8* %193 to double*
  %195 = getelementptr i8* %193, i32 8
  store i8* %195, i8** %192
  br label %196
...
; <label>:201                                     ; preds = %196
  %202 = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
