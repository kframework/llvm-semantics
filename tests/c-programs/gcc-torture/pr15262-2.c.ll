...
define i32 @foo(i32* %b.coerce0, float %b.coerce1, %struct.A* %q, float* %h) #0 {
  ...
  %4 = getelementptr { i32*, float }, { i32*, float }* %3, i32 0, i32 0
  store i32* %b.coerce0, i32** %4
  %5 = getelementptr { i32*, float }, { i32*, float }* %3, i32 0, i32 1
  ...
  %10 = getelementptr inbounds %struct.B, %struct.B* %b, i32 0, i32 0
  %11 = load i32*, i32** %10, align 8
  store i32 3, i32* %11, align 4
  %12 = load %struct.A*, %struct.A** %1, align 8
  %13 = getelementptr inbounds %struct.A, %struct.A* %12, i32 0, i32 0
  store i32 2, i32* %13, align 4
  %14 = getelementptr inbounds %struct.B, %struct.B* %b, i32 0, i32 0
...
define i32 @main() #0 {
  ...
  %3 = getelementptr inbounds %struct.B, %struct.B* %b, i32 0, i32 0
  store i32* %2, i32** %3, align 8
  %4 = bitcast %struct.B* %b to { i32*, float }*
  %5 = getelementptr { i32*, float }, { i32*, float }* %4, i32 0, i32 0
  %6 = load i32*, i32** %5, align 1
  %7 = getelementptr { i32*, float }, { i32*, float }* %4, i32 0, i32 1
