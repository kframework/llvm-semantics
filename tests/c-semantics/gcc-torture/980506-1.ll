...
define i32 @main() #0 {
  ...
  %2 = load %struct.decision** %p, align 8
...
; <label>:2                                       ; preds = %8
  %3 = load %struct.decision** %1, align 8
  %4 = getelementptr inbounds %struct.decision* %3, i32 0, i32 0
  store i8 0, i8* %4, align 1
  br label %5

; <label>:5                                       ; preds = %2, %0
  %6 = load %struct.decision** %1, align 8
