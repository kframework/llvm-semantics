; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20041114-1.c'
...
entry:
  ...
  %tmp = load i32* %var.addr, align 4
  %cmp = icmp sle i32 %tmp, 0
  br i1 %cmp, label %if.end, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %entry
  %tmp1 = load i32* %var.addr, align 4
  %sub = sub nsw i32 %tmp1, 1
  %conv = zext i32 %sub to i64
  %cmp2 = icmp ult i64 %conv, 4294967295
...
entry:
  ...
  %tmp = volatile load i32* @v, align 4
  call void @foo(i32 %tmp)
  ret i32 0
}
