...
define i32 @main() #0 {
  ...
  %Ly = alloca i64, align 8
  store i32 0, i32* %1
  %2 = load i8, i8* @cx, align 1
  %3 = zext i8 %2 to i32
  %4 = sdiv i32 %3, 6
  %5 = trunc i32 %4 to i8
  store i8 %5, i8* %cy, align 1
  %6 = load i8, i8* %cy, align 1
  %7 = zext i8 %6 to i32
  %8 = icmp ne i32 %7, 1
...
; <label>:10                                      ; preds = %0
  %11 = load i8, i8* @cx, align 1
  %12 = zext i8 %11 to i32
  %13 = srem i32 %12, 6
  %14 = trunc i32 %13 to i8
  store i8 %14, i8* %cy, align 1
  %15 = load i8, i8* %cy, align 1
...
; <label>:19                                      ; preds = %10
  %20 = load i16, i16* @sx, align 2
  %21 = zext i16 %20 to i32
  %22 = sdiv i32 %21, 6
  %23 = trunc i32 %22 to i16
  store i16 %23, i16* %sy, align 2
  %24 = load i16, i16* %sy, align 2
...
; <label>:28                                      ; preds = %19
  %29 = load i16, i16* @sx, align 2
  %30 = zext i16 %29 to i32
  %31 = srem i32 %30, 6
  %32 = trunc i32 %31 to i16
  store i16 %32, i16* %sy, align 2
  %33 = load i16, i16* %sy, align 2
...
; <label>:49                                      ; preds = %43
  %50 = load i64, i64* @lx, align 8
  %51 = udiv i64 %50, 6
  store i64 %51, i64* %ly, align 8
  %52 = load i64, i64* %ly, align 8
  %53 = icmp ne i64 %52, 4
...
; <label>:55                                      ; preds = %49
  %56 = load i64, i64* @lx, align 8
  %57 = urem i64 %56, 6
  store i64 %57, i64* %ly, align 8
  %58 = load i64, i64* %ly, align 8
  %59 = icmp ne i64 %58, 4
...
; <label>:61                                      ; preds = %55
  %62 = load i64, i64* @Lx, align 8
  %63 = udiv i64 %62, 6
  store i64 %63, i64* %Ly, align 8
  %64 = load i64, i64* %Ly, align 8
  %65 = icmp ne i64 %64, 5
...
; <label>:67                                      ; preds = %61
  %68 = load i64, i64* @Lx, align 8
  %69 = urem i64 %68, 6
  store i64 %69, i64* %Ly, align 8
  %70 = load i64, i64* %Ly, align 8
  %71 = icmp ne i64 %70, 5
