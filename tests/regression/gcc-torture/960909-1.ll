; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/960909-1.c'
...
for.cond:                                         ; preds = %for.inc, %if.end
  ...
  %tmp2 = load i32* %mask, align 4
  %and = and i32 %tmp1, %tmp2
...
for.inc:                                          ; preds = %for.body
  %tmp3 = load i32* %bit, align 4
  %inc = add nsw i32 %tmp3, 1
  store i32 %inc, i32* %bit, align 4
  %tmp4 = load i32* %mask, align 4
  %shl = shl i32 %tmp4, 1
  store i32 %shl, i32* %mask, align 4
  br label %for.cond

for.end:                                          ; preds = %for.cond
  %tmp5 = load i32* %bit, align 4
...
entry:
  ...
  store i32 %x, i32* %x.addr, align 4
  %tmp = load i32* %x.addr, align 4
  %call = call i32 (...)* bitcast (i32 (i32)* @ffs to i32 (...)*)(i32 %tmp)
