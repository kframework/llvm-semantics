; ModuleID = '/home/grosu/celliso2/c-semantics/tests/unitTests/cq-19-s88.ll'
...
while.cond:                                       ; preds = %while.cond, %entry
  ...
  %incdec.ptr43 = getelementptr %struct.defs* %pd0, i64 0, i32 15, i64 %indvar
  %incdec.ptr2 = getelementptr [8 x i8]* @sec.qs88, i64 0, i64 %indvar
  %tmp2 = load i8* %incdec.ptr2, align 1
  store i8 %tmp2, i8* %incdec.ptr43, align 1
  %tobool = icmp eq i8 %tmp2, 0
  %indvar.next = add i64 %indvar, 1
  br i1 %tobool, label %if.end33, label %while.cond
...
entry:
  ...
  %0 = bitcast i32* %distance.i to i8*
  call void @llvm.lifetime.start(i64 -1, i8* %0)
  br label %while.cond.i

while.cond.i:                                     ; preds = %while.cond.i, %entry
  %indvar.i = phi i64 [ %indvar.next.i, %while.cond.i ], [ 0, %entry ]
  %incdec.ptr2.i = getelementptr [8 x i8]* @sec.qs88, i64 0, i64 %indvar.i
  %incdec.ptr43.i = getelementptr %struct.defs* @main.d0, i64 0, i32 15, i64 %indvar.i
  %tmp2.i = load i8* %incdec.ptr2.i, align 1
  store i8 %tmp2.i, i8* %incdec.ptr43.i, align 1
  %tobool.i = icmp eq i8 %tmp2.i, 0
  %indvar.next.i = add i64 %indvar.i, 1
  br i1 %tobool.i, label %sec.exit, label %while.cond.i

sec.exit:                                         ; preds = %while.cond.i
  store i32* %distance.i, i32** @metricp, align 8
...
if.then:                                          ; preds = %sec.exit
  %call5 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds (%struct.defs* @main.d0, i64 0, i32 15, i64 0), i32 0) nounwind
  br label %if.end
