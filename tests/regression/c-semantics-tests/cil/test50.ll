; ModuleID = '/home/david/src/c-semantics/tests/cil/test50.c'
...
entry:
  ...
  %0 = load [20 x i32]** @b, align 8
  %arrayidx = getelementptr inbounds [20 x i32]* %0, i64 1
  %arraydecay = getelementptr inbounds [20 x i32]* %arrayidx, i32 0, i32 0
  store i32* %arraydecay, i32** %c, align 8
