...
%struct.s1 = type { [4 x i8] }
%struct.s2 = type { [4 x i8] }
...
define i32 @f1(i8* %port) #0 {
  ...
  %14 = load %struct.io** @i, align 8
  %15 = getelementptr inbounds %struct.io* %14, i32 0, i32 0
  ...
  %18 = load %struct.io** @i, align 8
  %19 = getelementptr inbounds %struct.io* %18, i32 0, i32 1
...
; <label>:26                                      ; preds = %23
  ...
  %39 = load %struct.io** @i, align 8
  %40 = getelementptr inbounds %struct.io* %39, i32 0, i32 1
...
; <label>:45                                      ; preds = %26
  %46 = load i32* @test_length, align 4
  %47 = mul nsw i32 2170, %46
  %48 = sext i32 %47 to i64
  store i64 %48, i64* %e, align 8
  %49 = load i64* @test_t1, align 8
  %50 = load i64* @test_t0, align 8
  %51 = sub i64 %49, %50
  store i64 %51, i64* %tlen, align 8
  %52 = load i64* %tlen, align 8
  %53 = load i64* %e, align 8
  %54 = sub i64 %52, %53
...
; <label>:62                                      ; preds = %59
  %63 = load i32* @test_length, align 4
  %64 = mul nsw i32 2170, %63
  %65 = sext i32 %64 to i64
  store i64 %65, i64* %e1, align 8
  %66 = load i64* @test_t1, align 8
  %67 = load i64* @test_t0, align 8
  %68 = sub i64 %66, %67
  store i64 %68, i64* %tlen, align 8
  %69 = load i64* %tlen, align 8
  %70 = load i64* %e1, align 8
  %71 = sub i64 %69, %70
...
; <label>:76                                      ; preds = %75, %59
  %77 = load i32* %fail_count, align 4
  %78 = icmp ne i32 %77, 0
...
define void @f0() #0 {
  ...
  %1 = load %struct.io** @i, align 8
  store %struct.io* %1, %struct.io** %iop, align 8
  %2 = load i32* @f0.washere, align 4
  %3 = add nsw i32 %2, 1
...
; <label>:5                                       ; preds = %0
  %6 = load %struct.io** %iop, align 8
  %7 = getelementptr inbounds %struct.io* %6, i32 0, i32 0
...
; <label>:12                                      ; preds = %5
  %13 = load %struct.io** %iop, align 8
  %14 = getelementptr inbounds %struct.io* %13, i32 0, i32 1
...
define void @test() #0 {
  ...
  %3 = getelementptr inbounds %struct.io* %2, i32 0, i32 0
...
; <label>:8                                       ; preds = %0
  %9 = load %struct.io** %iop, align 8
  %10 = getelementptr inbounds %struct.io* %9, i32 0, i32 1
