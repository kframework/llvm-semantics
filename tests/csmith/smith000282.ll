; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith000282.c'
...
for.body:                                         ; preds = %for.cond
  ...
  store i32 -2078589847, i32* %arrayidx, align 4
  br label %for.inc
...
for.inc8:                                         ; No predecessors!
  %tmp9 = volatile load i32* @g_3, align 4
  %add = add nsw i32 %tmp9, 2
  volatile store i32 %add, i32* @g_3, align 4
  br label %for.cond3

for.end10:                                        ; preds = %for.cond3
  %tmp11 = volatile load i32* @g_3, align 4
  %conv12 = sext i32 %tmp11 to i64
  store i64 %conv12, i64* %retval
  br label %return

return:                                           ; preds = %for.end10, %for.body6
  %0 = load i64* %retval
  ret i64 %0
}
