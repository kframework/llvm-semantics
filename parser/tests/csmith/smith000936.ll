; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith000936.c'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64"
target triple = "x86_64-unknown-linux-gnu"

@g_3 = global [9 x i32] [i32 -1, i32 -1, i32 -1, i32 -1, i32 -1, i32 -1, i32 -1, i32 -1, i32 -1], align 16
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [2 x i32*]* %l_2, i32 0, i64 %idxprom
  store i32* getelementptr inbounds ([9 x i32]* @g_3, i32 0, i64 8), i32** %arrayidx, align 8
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  store i32 -1443925292, i32* getelementptr inbounds ([9 x i32]* @g_3, i32 0, i64 8), align 4
  %tmp3 = load i32* getelementptr inbounds ([9 x i32]* @g_3, i32 0, i64 8), align 4
