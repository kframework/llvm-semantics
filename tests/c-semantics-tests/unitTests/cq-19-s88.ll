; ModuleID = '/home/david/src/c-semantics/tests/unitTests/cq-19-s88.c'
...
while.end:                                        ; preds = %while.cond
  ...
  %4 = load i32** @metricp, align 8
  store i32 3, i32* %4, align 4
  %5 = load i32* %distance, align 4
  %cmp = icmp ne i32 %5, 3
...
if.end4:                                          ; preds = %if.end, %while.end
  ...
  %9 = load %struct.complex** %zp, align 8
  %re5 = getelementptr inbounds %struct.complex* %9, i32 0, i32 0
  store double 1.000000e+00, double* %re5, align 8
  %10 = load %struct.complex** %zp, align 8
  %im6 = getelementptr inbounds %struct.complex* %10, i32 0, i32 1
  store double 1.000000e+00, double* %im6, align 8
  %re7 = getelementptr inbounds %struct.complex* %z, i32 0, i32 0
  %11 = load double* %re7, align 8
  %im8 = getelementptr inbounds %struct.complex* %z, i32 0, i32 1
  %12 = load double* %im8, align 8
  %add9 = fadd double %11, %12
  %cmp10 = fcmp une double %add9, 2.000000e+00
  br i1 %cmp10, label %if.then11, label %if.end18

if.then11:                                        ; preds = %if.end4
  %13 = load %struct.defs** %pd0.addr, align 8
  %flgd12 = getelementptr inbounds %struct.defs* %13, i32 0, i32 11
  %14 = load i32* %flgd12, align 4
  %cmp13 = icmp ne i32 %14, 0
  br i1 %cmp13, label %if.then14, label %if.end16

if.then14:                                        ; preds = %if.then11
  %call15 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s88er, i32 0, i32 0), i32 4)
  br label %if.end16

if.end16:                                         ; preds = %if.then14, %if.then11
  %15 = load i32* %rc, align 4
  %add17 = add nsw i32 %15, 4
  store i32 %add17, i32* %rc, align 4
  br label %if.end18

if.end18:                                         ; preds = %if.end16, %if.end4
  %16 = load i32* %rc, align 4
  ret i32 %16
}
