; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith000834.c'
...
for.body:                                         ; preds = %for.cond
  ...
  store i16 -9083, i16* %arrayidx, align 2
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  %arrayidx3 = getelementptr inbounds [9 x i16]* %l_2, i32 0, i64 2
