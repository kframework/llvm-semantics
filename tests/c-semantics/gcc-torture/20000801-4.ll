...
define i32 @foo() #0 {
  ...
  %2 = getelementptr inbounds [2 x i8]* %s, i32 0, i64 1
  %3 = load i8* %2, align 1
  %4 = sext i8 %3 to i32
  %5 = icmp eq i32 0, %4
  %6 = zext i1 %5 to i32
...
define i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* getelementptr inbounds ([2 x i8]* @main.s, i32 0, i32 0), i64 2, i32 1, i1 false)
  %3 = getelementptr inbounds [2 x i8]* %s, i32 0, i32 0
