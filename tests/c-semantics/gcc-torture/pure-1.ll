...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = getelementptr inbounds [10 x i32]* %i, i32 0, i64 0
  store i32 0, i32* %2, align 4
  %3 = call i32 @func0(i32 0) #3
  store i32 %3, i32* %r, align 4
  %4 = getelementptr inbounds [10 x i32]* %i, i32 0, i64 0
...
; <label>:8                                       ; preds = %7, %0
  %9 = getelementptr inbounds [10 x i32]* %i, i32 0, i64 1
  store i32 0, i32* %9, align 4
  %10 = call i32 @func1(i32 0) #4
  store i32 %10, i32* %r, align 4
  %11 = getelementptr inbounds [10 x i32]* %i, i32 0, i64 1
...
; <label>:15                                      ; preds = %14, %8
  %16 = getelementptr inbounds [10 x i32]* %i, i32 0, i64 2
  store i32 0, i32* %16, align 4
  %17 = call i32 @func2(i32 0)
  store i32 %17, i32* %r, align 4
  %18 = getelementptr inbounds [10 x i32]* %i, i32 0, i64 2
...
; <label>:22                                      ; preds = %21, %15
  %23 = getelementptr inbounds [10 x i32]* %i, i32 0, i64 3
  store i32 0, i32* %23, align 4
  %24 = call i32 @func3(i32 0)
  store i32 %24, i32* %r, align 4
  %25 = getelementptr inbounds [10 x i32]* %i, i32 0, i64 3
...
; <label>:29                                      ; preds = %28, %22
  %30 = getelementptr inbounds [10 x i32]* %i, i32 0, i64 4
  store i32 0, i32* %30, align 4
  %31 = call i32 @func4(i32 0)
  store i32 %31, i32* %r, align 4
  %32 = getelementptr inbounds [10 x i32]* %i, i32 0, i64 4
...
; <label>:36                                      ; preds = %35, %29
  %37 = getelementptr inbounds [10 x i32]* %i, i32 0, i64 5
  store i32 0, i32* %37, align 4
  %38 = call i32 @func5(i32 0)
  store i32 %38, i32* %r, align 4
  %39 = getelementptr inbounds [10 x i32]* %i, i32 0, i64 5
...
; <label>:43                                      ; preds = %42, %36
  %44 = getelementptr inbounds [10 x i32]* %i, i32 0, i64 6
  store i32 0, i32* %44, align 4
  %45 = call i32 @func6(i32 0)
  store i32 %45, i32* %r, align 4
  %46 = getelementptr inbounds [10 x i32]* %i, i32 0, i64 6
...
; <label>:50                                      ; preds = %49, %43
  %51 = getelementptr inbounds [10 x i32]* %i, i32 0, i64 7
  store i32 0, i32* %51, align 4
  %52 = call i32 @func7(i32 0)
  store i32 %52, i32* %r, align 4
  %53 = getelementptr inbounds [10 x i32]* %i, i32 0, i64 7
...
attributes #1 = { nounwind readonly uwtable "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-soft-float"="false" }
