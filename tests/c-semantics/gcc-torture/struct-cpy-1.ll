...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  call void @ini()
  %2 = load i32* getelementptr inbounds (%struct.tty_driver* @pty, i32 0, i32 1, i32 0), align 4
  %3 = icmp ne i32 %2, 1
  br i1 %3, label %13, label %4

; <label>:4                                       ; preds = %0
  %5 = load i32* getelementptr inbounds (%struct.tty_driver* @pty, i32 0, i32 1, i32 1), align 4
  %6 = icmp ne i32 %5, 2
  br i1 %6, label %13, label %7

; <label>:7                                       ; preds = %4
  %8 = load i32* getelementptr inbounds (%struct.tty_driver* @pty, i32 0, i32 1, i32 2), align 4
  %9 = icmp ne i32 %8, 3
  br i1 %9, label %13, label %10

; <label>:10                                      ; preds = %7
  %11 = load i32* getelementptr inbounds (%struct.tty_driver* @pty, i32 0, i32 1, i32 3), align 4
  %12 = icmp ne i32 %11, 4
