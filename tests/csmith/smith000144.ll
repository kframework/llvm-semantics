; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith000144.c'
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [10 x i8]* %l_2, i32 0, i64 %idxprom
...
for.body6:                                        ; preds = %for.cond3
  ...
  %arrayidx9 = getelementptr inbounds [4 x i32]* %l_5, i32 0, i64 %idxprom8
...
for.end13:                                        ; preds = %for.cond3
  %arrayidx14 = getelementptr inbounds [10 x i8]* %l_2, i32 0, i64 2
  %tmp15 = load i8* %arrayidx14, align 1
  %conv = zext i8 %tmp15 to i32
  %tmp16 = volatile load i32** @g_3, align 8
  %tmp17 = load i32* %tmp16
  %xor = xor i32 %tmp17, %conv
  store i32 %xor, i32* %tmp16
  %arrayidx18 = getelementptr inbounds [4 x i32]* %l_5, i32 0, i64 0
