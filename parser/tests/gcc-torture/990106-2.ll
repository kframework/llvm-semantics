; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/990106-2.c'
...
entry:
  ...
  %tmp1 = load i32* %mod.addr, align 4
  %div = udiv i32 %tmp, %tmp1
  store i32 %div, i32* %a, align 4
  %tmp2 = load i32* %a, align 4
  %tmp3 = load i32* %mod.addr, align 4
  %mul = mul i32 %tmp2, %tmp3
  %sub = sub i32 0, %mul
  store i32 %sub, i32* %b, align 4
  %tmp4 = load i32* %b, align 4
  %tmp5 = load i32* %mod.addr, align 4
  %cmp = icmp ugt i32 %tmp4, %tmp5
...
if.then:                                          ; preds = %entry
  ...
  %tmp7 = load i32* %mod.addr, align 4
  %tmp8 = load i32* %b, align 4
  %sub9 = sub i32 %tmp8, %tmp7
...
entry:
  ...
  %call = call i32 @calc_mp(i32 %tmp)
  store i32 %call, i32* %y, align 4
  %tmp1 = load i32* %y, align 4
  %cmp = icmp ne i32 %tmp1, 680
  br i1 %cmp, label %if.then, label %if.end
