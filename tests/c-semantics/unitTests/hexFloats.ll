...
define i32 @main() #0 {
  ...
  %26 = load x86_fp80* %x7, align 16
  %27 = fmul x86_fp80 0xK4005C800000000000000, %26
  %28 = fptosi x86_fp80 %27 to i32
  %29 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0), i32 %28)
  %30 = load x86_fp80* %x8, align 16
  %31 = fmul x86_fp80 0xK4005C800000000000000, %30
  %32 = fptosi x86_fp80 %31 to i32
  %33 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0), i32 %32)
  ret i32 0
}
