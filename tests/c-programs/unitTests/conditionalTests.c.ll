...
define i32 @main() #0 {
  ...
  %6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i32 -2147483648)
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i32 -2147483648)
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i32 250)
  %9 = load %struct.S*, %struct.S** %p2, align 8
...
; <label>:17                                      ; preds = %0
  %18 = load %struct.S*, %struct.S** %p2, align 8
...
; <label>:21                                      ; preds = %17, %13
  %22 = getelementptr inbounds %struct.S, %struct.S* %2, i32 0, i32 0
  %23 = load i32, i32* %22, align 4
  %24 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i32 %23)
  %25 = getelementptr inbounds %struct.S, %struct.S* %b, i32 0, i32 0
