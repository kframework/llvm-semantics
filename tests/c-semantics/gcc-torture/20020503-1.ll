...
define i32 @main() #0 {
  ...
  %p = alloca i8*, align 8
  store i32 0, i32* %1
  %2 = getelementptr inbounds [128 x i8]* %buf, i32 0, i32 0
...
define internal i8* @inttostr(i64 %i, i8* %buf) #0 {
  ...
  %4 = load i8** %2, align 8
  %5 = getelementptr inbounds i8* %4, i64 127
