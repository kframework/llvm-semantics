...
@.str.1 = private unnamed_addr constant [23 x i8] c"%d, %ld, %d, %d, %lld\0A\00", align 1
...
define void @printfn(i32 %a, i16 signext %b, double %C, float %D, i8 signext %E, i8 signext %F, i8* %G, double* %H, i32 %I, i64 %J) #0 {
  ...
  %22 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i32 0, i32 0), i32 %11, i32 %13, i32 %16, i32 %19, i32 %21)
  ...
  %34 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i32 0, i32 0), i32 %24, i64 %28, i32 %31, i32 %32, i64 %33)
  ret void
}
