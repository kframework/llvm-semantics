; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/pr20187-1.c'
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %tmp1, %cond.true ], [ 1, %cond.false ]
  %tmp2 = load i32* @a, align 4
  %tmp3 = load i32* @b, align 4
  %mul = mul nsw i32 %tmp2, %tmp3
  %and = and i32 %cond, %mul
  %conv = sext i32 %and to i64
  %conv4 = trunc i64 %conv to i8
