; ModuleID = '/home/grosu/celliso2/c-semantics/tests/unitTests/cq-19-s88.c'
...
@sec.s88er = internal global [10 x i8] c"s88,er%d\0A\00", align 1
@sec.qs88 = internal global [8 x i8] c"s88    \00", align 1
@metricp = common global i32* null, align 8
...
entry:
  ...
  %z = alloca %struct.complex, align 8
  %zp = alloca %struct.complex*, align 8
  store %struct.defs* %pd0, %struct.defs** %pd0.addr, align 8
  store i8* getelementptr inbounds ([8 x i8]* @sec.qs88, i32 0, i32 0), i8** %ps, align 8
  %tmp = load %struct.defs** %pd0.addr, align 8
  %rfs = getelementptr inbounds %struct.defs* %tmp, i32 0, i32 15
  %arraydecay = getelementptr inbounds [8 x i8]* %rfs, i32 0, i32 0
  store i8* %arraydecay, i8** %pt, align 8
...
while.end:                                        ; preds = %while.cond
  store i32* %distance, i32** @metricp, align 8
  store i32 2, i32* %distance, align 4
  %tmp5 = load i32** @metricp, align 8
  store i32 3, i32* %tmp5
  %tmp6 = load i32* %distance, align 4
...
if.then10:                                        ; preds = %if.then
  %call = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s88er, i32 0, i32 0), i32 2)
  br label %if.end

if.end:                                           ; preds = %if.then10, %if.then
  %tmp11 = load i32* %rc, align 4
  %add = add nsw i32 %tmp11, 2
  store i32 %add, i32* %rc, align 4
  br label %if.end12

if.end12:                                         ; preds = %if.end, %while.end
  %re = getelementptr inbounds %struct.complex* %z, i32 0, i32 0
  store double 0.000000e+00, double* %re, align 8
  %im = getelementptr inbounds %struct.complex* %z, i32 0, i32 1
  store double 0.000000e+00, double* %im, align 8
  store %struct.complex* %z, %struct.complex** %zp, align 8
  %tmp13 = load %struct.complex** %zp, align 8
  %re14 = getelementptr inbounds %struct.complex* %tmp13, i32 0, i32 0
  store double 1.000000e+00, double* %re14, align 8
  %tmp15 = load %struct.complex** %zp, align 8
  %im16 = getelementptr inbounds %struct.complex* %tmp15, i32 0, i32 1
  store double 1.000000e+00, double* %im16, align 8
  %re17 = getelementptr inbounds %struct.complex* %z, i32 0, i32 0
  %tmp18 = load double* %re17, align 8
  %im19 = getelementptr inbounds %struct.complex* %z, i32 0, i32 1
  %tmp20 = load double* %im19, align 8
  %add21 = fadd double %tmp18, %tmp20
  %cmp22 = fcmp une double %add21, 2.000000e+00
  br i1 %cmp22, label %if.then23, label %if.end33

if.then23:                                        ; preds = %if.end12
  %tmp24 = load %struct.defs** %pd0.addr, align 8
  %flgd25 = getelementptr inbounds %struct.defs* %tmp24, i32 0, i32 11
  %tmp26 = load i32* %flgd25, align 4
  %cmp27 = icmp ne i32 %tmp26, 0
  br i1 %cmp27, label %if.then28, label %if.end30

if.then28:                                        ; preds = %if.then23
  %call29 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s88er, i32 0, i32 0), i32 4)
  br label %if.end30

if.end30:                                         ; preds = %if.then28, %if.then23
  %tmp31 = load i32* %rc, align 4
  %add32 = add nsw i32 %tmp31, 4
  store i32 %add32, i32* %rc, align 4
  br label %if.end33

if.end33:                                         ; preds = %if.end30, %if.end12
  %tmp34 = load i32* %rc, align 4
  ret i32 %tmp34
}
