...
define i32 @foo_create_got_section(i32* %abfd, %struct.foo_link_info* %info) #0 {
  ...
  %4 = load %struct.foo_link_info*, %struct.foo_link_info** %2, align 8
  %5 = getelementptr inbounds %struct.foo_link_info, %struct.foo_link_info* %4, i32 0, i32 0
  %6 = load %struct.foo_link_hash_table*, %struct.foo_link_hash_table** %5, align 8
  %7 = getelementptr inbounds %struct.foo_link_hash_table, %struct.foo_link_hash_table* %6, i32 0, i32 2
...
define i32* @elf64_ia64_check_relocs(i32* %abfd, %struct.foo_link_info* %info) #0 {
  ...
  %3 = load i32*, i32** %1, align 8
  %4 = load %struct.foo_link_info*, %struct.foo_link_info** %2, align 8
  %5 = load %struct.foo_link_info*, %struct.foo_link_info** %2, align 8
  %6 = getelementptr inbounds %struct.foo_link_info, %struct.foo_link_info* %5, i32 0, i32 0
  %7 = load %struct.foo_link_hash_table*, %struct.foo_link_hash_table** %6, align 8
...
define internal i32* @get_got(i32* %abfd, %struct.foo_link_info* %info, %struct.foo_link_hash_table* %hash) #1 {
  ...
  %5 = load %struct.foo_link_hash_table*, %struct.foo_link_hash_table** %4, align 8
  %6 = getelementptr inbounds %struct.foo_link_hash_table, %struct.foo_link_hash_table* %5, i32 0, i32 2
  %7 = load i32*, i32** %6, align 8
  store i32* %7, i32** %got, align 8
  %8 = load i32*, i32** %got, align 8
  %9 = icmp ne i32* %8, null
  br i1 %9, label %30, label %10

; <label>:10                                      ; preds = %0
  %11 = load %struct.foo_link_hash_table*, %struct.foo_link_hash_table** %4, align 8
  %12 = getelementptr inbounds %struct.foo_link_hash_table, %struct.foo_link_hash_table* %11, i32 0, i32 1
  %13 = load i32*, i32** %12, align 8
  store i32* %13, i32** %dynobj, align 8
  %14 = load i32*, i32** %dynobj, align 8
...
; <label>:16                                      ; preds = %10
  ...
  %18 = load %struct.foo_link_hash_table*, %struct.foo_link_hash_table** %4, align 8
  %19 = getelementptr inbounds %struct.foo_link_hash_table, %struct.foo_link_hash_table* %18, i32 0, i32 1
  store i32* %17, i32** %19, align 8
  br label %20

; <label>:20                                      ; preds = %16, %10
  %21 = load i32*, i32** %dynobj, align 8
  %22 = load %struct.foo_link_info*, %struct.foo_link_info** %3, align 8
...
; <label>:26                                      ; preds = %20
  %27 = load %struct.foo_link_hash_table*, %struct.foo_link_hash_table** %4, align 8
  %28 = getelementptr inbounds %struct.foo_link_hash_table, %struct.foo_link_hash_table* %27, i32 0, i32 2
  %29 = load i32*, i32** %28, align 8
  store i32* %29, i32** %got, align 8
  br label %30

; <label>:30                                      ; preds = %26, %0
  %31 = load i32*, i32** %got, align 8
  store i32* %31, i32** %1
  br label %32
