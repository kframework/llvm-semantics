...
; <label>:5                                       ; preds = %2
  %6 = load i32* %i, align 4
  %7 = sext i32 %6 to i64
  %8 = getelementptr inbounds [288 x i32]* %l, i32 0, i64 %7
...
; <label>:16                                      ; preds = %13
  ...
  %19 = getelementptr inbounds [288 x i32]* %l, i32 0, i64 %18
...
; <label>:27                                      ; preds = %24
  ...
  %30 = getelementptr inbounds [288 x i32]* %l, i32 0, i64 %29
...
; <label>:38                                      ; preds = %35
  ...
  %41 = getelementptr inbounds [288 x i32]* %l, i32 0, i64 %40
...
; <label>:45                                      ; preds = %35
  %46 = getelementptr inbounds [288 x i32]* %l, i32 0, i32 0
