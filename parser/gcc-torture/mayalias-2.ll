; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/mayalias-2.c'
...
entry:
  ...
  %tmp = load %struct.test** %p, align 8
  %x = getelementptr inbounds %struct.test* %tmp, i32 0, i32 0
