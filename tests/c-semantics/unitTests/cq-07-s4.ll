...
; <label>:24                                      ; preds = %19
  ...
  %26 = getelementptr inbounds %struct.defs* %25, i32 0, i32 11
  %27 = load i32* %26, align 4
  %28 = icmp ne i32 %27, 0
  br i1 %28, label %29, label %31

; <label>:29                                      ; preds = %24
  %30 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @sec.s4er, i32 0, i32 0), i32 1)
  br label %31
...
; <label>:46                                      ; preds = %39
  %47 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @sec.s4er, i32 0, i32 0), i32 2)
  br label %48
...
; <label>:50                                      ; preds = %65, %49
  ...
  %53 = load %struct.defs** %1, align 8
  %54 = getelementptr inbounds %struct.defs* %53, i32 0, i32 0
...
; <label>:68                                      ; preds = %50
  %69 = load i32* %mask, align 4
  %70 = icmp ne i32 %69, 1
  br i1 %70, label %74, label %71

; <label>:71                                      ; preds = %68
  %72 = load i32* %target, align 4
  %73 = icmp ne i32 %72, 0
...
; <label>:74                                      ; preds = %71, %68
  ...
  %77 = load %struct.defs** %1, align 8
  %78 = getelementptr inbounds %struct.defs* %77, i32 0, i32 11
  %79 = load i32* %78, align 4
  %80 = icmp ne i32 %79, 0
  br i1 %80, label %81, label %83

; <label>:81                                      ; preds = %74
  %82 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @sec.s4er, i32 0, i32 0), i32 8)
  br label %83
