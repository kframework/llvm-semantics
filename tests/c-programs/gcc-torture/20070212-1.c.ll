...
; <label>:8                                       ; preds = %0
  %9 = load %struct.f*, %struct.f** %3, align 8
  %10 = getelementptr inbounds %struct.f, %struct.f* %9, i32 0, i32 0
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = getelementptr inbounds %struct.f, %struct.f* %f, i32 0, i32 0
  store i32 1, i32* %2, align 4
  %3 = getelementptr inbounds %struct.f, %struct.f* %f, i32 0, i32 0
