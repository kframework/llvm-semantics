...
; <label>:3                                       ; preds = %27, %0
  ...
  %12 = load i64*, i64** @cp, align 8
  store i64 1, i64* %12, align 8
  %13 = load i32, i32* %rs1, align 4
  %14 = zext i32 %13 to i64
  %15 = load i64*, i64** %2, align 8
  %16 = getelementptr inbounds i64, i64* %15, i64 %14
  %17 = load i64, i64* %16, align 8
  %18 = load i32, i32* %rs2, align 4
...
define i32 @main() #0 {
  ...
  store i64 47, i64* getelementptr inbounds ([64 x i64], [64 x i64]* @main.r, i32 0, i64 4), align 8
  store i64 11, i64* getelementptr inbounds ([64 x i64], [64 x i64]* @main.r, i32 0, i64 8), align 8
  call void @bar(i32 67110927, i64* getelementptr inbounds ([64 x i64], [64 x i64]* @main.r, i32 0, i32 0))
