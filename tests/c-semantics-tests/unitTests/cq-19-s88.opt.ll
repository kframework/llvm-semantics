...
entry:
  ...
  %incdec.ptr1.2 = getelementptr inbounds %struct.defs* %pd0, i64 0, i32 15, i64 3
  store i8 56, i8* %incdec.ptr1.1, align 1, !tbaa !0
  %incdec.ptr1.3 = getelementptr inbounds %struct.defs* %pd0, i64 0, i32 15, i64 4
  store i8 32, i8* %incdec.ptr1.2, align 1, !tbaa !0
  %incdec.ptr1.4 = getelementptr inbounds %struct.defs* %pd0, i64 0, i32 15, i64 5
  store i8 32, i8* %incdec.ptr1.3, align 1, !tbaa !0
  ...
  store i8 32, i8* %incdec.ptr1.5, align 1, !tbaa !0
  store i8 0, i8* %incdec.ptr1.6, align 1, !tbaa !0
  store i32* %distance, i32** @metricp, align 8, !tbaa !4
  ret i32 0
}
...
if.end:
  ...
  store i8 56, i8* getelementptr inbounds (%struct.defs* @main.d0, i64 0, i32 15, i64 1), align 1, !tbaa !0
  store i8 56, i8* getelementptr inbounds (%struct.defs* @main.d0, i64 0, i32 15, i64 2), align 2, !tbaa !0
  ...
  store i32* %distance.i, i32** @metricp, align 8, !tbaa !4
  call void @llvm.lifetime.end(i64 -1, i8* %0)
  store i32 0, i32* getelementptr inbounds (%struct.defs* @main.d0, i64 0, i32 13), align 4, !tbaa !2
  %call1 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds (%struct.defs* @main.d0, i64 0, i32 15, i64 0), i32 0) nounwind
  %1 = load i32* getelementptr inbounds (%struct.defs* @main.d0, i64 0, i32 14), align 4
