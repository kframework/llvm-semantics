; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/930713-1.c'
...
entry:
  ...
  store i8 17, i8* %x, align 1
  %tmp = bitcast %struct.T* %retval to i8*
  %tmp1 = bitcast %struct.T* %s1a to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %tmp, i8* %tmp1, i64 1, i32 1, i1 false)
  %coerce.dive2 = getelementptr %struct.T* %retval, i32 0, i32 0
  %0 = load i8* %coerce.dive2
  ret i8 %0
}
...
entry:
  ...
  %coerce.dive1 = getelementptr %struct.T* %s1b, i32 0, i32 0
  store i8 %call, i8* %coerce.dive1
  %x2 = getelementptr inbounds %struct.T* %s1a, i32 0, i32 0
  %tmp = load i8* %x2, align 1
  %conv = sext i8 %tmp to i32
  %cmp = icmp ne i32 %conv, 13
  br i1 %cmp, label %if.then, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %entry
  %x4 = getelementptr inbounds %struct.T* %s1b, i32 0, i32 0
  %tmp5 = load i8* %x4, align 1
  %conv6 = sext i8 %tmp5 to i32
  %cmp7 = icmp ne i32 %conv6, 17
