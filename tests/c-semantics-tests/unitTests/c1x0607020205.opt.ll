; ModuleID = '/home/david/src/c-semantics/tests/unitTests/c1x0607020205.c'
...
entry:
  ...
  %call4 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str2, i64 0, i64 0), i32 20) nounwind
  ret i32 0
}
