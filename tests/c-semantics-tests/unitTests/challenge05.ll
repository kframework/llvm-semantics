; ModuleID = '/home/david/src/c-semantics/tests/unitTests/challenge05.c'
...
entry:
  ...
  %1 = load i32* getelementptr inbounds (%struct.t* @s, i32 0, i32 0)
  ...
  %3 = load i32* getelementptr inbounds (%struct.t* @s, i32 0, i32 0), align 4
  %add = add nsw i32 %2, %3
  ret i32 %add
}
