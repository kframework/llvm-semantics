...
; <label>:15                                      ; preds = %7
  %16 = load i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0), align 1
  %17 = sext i8 %16 to i32
  %18 = load i8* @sec.q, align 1
  %19 = sext i8 %18 to i32
  %20 = icmp ne i32 %17, %19
  br i1 %20, label %21, label %31

; <label>:21                                      ; preds = %15
  %22 = load i32* %rc, align 4
  %23 = add nsw i32 %22, 1
...
; <label>:28                                      ; preds = %21
  %29 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s71er, i32 0, i32 0), i32 1)
  br label %30
...
; <label>:31                                      ; preds = %30, %15
  %32 = getelementptr inbounds [10 x i32]* %x, i32 0, i64 5
  store i32 1942, i32* %32, align 4
  %33 = getelementptr inbounds [10 x i32]* %x, i32 0, i64 5
  %34 = load i32* %33, align 4
  %35 = icmp ne i32 %34, 1942
  br i1 %35, label %43, label %36

; <label>:36                                      ; preds = %31
  %37 = getelementptr inbounds [10 x i32]* %x, i32 0, i64 5
  %38 = load i32* %37, align 4
  %39 = getelementptr inbounds [10 x i32]* %x, i32 0, i32 0
  %40 = getelementptr inbounds i32* %39, i64 5
  %41 = load i32* %40, align 4
  %42 = icmp ne i32 %38, %41
  br i1 %42, label %43, label %53

; <label>:43                                      ; preds = %36, %31
  %44 = load i32* %rc, align 4
  %45 = add nsw i32 %44, 4
  store i32 %45, i32* %rc, align 4
  %46 = load %struct.defs** %1, align 8
  %47 = getelementptr inbounds %struct.defs* %46, i32 0, i32 11
  %48 = load i32* %47, align 4
  %49 = icmp ne i32 %48, 0
  br i1 %49, label %50, label %52

; <label>:50                                      ; preds = %43
  %51 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s71er, i32 0, i32 0), i32 4)
  br label %52
...
; <label>:56                                      ; preds = %53
  %57 = load i32* %rc, align 4
  %58 = add nsw i32 %57, 8
  store i32 %58, i32* %rc, align 4
  %59 = load %struct.defs** %1, align 8
  %60 = getelementptr inbounds %struct.defs* %59, i32 0, i32 11
  %61 = load i32* %60, align 4
  %62 = icmp ne i32 %61, 0
  br i1 %62, label %63, label %65

; <label>:63                                      ; preds = %56
  %64 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s71er, i32 0, i32 0), i32 8)
  br label %65
...
; <label>:75                                      ; preds = %72, %66
  %76 = load i32* %rc, align 4
  %77 = add nsw i32 %76, 16
  store i32 %77, i32* %rc, align 4
  %78 = load %struct.defs** %1, align 8
  %79 = getelementptr inbounds %struct.defs* %78, i32 0, i32 11
  %80 = load i32* %79, align 4
  %81 = icmp ne i32 %80, 0
  br i1 %81, label %82, label %84

; <label>:82                                      ; preds = %75
  %83 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s71er, i32 0, i32 0), i32 16)
  br label %84
...
; <label>:85                                      ; preds = %84, %72
  %86 = load %struct.defs** %1, align 8
  %87 = getelementptr inbounds %struct.defs* %86, i32 0, i32 8
  %88 = load float* %87, align 4
  %89 = load %struct.defs** %1, align 8
  %90 = getelementptr inbounds %struct.defs* %89, i32 0, i32 8
...
; <label>:93                                      ; preds = %85
  ...
  %96 = load %struct.defs** %1, align 8
  %97 = getelementptr inbounds %struct.defs* %96, i32 0, i32 11
  %98 = load i32* %97, align 4
  %99 = icmp ne i32 %98, 0
  br i1 %99, label %100, label %102

; <label>:100                                     ; preds = %93
  %101 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s71er, i32 0, i32 0), i32 32)
  br label %102
...
; <label>:9                                       ; preds = %0
  ...
  %11 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds (%struct.defs* @main.d0, i32 0, i32 15, i32 0), i32 %10)
  br label %12
...
; <label>:15                                      ; preds = %12
  %16 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str2, i32 0, i32 0))
  br label %19

; <label>:17                                      ; preds = %12
  %18 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str3, i32 0, i32 0))
  br label %19
