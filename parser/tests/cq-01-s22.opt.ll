; ModuleID = '/home/grosu/celliso2/c-semantics/tests/unitTests/cq-01-s22.ll'
...
while.cond:                                       ; preds = %while.cond, %entry
  ...
  %incdec.ptr2 = getelementptr [8 x i8]* @sec.qs22, i64 0, i64 %indvar
  %tmp2 = load i8* %incdec.ptr2, align 1
  store i8 %tmp2, i8* %incdec.ptr43, align 1
  %tobool = icmp eq i8 %tmp2, 0
  %indvar.next = add i64 %indvar, 1
  br i1 %tobool, label %if.end31, label %while.cond
...
while.cond.i:                                     ; preds = %while.cond.i, %entry
  ...
  %incdec.ptr2.i = getelementptr [8 x i8]* @sec.qs22, i64 0, i64 %indvar.i
