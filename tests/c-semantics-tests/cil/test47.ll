...
for.cond10:                                       ; preds = %for.inc17, %for.end9
  ...
  %cmp11 = icmp slt i32 %10, 15
  br i1 %cmp11, label %for.body12, label %for.end19

for.body12:                                       ; preds = %for.cond10
  %11 = load i32* %i, align 4
  %idxprom13 = sext i32 %11 to i64
  %12 = load [20 x i32]** @b, align 8
  %arrayidx14 = getelementptr inbounds [20 x i32]* %12, i64 1
  %arrayidx15 = getelementptr inbounds [20 x i32]* %arrayidx14, i32 0, i64 %idxprom13
  %13 = load i32* %arrayidx15, align 4
  %14 = load i32* %sum2, align 4
  %add16 = add nsw i32 %14, %13
  store i32 %add16, i32* %sum2, align 4
  br label %for.inc17
