...
@llvm.global_ctors = appending global [1 x %0] [%0 { i32 65535, void ()* @_GLOBAL__I__Z8mkmatrixii }] ; <[1 x %0]*> [#uses=0]
...
define internal void @_GLOBAL__I__Z8mkmatrixii() {
entry:
...
bb2:                                              ; preds = %bb, %entry
  %iftmp.91.0 = phi i32 [ %3, %bb ], [ 100000, %entry ] ; <i32> [#uses=2]
  %4 = malloc [30 x i32*]                         ; <[30 x i32*]*> [#uses=4]
  br label %bb.us.i

bb.us.i:                                          ; preds = %bb2.bb3_crit_edge.us.i, %bb2
  %i.05.us.i = phi i32 [ 0, %bb2 ], [ %8, %bb2.bb3_crit_edge.us.i ] ; <i32> [#uses=3]
  %tmp81 = mul i32 %i.05.us.i, 30                 ; <i32> [#uses=1]
  %tmp7885 = or i32 %tmp81, 1                     ; <i32> [#uses=1]
  %scevgep9.i = getelementptr [30 x i32*]* %4, i32 0, i32 %i.05.us.i ; <i32**> [#uses=2]
  %5 = malloc [30 x i32]                          ; <[30 x i32]*> [#uses=1]
  %.sub48 = getelementptr inbounds [30 x i32]* %5, i32 0, i32 0 ; <i32*> [#uses=1]
  store i32* %.sub48, i32** %scevgep9.i, align 4
  br label %bb1.us.i

bb1.us.i:                                         ; preds = %bb1.us.i, %bb.us.i
  %j.02.us.i = phi i32 [ 0, %bb.us.i ], [ %7, %bb1.us.i ] ; <i32> [#uses=3]
  %count.01.us.i = add i32 %j.02.us.i, %tmp7885   ; <i32> [#uses=1]
  %6 = load i32** %scevgep9.i, align 4            ; <i32*> [#uses=1]
  %scevgep.i = getelementptr i32* %6, i32 %j.02.us.i ; <i32*> [#uses=1]
  store i32 %count.01.us.i, i32* %scevgep.i, align 4
  %7 = add nsw i32 %j.02.us.i, 1                  ; <i32> [#uses=2]
  %exitcond76 = icmp eq i32 %7, 30                ; <i1> [#uses=1]
  br i1 %exitcond76, label %bb2.bb3_crit_edge.us.i, label %bb1.us.i

bb2.bb3_crit_edge.us.i:                           ; preds = %bb1.us.i
  %8 = add nsw i32 %i.05.us.i, 1                  ; <i32> [#uses=2]
  %exitcond80 = icmp eq i32 %8, 30                ; <i1> [#uses=1]
  br i1 %exitcond80, label %_Z8mkmatrixii.exit, label %bb.us.i

_Z8mkmatrixii.exit:                               ; preds = %bb2.bb3_crit_edge.us.i
  %9 = malloc [30 x i32*]                         ; <[30 x i32*]*> [#uses=4]
  br label %bb.us.i35

bb.us.i35:                                        ; preds = %bb2.bb3_crit_edge.us.i43, %_Z8mkmatrixii.exit
  %i.05.us.i32 = phi i32 [ 0, %_Z8mkmatrixii.exit ], [ %13, %bb2.bb3_crit_edge.us.i43 ] ; <i32> [#uses=3]
  %tmp74 = mul i32 %i.05.us.i32, 30               ; <i32> [#uses=1]
  %tmp7184 = or i32 %tmp74, 1                     ; <i32> [#uses=1]
  %scevgep9.i34 = getelementptr [30 x i32*]* %9, i32 0, i32 %i.05.us.i32 ; <i32**> [#uses=2]
  %10 = malloc [30 x i32]                         ; <[30 x i32]*> [#uses=1]
  %.sub46 = getelementptr inbounds [30 x i32]* %10, i32 0, i32 0 ; <i32*> [#uses=1]
  store i32* %.sub46, i32** %scevgep9.i34, align 4
  br label %bb1.us.i40

bb1.us.i40:                                       ; preds = %bb1.us.i40, %bb.us.i35
  %j.02.us.i36 = phi i32 [ 0, %bb.us.i35 ], [ %12, %bb1.us.i40 ] ; <i32> [#uses=3]
  %count.01.us.i37 = add i32 %j.02.us.i36, %tmp7184 ; <i32> [#uses=1]
  %11 = load i32** %scevgep9.i34, align 4         ; <i32*> [#uses=1]
  %scevgep.i38 = getelementptr i32* %11, i32 %j.02.us.i36 ; <i32*> [#uses=1]
  store i32 %count.01.us.i37, i32* %scevgep.i38, align 4
  %12 = add nsw i32 %j.02.us.i36, 1               ; <i32> [#uses=2]
  %exitcond69 = icmp eq i32 %12, 30               ; <i1> [#uses=1]
  br i1 %exitcond69, label %bb2.bb3_crit_edge.us.i43, label %bb1.us.i40

bb2.bb3_crit_edge.us.i43:                         ; preds = %bb1.us.i40
  %13 = add nsw i32 %i.05.us.i32, 1               ; <i32> [#uses=2]
  %exitcond73 = icmp eq i32 %13, 30               ; <i1> [#uses=1]
  br i1 %exitcond73, label %_Z8mkmatrixii.exit44, label %bb.us.i35

_Z8mkmatrixii.exit44:                             ; preds = %bb2.bb3_crit_edge.us.i43
  %14 = malloc [30 x i32*]                        ; <[30 x i32*]*> [#uses=8]
  br label %bb.us.i22

bb.us.i22:                                        ; preds = %bb2.bb3_crit_edge.us.i30, %_Z8mkmatrixii.exit44
  %i.05.us.i19 = phi i32 [ 0, %_Z8mkmatrixii.exit44 ], [ %18, %bb2.bb3_crit_edge.us.i30 ] ; <i32> [#uses=3]
  %tmp67 = mul i32 %i.05.us.i19, 30               ; <i32> [#uses=1]
  %tmp6483 = or i32 %tmp67, 1                     ; <i32> [#uses=1]
  %scevgep9.i21 = getelementptr [30 x i32*]* %14, i32 0, i32 %i.05.us.i19 ; <i32**> [#uses=2]
  %15 = malloc [30 x i32]                         ; <[30 x i32]*> [#uses=1]
  %.sub = getelementptr inbounds [30 x i32]* %15, i32 0, i32 0 ; <i32*> [#uses=1]
  store i32* %.sub, i32** %scevgep9.i21, align 4
  br label %bb1.us.i27

bb1.us.i27:                                       ; preds = %bb1.us.i27, %bb.us.i22
  %j.02.us.i23 = phi i32 [ 0, %bb.us.i22 ], [ %17, %bb1.us.i27 ] ; <i32> [#uses=3]
  %count.01.us.i24 = add i32 %j.02.us.i23, %tmp6483 ; <i32> [#uses=1]
  %16 = load i32** %scevgep9.i21, align 4         ; <i32*> [#uses=1]
  %scevgep.i25 = getelementptr i32* %16, i32 %j.02.us.i23 ; <i32*> [#uses=1]
  store i32 %count.01.us.i24, i32* %scevgep.i25, align 4
  %17 = add nsw i32 %j.02.us.i23, 1               ; <i32> [#uses=2]
  %exitcond62 = icmp eq i32 %17, 30               ; <i1> [#uses=1]
  br i1 %exitcond62, label %bb2.bb3_crit_edge.us.i30, label %bb1.us.i27

bb2.bb3_crit_edge.us.i30:                         ; preds = %bb1.us.i27
  %18 = add nsw i32 %i.05.us.i19, 1               ; <i32> [#uses=2]
  %exitcond66 = icmp eq i32 %18, 30               ; <i1> [#uses=1]
  br i1 %exitcond66, label %bb4.loopexit, label %bb.us.i22

bb3.preheader.us.i:                               ; preds = %bb5.preheader.i, %bb3.bb4_crit_edge.us.i
  %j.04.us.i = phi i32 [ 0, %bb5.preheader.i ], [ %27, %bb3.bb4_crit_edge.us.i ] ; <i32> [#uses=3]
  %19 = load i32** %scevgep15.i, align 4          ; <i32*> [#uses=1]
  br label %bb2.us.i

bb2.us.i:                                         ; preds = %bb2.us.i, %bb3.preheader.us.i
  %k.02.us.i = phi i32 [ 0, %bb3.preheader.us.i ], [ %25, %bb2.us.i ] ; <i32> [#uses=3]
  %val.01.us.i = phi i32 [ 0, %bb3.preheader.us.i ], [ %24, %bb2.us.i ] ; <i32> [#uses=1]
  %scevgep.i17 = getelementptr [30 x i32*]* %9, i32 0, i32 %k.02.us.i ; <i32**> [#uses=1]
  %scevgep8.i = getelementptr i32* %19, i32 %k.02.us.i ; <i32*> [#uses=1]
  %20 = load i32* %scevgep8.i, align 4            ; <i32> [#uses=1]
  %21 = load i32** %scevgep.i17, align 4          ; <i32*> [#uses=1]
  %scevgep10.i = getelementptr i32* %21, i32 %j.04.us.i ; <i32*> [#uses=1]
  %22 = load i32* %scevgep10.i, align 4           ; <i32> [#uses=1]
  %23 = mul i32 %22, %20                          ; <i32> [#uses=1]
  %24 = add nsw i32 %23, %val.01.us.i             ; <i32> [#uses=2]
  %25 = add nsw i32 %k.02.us.i, 1                 ; <i32> [#uses=2]
  %exitcond58 = icmp eq i32 %25, 30               ; <i1> [#uses=1]
  br i1 %exitcond58, label %bb3.bb4_crit_edge.us.i, label %bb2.us.i

bb3.bb4_crit_edge.us.i:                           ; preds = %bb2.us.i
  %26 = load i32** %scevgep16.i, align 4          ; <i32*> [#uses=1]
  %scevgep11.i = getelementptr i32* %26, i32 %j.04.us.i ; <i32*> [#uses=1]
  store i32 %24, i32* %scevgep11.i, align 4
  %27 = add nsw i32 %j.04.us.i, 1                 ; <i32> [#uses=2]
  %exitcond59 = icmp eq i32 %27, 30               ; <i1> [#uses=1]
  br i1 %exitcond59, label %bb6.i, label %bb3.preheader.us.i

bb6.i:                                            ; preds = %bb3.bb4_crit_edge.us.i
  %28 = add i32 %i.06.i, 1                        ; <i32> [#uses=2]
  %exitcond60 = icmp eq i32 %28, 30               ; <i1> [#uses=1]
  br i1 %exitcond60, label %_Z5mmultiiPPiS0_S0_.exit, label %bb5.preheader.i

bb5.preheader.i:                                  ; preds = %bb5.preheader.i.preheader, %bb6.i
  %i.06.i = phi i32 [ 0, %bb5.preheader.i.preheader ], [ %28, %bb6.i ] ; <i32> [#uses=3]
  %scevgep15.i = getelementptr [30 x i32*]* %4, i32 0, i32 %i.06.i ; <i32**> [#uses=1]
  %scevgep16.i = getelementptr [30 x i32*]* %14, i32 0, i32 %i.06.i ; <i32**> [#uses=1]
  br label %bb3.preheader.us.i

_Z5mmultiiPPiS0_S0_.exit:                         ; preds = %bb6.i
  %29 = add i32 %i.050, 1                         ; <i32> [#uses=2]
  %exitcond61 = icmp eq i32 %29, %iftmp.91.0      ; <i1> [#uses=1]
  br i1 %exitcond61, label %bb5, label %bb5.preheader.i.preheader

bb4.loopexit:                                     ; preds = %bb2.bb3_crit_edge.us.i30
  %.sub45 = getelementptr inbounds [30 x i32*]* %14, i32 0, i32 0 ; <i32**> [#uses=1]
  %30 = icmp sgt i32 %iftmp.91.0, 0               ; <i1> [#uses=1]
  br i1 %30, label %bb5.preheader.i.preheader, label %bb5

bb5.preheader.i.preheader:                        ; preds = %bb4.loopexit, %_Z5mmultiiPPiS0_S0_.exit
  %i.050 = phi i32 [ %29, %_Z5mmultiiPPiS0_S0_.exit ], [ 0, %bb4.loopexit ] ; <i32> [#uses=1]
  br label %bb5.preheader.i

bb5:                                              ; preds = %bb4.loopexit, %_Z5mmultiiPPiS0_S0_.exit
  %31 = getelementptr inbounds [30 x i32*]* %14, i32 0, i32 4 ; <i32**> [#uses=1]
  %32 = load i32** %31, align 4                   ; <i32*> [#uses=1]
  %33 = getelementptr inbounds i32* %32, i32 4    ; <i32*> [#uses=1]
  %34 = load i32* %33, align 4                    ; <i32> [#uses=1]
  %35 = getelementptr inbounds [30 x i32*]* %14, i32 0, i32 3 ; <i32**> [#uses=1]
  %36 = load i32** %35, align 4                   ; <i32*> [#uses=1]
  %37 = getelementptr inbounds i32* %36, i32 2    ; <i32*> [#uses=1]
  %38 = load i32* %37, align 4                    ; <i32> [#uses=1]
  %39 = getelementptr inbounds [30 x i32*]* %14, i32 0, i32 2 ; <i32**> [#uses=1]
  %40 = load i32** %39, align 4                   ; <i32*> [#uses=1]
  %41 = getelementptr inbounds i32* %40, i32 3    ; <i32*> [#uses=1]
  %42 = load i32* %41, align 4                    ; <i32> [#uses=1]
  %43 = load i32** %.sub45, align 4               ; <i32*> [#uses=1]
  %44 = load i32* %43, align 4                    ; <i32> [#uses=1]
  tail call fastcc void @_ZNSo9_M_insertIlEERSoT_(i32 %44)
  tail call fastcc void @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_i()
  tail call fastcc void @_ZNSo9_M_insertIlEERSoT_(i32 %42)
  tail call fastcc void @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_i()
  tail call fastcc void @_ZNSo9_M_insertIlEERSoT_(i32 %38)
  tail call fastcc void @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_i()
  tail call fastcc void @_ZNSo9_M_insertIlEERSoT_(i32 %34)
  ...
  %.idx.val = load %"struct.std::ctype<char>"** %.idx ; <%"struct.std::ctype<char>"*> [#uses=1]
  %51 = tail call fastcc signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(%"struct.std::ctype<char>"* %.idx.val, i8 signext 10) ; <i8> [#uses=3]
...
bb9.i.i.i.i:                                      ; preds = %bb8.i.i.i.i, %bb.i.i.i.i, %bb5
  %66 = phi i32 (...)** [ %.pre.i.i.i.i, %bb8.i.i.i.i ], [ %54, %bb5 ], [ %54, %bb.i.i.i.i ] ; <i32 (...)**> [#uses=1]
...
bb.i15:                                           ; preds = %bb.i15, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit
  %indvar.i10 = phi i32 [ 0, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit ], [ %indvar.next.i13, %bb.i15 ] ; <i32> [#uses=2]
  %tmp57 = sub i32 29, %indvar.i10                ; <i32> [#uses=1]
  %scevgep.i12 = getelementptr [30 x i32*]* %4, i32 0, i32 %tmp57 ; <i32**> [#uses=1]
  %133 = load i32** %scevgep.i12, align 4         ; <i32*> [#uses=1]
  free i32* %133
  %indvar.next.i13 = add i32 %indvar.i10, 1       ; <i32> [#uses=2]
  %exitcond55 = icmp eq i32 %indvar.next.i13, 30  ; <i1> [#uses=1]
  br i1 %exitcond55, label %_Z10freematrixiPPi.exit16, label %bb.i15

_Z10freematrixiPPi.exit16:                        ; preds = %bb.i15
  free [30 x i32*]* %4
  br label %bb.i8

bb.i8:                                            ; preds = %bb.i8, %_Z10freematrixiPPi.exit16
  %indvar.i3 = phi i32 [ 0, %_Z10freematrixiPPi.exit16 ], [ %indvar.next.i6, %bb.i8 ] ; <i32> [#uses=2]
  %tmp54 = sub i32 29, %indvar.i3                 ; <i32> [#uses=1]
  %scevgep.i5 = getelementptr [30 x i32*]* %9, i32 0, i32 %tmp54 ; <i32**> [#uses=1]
  %134 = load i32** %scevgep.i5, align 4          ; <i32*> [#uses=1]
  free i32* %134
  %indvar.next.i6 = add i32 %indvar.i3, 1         ; <i32> [#uses=2]
  %exitcond52 = icmp eq i32 %indvar.next.i6, 30   ; <i1> [#uses=1]
  br i1 %exitcond52, label %_Z10freematrixiPPi.exit9, label %bb.i8

_Z10freematrixiPPi.exit9:                         ; preds = %bb.i8
  free [30 x i32*]* %9
  br label %bb.i

bb.i:                                             ; preds = %bb.i, %_Z10freematrixiPPi.exit9
  %indvar.i = phi i32 [ 0, %_Z10freematrixiPPi.exit9 ], [ %indvar.next.i, %bb.i ] ; <i32> [#uses=2]
  %tmp51 = sub i32 29, %indvar.i                  ; <i32> [#uses=1]
  %scevgep.i1 = getelementptr [30 x i32*]* %14, i32 0, i32 %tmp51 ; <i32**> [#uses=1]
  %135 = load i32** %scevgep.i1, align 4          ; <i32*> [#uses=1]
  free i32* %135
  %indvar.next.i = add i32 %indvar.i, 1           ; <i32> [#uses=2]
  %exitcond = icmp eq i32 %indvar.next.i, 30      ; <i1> [#uses=1]
  br i1 %exitcond, label %_Z10freematrixiPPi.exit, label %bb.i

_Z10freematrixiPPi.exit:                          ; preds = %bb.i
  free [30 x i32*]* %14
  ret i32 0
}
