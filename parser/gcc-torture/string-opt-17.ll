; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/string-opt-17.c'
...
entry:
  ...
  %tmp1 = load i64* %i.addr, align 8
  %inc = add i64 %tmp1, 1
  store i64 %inc, i64* %i.addr, align 8
  %add.ptr = getelementptr inbounds i8* getelementptr inbounds ([10 x i8]* @.str, i32 0, i32 0), i64 %tmp1
  %call = call i8* @strcpy(i8* %tmp, i8* %add.ptr)
  %tmp2 = load i64* %i.addr, align 8
  ret i64 %tmp2
}
...
if.end:                                           ; preds = %entry
  %tmp1 = load i64* @check2.r, align 8
  %inc = add i64 %tmp1, 1
...
entry:
  ...
  %call1 = call i8* @strcpy(i8* %tmp, i8* %add.ptr)
  ret void
}
