; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20030914-1.c'
...
for.body:                                         ; preds = %for.cond
  ...
  %tmp3 = load x86_fp80* %pc.addr, align 16
  %add = fadd x86_fp80 %tmp3, %conv
...
for.end:                                          ; preds = %for.cond
  %tmp5 = load x86_fp80* %pc.addr, align 16
  ret x86_fp80 %tmp5
}
...
for.end:                                          ; preds = %for.cond
  ...
  %cmp4 = fcmp une x86_fp80 %call, 0xK400C9E60000000000000
