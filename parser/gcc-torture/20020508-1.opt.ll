; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20020508-1.ll'
...
if.end33:                                         ; preds = %if.end17
  ...
  %cmp41 = icmp eq i32 %or40, 253972259
...
if.end44:                                         ; preds = %if.end33
  ...
  %cmp55 = icmp eq i32 %or54, 1073745699
...
if.end58:                                         ; preds = %if.end44
  ...
  %cmp64 = icmp eq i32 %or63, 1073745699
...
if.end67:                                         ; preds = %if.end58
  ...
  %cmp78 = icmp eq i64 %or77, -9223372036600806041
...
if.end81:                                         ; preds = %if.end67
  ...
  %cmp87 = icmp eq i64 %or86, -9223372036600806041
...
if.end90:                                         ; preds = %if.end81
  ...
  %cmp101 = icmp eq i64 %or100, 68174490360335855
...
if.end104:                                        ; preds = %if.end90
  ...
  %cmp110 = icmp eq i64 %or109, 68174490360335855
...
if.end113:                                        ; preds = %if.end104
  ...
  %cmp124 = icmp eq i64 %or123, -994074541463572736
...
if.end127:                                        ; preds = %if.end113
  ...
  %cmp133 = icmp eq i64 %or132, -994074541463572736
...
if.end163:                                        ; preds = %if.end152
  ...
  %cmp176 = icmp eq i32 %or175, 992079
...
if.end179:                                        ; preds = %if.end163
  ...
  %cmp187 = icmp eq i32 %or186, 992079
...
if.end190:                                        ; preds = %if.end179
  ...
  %cmp201 = icmp eq i32 %or200, 992064
...
if.end204:                                        ; preds = %if.end190
  ...
  %cmp210 = icmp eq i32 %or209, 992064
...
if.end213:                                        ; preds = %if.end204
  ...
  %cmp224 = icmp eq i64 %or223, 65016260480
...
if.end227:                                        ; preds = %if.end213
  ...
  %cmp233 = icmp eq i64 %or232, 65016260480
...
if.end236:                                        ; preds = %if.end227
  ...
  %cmp247 = icmp eq i64 %or246, -994074541463572736
...
if.end250:                                        ; preds = %if.end236
  ...
  %cmp256 = icmp eq i64 %or255, -994074541463572736
...
if.end259:                                        ; preds = %if.end250
  ...
  %cmp270 = icmp eq i64 %or269, 68174490360335855
...
if.end273:                                        ; preds = %if.end259
  ...
  %cmp279 = icmp eq i64 %or278, 68174490360335855
