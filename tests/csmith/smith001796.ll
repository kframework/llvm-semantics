; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith001796.c'
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [1 x i32**]* %l_3, i32 0, i64 %idxprom
  store i32** %l_4, i32*** %arrayidx, align 8
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  volatile store i32* null, i32** getelementptr inbounds ([1 x i32*]* @g_6, i32 0, i64 0), align 8
