...
define i32 @main(i32 %argc, i8** %argv) #0 {
  ...
  %6 = getelementptr [5 x i8*]* %5, i32 0, i32 0
  store i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0), i8** %6
  %7 = getelementptr [5 x i8*]* %5, i32 0, i32 1
  store i8* getelementptr inbounds ([2 x i8]* @.str1, i32 0, i32 0), i8** %7
  %8 = getelementptr [5 x i8*]* %5, i32 0, i32 2
  store i8* getelementptr inbounds ([2 x i8]* @.str2, i32 0, i32 0), i8** %8
  %9 = getelementptr [5 x i8*]* %5, i32 0, i32 3
  store i8* getelementptr inbounds ([2 x i8]* @.str3, i32 0, i32 0), i8** %9
  %10 = getelementptr [5 x i8*]* %5, i32 0, i32 4
  store i8* getelementptr inbounds ([2 x i8]* @.str4, i32 0, i32 0), i8** %10
  %11 = getelementptr inbounds [5 x i8*]* %args, i32 0, i32 0
...
define i8* @s(i8* %v, i8** %pp) #0 {
  ...
  %3 = load i8** %1, align 8
  %4 = call i32 @strcmp(i8* %3, i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0)) #5
  %5 = icmp ne i32 %4, 0
...
define i32 @r(i8* %f) #0 {
  ...
  %3 = load i8* %2, align 1
  %4 = sext i8 %3 to i32
  %5 = load i8* getelementptr inbounds ([2 x i8]* @r.c, i32 0, i32 0), align 1
  %6 = sext i8 %5 to i32
  %7 = icmp ne i32 %4, %6
...
; <label>:8                                       ; preds = %0
  ...
  %13 = load i8* getelementptr inbounds ([2 x i8]* @r.c, i32 0, i64 1), align 1
  %14 = sext i8 %13 to i32
  %15 = icmp ne i32 %12, %14
  br i1 %15, label %19, label %16

; <label>:16                                      ; preds = %8
  %17 = load i32* @r.cnt, align 4
...
; <label>:20                                      ; preds = %16
  %21 = load i8* getelementptr inbounds ([2 x i8]* @r.c, i32 0, i64 0), align 1
  %22 = add i8 %21, 1
  store i8 %22, i8* getelementptr inbounds ([2 x i8]* @r.c, i32 0, i64 0), align 1
  %23 = load i32* @r.cnt, align 4
  %24 = add nsw i32 %23, 1
