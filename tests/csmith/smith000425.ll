; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith000425.c'
...
entry:
  ...
  %tmp = load i32** %l_5, align 8
  %tmp1 = load i32** %l_5, align 8
  %tmp2 = load i32* %tmp1
  %call = call i32* @func_2(i32* %tmp, i32 %tmp2)
  store i32* %call, i32** @g_7, align 8
...
entry:
  ...
  %tmp = load i32** %p_3.addr, align 8
  %tmp1 = load i32* %tmp
  %tmp2 = load i32** %p_3.addr, align 8
  store i32 %tmp1, i32* %tmp2
  %tmp3 = load i32** %p_3.addr, align 8
  ret i32* %tmp3
}
