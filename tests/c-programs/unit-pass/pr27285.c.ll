...
define void @foo(%struct.S* %x, %struct.S* %y) #0 {
  ...
  %8 = getelementptr inbounds %struct.S, %struct.S* %7, i32 0, i32 3
  ...
  %12 = getelementptr inbounds [16 x i8], [16 x i8]* %11, i32 0, i32 0
...
define i32 @main() #1 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* getelementptr inbounds (%struct.S, %struct.S* @main.x, i32 0, i32 0), i64 19, i32 1, i1 false)
  ...
  %4 = getelementptr inbounds %struct.S, %struct.S* %x, i32 0, i32 3
  %5 = getelementptr inbounds [16 x i8], [16 x i8]* %4, i32 0, i64 0
  %6 = load i8, i8* %5, align 1
  %7 = zext i8 %6 to i32
  %8 = getelementptr inbounds %struct.S, %struct.S* %y, i32 0, i32 3
  %9 = getelementptr inbounds [16 x i8], [16 x i8]* %8, i32 0, i64 0
...
; <label>:13                                      ; preds = %0
  %14 = getelementptr inbounds %struct.S, %struct.S* %x, i32 0, i32 3
  %15 = getelementptr inbounds [16 x i8], [16 x i8]* %14, i32 0, i64 1
  %16 = load i8, i8* %15, align 1
  %17 = zext i8 %16 to i32
  %18 = getelementptr inbounds %struct.S, %struct.S* %y, i32 0, i32 3
  %19 = getelementptr inbounds [16 x i8], [16 x i8]* %18, i32 0, i64 1
...
; <label>:23                                      ; preds = %13
  %24 = getelementptr inbounds %struct.S, %struct.S* %x, i32 0, i32 3
  %25 = getelementptr inbounds [16 x i8], [16 x i8]* %24, i32 0, i64 2
  %26 = load i8, i8* %25, align 1
  %27 = zext i8 %26 to i32
  %28 = getelementptr inbounds %struct.S, %struct.S* %y, i32 0, i32 3
  %29 = getelementptr inbounds [16 x i8], [16 x i8]* %28, i32 0, i64 2
...
; <label>:33                                      ; preds = %23
  %34 = getelementptr inbounds %struct.S, %struct.S* %x, i32 0, i32 3
  %35 = getelementptr inbounds [16 x i8], [16 x i8]* %34, i32 0, i64 3
  %36 = load i8, i8* %35, align 1
  %37 = zext i8 %36 to i32
  %38 = and i32 %37, 128
  %39 = getelementptr inbounds %struct.S, %struct.S* %y, i32 0, i32 3
  %40 = getelementptr inbounds [16 x i8], [16 x i8]* %39, i32 0, i64 3
