...
define void @f(i32 %n, ...) #0 {
  ...
  %4 = getelementptr inbounds [1 x %struct.__va_list_tag]* %args, i32 0, i32 0
...
; <label>:24                                      ; preds = %19
  %25 = getelementptr inbounds [1 x %struct.__va_list_tag]* %args, i32 0, i32 0
...
; <label>:45                                      ; preds = %40
  %46 = getelementptr inbounds [1 x %struct.__va_list_tag]* %args, i32 0, i32 0
...
; <label>:66                                      ; preds = %61
  %67 = getelementptr inbounds [1 x %struct.__va_list_tag]* %args, i32 0, i32 0
  %68 = getelementptr inbounds %struct.__va_list_tag* %67, i32 0, i32 2
  %69 = load i8** %68
  %70 = getelementptr i8* %69, i64 15
  %71 = ptrtoint i8* %70 to i64
  %72 = and i64 %71, -16
  %73 = inttoptr i64 %72 to i8*
  %74 = bitcast i8* %73 to x86_fp80*
  %75 = getelementptr i8* %73, i32 16
  store i8* %75, i8** %68
  %76 = load x86_fp80* %74
...
; <label>:79                                      ; preds = %66
  %80 = getelementptr inbounds [1 x %struct.__va_list_tag]* %args, i32 0, i32 0
  %81 = getelementptr inbounds %struct.__va_list_tag* %80, i32 0, i32 0
  %82 = load i32* %81
  %83 = icmp ule i32 %82, 40
  br i1 %83, label %84, label %90

; <label>:84                                      ; preds = %79
  %85 = getelementptr inbounds %struct.__va_list_tag* %80, i32 0, i32 3
  %86 = load i8** %85
  %87 = getelementptr i8* %86, i32 %82
...
; <label>:90                                      ; preds = %79
  %91 = getelementptr inbounds %struct.__va_list_tag* %80, i32 0, i32 2
  %92 = load i8** %91
  %93 = bitcast i8* %92 to i32*
  %94 = getelementptr i8* %92, i32 8
  store i8* %94, i8** %91
  br label %95
...
; <label>:100                                     ; preds = %95
  %101 = getelementptr inbounds [1 x %struct.__va_list_tag]* %args, i32 0, i32 0
  %102 = getelementptr inbounds %struct.__va_list_tag* %101, i32 0, i32 0
  %103 = load i32* %102
  %104 = icmp ule i32 %103, 40
  br i1 %104, label %105, label %111

; <label>:105                                     ; preds = %100
  %106 = getelementptr inbounds %struct.__va_list_tag* %101, i32 0, i32 3
  %107 = load i8** %106
  %108 = getelementptr i8* %107, i32 %103
...
; <label>:111                                     ; preds = %100
  %112 = getelementptr inbounds %struct.__va_list_tag* %101, i32 0, i32 2
  %113 = load i8** %112
  %114 = bitcast i8* %113 to i32*
  %115 = getelementptr i8* %113, i32 8
  store i8* %115, i8** %112
  br label %116
...
; <label>:121                                     ; preds = %116
  %122 = getelementptr inbounds [1 x %struct.__va_list_tag]* %args, i32 0, i32 0
  %123 = getelementptr inbounds %struct.__va_list_tag* %122, i32 0, i32 0
  %124 = load i32* %123
  %125 = icmp ule i32 %124, 40
  br i1 %125, label %126, label %132

; <label>:126                                     ; preds = %121
  %127 = getelementptr inbounds %struct.__va_list_tag* %122, i32 0, i32 3
  %128 = load i8** %127
  %129 = getelementptr i8* %128, i32 %124
...
; <label>:132                                     ; preds = %121
  %133 = getelementptr inbounds %struct.__va_list_tag* %122, i32 0, i32 2
  %134 = load i8** %133
  %135 = bitcast i8* %134 to i64*
  %136 = getelementptr i8* %134, i32 8
  store i8* %136, i8** %133
  br label %137
...
; <label>:142                                     ; preds = %137
  %143 = getelementptr inbounds [1 x %struct.__va_list_tag]* %args, i32 0, i32 0
...
; <label>:163                                     ; preds = %158
  %164 = getelementptr inbounds [1 x %struct.__va_list_tag]* %args, i32 0, i32 0
  %165 = getelementptr inbounds %struct.__va_list_tag* %164, i32 0, i32 1
  %166 = load i32* %165
  %167 = icmp ule i32 %166, 160
  br i1 %167, label %168, label %174

; <label>:168                                     ; preds = %163
  %169 = getelementptr inbounds %struct.__va_list_tag* %164, i32 0, i32 3
  %170 = load i8** %169
  %171 = getelementptr i8* %170, i32 %166
...
; <label>:174                                     ; preds = %163
  %175 = getelementptr inbounds %struct.__va_list_tag* %164, i32 0, i32 2
  %176 = load i8** %175
  %177 = bitcast i8* %176 to double*
  %178 = getelementptr i8* %176, i32 8
  store i8* %178, i8** %175
  br label %179
...
; <label>:184                                     ; preds = %179
  %185 = getelementptr inbounds [1 x %struct.__va_list_tag]* %args, i32 0, i32 0
