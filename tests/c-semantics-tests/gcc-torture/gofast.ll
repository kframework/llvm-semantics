...
entry:
  ...
  %0 = load i32* @fail_count, align 4
  %inc = add nsw i32 %0, 1
  store i32 %inc, i32* @fail_count, align 4
  %1 = load %struct._IO_FILE** @stderr, align 8
  %2 = load i8** %msg.addr, align 8
  %call = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([17 x i8]* @.str, i32 0, i32 0), i8* %2)
  ret i32 0
}
