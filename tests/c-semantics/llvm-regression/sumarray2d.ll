...
; <label>:13                                      ; preds = %9
  ...
  %18 = load [10 x i32]** %1, align 8
  %19 = getelementptr inbounds [10 x i32]* %18, i64 %17
  %20 = getelementptr inbounds [10 x i32]* %19, i32 0, i64 %15
...
; <label>:5                                       ; preds = %2
  ...
  %12 = getelementptr inbounds [10 x [10 x i32]]* %Array, i32 0, i64 %11
  %13 = getelementptr inbounds [10 x i32]* %12, i32 0, i64 %9
...
; <label>:29                                      ; preds = %25
  ...
  %37 = getelementptr inbounds [10 x [10 x i32]]* %Array, i32 0, i64 %36
  %38 = getelementptr inbounds [10 x i32]* %37, i32 0, i64 %34
...
; <label>:47                                      ; preds = %18
  %48 = getelementptr inbounds [10 x [10 x i32]]* %Array, i32 0, i32 0
  %49 = call i32 @SumArray([10 x i32]* %48, i32 10, i32 10)
  %50 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([23 x i8]* @.str, i32 0, i32 0), i32 10, i32 10, i32 %49)
  ret i32 0
}
