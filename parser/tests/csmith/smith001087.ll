; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith001087.c'
...
entry:
  %tmp = load i32* getelementptr inbounds ([3 x i32]* @g_2, i32 0, i64 2), align 4
...
entry:
  ...
  %tmp6 = load i32* getelementptr inbounds ([3 x i32]* @g_2, i32 0, i64 2), align 4
