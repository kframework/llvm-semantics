...
@.str.7 = private unnamed_addr constant [25 x i8] c"Section %s returned %d.\0A\00", align 1
@.str.8 = private unnamed_addr constant [22 x i8] c"\0ANo errors detected.\0A\00", align 1
@.str.9 = private unnamed_addr constant [10 x i8] c"\0AFailed.\0A\00", align 1
...
define i32 @sec(%struct.defs* %pd0) #0 {
  ...
  %5 = getelementptr inbounds %struct.defs, %struct.defs* %4, i32 0, i32 10
  %6 = load i32, i32* %5, align 4
  %7 = icmp ne i32 %6, 0
  br i1 %7, label %8, label %47

; <label>:8                                       ; preds = %0
  %9 = load %struct.defs*, %struct.defs** %1, align 8
  %10 = getelementptr inbounds %struct.defs, %struct.defs* %9, i32 0, i32 0
  %11 = load i32, i32* %10, align 4
  %12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @sec.s, i32 0, i32 0), i32 %11, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0))
  %13 = load %struct.defs*, %struct.defs** %1, align 8
  %14 = getelementptr inbounds %struct.defs, %struct.defs* %13, i32 0, i32 1
  %15 = load i32, i32* %14, align 4
  %16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @sec.s, i32 0, i32 0), i32 %15, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i32 0, i32 0))
  %17 = load %struct.defs*, %struct.defs** %1, align 8
  %18 = getelementptr inbounds %struct.defs, %struct.defs* %17, i32 0, i32 2
  %19 = load i32, i32* %18, align 4
  %20 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @sec.s, i32 0, i32 0), i32 %19, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i32 0, i32 0))
  %21 = load %struct.defs*, %struct.defs** %1, align 8
  %22 = getelementptr inbounds %struct.defs, %struct.defs* %21, i32 0, i32 3
  %23 = load i32, i32* %22, align 4
  %24 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @sec.s, i32 0, i32 0), i32 %23, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i32 0, i32 0))
  %25 = load %struct.defs*, %struct.defs** %1, align 8
  %26 = getelementptr inbounds %struct.defs, %struct.defs* %25, i32 0, i32 4
  %27 = load i32, i32* %26, align 4
  %28 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @sec.s, i32 0, i32 0), i32 %27, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.4, i32 0, i32 0))
  %29 = load %struct.defs*, %struct.defs** %1, align 8
  %30 = getelementptr inbounds %struct.defs, %struct.defs* %29, i32 0, i32 5
  %31 = load i32, i32* %30, align 4
  %32 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @sec.s, i32 0, i32 0), i32 %31, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.5, i32 0, i32 0))
  %33 = load %struct.defs*, %struct.defs** %1, align 8
  %34 = getelementptr inbounds %struct.defs, %struct.defs* %33, i32 0, i32 6
  %35 = load i32, i32* %34, align 4
  %36 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @sec.s, i32 0, i32 0), i32 %35, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.6, i32 0, i32 0))
  %37 = load %struct.defs*, %struct.defs** %1, align 8
  %38 = getelementptr inbounds %struct.defs, %struct.defs* %37, i32 0, i32 7
  %39 = load float, float* %38, align 4
  %40 = fpext float %39 to double
  %41 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([64 x i8], [64 x i8]* @sec.s2, i32 0, i32 0), double %40, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.5, i32 0, i32 0))
  %42 = load %struct.defs*, %struct.defs** %1, align 8
  %43 = getelementptr inbounds %struct.defs, %struct.defs* %42, i32 0, i32 8
  %44 = load float, float* %43, align 4
  %45 = fpext float %44 to double
  %46 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([64 x i8], [64 x i8]* @sec.s2, i32 0, i32 0), double %45, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.6, i32 0, i32 0))
  br label %47
...
; <label>:9                                       ; preds = %0
  ...
  %11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.7, i32 0, i32 0), i8* getelementptr inbounds (%struct.defs, %struct.defs* @main.d0, i32 0, i32 15, i32 0), i32 %10)
  br label %12
...
; <label>:15                                      ; preds = %12
  %16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.8, i32 0, i32 0))
  br label %19

; <label>:17                                      ; preds = %12
  %18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.9, i32 0, i32 0))
  br label %19
