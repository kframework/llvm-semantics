...
define i32 @main() #0 {
  ...
  %2 = load x86_fp80, x86_fp80* %xl, align 16
  %3 = load i32, i32* %n, align 4
  %4 = add nsw i32 %3, 1
  %5 = sitofp i32 %4 to x86_fp80
  %6 = fdiv x86_fp80 %2, %5
  store x86_fp80 %6, x86_fp80* %h, align 16
  %7 = load x86_fp80, x86_fp80* %h, align 16
  %8 = load x86_fp80, x86_fp80* %h, align 16
  %9 = fmul x86_fp80 %7, %8
  ...
  %18 = load x86_fp80, x86_fp80* %d, align 16
  %19 = fptrunc x86_fp80 %18 to double
  %20 = getelementptr inbounds [20 x double], [20 x double]* %w, i32 0, i64 0
  store double %19, double* %20, align 8
  %21 = load x86_fp80, x86_fp80* %e, align 16
  %22 = load x86_fp80, x86_fp80* %d, align 16
  %23 = fdiv x86_fp80 %21, %22
  %24 = fptrunc x86_fp80 %23 to double
  %25 = getelementptr inbounds [20 x double], [20 x double]* %u, i32 0, i64 0
...
; <label>:30                                      ; preds = %26
  %31 = load x86_fp80, x86_fp80* %d, align 16
  %32 = load x86_fp80, x86_fp80* %e, align 16
  %33 = load i32, i32* %i, align 4
  %34 = sub nsw i32 %33, 1
  %35 = sext i32 %34 to i64
  %36 = getelementptr inbounds [20 x double], [20 x double]* %u, i32 0, i64 %35
  ...
  %44 = getelementptr inbounds [20 x double], [20 x double]* %w, i32 0, i64 %43
  store double %41, double* %44, align 8
  %45 = load x86_fp80, x86_fp80* %e, align 16
  %46 = load i32, i32* %i, align 4
  %47 = sext i32 %46 to i64
  %48 = getelementptr inbounds [20 x double], [20 x double]* %w, i32 0, i64 %47
  ...
  %55 = getelementptr inbounds [20 x double], [20 x double]* %u, i32 0, i64 %54
...
; <label>:64                                      ; preds = %60
  %65 = load x86_fp80, x86_fp80* %h, align 16
  %66 = load i32, i32* %i, align 4
  %67 = add nsw i32 %66, 1
  %68 = sitofp i32 %67 to x86_fp80
  %69 = fmul x86_fp80 %65, %68
  store x86_fp80 %69, x86_fp80* %xd, align 16
  %70 = load x86_fp80, x86_fp80* %h2, align 16
  %71 = fsub x86_fp80 0xK80000000000000000000, %70
  %72 = load x86_fp80, x86_fp80* %rho, align 16
  %73 = fmul x86_fp80 %71, %72
  %74 = load x86_fp80, x86_fp80* %g, align 16
  %75 = fmul x86_fp80 %73, %74
  %76 = fptrunc x86_fp80 %75 to double
  %77 = load i32, i32* %i, align 4
  %78 = sext i32 %77 to i64
  %79 = getelementptr inbounds [20 x double], [20 x double]* %b, i32 0, i64 %78
  store double %76, double* %79, align 8
  %80 = load x86_fp80, x86_fp80* %xd, align 16
  %81 = load x86_fp80, x86_fp80* %xl, align 16
  ...
  %87 = load x86_fp80, x86_fp80* %x0, align 16
...
; <label>:89                                      ; preds = %64
  ...
  %92 = getelementptr inbounds [20 x double], [20 x double]* %b, i32 0, i64 %91
  %93 = load double, double* %92, align 8
  %94 = fpext double %93 to x86_fp80
  %95 = load x86_fp80, x86_fp80* %h2, align 16
  %96 = load x86_fp80, x86_fp80* %f0, align 16
  %97 = fmul x86_fp80 %95, %96
  %98 = load x86_fp80, x86_fp80* %xd, align 16
  %99 = load x86_fp80, x86_fp80* %xl, align 16
  %100 = fdiv x86_fp80 %99, 0xK40008000000000000000
  %101 = fsub x86_fp80 %98, %100
  %102 = load x86_fp80, x86_fp80* %x0, align 16
  ...
  %109 = load x86_fp80, x86_fp80* %e0, align 16
  ...
  %116 = getelementptr inbounds [20 x double], [20 x double]* %b, i32 0, i64 %115
...
; <label>:117                                     ; preds = %89, %64
  ...
  %120 = getelementptr inbounds [20 x double], [20 x double]* %b, i32 0, i64 %119
  %121 = load double, double* %120, align 8
  %122 = fpext double %121 to x86_fp80
  %123 = load x86_fp80, x86_fp80* %y0, align 16
  %124 = fdiv x86_fp80 %122, %123
  %125 = fptrunc x86_fp80 %124 to double
  %126 = load i32, i32* %i, align 4
  %127 = sext i32 %126 to i64
  %128 = getelementptr inbounds [20 x double], [20 x double]* %b, i32 0, i64 %127
...
; <label>:132                                     ; preds = %60
  %133 = getelementptr inbounds [20 x double], [20 x double]* %b, i32 0, i64 0
  %134 = load double, double* %133, align 8
  %135 = getelementptr inbounds [20 x double], [20 x double]* %w, i32 0, i64 0
  %136 = load double, double* %135, align 8
  %137 = fdiv double %134, %136
  %138 = getelementptr inbounds [20 x double], [20 x double]* %y, i32 0, i64 0
...
; <label>:143                                     ; preds = %139
  ...
  %146 = getelementptr inbounds [20 x double], [20 x double]* %b, i32 0, i64 %145
  %147 = load double, double* %146, align 8
  %148 = load i32, i32* %i, align 4
  %149 = sub nsw i32 %148, 1
  %150 = sext i32 %149 to i64
  %151 = getelementptr inbounds [20 x double], [20 x double]* %y, i32 0, i64 %150
  %152 = load double, double* %151, align 8
  %153 = fadd double %147, %152
  %154 = load i32, i32* %i, align 4
  %155 = sext i32 %154 to i64
  %156 = getelementptr inbounds [20 x double], [20 x double]* %w, i32 0, i64 %155
  %157 = load double, double* %156, align 8
  %158 = fdiv double %153, %157
  %159 = load i32, i32* %i, align 4
  %160 = sext i32 %159 to i64
  %161 = getelementptr inbounds [20 x double], [20 x double]* %y, i32 0, i64 %160
...
; <label>:165                                     ; preds = %139
  ...
  %169 = getelementptr inbounds [20 x double], [20 x double]* %y, i32 0, i64 %168
  %170 = load double, double* %169, align 8
  %171 = load i32, i32* %n, align 4
  %172 = sub nsw i32 %171, 1
  %173 = sext i32 %172 to i64
  %174 = getelementptr inbounds [20 x double], [20 x double]* %x, i32 0, i64 %173
...
; <label>:180                                     ; preds = %177
  ...
  %183 = getelementptr inbounds [20 x double], [20 x double]* %y, i32 0, i64 %182
  %184 = load double, double* %183, align 8
  %185 = load i32, i32* %i, align 4
  %186 = sext i32 %185 to i64
  %187 = getelementptr inbounds [20 x double], [20 x double]* %u, i32 0, i64 %186
  %188 = load double, double* %187, align 8
  %189 = load i32, i32* %i, align 4
  %190 = add nsw i32 %189, 1
  %191 = sext i32 %190 to i64
  %192 = getelementptr inbounds [20 x double], [20 x double]* %x, i32 0, i64 %191
  %193 = load double, double* %192, align 8
  %194 = fmul double %188, %193
  %195 = fsub double %184, %194
  %196 = load i32, i32* %i, align 4
  %197 = sext i32 %196 to i64
  %198 = getelementptr inbounds [20 x double], [20 x double]* %x, i32 0, i64 %197
...
; <label>:207                                     ; preds = %203
  %208 = load x86_fp80, x86_fp80* %h, align 16
  ...
  %217 = getelementptr inbounds [20 x double], [20 x double]* %x, i32 0, i64 %216
  %218 = load double, double* %217, align 8
  %219 = fmul double 1.000000e+02, %218
  %220 = fmul double %219, 1.000000e+03
  %221 = fptosi double %220 to i32
  %222 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0), i32 %214, i32 %221)
  br label %223
