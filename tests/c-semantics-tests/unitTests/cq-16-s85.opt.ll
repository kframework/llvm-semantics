...
@str = private unnamed_addr constant [35 x i8] c"VOLATILE: Sign extension in fields\00"
@str13 = private unnamed_addr constant [51 x i8] c"VOLATILE: Be especially careful with 1-bit fields!\00"
@str14 = private unnamed_addr constant [21 x i8] c"\0ANo errors detected.\00"
@str15 = private unnamed_addr constant [9 x i8] c"\0AFailed.\00"
...
entry:
  ...
  store i8 32, i8* %incdec.ptr1.5, align 1, !tbaa !0
  store i8 0, i8* %incdec.ptr1.6, align 1, !tbaa !0
  %arrayidx = getelementptr inbounds [7 x i32]* %diff, i64 0, i64 0
  store i32 1, i32* %arrayidx, align 16, !tbaa !2
  %arrayidx7 = getelementptr inbounds [7 x i32]* %diff, i64 0, i64 1
  store i32 2, i32* %arrayidx7, align 4, !tbaa !2
  %arrayidx13 = getelementptr inbounds [7 x i32]* %diff, i64 0, i64 2
  store i32 4, i32* %arrayidx13, align 8, !tbaa !2
  %arrayidx19 = getelementptr inbounds [7 x i32]* %diff, i64 0, i64 3
  store i32 8, i32* %arrayidx19, align 4, !tbaa !2
  %arrayidx25 = getelementptr inbounds [7 x i32]* %diff, i64 0, i64 4
  store i32 4, i32* %arrayidx25, align 16, !tbaa !2
  %arrayidx31 = getelementptr inbounds [7 x i32]* %diff, i64 0, i64 5
  store i32 4, i32* %arrayidx31, align 4, !tbaa !2
  %arrayidx37 = getelementptr inbounds [7 x i32]* %diff, i64 0, i64 6
  store i32 8, i32* %arrayidx37, align 8, !tbaa !2
  %flgm = getelementptr inbounds %struct.defs* %pd0, i64 0, i32 10
  %0 = load i32* %flgm, align 4, !tbaa !2
  %cmp = icmp eq i32 %0, 0
  br i1 %cmp, label %if.end103, label %for.cond.preheader

for.cond.preheader:                               ; preds = %entry
  %call = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([18 x i8]* @.str7, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([13 x i8]* @sec.aln, i64 0, i64 0), i32 1) nounwind
  %call.1 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([18 x i8]* @.str7, i64 0, i64 0), i8* getelementptr inbounds ([6 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([13 x i8]* @sec.aln, i64 0, i64 0), i32 2) nounwind
  %call.2 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([18 x i8]* @.str7, i64 0, i64 0), i8* getelementptr inbounds ([4 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([13 x i8]* @sec.aln, i64 0, i64 0), i32 4) nounwind
  %call.3 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([18 x i8]* @.str7, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([13 x i8]* @sec.aln, i64 0, i64 0), i32 8) nounwind
  %call.4 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([18 x i8]* @.str7, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8]* @.str4, i64 0, i64 0), i8* getelementptr inbounds ([13 x i8]* @sec.aln, i64 0, i64 0), i32 4) nounwind
  %call.5 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([18 x i8]* @.str7, i64 0, i64 0), i8* getelementptr inbounds ([6 x i8]* @.str5, i64 0, i64 0), i8* getelementptr inbounds ([13 x i8]* @sec.aln, i64 0, i64 0), i32 4) nounwind
  %call.6 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([18 x i8]* @.str7, i64 0, i64 0), i8* getelementptr inbounds ([7 x i8]* @.str6, i64 0, i64 0), i8* getelementptr inbounds ([13 x i8]* @sec.aln, i64 0, i64 0), i32 8) nounwind
  %.pr = load i32* %flgm, align 4, !tbaa !2
  %cmp59 = icmp eq i32 %.pr, 0
  br i1 %cmp59, label %if.end103, label %if.then75

if.then75:                                        ; preds = %for.cond.preheader
  %puts = call i32 @puts(i8* getelementptr inbounds ([35 x i8]* @str, i64 0, i64 0))
  %.pr109.pr = load i32* %flgm, align 4, !tbaa !2
  %cmp77 = icmp eq i32 %.pr109.pr, 0
  br i1 %cmp77, label %if.end103, label %if.then79

if.then79:                                        ; preds = %if.then75
  %puts107 = call i32 @puts(i8* getelementptr inbounds ([51 x i8]* @str13, i64 0, i64 0))
  br label %if.end103

if.end103:                                        ; preds = %entry, %for.cond.preheader, %if.then79, %if.then75
  ret i32 0
}
...
if.then:                                          ; preds = %entry
  %call1 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str10, i64 0, i64 0), i8* getelementptr inbounds (%struct.defs* @main.d0, i64 0, i32 15, i64 0), i32 %call) nounwind
...
if.then3:                                         ; preds = %if.end
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([21 x i8]* @str14, i64 0, i64 0))
  br label %if.end6

if.else:                                          ; preds = %if.end
  %puts7 = tail call i32 @puts(i8* getelementptr inbounds ([9 x i8]* @str15, i64 0, i64 0))
  br label %if.end6
