; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith001475.ll'
...
entry:
  store i32* null, i32** @g_12, align 8
  %tmp20 = load i32* @g_13, align 4
  ret i32 %tmp20
}

define i32* @func_2(i16 zeroext %p_3, i8 signext %p_4, i32 %p_5, i16 zeroext %p_6) nounwind uwtable readnone {
entry:
  ret i32* null
}
