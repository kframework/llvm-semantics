; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/index-1.ll'
...
entry:
  %tmp1.i = load i32* getelementptr inbounds ([40 x i32]* @a, i64 0, i64 30), align 8
  %cmp = icmp eq i32 %tmp1.i, 30
