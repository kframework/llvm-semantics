; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/930518-1.c'
...
while.cond:                                       ; preds = %while.body, %entry
  ...
  %tmp1 = load i32* @bar, align 4
  %cmp = icmp sgt i32 %tmp, %tmp1
  br i1 %cmp, label %while.body, label %while.end

while.body:                                       ; preds = %while.cond
  %tmp2 = load i32* @bar, align 4
  %tmp3 = load i32* %foo, align 4
  %sub = sub nsw i32 %tmp3, %tmp2
