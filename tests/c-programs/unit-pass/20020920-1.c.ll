...
define i32 @main() #0 {
  ...
  %6 = getelementptr inbounds %struct.A, %struct.A* %a, i32 0, i32 0
  %7 = load i32, i32* %6, align 4
  %8 = icmp ne i32 %7, 2
  br i1 %8, label %19, label %9

; <label>:9                                       ; preds = %0
  %10 = getelementptr inbounds %struct.A, %struct.A* %a, i32 0, i32 1
...
; <label>:14                                      ; preds = %9
  %15 = getelementptr inbounds %struct.A, %struct.A* %a, i32 0, i32 1
  %16 = getelementptr inbounds %struct.B, %struct.B* %15, i32 0, i32 1
