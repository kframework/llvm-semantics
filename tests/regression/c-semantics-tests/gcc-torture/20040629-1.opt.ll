...
entry:
  ...
  %1 = and i32 %0, -32
  %2 = or i32 %bf.value, %1
  store i32 %2, i32* bitcast (%struct.anon.0* @c to i32*), align 4
  ret void
}
...
entry:
  ...
  %add1 = shl i32 %x, 6
  %1 = add i32 %0, %add1
  store i32 %1, i32* bitcast (%struct.anon.0* @c to i32*), align 4
  ret void
}
...
entry:
  ...
  %1 = and i32 %0, -65536
  %2 = or i32 %bf.value, %1
  store i32 %2, i32* bitcast (%struct.anon.1* @d to i32*), align 4
  ret void
}
...
entry:
  ...
  %add1 = shl i32 %x, 24
  %1 = add i32 %0, %add1
  store i32 %1, i32* bitcast (%struct.anon.1* @d to i32*), align 4
  ret void
}
...
entry:
  ...
  %3 = or i32 %1, %2
  store i32 %3, i32* bitcast (%struct.anon.1* @d to i32*), align 4
  ret void
}
...
entry:
  ...
  %2 = and i32 %0, -33
  %3 = or i32 %1, %2
  store i32 %3, i32* bitcast (%struct.anon.0* @c to i32*), align 4
  ret void
}
...
if.end644:
  ...
  store i32 -2147483595, i32* bitcast (%struct.anon.0* @c to i32*), align 4
  store i32 -1147377476, i32* bitcast (%struct.anon.1* @d to i32*), align 4
  ret i32 0
}
