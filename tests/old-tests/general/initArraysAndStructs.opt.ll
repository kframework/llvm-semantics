; ModuleID = '/home/grosu/celliso2/c-semantics/tests/unitTests/initArraysAndStructs.ll'
...
entry:
  ...
  %call15 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([29 x i8]* @.str1, i64 0, i64 0), i64 6) nounwind
  ret i32 0
}
