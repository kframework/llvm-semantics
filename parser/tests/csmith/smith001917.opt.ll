; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith001917.ll'
...
entry:
  %tmp3 = load i32* @g_6, align 4
  %or = or i32 %tmp3, 255
  store i32 %or, i32* @g_6, align 4
  ret i32 %or
}

define i32 @main(i32 %argc, i8** nocapture %argv) nounwind uwtable {
entry:
  %tmp3.i = load i32* @g_6, align 4
  %or.i = or i32 %tmp3.i, 255
  store i32 %or.i, i32* @g_6, align 4
