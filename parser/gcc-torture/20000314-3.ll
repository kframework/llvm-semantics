; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20000314-3.c'
...
entry:
  ...
  %call = call i8* @attr_string(i8* %tmp)
  %tmp1 = load i8** %value.addr, align 8
  %call2 = call i8* @attr_string(i8* %tmp1)
  call void @attr_rtx(i8* %call, i8* %call2)
  ret void
}
...
entry:
  ...
  %tmp = load i8** %varg0.addr, align 8
  %cmp = icmp ne i8* %tmp, getelementptr inbounds ([5 x i8]* @arg0, i32 0, i32 0)
...
if.end:                                           ; preds = %entry
  %tmp1 = load i8** %varg1.addr, align 8
  %cmp2 = icmp ne i8* %tmp1, getelementptr inbounds ([5 x i8]* @arg1, i32 0, i32 0)
