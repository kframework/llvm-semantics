...
; <label>:10                                      ; preds = %6
  ...
  %21 = load i64, i64* %vec, align 8
  %22 = add nsw i64 %21, %20
  store i64 %22, i64* %vec, align 8
  %23 = load i64, i64* %vec, align 8
  %24 = sub nsw i64 %23, 1
...
define i32 @main() #1 {
  ...
  store i32 0, i32* %1
  %2 = getelementptr inbounds [3 x i64], [3 x i64]* %l, i32 0, i32 0
  call void @f(i64* %2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @b, i32 0, i32 0), i64 0, i64 2)
  %3 = getelementptr inbounds [3 x i64], [3 x i64]* %l, i32 0, i64 0
  %4 = load i64, i64* %3, align 8
  %5 = icmp ne i64 %4, 3
  br i1 %5, label %14, label %6

; <label>:6                                       ; preds = %0
  %7 = getelementptr inbounds [3 x i64], [3 x i64]* %l, i32 0, i64 1
  %8 = load i64, i64* %7, align 8
  %9 = icmp ne i64 %8, 9
  br i1 %9, label %14, label %10

; <label>:10                                      ; preds = %6
  %11 = getelementptr inbounds [3 x i64], [3 x i64]* %l, i32 0, i64 2
