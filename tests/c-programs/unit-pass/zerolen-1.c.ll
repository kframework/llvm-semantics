...
define i32 @main() #0 {
  ...
  %2 = load %union.iso_directory_record*, %union.iso_directory_record** %de, align 8
  call void @set(%union.iso_directory_record* %2)
  %3 = load %union.iso_directory_record*, %union.iso_directory_record** %de, align 8
  %4 = bitcast %union.iso_directory_record* %3 to %struct.anon*
  %5 = getelementptr inbounds %struct.anon, %struct.anon* %4, i32 0, i32 0
  %6 = getelementptr inbounds [1 x i8], [1 x i8]* %5, i32 0, i64 0
...
; <label>:10                                      ; preds = %0
  %11 = load %union.iso_directory_record*, %union.iso_directory_record** %de, align 8
  %12 = bitcast %union.iso_directory_record* %11 to %struct.anon*
  %13 = getelementptr inbounds %struct.anon, %struct.anon* %12, i32 0, i32 1
  %14 = getelementptr inbounds [0 x i8], [0 x i8]* %13, i32 0, i64 0
...
define void @set(%union.iso_directory_record* %p) #0 {
  ...
  %2 = load %union.iso_directory_record*, %union.iso_directory_record** %1, align 8
  %3 = bitcast %union.iso_directory_record* %2 to [4 x i8]*
  %4 = getelementptr inbounds [4 x i8], [4 x i8]* %3, i32 0, i64 0
  store i8 1, i8* %4, align 1
  %5 = load %union.iso_directory_record*, %union.iso_directory_record** %1, align 8
  %6 = bitcast %union.iso_directory_record* %5 to [4 x i8]*
  %7 = getelementptr inbounds [4 x i8], [4 x i8]* %6, i32 0, i64 1
