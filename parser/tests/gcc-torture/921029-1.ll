; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/921029-1.c'
...
entry:
  ...
  %tmp = load i64* %h.addr, align 8
  store i64 %tmp, i64* @hpart, align 8
  %tmp1 = load i64* @hpart, align 8
  %shl = shl i64 %tmp1, 32
  store i64 %shl, i64* @hpart, align 8
  %tmp2 = load i64* %l.addr, align 8
  store i64 %tmp2, i64* @lpart, align 8
  %tmp3 = load i64* @lpart, align 8
  %and = and i64 %tmp3, 4294967295
  store i64 %and, i64* @lpart, align 8
  %tmp4 = load i64* @hpart, align 8
  %tmp5 = load i64* @lpart, align 8
  %or = or i64 %tmp4, %tmp5
  store i64 %or, i64* @back, align 8
  %tmp6 = load i64* @back, align 8
  ret i64 %tmp6
}
