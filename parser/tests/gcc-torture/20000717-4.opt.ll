; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20000717-4.ll'
...
entry:
  %tmp1 = load i32* getelementptr inbounds (%struct.anon* @s, i64 0, i32 1, i64 0, i32 0, i64 1), align 4
  ret i32 %tmp1
}
