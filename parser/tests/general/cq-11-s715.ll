; ModuleID = '/home/grosu/celliso2/c-semantics/tests/unitTests/cq-11-s715.c'
...
@sec.s715er = internal global [11 x i8] c"s715,er%d\0A\00", align 1
@sec.qs715 = internal global [8 x i8] c"s715   \00", align 1
...
define i32 @s715f(i32 %x, i32 %y, i32 %z) nounwind uwtable {
entry:
  %x.addr = alloca i32, align 4
...
entry:
  ...
  store i8* getelementptr inbounds ([8 x i8]* @sec.qs715, i32 0, i32 0), i8** %ps, align 8
  %tmp = load %struct.defs** %pd0.addr, align 8
  %rfs = getelementptr inbounds %struct.defs* %tmp, i32 0, i32 15
  %arraydecay = getelementptr inbounds [8 x i8]* %rfs, i32 0, i32 0
  store i8* %arraydecay, i8** %pt, align 8
...
while.end:                                        ; preds = %while.cond
  ...
  %cmp = icmp ne i32 %inc13, 6
  br i1 %cmp, label %if.then, label %if.end19

if.then:                                          ; preds = %while.end
  %tmp14 = load %struct.defs** %pd0.addr, align 8
  %flgd = getelementptr inbounds %struct.defs* %tmp14, i32 0, i32 11
  %tmp15 = load i32* %flgd, align 4
  %cmp16 = icmp ne i32 %tmp15, 0
  br i1 %cmp16, label %if.then17, label %if.end

if.then17:                                        ; preds = %if.then
  %call = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @sec.s715er, i32 0, i32 0), i32 1)
  br label %if.end

if.end:                                           ; preds = %if.then17, %if.then
  %tmp18 = load i32* %rc, align 4
  %add = add nsw i32 %tmp18, 1
  store i32 %add, i32* %rc, align 4
  br label %if.end19

if.end19:                                         ; preds = %if.end, %while.end
  %tmp20 = load i32* %a, align 4
  store i32 3, i32* %t, align 4
  %tmp21 = load i32* %t, align 4
  %add22 = add nsw i32 %tmp21, 2
  %tmp23 = load i32* %c, align 4
  %call24 = call i32 (...)* bitcast (i32 (i32, i32, i32)* @s715f to i32 (...)*)(i32 %tmp20, i32 %add22, i32 %tmp23)
  %cmp25 = icmp ne i32 %call24, 5
  br i1 %cmp25, label %if.then26, label %if.end36

if.then26:                                        ; preds = %if.end19
  %tmp27 = load %struct.defs** %pd0.addr, align 8
  %flgd28 = getelementptr inbounds %struct.defs* %tmp27, i32 0, i32 11
  %tmp29 = load i32* %flgd28, align 4
  %cmp30 = icmp ne i32 %tmp29, 0
  br i1 %cmp30, label %if.then31, label %if.end33

if.then31:                                        ; preds = %if.then26
  %call32 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @sec.s715er, i32 0, i32 0), i32 2)
  br label %if.end33

if.end33:                                         ; preds = %if.then31, %if.then26
  %tmp34 = load i32* %rc, align 4
  %add35 = add nsw i32 %tmp34, 2
  store i32 %add35, i32* %rc, align 4
  br label %if.end36

if.end36:                                         ; preds = %if.end33, %if.end19
  %tmp37 = load i32* %rc, align 4
  ret i32 %tmp37
}
