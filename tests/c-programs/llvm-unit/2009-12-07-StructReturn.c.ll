...
define float* @spooky(i32 %i) #0 {
  ...
  %3 = sext i32 %2 to i64
  %4 = getelementptr inbounds [4 x %struct.barstruct], [4 x %struct.barstruct]* @bar_ary, i32 0, i64 %3
  %5 = getelementptr inbounds %struct.barstruct, %struct.barstruct* %4, i32 0, i32 1
  store float 1.420000e+02, float* %5, align 4
  %6 = load i32, i32* %1, align 4
  %7 = sext i32 %6 to i64
  %8 = getelementptr inbounds [4 x %struct.barstruct], [4 x %struct.barstruct]* @bar_ary, i32 0, i64 %7
  %9 = getelementptr inbounds %struct.barstruct, %struct.barstruct* %8, i32 0, i32 1
  ret float* %9
}
...
define { <2 x float>, float } @foobify() #0 {
  ...
  %4 = getelementptr %struct.foostruct, %struct.foostruct* %1, i32 0, i32 0
  ...
  %7 = load { <2 x float>, float }, { <2 x float>, float }* %2, align 4
...
define i32 @main(i32 %argc, i8** %argv) #2 {
  ...
  %8 = getelementptr %struct.foostruct, %struct.foostruct* %4, i32 0, i32 0
  store { <2 x float>, float } %7, { <2 x float>, float }* %5, align 4
  ...
  %12 = load float*, float** %pf, align 8
...
; <label>:16                                      ; preds = %0
  %17 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str, i32 0, i32 0))
  call void @abort() #5
  unreachable
