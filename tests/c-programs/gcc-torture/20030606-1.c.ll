...
define i32 @main() #0 {
  ...
  %5 = getelementptr inbounds [5 x i32], [5 x i32]* %a, i32 0, i32 0
...
; <label>:11                                      ; preds = %0
  %12 = getelementptr inbounds [5 x i32], [5 x i32]* %a, i32 0, i64 0
  %13 = load i32, i32* %12, align 4
  %14 = icmp ne i32 %13, 55
  br i1 %14, label %21, label %15

; <label>:15                                      ; preds = %11
  %16 = getelementptr inbounds [5 x i32], [5 x i32]* %a, i32 0, i64 1
  %17 = load i32, i32* %16, align 4
  %18 = getelementptr inbounds [5 x i32], [5 x i32]* %a, i32 0, i64 4
...
; <label>:22                                      ; preds = %15
  ...
  %24 = getelementptr inbounds [5 x i32], [5 x i32]* %a, i32 0, i32 0
  %25 = call i32* @foo(i32* %24, i32 2)
  %26 = getelementptr inbounds [5 x i32], [5 x i32]* %a, i32 0, i32 0
...
; <label>:32                                      ; preds = %22
  %33 = getelementptr inbounds [5 x i32], [5 x i32]* %a, i32 0, i64 0
  %34 = load i32, i32* %33, align 4
  %35 = icmp ne i32 %34, 55
  br i1 %35, label %40, label %36

; <label>:36                                      ; preds = %32
  %37 = getelementptr inbounds [5 x i32], [5 x i32]* %a, i32 0, i64 1
