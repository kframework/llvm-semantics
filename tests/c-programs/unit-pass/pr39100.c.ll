...
; <label>:3                                       ; preds = %35, %0
  %4 = load %struct.E*, %struct.E** %2, align 8
  %5 = icmp ne %struct.E* %4, null
  br i1 %5, label %6, label %37

; <label>:6                                       ; preds = %3
  %7 = load %struct.E*, %struct.E** %2, align 8
  %8 = getelementptr inbounds %struct.E, %struct.E* %7, i32 0, i32 1
  %9 = load %struct.E*, %struct.E** %8, align 8
  store %struct.E* %9, %struct.E** %n, align 8
  %10 = load %struct.E*, %struct.E** %2, align 8
...
; <label>:15                                      ; preds = %6
  %16 = load %struct.C*, %struct.C** %1, align 8
  %17 = getelementptr inbounds %struct.C, %struct.C* %16, i32 0, i32 2
  %18 = load i16, i16* %17, align 2
  %19 = add i16 %18, 1
  store i16 %19, i16* %17, align 2
  %20 = load %struct.E*, %struct.E** %2, align 8
  %21 = load %struct.E**, %struct.E*** %pa, align 8
  store %struct.E* %20, %struct.E** %21, align 8
  %22 = load %struct.E**, %struct.E*** %pa, align 8
...
; <label>:25                                      ; preds = %6
  %26 = load %struct.C*, %struct.C** %1, align 8
  %27 = getelementptr inbounds %struct.C, %struct.C* %26, i32 0, i32 1
  %28 = load i16, i16* %27, align 2
  %29 = add i16 %28, 1
  store i16 %29, i16* %27, align 2
  %30 = load %struct.E*, %struct.E** %2, align 8
  %31 = load %struct.E**, %struct.E*** %na, align 8
  store %struct.E* %30, %struct.E** %31, align 8
  %32 = load %struct.E**, %struct.E*** %na, align 8
  %33 = load %struct.E*, %struct.E** %32, align 8
  %34 = getelementptr inbounds %struct.E, %struct.E* %33, i32 0, i32 1
  store %struct.E** %34, %struct.E*** %na, align 8
  br label %35

; <label>:35                                      ; preds = %25, %15
  %36 = load %struct.E*, %struct.E** %n, align 8
  store %struct.E* %36, %struct.E** %2, align 8
  br label %3

; <label>:37                                      ; preds = %3
  %38 = load %struct.E*, %struct.E** %nl, align 8
  %39 = load %struct.E**, %struct.E*** %pa, align 8
  store %struct.E* %38, %struct.E** %39, align 8
  %40 = load %struct.E**, %struct.E*** %na, align 8
  store %struct.E* null, %struct.E** %40, align 8
  %41 = load %struct.E*, %struct.E** %pl, align 8
  %42 = load %struct.C*, %struct.C** %1, align 8
  %43 = getelementptr inbounds %struct.C, %struct.C* %42, i32 0, i32 0
  store %struct.E* %41, %struct.E** %43, align 8
  %44 = load %struct.C*, %struct.C** %1, align 8
  ret %struct.C* %44
}
...
define i32 @main() #1 {
  ...
  %3 = getelementptr inbounds [2 x %struct.E], [2 x %struct.E]* %e, i64 0, i64 0
  %4 = getelementptr inbounds %struct.E, %struct.E* %3, i32 0, i32 0
  store i32 0, i32* %4, align 4
  %5 = getelementptr inbounds %struct.E, %struct.E* %3, i32 0, i32 1
  %6 = getelementptr inbounds [2 x %struct.E], [2 x %struct.E]* %e, i32 0, i64 1
  store %struct.E* %6, %struct.E** %5, align 8
  %7 = getelementptr inbounds %struct.E, %struct.E* %3, i64 1
  %8 = getelementptr inbounds %struct.E, %struct.E* %7, i32 0, i32 0
  store i32 1, i32* %8, align 4
  %9 = getelementptr inbounds %struct.E, %struct.E* %7, i32 0, i32 1
  store %struct.E* null, %struct.E** %9, align 8
  %10 = getelementptr inbounds [2 x %struct.E], [2 x %struct.E]* %e, i32 0, i64 0
  %11 = call %struct.C* @foo(%struct.C* %c, %struct.E* %10)
  %12 = getelementptr inbounds %struct.C, %struct.C* %c, i32 0, i32 1
...
; <label>:16                                      ; preds = %0
  %17 = getelementptr inbounds %struct.C, %struct.C* %c, i32 0, i32 2
  %18 = load i16, i16* %17, align 2
...
; <label>:22                                      ; preds = %16
  %23 = getelementptr inbounds %struct.C, %struct.C* %c, i32 0, i32 0
  %24 = load %struct.E*, %struct.E** %23, align 8
  %25 = getelementptr inbounds [2 x %struct.E], [2 x %struct.E]* %e, i32 0, i64 1
...
; <label>:28                                      ; preds = %22
  %29 = getelementptr inbounds [2 x %struct.E], [2 x %struct.E]* %e, i32 0, i64 1
  %30 = getelementptr inbounds %struct.E, %struct.E* %29, i32 0, i32 1
  %31 = load %struct.E*, %struct.E** %30, align 8
  %32 = getelementptr inbounds [2 x %struct.E], [2 x %struct.E]* %e, i32 0, i64 0
...
; <label>:35                                      ; preds = %28
  %36 = getelementptr inbounds [2 x %struct.E], [2 x %struct.E]* %e, i32 0, i64 0
  %37 = getelementptr inbounds %struct.E, %struct.E* %36, i32 0, i32 1
