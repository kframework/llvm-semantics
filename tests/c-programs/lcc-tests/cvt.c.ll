...
define void @print() #0 {
  ...
  %13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str, i32 0, i32 0), i32 %2, i32 %4, i32 %5, i64 %6, i32 %8, i32 %10, i32 %11, i64 %12)
  ret void
}
...
define i32 @main() #0 {
  ...
  %164 = load float, float* @f, align 4
  %165 = fptoui float %164 to i16
  store i16 %165, i16* @S, align 2
  %166 = load float, float* @f, align 4
  %167 = fptoui float %166 to i32
  store i32 %167, i32* @I, align 4
  %168 = load float, float* @f, align 4
  ...
  %172 = load float, float* @f, align 4
