...
define %struct.blockvector* @blockvector_for_pc_sect(i64 %pc, %struct.symtab* %symtab) #0 {
  ...
  %4 = load %struct.symtab** %3, align 8
  %5 = getelementptr inbounds %struct.symtab* %4, i32 0, i32 0
  %6 = load %struct.blockvector** %5, align 8
  store %struct.blockvector* %6, %struct.blockvector** %bl, align 8
  %7 = load %struct.blockvector** %bl, align 8
  %8 = getelementptr inbounds %struct.blockvector* %7, i32 0, i32 1
  %9 = getelementptr inbounds [2 x %struct.block*]* %8, i32 0, i64 0
  %10 = load %struct.block** %9, align 8
  store %struct.block* %10, %struct.block** %b, align 8
  store i32 0, i32* %bot, align 4
  %11 = load %struct.blockvector** %bl, align 8
  %12 = getelementptr inbounds %struct.blockvector* %11, i32 0, i32 0
...
; <label>:19                                      ; preds = %14
  ...
  %25 = load i32* %bot, align 4
  %26 = load i32* %half, align 4
  %27 = add nsw i32 %25, %26
  %28 = sext i32 %27 to i64
  %29 = load %struct.blockvector** %bl, align 8
  %30 = getelementptr inbounds %struct.blockvector* %29, i32 0, i32 1
  %31 = getelementptr inbounds [2 x %struct.block*]* %30, i32 0, i64 %28
  %32 = load %struct.block** %31, align 8
  store %struct.block* %32, %struct.block** %b, align 8
  %33 = load %struct.block** %b, align 8
  %34 = getelementptr inbounds %struct.block* %33, i32 0, i32 0
...
; <label>:38                                      ; preds = %19
  %39 = load i32* %half, align 4
  %40 = load i32* %bot, align 4
  %41 = add nsw i32 %40, %39
  store i32 %41, i32* %bot, align 4
  br label %46

; <label>:42                                      ; preds = %19
  %43 = load i32* %bot, align 4
  %44 = load i32* %half, align 4
...
; <label>:48                                      ; preds = %65, %47
  %49 = load i32* %bot, align 4
  %50 = icmp sge i32 %49, 0
  br i1 %50, label %51, label %68

; <label>:51                                      ; preds = %48
  %52 = load i32* %bot, align 4
  %53 = sext i32 %52 to i64
  %54 = load %struct.blockvector** %bl, align 8
  %55 = getelementptr inbounds %struct.blockvector* %54, i32 0, i32 1
  %56 = getelementptr inbounds [2 x %struct.block*]* %55, i32 0, i64 %53
  %57 = load %struct.block** %56, align 8
  store %struct.block* %57, %struct.block** %b, align 8
  %58 = load %struct.block** %b, align 8
  %59 = getelementptr inbounds %struct.block* %58, i32 0, i32 1
...
; <label>:63                                      ; preds = %51
  %64 = load %struct.blockvector** %bl, align 8
  store %struct.blockvector* %64, %struct.blockvector** %1
  br label %69

; <label>:65                                      ; preds = %51
  %66 = load i32* %bot, align 4
  %67 = add nsw i32 %66, -1
...
define i32 @main() #0 {
  ...
  %4 = getelementptr %struct.block* %3, i32 0, i32 1
  store i64 65536, i64* %4
  %5 = getelementptr %struct.block* %3, i32 0, i32 4
  store i8 1, i8* %5
  %6 = getelementptr %struct.block* %3, i32 0, i32 5
  store i32 20, i32* %6
  ...
  %9 = getelementptr %struct.block* %8, i32 0, i32 0
  store i64 65536, i64* %9
  %10 = getelementptr %struct.block* %8, i32 0, i32 1
  store i64 131072, i64* %10
  %11 = getelementptr %struct.block* %8, i32 0, i32 4
  store i8 1, i8* %11
  %12 = getelementptr %struct.block* %8, i32 0, i32 5
  store i32 20, i32* %12
  %13 = getelementptr inbounds %struct.blockvector* %bv, i32 0, i32 0
  store i32 2, i32* %13, align 4
  %14 = getelementptr inbounds %struct.blockvector* %bv, i32 0, i32 1
  %15 = getelementptr inbounds [2 x %struct.block*]* %14, i64 0, i64 0
  store %struct.block* %a, %struct.block** %15
  %16 = getelementptr inbounds %struct.block** %15, i64 1
  store %struct.block* %b, %struct.block** %16
  %17 = getelementptr inbounds %struct.symtab* %s, i32 0, i32 0
