...
define [1 x %struct.__va_list_tag]* @foo() #0 {
  ...
  unreachable
                                                  ; No predecessors!
  %3 = load [1 x %struct.__va_list_tag]** %1
...
define void @bar(i32 %i, ...) #0 {
  ...
  %4 = getelementptr inbounds %struct.__va_list_tag* %3, i32 0, i32 1
  %5 = load i32* %4
  %6 = icmp ule i32 %5, 160
  br i1 %6, label %7, label %13

; <label>:7                                       ; preds = %0
  %8 = getelementptr inbounds %struct.__va_list_tag* %3, i32 0, i32 3
  %9 = load i8** %8
  %10 = getelementptr i8* %9, i32 %5
...
; <label>:13                                      ; preds = %0
  %14 = getelementptr inbounds %struct.__va_list_tag* %3, i32 0, i32 2
  %15 = load i8** %14
  %16 = bitcast i8* %15 to float*
  %17 = getelementptr i8* %15, i32 8
  store i8* %17, i8** %14
  br label %18
