; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/va-arg-2.ll'
...
while.cond:                                       ; preds = %while.cond.preheader, %to_hex.exit
  ...
  %tmp3 = load i8* %incdec.ptr1, align 1
  %tobool = icmp eq i8 %tmp3, 0
...
to_hex.exit:                                      ; preds = %vaarg.end
  ...
  %cmp8 = icmp eq i8 %tmp3, %tmp2.i
  %indvar.next = add i64 %indvar, 1
  br i1 %cmp8, label %while.cond, label %if.then10

if.then10:                                        ; preds = %to_hex.exit
  call void @abort() noreturn nounwind
  unreachable
