...
define i8* @server_type(i8* %a, i8* %b, i8* %arg) #0 {
  ...
  %7 = load i8** %err, align 8
  %8 = icmp ne i8* %7, null
  br i1 %8, label %9, label %11

; <label>:9                                       ; preds = %0
  %10 = load i8** %err, align 8
  store i8* %10, i8** %1
  br label %24

; <label>:11                                      ; preds = %0
  %12 = load i8** %4, align 8
  %13 = call i32 @strcmp(i8* %12, i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0))
  %14 = icmp ne i32 %13, 0
...
; <label>:16                                      ; preds = %11
  ...
  %18 = call i32 @strcmp(i8* %17, i8* getelementptr inbounds ([11 x i8]* @.str1, i32 0, i32 0))
  %19 = icmp ne i32 %18, 0
...
; <label>:21                                      ; preds = %16
  store i8* getelementptr inbounds ([50 x i8]* @.str2, i32 0, i32 0), i8** %1
  br label %24
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = call i8* @server_type(i8* null, i8* null, i8* getelementptr inbounds ([11 x i8]* @.str1, i32 0, i32 0))
  ret i32 0
}
