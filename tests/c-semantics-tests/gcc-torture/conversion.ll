...
lor.rhs:                                          ; preds = %entry
  ...
  %cmp1 = fcmp ogt double %conv, 1.000000e+06
  br label %lor.end
...
entry:
  ...
  %0 = load x86_fp80* %x.addr, align 16
  %1 = load x86_fp80* %y.addr, align 16
  %sub = fsub x86_fp80 %0, %1
  store x86_fp80 %sub, x86_fp80* %t, align 16
  %2 = load x86_fp80* %t, align 16
  %cmp = fcmp oeq x86_fp80 %2, 0xK00000000000000000000
  br i1 %cmp, label %lor.end, label %lor.rhs

lor.rhs:                                          ; preds = %entry
  %3 = load x86_fp80* %x.addr, align 16
  %4 = load x86_fp80* %t, align 16
  %div = fdiv x86_fp80 %3, %4
