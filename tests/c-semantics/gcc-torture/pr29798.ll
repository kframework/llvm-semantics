...
; <label>:11                                      ; preds = %5
  %12 = load double* %rho, align 8
  %13 = load double* %oldrho, align 8
  %14 = fdiv double %12, %13
  store double %14, double* %beta, align 8
  br label %15

; <label>:15                                      ; preds = %11, %5
  %16 = load double* %beta, align 8
...
; <label>:19                                      ; preds = %15
  %20 = load double* %work, align 8
  %21 = fdiv double %20, 2.000000e+00
  store double %21, double* %work, align 8
  %22 = load double* %rho, align 8
