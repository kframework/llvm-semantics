...
define internal double @sub(double %s.coerce) #2 {
  %1 = alloca %struct.s, align 8
  %s = alloca %struct.s, align 8
  %2 = getelementptr %struct.s, %struct.s* %s, i32 0, i32 0
  store double %s.coerce, double* %2, align 8
  ...
  %8 = getelementptr %struct.s, %struct.s* %1, i32 0, i32 0
