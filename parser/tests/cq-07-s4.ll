; ModuleID = '/home/grosu/celliso2/c-semantics/tests/unitTests/cq-07-s4.c'
...
entry:
  ...
  store i32 0, i32* %rc, align 4
  store i8* getelementptr inbounds ([8 x i8]* @sec.qs4, i32 0, i32 0), i8** %ps, align 8
  %tmp10 = load %struct.defs** %pd0.addr, align 8
  %rfs = getelementptr inbounds %struct.defs* %tmp10, i32 0, i32 15
  %arraydecay = getelementptr inbounds [8 x i8]* %rfs, i32 0, i32 0
  store i8* %arraydecay, i8** %pt, align 8
  br label %while.cond

while.cond:                                       ; preds = %while.body, %entry
  %tmp11 = load i8** %ps, align 8
  %incdec.ptr = getelementptr inbounds i8* %tmp11, i32 1
  store i8* %incdec.ptr, i8** %ps, align 8
  %tmp12 = load i8* %tmp11
  %tmp13 = load i8** %pt, align 8
  %incdec.ptr14 = getelementptr inbounds i8* %tmp13, i32 1
  store i8* %incdec.ptr14, i8** %pt, align 8
...
for.cond:                                         ; preds = %for.inc, %while.end
  ...
  %cmp = icmp slt i32 %tmp15, 3
  br i1 %cmp, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %tmp16 = load i32* %j, align 4
  %call17 = call i32 @svtest(i32 %tmp16)
  %call18 = call i32 @zero()
  %cmp19 = icmp ne i32 %call17, %call18
  br i1 %cmp19, label %if.then, label %if.end25

if.then:                                          ; preds = %for.body
  store i32 1, i32* %rc, align 4
  %tmp20 = load %struct.defs** %pd0.addr, align 8
  %flgd = getelementptr inbounds %struct.defs* %tmp20, i32 0, i32 11
  %tmp21 = load i32* %flgd, align 4
  %cmp22 = icmp ne i32 %tmp21, 0
  br i1 %cmp22, label %if.then23, label %if.end

if.then23:                                        ; preds = %if.then
  %call24 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @sec.s4er, i32 0, i32 0), i32 1)
  br label %if.end
...
for.end:                                          ; preds = %for.cond
  call void @setev()
  %call27 = call i32 @testev()
  %cmp28 = icmp ne i32 %call27, 0
  br i1 %cmp28, label %if.then29, label %if.end38

if.then29:                                        ; preds = %for.end
  %tmp30 = load i32* %rc, align 4
  %add = add nsw i32 %tmp30, 2
  store i32 %add, i32* %rc, align 4
  %tmp31 = load %struct.defs** %pd0.addr, align 8
  %flgd32 = getelementptr inbounds %struct.defs* %tmp31, i32 0, i32 11
  %tmp33 = load i32* %flgd32, align 4
  %cmp34 = icmp ne i32 %tmp33, 0
  br i1 %cmp34, label %if.then35, label %if.end37

if.then35:                                        ; preds = %if.then29
  %call36 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @sec.s4er, i32 0, i32 0), i32 2)
  br label %if.end37
...
for.cond39:                                       ; preds = %for.inc50, %if.end38
  ...
  %tmp41 = load %struct.defs** %pd0.addr, align 8
  %cbits = getelementptr inbounds %struct.defs* %tmp41, i32 0, i32 0
  %tmp42 = load i32* %cbits, align 4
  %conv43 = sext i32 %tmp42 to i64
  %mul = mul i64 4, %conv43
  %cmp44 = icmp ult i64 %conv, %mul
  br i1 %cmp44, label %for.body46, label %for.end53

for.body46:                                       ; preds = %for.cond39
  %tmp47 = load i32* %mask, align 4
  %tmp48 = load i32* %target, align 4
  %and = and i32 %tmp47, %tmp48
  store i32 %and, i32* %mask, align 4
  %tmp49 = load i32* %target, align 4
  %shr = lshr i32 %tmp49, 1
  store i32 %shr, i32* %target, align 4
  br label %for.inc50
...
for.end53:                                        ; preds = %for.cond39
  %tmp54 = load i32* %mask, align 4
  %cmp55 = icmp ne i32 %tmp54, 1
  br i1 %cmp55, label %if.then60, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %for.end53
  %tmp57 = load i32* %target, align 4
  %cmp58 = icmp ne i32 %tmp57, 0
  br i1 %cmp58, label %if.then60, label %if.end71

if.then60:                                        ; preds = %lor.lhs.false, %for.end53
  %tmp61 = load i32* %rc, align 4
  %add62 = add nsw i32 %tmp61, 8
  store i32 %add62, i32* %rc, align 4
  %tmp63 = load %struct.defs** %pd0.addr, align 8
  %flgd64 = getelementptr inbounds %struct.defs* %tmp63, i32 0, i32 11
  %tmp65 = load i32* %flgd64, align 4
  %cmp66 = icmp ne i32 %tmp65, 0
  br i1 %cmp66, label %if.then68, label %if.end70

if.then68:                                        ; preds = %if.then60
  %call69 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @sec.s4er, i32 0, i32 0), i32 8)
  br label %if.end70

if.end70:                                         ; preds = %if.then68, %if.then60
  br label %if.end71

if.end71:                                         ; preds = %if.end70, %lor.lhs.false
  %tmp72 = load i32* %rc, align 4
  ret i32 %tmp72
}
