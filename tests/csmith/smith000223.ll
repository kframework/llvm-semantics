; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith000223.c'
...
entry:
  %tmp = load i32* getelementptr inbounds ([6 x i32]* @g_2, i32 0, i64 4), align 4
  ret i32 %tmp
}
...
entry:
  ...
  %tmp12 = load i32* getelementptr inbounds ([6 x i32]* @g_2, i32 0, i64 4), align 4
  %call13 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str4, i32 0, i32 0), i32 %tmp12)
  %0 = load i32* %retval
  ret i32 %0
}
