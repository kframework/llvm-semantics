...
define i32 @main() #0 {
  ...
  %6 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0))
  %7 = getelementptr inbounds %struct.A* %a, i32 0, i32 0
  %8 = load i32* %7, align 4
  store i32 %8, i32* %test1, align 4
  %9 = getelementptr inbounds %struct.A* %a, i32 0, i32 1
  %10 = getelementptr inbounds %struct.B* %9, i32 0, i32 0
  %11 = load i32* %10, align 4
  store i32 %11, i32* %test2, align 4
  %12 = getelementptr inbounds %struct.A* %a, i32 0, i32 1
  %13 = getelementptr inbounds %struct.B* %12, i32 0, i32 1
  %14 = load i32* %13, align 4
  store i32 %14, i32* %test3, align 4
  %15 = load i32* %test1, align 4
  %16 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i32 0, i32 0), i32 %15)
  %17 = load i32* %test2, align 4
  %18 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i32 0, i32 0), i32 %17)
  %19 = load i32* %test3, align 4
  %20 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i32 0, i32 0), i32 %19)
  ret i32 0
}
...
define internal { i64, i32 } @f() #0 {
  ...
  %8 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @.str2, i32 0, i32 0))
  %9 = getelementptr inbounds %struct.B* %b, i32 0, i32 0
  %10 = load i32* %9, align 4
  %11 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str3, i32 0, i32 0), i32 %10)
  %12 = getelementptr inbounds %struct.B* %b, i32 0, i32 1
  %13 = load i32* %12, align 4
  %14 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str4, i32 0, i32 0), i32 %13)
  %15 = getelementptr inbounds %struct.A* %a, i32 0, i32 0
  %16 = load i32* %15, align 4
  store i32 %16, i32* %test1, align 4
  %17 = getelementptr inbounds %struct.A* %a, i32 0, i32 1
  %18 = getelementptr inbounds %struct.B* %17, i32 0, i32 0
  %19 = load i32* %18, align 4
  store i32 %19, i32* %test2, align 4
  %20 = getelementptr inbounds %struct.A* %a, i32 0, i32 1
  %21 = getelementptr inbounds %struct.B* %20, i32 0, i32 1
  %22 = load i32* %21, align 4
  store i32 %22, i32* %test3, align 4
  %23 = load i32* %test1, align 4
  %24 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i32 0, i32 0), i32 %23)
  %25 = load i32* %test2, align 4
  %26 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i32 0, i32 0), i32 %25)
  %27 = load i32* %test3, align 4
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %31, i8* %32, i64 12, i32 1, i1 false)
  %33 = load { i64, i32 }* %2
  ret { i64, i32 } %33
}
