...
bb3:                                              ; preds = %bb, %entry
  %iftmp.90.0 = phi i32 [ %3, %bb ], [ 1000000000, %entry ] ; <i32> [#uses=3]
  ...
  %8 = icmp sgt i32 %iftmp.90.0, 0                ; <i1> [#uses=2]
  br i1 %8, label %bb4, label %bb6

bb4:                                              ; preds = %bb4, %bb3
  %i1.010 = phi i32 [ %14, %bb4 ], [ 0, %bb3 ]    ; <i32> [#uses=1]
  %9 = load i32 (...)*** %6, align 4              ; <i32 (...)**> [#uses=1]
  %10 = getelementptr inbounds i32 (...)** %9, i32 2 ; <i32 (...)**> [#uses=1]
  %11 = load i32 (...)** %10, align 4             ; <i32 (...)*> [#uses=1]
  %12 = bitcast i32 (...)* %11 to %struct.Toggle* (%struct.Toggle*)* ; <%struct.Toggle* (%struct.Toggle*)*> [#uses=1]
  %13 = tail call %struct.Toggle* %12(%struct.Toggle* %5) ; <%struct.Toggle*> [#uses=1]
  %14 = add nsw i32 %i1.010, 1                    ; <i32> [#uses=2]
  %exitcond15 = icmp eq i32 %14, %iftmp.90.0      ; <i1> [#uses=1]
  br i1 %exitcond15, label %bb5.bb6_crit_edge, label %bb4

bb5.bb6_crit_edge:                                ; preds = %bb4
  %15 = getelementptr inbounds %struct.Toggle* %13, i32 0, i32 1 ; <i8*> [#uses=1]
  %16 = load i8* %15, align 4                     ; <i8> [#uses=1]
  %phitmp13 = icmp eq i8 %16, 0                   ; <i1> [#uses=1]
  br label %bb6

bb6:                                              ; preds = %bb5.bb6_crit_edge, %bb3
  %val.0.lcssa = phi i1 [ %phitmp13, %bb5.bb6_crit_edge ], [ false, %bb3 ] ; <i1> [#uses=1]
  %iftmp.91.0 = select i1 %val.0.lcssa, i8* getelementptr inbounds ([6 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8]* @.str1, i32 0, i32 0) ; <i8*> [#uses=3]
  %17 = icmp eq i8* %iftmp.91.0, null             ; <i1> [#uses=1]
  br i1 %17, label %bb.i1, label %bb1.i4

bb.i1:                                            ; preds = %bb6
  %18 = load i32 (...)*** getelementptr inbounds (%"struct.std::basic_ostream<char,std::char_traits<char> >"* @_ZSt4cout, i32 0, i32 0), align 4 ; <i32 (...)**> [#uses=1]
  %19 = getelementptr inbounds i32 (...)** %18, i32 -3 ; <i32 (...)**> [#uses=1]
  %20 = bitcast i32 (...)** %19 to i32*           ; <i32*> [#uses=1]
  %21 = load i32* %20, align 4                    ; <i32> [#uses=1]
  %22 = add i32 %21, ptrtoint (%"struct.std::basic_ostream<char,std::char_traits<char> >"* @_ZSt4cout to i32) ; <i32> [#uses=1]
  ...
  %26 = or i32 %25, 1                             ; <i32> [#uses=2]
  store i32 %26, i32* %24
  %27 = getelementptr inbounds %"struct.std::basic_ios<char,std::char_traits<char> >"* %23, i32 0, i32 0, i32 4 ; <i32*> [#uses=1]
  %28 = load i32* %27, align 4                    ; <i32> [#uses=1]
  %29 = and i32 %26, %28                          ; <i32> [#uses=1]
  %30 = icmp eq i32 %29, 0                        ; <i1> [#uses=1]
  br i1 %30, label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit5, label %bb4.i.i.i2
...
bb1.i4:                                           ; preds = %bb6
  %31 = tail call i32 @strlen(i8* %iftmp.91.0) nounwind readonly ; <i32> [#uses=1]
  tail call fastcc void @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_i(i8* %iftmp.91.0, i32 %31)
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit5: ; preds = %bb1.i4, %bb.i1
  ...
  %32 = icmp eq i8* %4, null                      ; <i1> [#uses=1]
  br i1 %32, label %bb11, label %bb10

bb10:                                             ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit5
  %33 = load i32 (...)*** %6, align 4             ; <i32 (...)**> [#uses=1]
  %34 = getelementptr inbounds i32 (...)** %33, i32 1 ; <i32 (...)**> [#uses=1]
  %35 = load i32 (...)** %34, align 4             ; <i32 (...)*> [#uses=1]
  %36 = bitcast i32 (...)* %35 to void (%struct.Toggle*)* ; <void (%struct.Toggle*)*> [#uses=1]
  tail call void %36(%struct.Toggle* %5)
  br label %bb11

bb11:                                             ; preds = %bb10, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit5
  %37 = tail call i8* @_Znwj(i32 16)              ; <i8*> [#uses=6]
  %38 = bitcast i8* %37 to %struct.NthToggle*     ; <%struct.NthToggle*> [#uses=2]
  %39 = bitcast i8* %37 to i32 (...)***           ; <i32 (...)***> [#uses=3]
  %40 = getelementptr i8* %37, i32 4              ; <i8*> [#uses=1]
  store i8 1, i8* %40, align 4
  store i32 (...)** getelementptr inbounds ([5 x i32 (...)*]* @_ZTV9NthToggle, i32 0, i32 2), i32 (...)*** %39, align 4
  %41 = getelementptr inbounds i8* %37, i32 8     ; <i8*> [#uses=1]
  %42 = bitcast i8* %41 to i32*                   ; <i32*> [#uses=1]
  store i32 3, i32* %42, align 4
  %43 = getelementptr inbounds i8* %37, i32 12    ; <i8*> [#uses=1]
  %44 = bitcast i8* %43 to i32*                   ; <i32*> [#uses=1]
  store i32 0, i32* %44, align 4
  br i1 %8, label %bb12, label %bb14

bb12:                                             ; preds = %bb12, %bb11
  %i.07 = phi i32 [ %50, %bb12 ], [ 0, %bb11 ]    ; <i32> [#uses=1]
  %45 = load i32 (...)*** %39, align 4            ; <i32 (...)**> [#uses=1]
  %46 = getelementptr inbounds i32 (...)** %45, i32 2 ; <i32 (...)**> [#uses=1]
  %47 = load i32 (...)** %46, align 4             ; <i32 (...)*> [#uses=1]
  %48 = bitcast i32 (...)* %47 to %struct.Toggle* (%struct.NthToggle*)* ; <%struct.Toggle* (%struct.NthToggle*)*> [#uses=1]
  %49 = tail call %struct.Toggle* %48(%struct.NthToggle* %38) ; <%struct.Toggle*> [#uses=1]
  %50 = add nsw i32 %i.07, 1                      ; <i32> [#uses=2]
  %exitcond = icmp eq i32 %50, %iftmp.90.0        ; <i1> [#uses=1]
  br i1 %exitcond, label %bb13.bb14_crit_edge, label %bb12

bb13.bb14_crit_edge:                              ; preds = %bb12
  %51 = getelementptr inbounds %struct.Toggle* %49, i32 0, i32 1 ; <i8*> [#uses=1]
  %52 = load i8* %51, align 4                     ; <i8> [#uses=1]
  %phitmp = icmp eq i8 %52, 0                     ; <i1> [#uses=1]
  br label %bb14

bb14:                                             ; preds = %bb13.bb14_crit_edge, %bb11
  %val.1.lcssa = phi i1 [ %phitmp, %bb13.bb14_crit_edge ], [ false, %bb11 ] ; <i1> [#uses=1]
  %iftmp.92.0 = select i1 %val.1.lcssa, i8* getelementptr inbounds ([6 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8]* @.str1, i32 0, i32 0) ; <i8*> [#uses=3]
  %53 = icmp eq i8* %iftmp.92.0, null             ; <i1> [#uses=1]
  br i1 %53, label %bb.i, label %bb1.i
...
bb.i:                                             ; preds = %bb14
  ...
  %60 = getelementptr inbounds %"struct.std::basic_ios<char,std::char_traits<char> >"* %59, i32 0, i32 0, i32 5 ; <i32*> [#uses=2]
  %61 = load i32* %60, align 4                    ; <i32> [#uses=1]
  %62 = or i32 %61, 1                             ; <i32> [#uses=2]
  store i32 %62, i32* %60
  %63 = getelementptr inbounds %"struct.std::basic_ios<char,std::char_traits<char> >"* %59, i32 0, i32 0, i32 4 ; <i32*> [#uses=1]
  %64 = load i32* %63, align 4                    ; <i32> [#uses=1]
  %65 = and i32 %62, %64                          ; <i32> [#uses=1]
  %66 = icmp eq i32 %65, 0                        ; <i1> [#uses=1]
  br i1 %66, label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit, label %bb4.i.i.i
...
bb1.i:                                            ; preds = %bb14
  %67 = tail call i32 @strlen(i8* %iftmp.92.0) nounwind readonly ; <i32> [#uses=1]
  tail call fastcc void @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_i(i8* %iftmp.92.0, i32 %67)
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit

_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit: ; preds = %bb1.i, %bb.i
  tail call fastcc void @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_()
  %68 = icmp eq i8* %37, null                     ; <i1> [#uses=1]
  br i1 %68, label %bb20, label %bb19

bb19:                                             ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit
  %69 = load i32 (...)*** %39, align 4            ; <i32 (...)**> [#uses=1]
  %70 = getelementptr inbounds i32 (...)** %69, i32 1 ; <i32 (...)**> [#uses=1]
  %71 = load i32 (...)** %70, align 4             ; <i32 (...)*> [#uses=1]
  %72 = bitcast i32 (...)* %71 to void (%struct.NthToggle*)* ; <void (%struct.NthToggle*)*> [#uses=1]
  tail call void %72(%struct.NthToggle* %38)
  ret i32 0

bb20:                                             ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit
  ret i32 0
}
