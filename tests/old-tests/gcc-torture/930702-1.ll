; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/930702-1.c'
...
entry:
  ...
  %cmp = fcmp une double %tmp, 3.300000e+01
  br i1 %cmp, label %if.then, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %entry
  %tmp1 = load i32* %b.addr, align 4
  %cmp2 = icmp ne i32 %tmp1, 11
...
entry:
  ...
  %tmp = load i32 (double, i32)** %f, align 8
  %call1 = call i32 %tmp(double 3.300000e+01, i32 11)
