...
; <label>:16                                      ; preds = %30, %15
  ...
  %18 = load %struct.defs** %1, align 8
  %19 = getelementptr inbounds %struct.defs* %18, i32 0, i32 3
...
; <label>:23                                      ; preds = %16
  %24 = load float* %f1, align 4
  %25 = fmul float %24, 2.000000e+00
  store float %25, float* %f1, align 4
  %26 = load i64* %lint2, align 8
  %27 = shl i64 %26, 1
  %28 = load i64* %lint1, align 8
  %29 = or i64 %27, %28
...
; <label>:33                                      ; preds = %16
  %34 = load i64* %lint2, align 8
  %35 = sitofp i64 %34 to float
  store float %35, float* %f2, align 4
  %36 = load float* %f1, align 4
  %37 = load float* %f2, align 4
  %38 = fsub float %36, %37
  %39 = load float* %f1, align 4
  %40 = fdiv float %38, %39
  store float %40, float* %f1, align 4
  %41 = load float* %f1, align 4
  %42 = fpext float %41 to double
  %43 = load %struct.defs** %1, align 8
  %44 = getelementptr inbounds %struct.defs* %43, i32 0, i32 7
...
; <label>:49                                      ; preds = %33
  ...
  %52 = load %struct.defs** %1, align 8
  %53 = getelementptr inbounds %struct.defs* %52, i32 0, i32 11
  %54 = load i32* %53, align 4
  %55 = icmp ne i32 %54, 0
  br i1 %55, label %56, label %58

; <label>:56                                      ; preds = %49
  %57 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @sec.s626er, i32 0, i32 0), i32 2)
  br label %58
...
; <label>:63                                      ; preds = %60
  ...
  %66 = getelementptr inbounds [28 x i8]* %t, i32 0, i64 %65
...
; <label>:70                                      ; preds = %60
  ...
  %73 = load i8* %c, align 1
  %74 = sext i8 %73 to i32
  %75 = mul nsw i32 %72, %74
  %76 = load i32* %is, align 4
  %77 = icmp ne i32 %75, %76
  br i1 %77, label %78, label %80

; <label>:78                                      ; preds = %70
  %79 = getelementptr inbounds [28 x i8]* %t, i32 0, i64 0
...
; <label>:80                                      ; preds = %78, %70
  ...
  %86 = load i32* %is, align 4
  %87 = icmp ne i32 %85, %86
  br i1 %87, label %88, label %90

; <label>:88                                      ; preds = %80
  %89 = getelementptr inbounds [28 x i8]* %t, i32 0, i64 1
  store i8 1, i8* %89, align 1
  br label %90

; <label>:90                                      ; preds = %88, %80
  %91 = load i16* %s, align 2
  %92 = sext i16 %91 to i32
  %93 = load i16* %s, align 2
...
; <label>:98                                      ; preds = %90
  %99 = getelementptr inbounds [28 x i8]* %t, i32 0, i64 2
  store i8 1, i8* %99, align 1
  br label %100

; <label>:100                                     ; preds = %98, %90
  %101 = load i32* %i, align 4
  %102 = load i8* %c, align 1
  %103 = sext i8 %102 to i32
  %104 = mul nsw i32 %101, %103
  %105 = load i32* %is, align 4
  %106 = icmp ne i32 %104, %105
  br i1 %106, label %107, label %109

; <label>:107                                     ; preds = %100
  %108 = getelementptr inbounds [28 x i8]* %t, i32 0, i64 3
  store i8 1, i8* %108, align 1
  br label %109

; <label>:109                                     ; preds = %107, %100
  %110 = load i32* %i, align 4
  %111 = load i16* %s, align 2
  %112 = sext i16 %111 to i32
  %113 = mul nsw i32 %110, %112
  %114 = load i32* %is, align 4
  %115 = icmp ne i32 %113, %114
  br i1 %115, label %116, label %118

; <label>:116                                     ; preds = %109
  %117 = getelementptr inbounds [28 x i8]* %t, i32 0, i64 4
...
; <label>:331                                     ; preds = %344, %330
  %332 = load i32* %j, align 4
  %333 = icmp slt i32 %332, 28
  br i1 %333, label %334, label %347

; <label>:334                                     ; preds = %331
  %335 = load i8* %t0, align 1
  %336 = sext i8 %335 to i32
  %337 = load i32* %j, align 4
  %338 = sext i32 %337 to i64
  %339 = getelementptr inbounds [28 x i8]* %t, i32 0, i64 %338
...
; <label>:347                                     ; preds = %331
  %348 = load i8* %t0, align 1
  %349 = sext i8 %348 to i32
  %350 = icmp ne i32 %349, 0
  br i1 %350, label %351, label %377

; <label>:351                                     ; preds = %347
  %352 = load i32* %rc, align 4
  %353 = add nsw i32 %352, 4
  store i32 %353, i32* %rc, align 4
  %354 = load %struct.defs** %1, align 8
  %355 = getelementptr inbounds %struct.defs* %354, i32 0, i32 11
  %356 = load i32* %355, align 4
  %357 = icmp ne i32 %356, 0
  br i1 %357, label %358, label %376

; <label>:358                                     ; preds = %351
  %359 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @sec.s626er, i32 0, i32 0), i32 4)
  %360 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([8 x i8]* @.str, i32 0, i32 0))
  store i32 0, i32* %j, align 4
  br label %361
...
; <label>:364                                     ; preds = %361
  ...
  %367 = getelementptr inbounds [28 x i8]* %t, i32 0, i64 %366
  %368 = load i8* %367, align 1
  %369 = sext i8 %368 to i32
  %370 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str1, i32 0, i32 0), i32 %369)
  br label %371
...
; <label>:374                                     ; preds = %361
  %375 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([2 x i8]* @.str2, i32 0, i32 0))
  br label %376
...
; <label>:377                                     ; preds = %376, %347
  ...
  %378 = load i64* %l, align 8
  %379 = icmp sgt i64 %378, 32768
  br i1 %379, label %380, label %390

; <label>:380                                     ; preds = %377
  %381 = load i32* %rc, align 4
  %382 = add nsw i32 %381, 8
  store i32 %382, i32* %rc, align 4
  %383 = load %struct.defs** %1, align 8
  %384 = getelementptr inbounds %struct.defs* %383, i32 0, i32 11
  %385 = load i32* %384, align 4
  %386 = icmp ne i32 %385, 0
  br i1 %386, label %387, label %389

; <label>:387                                     ; preds = %380
  %388 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @sec.s626er, i32 0, i32 0), i32 8)
  br label %389
...
; <label>:9                                       ; preds = %0
  ...
  %11 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds (%struct.defs* @main.d0, i32 0, i32 15, i32 0), i32 %10)
  br label %12
...
; <label>:15                                      ; preds = %12
  %16 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str4, i32 0, i32 0))
  br label %19

; <label>:17                                      ; preds = %12
  %18 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str5, i32 0, i32 0))
  br label %19
