; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith001609.c'
...
land.end:                                         ; preds = %land.rhs, %entry
  ...
  %call = call i32 @safe_add_func_int32_t_s_s(i32 %land.ext, i32 %tmp1)
...
lor.end:                                          ; preds = %lor.rhs, %land.end
  %1 = phi i1 [ true, %land.end ], [ true, %lor.rhs ]
  %lor.ext = zext i1 %1 to i32
  %tmp3 = volatile load i32** @g_7, align 8
  store i32 %lor.ext, i32* %tmp3
