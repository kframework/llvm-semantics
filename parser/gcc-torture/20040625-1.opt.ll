; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20040625-1.ll'
...
if.end:                                           ; preds = %entry, %if.then
  %tmp31 = phi %struct.s* [ %s, %entry ], [ %tmp2, %if.then ]
  ret %struct.s* %tmp31
}
...
entry:
  ...
  store %struct.s* %s2, %struct.s** %next, align 8
