...
define void @quote(i8* %s) #0 {
  ...
  %2 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0))
...
; <label>:18                                      ; preds = %10
  %19 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str1, i32 0, i32 0))
  br label %50
...
; <label>:28                                      ; preds = %20
  %29 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str2, i32 0, i32 0))
  br label %49
...
; <label>:38                                      ; preds = %30
  %39 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str3, i32 0, i32 0))
  br label %48
...
; <label>:40                                      ; preds = %30
  ...
  %47 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str4, i32 0, i32 0), i32 %46)
  br label %48
...
; <label>:54                                      ; preds = %50
  %55 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([8 x i8]* @.str5, i32 0, i32 0))
  br label %56
...
; <label>:60                                      ; preds = %3
  %61 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([2 x i8]* @.str6, i32 0, i32 0))
  ret void
}
...
; <label>:2                                       ; preds = %34, %0
  ...
  %4 = sext i32 %3 to i64
  %5 = getelementptr inbounds [1932 x i8]* @progdata, i32 0, i64 %4
  %6 = load i8* %5, align 1
  %7 = icmp ne i8 %6, 0
...
; <label>:8                                       ; preds = %2
  ...
  %11 = getelementptr inbounds [1932 x i8]* @progdata, i32 0, i64 %10
...
; <label>:15                                      ; preds = %8
  ...
  %19 = getelementptr inbounds [1932 x i8]* @progdata, i32 0, i64 %18
...
; <label>:26                                      ; preds = %15, %8
  ...
  %29 = getelementptr inbounds [1932 x i8]* @progdata, i32 0, i64 %28
  %30 = load i8* %29, align 1
  %31 = sext i8 %30 to i32
  %32 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str4, i32 0, i32 0), i32 %31)
  br label %33
