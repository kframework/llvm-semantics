...
; <label>:87                                      ; preds = %82
  %88 = getelementptr inbounds [1 x %struct.__va_list_tag]* %args, i32 0, i32 0
...
define void @va_long_double(i32 %n, ...) #0 {
  ...
  call void @llvm.va_start(i8* %3)
  %4 = getelementptr inbounds [1 x %struct.__va_list_tag]* %args, i32 0, i32 0
  %5 = getelementptr inbounds %struct.__va_list_tag* %4, i32 0, i32 2
  %6 = load i8** %5
  %7 = getelementptr i8* %6, i64 15
  %8 = ptrtoint i8* %7 to i64
  %9 = and i64 %8, -16
  %10 = inttoptr i64 %9 to i8*
  %11 = bitcast i8* %10 to x86_fp80*
  %12 = getelementptr i8* %10, i32 16
  store i8* %12, i8** %5
  %13 = load x86_fp80* %11
...
; <label>:16                                      ; preds = %0
  ...
  %18 = getelementptr inbounds %struct.__va_list_tag* %17, i32 0, i32 2
  %19 = load i8** %18
  %20 = getelementptr i8* %19, i64 15
  %21 = ptrtoint i8* %20 to i64
  %22 = and i64 %21, -16
  %23 = inttoptr i64 %22 to i8*
  %24 = bitcast i8* %23 to x86_fp80*
  %25 = getelementptr i8* %23, i32 16
  store i8* %25, i8** %18
  %26 = load x86_fp80* %24
...
; <label>:29                                      ; preds = %16
  ...
  %31 = getelementptr inbounds %struct.__va_list_tag* %30, i32 0, i32 2
  %32 = load i8** %31
  %33 = getelementptr i8* %32, i64 15
  %34 = ptrtoint i8* %33 to i64
  %35 = and i64 %34, -16
  %36 = inttoptr i64 %35 to i8*
  %37 = bitcast i8* %36 to x86_fp80*
  %38 = getelementptr i8* %36, i32 16
  store i8* %38, i8** %31
  %39 = load x86_fp80* %37
...
; <label>:42                                      ; preds = %29
  %43 = getelementptr inbounds [1 x %struct.__va_list_tag]* %args, i32 0, i32 0
  %44 = getelementptr inbounds %struct.__va_list_tag* %43, i32 0, i32 2
  %45 = load i8** %44
  %46 = getelementptr i8* %45, i64 15
  %47 = ptrtoint i8* %46 to i64
  %48 = and i64 %47, -16
  %49 = inttoptr i64 %48 to i8*
  %50 = bitcast i8* %49 to x86_fp80*
  %51 = getelementptr i8* %49, i32 16
  store i8* %51, i8** %44
  %52 = load x86_fp80* %50
