; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/991019-1.c'
...
entry:
  ...
  %add = fadd double 1.000000e+00, %tmp
  %epsilon = getelementptr inbounds %struct.material_type* %m, i32 0, i32 0
  store double %add, double* %epsilon, align 8
  %tmp1 = bitcast %struct.material_type* %retval to i8*
  %tmp2 = bitcast %struct.material_type* %m to i8*
  ...
  %0 = load double* %coerce.dive, align 1
  ret double %0
}
...
for.body:                                         ; preds = %for.cond
  ...
  %coerce.dive = getelementptr %struct.material_type* %x, i32 0, i32 0
  store double %call, double* %coerce.dive
  %epsilon = getelementptr inbounds %struct.material_type* %x, i32 0, i32 0
  %tmp1 = load double* %epsilon, align 8
