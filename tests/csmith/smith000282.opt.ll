; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith000282.ll'
...
entry:
  ...
  %storemerge1.in = volatile load i32* @g_3, align 4
...
entry:
  ...
  %storemerge1.in.i = volatile load i32* @g_3, align 4
