...
@bar = global i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i32 0, i32 0), align 8
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  store i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i32 0, i32 0), i8** %foo, align 8
...
; <label>:46                                      ; preds = %42
  %47 = load i8*, i8** %foo, align 8
  %48 = load i32, i32* @x, align 4
  %49 = sub nsw i32 %48, 6
  store i32 %49, i32* @x, align 4
  %50 = sext i32 %49 to i64
  %51 = getelementptr inbounds i8, i8* %47, i64 %50
  %52 = call i32 @strcmp(i8* %51, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i32 0, i32 0))
  %53 = icmp ne i32 %52, 0
...
; <label>:59                                      ; preds = %55
  %60 = load i8*, i8** %foo, align 8
  %61 = load i8*, i8** @bar, align 8
...
; <label>:65                                      ; preds = %59
  %66 = load i8*, i8** %foo, align 8
  %67 = load i8*, i8** @bar, align 8
...
; <label>:115                                     ; preds = %110
  %116 = load i8*, i8** @bar, align 8
  %117 = call i8* @strrchr(i8* %116, i32 111)
  %118 = load i8*, i8** @bar, align 8
...
; <label>:122                                     ; preds = %115
  ...
  %133 = getelementptr inbounds i8, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.3, i32 0, i32 0), i64 %132
...
; <label>:144                                     ; preds = %140
  %145 = getelementptr inbounds [64 x i8], [64 x i8]* %dst, i32 0, i64 5
  store i8 32, i8* %145, align 1
  %146 = getelementptr inbounds [64 x i8], [64 x i8]* %dst, i32 0, i64 6
  store i8 0, i8* %146, align 1
  store i32 5, i32* @x, align 4
  store i32 1, i32* @y, align 4
  %147 = getelementptr inbounds [64 x i8], [64 x i8]* %dst, i32 0, i32 0
  %148 = getelementptr inbounds i8, i8* %147, i64 1
  %149 = load i8*, i8** %foo, align 8
  ...
  %156 = getelementptr inbounds [64 x i8], [64 x i8]* %dst, i32 0, i32 0
...
; <label>:162                                     ; preds = %159
  %163 = getelementptr inbounds [64 x i8], [64 x i8]* %dst, i32 0, i32 0
  %164 = getelementptr inbounds i8, i8* %163, i64 1
  %165 = call i32 @strcmp(i8* %164, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.4, i32 0, i32 0))
...
; <label>:168                                     ; preds = %162
  ...
  %170 = getelementptr inbounds [64 x i8], [64 x i8]* %dst, i32 0, i32 0
  ...
  %180 = getelementptr inbounds i8, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.5, i32 0, i32 0), i64 %179
  %181 = call i8* @strncpy(i8* %175, i8* %180, i64 10)
  %182 = getelementptr inbounds [64 x i8], [64 x i8]* %dst, i32 0, i32 0
...
; <label>:191                                     ; preds = %188
  %192 = getelementptr inbounds [64 x i8], [64 x i8]* %dst, i32 0, i32 0
  %193 = call i32 @memcmp(i8* %192, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.6, i32 0, i32 0), i64 12)
...
; <label>:196                                     ; preds = %191
  ...
  %198 = getelementptr inbounds [64 x i8], [64 x i8]* %dst, i32 0, i32 0
  %199 = call i8* @strncpy(i8* %198, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.7, i32 0, i32 0), i64 8)
  %200 = getelementptr inbounds [64 x i8], [64 x i8]* %dst, i32 0, i32 0
  %201 = icmp ne i8* %199, %200
  br i1 %201, label %206, label %202

; <label>:202                                     ; preds = %196
  %203 = getelementptr inbounds [64 x i8], [64 x i8]* %dst, i32 0, i32 0
  %204 = call i32 @memcmp(i8* %203, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.8, i32 0, i32 0), i64 9)
...
; <label>:207                                     ; preds = %202
  ...
  call void @llvm.memset.p0i8.i64(i8* getelementptr inbounds ([64 x i8], [64 x i8]* @buf, i32 0, i32 0), i8 32, i64 64, i32 16, i1 false)
  ...
  call void @llvm.memset.p0i8.i64(i8* getelementptr inbounds ([64 x i8], [64 x i8]* @buf, i32 0, i32 0), i8 %210, i64 %213, i32 16, i1 false)
...
; <label>:220                                     ; preds = %217
  %221 = call i32 @memcmp(i8* getelementptr inbounds ([64 x i8], [64 x i8]* @buf, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.9, i32 0, i32 0), i64 3)
...
; <label>:224                                     ; preds = %220
  ...
  %228 = getelementptr inbounds i8, i8* getelementptr inbounds ([64 x i8], [64 x i8]* @buf, i32 0, i32 0), i64 %227
  call void @llvm.memset.p0i8.i64(i8* %228, i8 45, i64 8, i32 1, i1 false)
  %229 = icmp ne i8* %228, getelementptr inbounds ([64 x i8], [64 x i8]* @buf, i32 0, i64 3)
...
; <label>:233                                     ; preds = %230
  %234 = call i32 @memcmp(i8* getelementptr inbounds ([64 x i8], [64 x i8]* @buf, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.10, i32 0, i32 0), i64 11)
...
; <label>:237                                     ; preds = %233
  ...
  %241 = getelementptr inbounds i8, i8* getelementptr inbounds ([64 x i8], [64 x i8]* @buf, i32 0, i32 0), i64 %240
  %242 = load i32, i32* @y, align 4
  %243 = add nsw i32 %242, 1
  store i32 %243, i32* @y, align 4
  %244 = sext i32 %242 to i64
  call void @llvm.memset.p0i8.i64(i8* %241, i8 0, i64 %244, i32 1, i1 false)
  %245 = icmp ne i8* %241, getelementptr inbounds ([64 x i8], [64 x i8]* @buf, i32 0, i64 11)
...
; <label>:252                                     ; preds = %249
  %253 = call i32 @memcmp(i8* getelementptr inbounds ([64 x i8], [64 x i8]* @buf, i32 0, i64 8), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.11, i32 0, i32 0), i64 7)
...
; <label>:256                                     ; preds = %252
  ...
  %260 = getelementptr inbounds i8, i8* getelementptr inbounds ([64 x i8], [64 x i8]* @buf, i32 0, i32 0), i64 %259
  call void @llvm.memset.p0i8.i64(i8* %260, i8 0, i64 6, i32 1, i1 false)
  %261 = icmp ne i8* %260, getelementptr inbounds ([64 x i8], [64 x i8]* @buf, i32 0, i64 15)
...
; <label>:265                                     ; preds = %262
  %266 = call i32 @memcmp(i8* getelementptr inbounds ([64 x i8], [64 x i8]* @buf, i32 0, i64 10), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.12, i32 0, i32 0), i64 11)
