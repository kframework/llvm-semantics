...
define i32 @DUPFFdeg(%struct.DUPFFstruct* %f) #0 {
  ...
  %2 = load %struct.DUPFFstruct** %1, align 8
  %3 = getelementptr inbounds %struct.DUPFFstruct* %2, i32 0, i32 1
...
define %struct.DUPFFstruct* @DUPFFnew(i32 %maxdeg) #0 {
  ...
  %4 = load %struct.DUPFFstruct** %ans, align 8
  %5 = getelementptr inbounds %struct.DUPFFstruct* %4, i32 0, i32 2
...
; <label>:8                                       ; preds = %0
  ...
  %14 = load %struct.DUPFFstruct** %ans, align 8
  %15 = getelementptr inbounds %struct.DUPFFstruct* %14, i32 0, i32 2
  store i32* %13, i32** %15, align 8
  br label %16

; <label>:16                                      ; preds = %8, %0
  %17 = load i32* %1, align 4
  %18 = load %struct.DUPFFstruct** %ans, align 8
  %19 = getelementptr inbounds %struct.DUPFFstruct* %18, i32 0, i32 0
  store i32 %17, i32* %19, align 4
  %20 = load %struct.DUPFFstruct** %ans, align 8
  %21 = getelementptr inbounds %struct.DUPFFstruct* %20, i32 0, i32 1
  store i32 -1, i32* %21, align 4
  %22 = load %struct.DUPFFstruct** %ans, align 8
...
define %struct.DUPFFstruct* @DUPFFexgcd(%struct.DUPFFstruct** %fcofac, %struct.DUPFFstruct** %gcofac, %struct.DUPFFstruct* %f, %struct.DUPFFstruct* %g) #0 {
  ...
  %6 = load %struct.DUPFFstruct** %4, align 8
  %7 = call i32 @DUPFFdeg(%struct.DUPFFstruct* %6)
  %8 = load %struct.DUPFFstruct** %5, align 8
  %9 = call i32 @DUPFFdeg(%struct.DUPFFstruct* %8)
  %10 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([40 x i8]* @.str, i32 0, i32 0), i32 %7, i32 %9)
  %11 = load %struct.DUPFFstruct** %4, align 8
  %12 = call i32 @DUPFFdeg(%struct.DUPFFstruct* %11)
  %13 = load %struct.DUPFFstruct** %5, align 8
  %14 = call i32 @DUPFFdeg(%struct.DUPFFstruct* %13)
  %15 = icmp slt i32 %12, %14
  br i1 %15, label %16, label %22

; <label>:16                                      ; preds = %0
  %17 = load %struct.DUPFFstruct*** %3, align 8
  %18 = load %struct.DUPFFstruct*** %2, align 8
  %19 = load %struct.DUPFFstruct** %5, align 8
  %20 = load %struct.DUPFFstruct** %4, align 8
...
; <label>:22                                      ; preds = %0
  %23 = load %struct.DUPFFstruct** %4, align 8
  %24 = call i32 @DUPFFdeg(%struct.DUPFFstruct* %23)
  %25 = icmp ne i32 %24, 2
  br i1 %25, label %30, label %26

; <label>:26                                      ; preds = %22
  %27 = load %struct.DUPFFstruct** %5, align 8
...
; <label>:31                                      ; preds = %26
  %32 = load %struct.DUPFFstruct** %4, align 8
  %33 = getelementptr inbounds %struct.DUPFFstruct* %32, i32 0, i32 2
  %34 = load i32** %33, align 8
  %35 = getelementptr inbounds i32* %34, i64 0
  %36 = load i32* %35, align 4
  %37 = icmp eq i32 %36, 0
  br i1 %37, label %38, label %40

; <label>:38                                      ; preds = %31
  %39 = load %struct.DUPFFstruct** %4, align 8
  store %struct.DUPFFstruct* %39, %struct.DUPFFstruct** %1
  br label %161

; <label>:40                                      ; preds = %31
  store i32 2, i32* %p, align 4
  %41 = load %struct.DUPFFstruct** %4, align 8
  %42 = call i32 @DUPFFdeg(%struct.DUPFFstruct* %41)
  store i32 %42, i32* %df, align 4
  %43 = load i32* %df, align 4
...
; <label>:81                                      ; preds = %77
  %82 = load %struct.DUPFFstruct** %v, align 8
  %83 = call i32 @DUPFFdeg(%struct.DUPFFstruct* %82)
  store i32 %83, i32* %dv, align 4
  %84 = load i32* %dv, align 4
  %85 = sext i32 %84 to i64
  %86 = load %struct.DUPFFstruct** %v, align 8
  %87 = getelementptr inbounds %struct.DUPFFstruct* %86, i32 0, i32 2
  %88 = load i32** %87, align 8
  %89 = getelementptr inbounds i32* %88, i64 %85
...
; <label>:92                                      ; preds = %97, %81
  %93 = load %struct.DUPFFstruct** %u, align 8
  %94 = call i32 @DUPFFdeg(%struct.DUPFFstruct* %93)
  %95 = load i32* %dv, align 4
  %96 = icmp sge i32 %94, %95
  br i1 %96, label %97, label %134

; <label>:97                                      ; preds = %92
  %98 = load %struct.DUPFFstruct** %u, align 8
  %99 = call i32 @DUPFFdeg(%struct.DUPFFstruct* %98)
  store i32 %99, i32* %du, align 4
  %100 = load i32* %du, align 4
  %101 = sext i32 %100 to i64
  %102 = load %struct.DUPFFstruct** %u, align 8
  %103 = getelementptr inbounds %struct.DUPFFstruct* %102, i32 0, i32 2
  %104 = load i32** %103, align 8
  %105 = getelementptr inbounds i32* %104, i64 %101
  %106 = load i32* %105, align 4
  store i32 %106, i32* %lcu, align 4
  %107 = load i32* %lcu, align 4
  %108 = load i32* %lcvrecip, align 4
  %109 = call i32 @FFmul(i32 %107, i32 %108)
  store i32 %109, i32* %q, align 4
  %110 = load %struct.DUPFFstruct** %u, align 8
  %111 = load %struct.DUPFFstruct** %v, align 8
  %112 = load i32* %du, align 4
  %113 = load i32* %dv, align 4
  %114 = sub nsw i32 %112, %113
  %115 = load i32* %p, align 4
  %116 = load i32* %q, align 4
  %117 = sub i32 %115, %116
  call void @DUPFFshift_add(%struct.DUPFFstruct* %110, %struct.DUPFFstruct* %111, i32 %114, i32 %117)
  %118 = load %struct.DUPFFstruct** %uf, align 8
  %119 = load %struct.DUPFFstruct** %vf, align 8
  %120 = load i32* %du, align 4
  %121 = load i32* %dv, align 4
  %122 = sub nsw i32 %120, %121
  %123 = load i32* %p, align 4
  %124 = load i32* %q, align 4
  %125 = sub i32 %123, %124
  call void @DUPFFshift_add(%struct.DUPFFstruct* %118, %struct.DUPFFstruct* %119, i32 %122, i32 %125)
  %126 = load %struct.DUPFFstruct** %ug, align 8
  %127 = load %struct.DUPFFstruct** %vg, align 8
  %128 = load i32* %du, align 4
  %129 = load i32* %dv, align 4
  %130 = sub nsw i32 %128, %129
  %131 = load i32* %p, align 4
  %132 = load i32* %q, align 4
  %133 = sub i32 %131, %132
  call void @DUPFFshift_add(%struct.DUPFFstruct* %126, %struct.DUPFFstruct* %127, i32 %130, i32 %133)
  br label %92

; <label>:134                                     ; preds = %92
  %135 = load %struct.DUPFFstruct** %u, align 8
  %136 = load %struct.DUPFFstruct** %v, align 8
  call void @DUPFFswap(%struct.DUPFFstruct* %135, %struct.DUPFFstruct* %136)
  %137 = load %struct.DUPFFstruct** %uf, align 8
  %138 = load %struct.DUPFFstruct** %vf, align 8
  call void @DUPFFswap(%struct.DUPFFstruct* %137, %struct.DUPFFstruct* %138)
  %139 = load %struct.DUPFFstruct** %ug, align 8
  %140 = load %struct.DUPFFstruct** %vg, align 8
  call void @DUPFFswap(%struct.DUPFFstruct* %139, %struct.DUPFFstruct* %140)
  br label %77

; <label>:141                                     ; preds = %77
  %142 = load %struct.DUPFFstruct** %v, align 8
  %143 = call i32 @DUPFFdeg(%struct.DUPFFstruct* %142)
  %144 = icmp eq i32 %143, 0
  br i1 %144, label %145, label %152

; <label>:145                                     ; preds = %141
  %146 = load %struct.DUPFFstruct** %u, align 8
  %147 = load %struct.DUPFFstruct** %v, align 8
  call void @DUPFFswap(%struct.DUPFFstruct* %146, %struct.DUPFFstruct* %147)
  %148 = load %struct.DUPFFstruct** %uf, align 8
  %149 = load %struct.DUPFFstruct** %vf, align 8
  call void @DUPFFswap(%struct.DUPFFstruct* %148, %struct.DUPFFstruct* %149)
  %150 = load %struct.DUPFFstruct** %ug, align 8
  %151 = load %struct.DUPFFstruct** %vg, align 8
  call void @DUPFFswap(%struct.DUPFFstruct* %150, %struct.DUPFFstruct* %151)
  br label %152

; <label>:152                                     ; preds = %145, %141
  %153 = load %struct.DUPFFstruct** %vf, align 8
  call void @DUPFFfree(%struct.DUPFFstruct* %153)
  %154 = load %struct.DUPFFstruct** %vg, align 8
  call void @DUPFFfree(%struct.DUPFFstruct* %154)
  %155 = load %struct.DUPFFstruct** %v, align 8
  call void @DUPFFfree(%struct.DUPFFstruct* %155)
  %156 = load %struct.DUPFFstruct** %uf, align 8
  %157 = load %struct.DUPFFstruct*** %2, align 8
  store %struct.DUPFFstruct* %156, %struct.DUPFFstruct** %157, align 8
  %158 = load %struct.DUPFFstruct** %ug, align 8
  %159 = load %struct.DUPFFstruct*** %3, align 8
  store %struct.DUPFFstruct* %158, %struct.DUPFFstruct** %159, align 8
  %160 = load %struct.DUPFFstruct** %u, align 8
  store %struct.DUPFFstruct* %160, %struct.DUPFFstruct** %1
  br label %161

; <label>:161                                     ; preds = %152, %38, %16
  %162 = load %struct.DUPFFstruct** %1
...
define i32 @main() #0 {
  ...
  %3 = load %struct.DUPFFstruct** %f, align 8
  %4 = getelementptr inbounds %struct.DUPFFstruct* %3, i32 0, i32 2
  %5 = load i32** %4, align 8
  %6 = getelementptr inbounds i32* %5, i64 1
  store i32 1, i32* %6, align 4
  %7 = load %struct.DUPFFstruct** %f, align 8
  %8 = getelementptr inbounds %struct.DUPFFstruct* %7, i32 0, i32 1
  store i32 1, i32* %8, align 4
  %9 = call %struct.DUPFFstruct* @DUPFFnew(i32 2)
  store %struct.DUPFFstruct* %9, %struct.DUPFFstruct** %g, align 8
  %10 = load %struct.DUPFFstruct** %g, align 8
  %11 = getelementptr inbounds %struct.DUPFFstruct* %10, i32 0, i32 2
  %12 = load i32** %11, align 8
  %13 = getelementptr inbounds i32* %12, i64 2
  store i32 1, i32* %13, align 4
  %14 = load %struct.DUPFFstruct** %g, align 8
  %15 = getelementptr inbounds %struct.DUPFFstruct* %14, i32 0, i32 1
  store i32 2, i32* %15, align 4
  %16 = load %struct.DUPFFstruct** %f, align 8
  %17 = call i32 @DUPFFdeg(%struct.DUPFFstruct* %16)
  %18 = load %struct.DUPFFstruct** %g, align 8
  %19 = call i32 @DUPFFdeg(%struct.DUPFFstruct* %18)
  %20 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([41 x i8]* @.str1, i32 0, i32 0), i32 %17, i32 %19)
  %21 = load %struct.DUPFFstruct** %f, align 8
  %22 = load %struct.DUPFFstruct** %g, align 8
