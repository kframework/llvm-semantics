...
define void @f(%struct.big* byval align 8 %x, i8* %s, ...) #0 {
  ...
  %2 = getelementptr inbounds %struct.big, %struct.big* %x, i32 0, i32 0
  %3 = getelementptr inbounds [32 x i8], [32 x i8]* %2, i32 0, i64 0
...
; <label>:7                                       ; preds = %0
  %8 = getelementptr inbounds %struct.big, %struct.big* %x, i32 0, i32 0
  %9 = getelementptr inbounds [32 x i8], [32 x i8]* %8, i32 0, i64 1
...
; <label>:13                                      ; preds = %7
  %14 = getelementptr inbounds %struct.big, %struct.big* %x, i32 0, i32 0
  %15 = getelementptr inbounds [32 x i8], [32 x i8]* %14, i32 0, i64 2
...
; <label>:64                                      ; preds = %59
  %65 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  call void (%struct.big*, i8*, ...) @f(%struct.big* byval align 8 @main.x, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str, i32 0, i32 0), i32 42, i32 120, i32 0)
