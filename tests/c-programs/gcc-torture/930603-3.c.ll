...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = getelementptr inbounds [4 x i8], [4 x i8]* %buf, i32 0, i64 0
  store i8 -86, i8* %2, align 1
  %3 = getelementptr inbounds [4 x i8], [4 x i8]* %buf, i32 0, i64 1
  store i8 5, i8* %3, align 1
  %4 = getelementptr inbounds [4 x i8], [4 x i8]* %buf, i32 0, i32 0
