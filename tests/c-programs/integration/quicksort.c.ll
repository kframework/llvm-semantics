...
; <label>:16                                      ; preds = %13
  ...
  %21 = add nsw i32 %20, 1
  %22 = load i32 (i8*, i8*)*, i32 (i8*, i8*)** %4, align 8
...
define internal i32 @compare_elements_helper(i8* %base, i64 %element_size, i32 %idx1, i32 %idx2, i32 (i8*, i8*)* %comparer) #0 {
  ...
  %7 = load i32 (i8*, i8*)*, i32 (i8*, i8*)** %5, align 8
  %8 = load i32, i32* %3, align 4
  %9 = sext i32 %8 to i64
  %10 = load i64, i64* %2, align 8
  %11 = mul i64 %9, %10
  %12 = load i8*, i8** %base_bytes, align 8
  %13 = getelementptr inbounds i8, i8* %12, i64 %11
  %14 = load i32, i32* %4, align 4
  %15 = sext i32 %14 to i64
  %16 = load i64, i64* %2, align 8
  %17 = mul i64 %15, %16
  %18 = load i8*, i8** %base_bytes, align 8
...
; <label>:11                                      ; preds = %6
  ...
  %18 = add i64 %15, %17
  %19 = load i8*, i8** %base_bytes, align 8
  ...
  %28 = add i64 %25, %27
  %29 = load i8*, i8** %base_bytes, align 8
  ...
  %38 = add i64 %35, %37
  %39 = load i8*, i8** %base_bytes, align 8
  %40 = getelementptr inbounds i8, i8* %39, i64 %38
  store i8 %31, i8* %40, align 1
  %41 = load i8, i8* %temp, align 1
  ...
  %48 = add i64 %45, %47
  %49 = load i8*, i8** %base_bytes, align 8
...
; <label>:16                                      ; preds = %34, %15
  ...
  %23 = load i32 (i8*, i8*)*, i32 (i8*, i8*)** %4, align 8
...
; <label>:38                                      ; preds = %53, %37
  ...
  %41 = load i32, i32* %high, align 4
  %42 = load i64, i64* %2, align 8
  %43 = sub i64 %42, 1
  %44 = trunc i64 %43 to i32
  %45 = load i32 (i8*, i8*)*, i32 (i8*, i8*)** %4, align 8
  %46 = call i32 @compare_elements_helper(i8* %39, i64 %40, i32 %41, i32 %44, i32 (i8*, i8*)* %45)
  %47 = icmp slt i32 %46, 0
  br i1 %47, label %51, label %48

; <label>:48                                      ; preds = %38
  %49 = load i32, i32* %high, align 4
...
; <label>:53                                      ; preds = %51
  %54 = load i32, i32* %high, align 4
  %55 = add nsw i32 %54, -1
  store i32 %55, i32* %high, align 4
  br label %38

; <label>:56                                      ; preds = %51
  %57 = load i32, i32* %low, align 4
  %58 = load i32, i32* %high, align 4
...
; <label>:61                                      ; preds = %56
  ...
  %64 = load i32, i32* %low, align 4
  %65 = load i32, i32* %high, align 4
...
; <label>:7                                       ; preds = %0
  ...
  %9 = load i64, i64* %2, align 8
  %10 = load i64, i64* %3, align 8
  %11 = load i32 (i8*, i8*)*, i32 (i8*, i8*)** %4, align 8
...
; <label>:12                                      ; preds = %0
  ...
  %21 = load i32 (i8*, i8*)*, i32 (i8*, i8*)** %4, align 8
  %22 = load i32, i32* %pivotIndex, align 4
  %23 = call i32 @partition(i8* %18, i64 %19, i64 %20, i32 (i8*, i8*)* %21, i32 %22)
  store i32 %23, i32* %pivotIndex, align 4
  %24 = load i8*, i8** %1, align 8
  %25 = load i32, i32* %pivotIndex, align 4
  %26 = sext i32 %25 to i64
  %27 = load i64, i64* %3, align 8
  %28 = load i32 (i8*, i8*)*, i32 (i8*, i8*)** %4, align 8
  call void @quicksort(i8* %24, i64 %26, i64 %27, i32 (i8*, i8*)* %28)
  %29 = load i8*, i8** %1, align 8
  %30 = load i64, i64* %3, align 8
  %31 = load i32, i32* %pivotIndex, align 4
  %32 = add nsw i32 %31, 1
  %33 = sext i32 %32 to i64
  %34 = mul i64 %30, %33
  %35 = getelementptr inbounds i8, i8* %29, i64 %34
  %36 = load i64, i64* %2, align 8
  %37 = load i32, i32* %pivotIndex, align 4
  %38 = add nsw i32 %37, 1
  %39 = sext i32 %38 to i64
  %40 = sub i64 %36, %39
  %41 = load i64, i64* %3, align 8
  %42 = load i32 (i8*, i8*)*, i32 (i8*, i8*)** %4, align 8
...
; <label>:44                                      ; preds = %31
  %45 = call i32 @puts(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i32 0, i32 0))
  store i32 -1, i32* %1
  br label %52
...
; <label>:50                                      ; preds = %27
  %51 = call i32 @puts(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i32 0, i32 0))
  store i32 0, i32* %1
  br label %52
