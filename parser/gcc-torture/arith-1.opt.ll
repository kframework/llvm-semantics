; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/arith-1.ll'
...
entry:
  %uadd = tail call %0 @llvm.uadd.with.overflow.i32(i32 %i, i32 1)
  %0 = extractvalue %0 %uadd, 0
  %cmp = extractvalue %0 %uadd, 1
  %tmp41 = select i1 %cmp, i32 %i, i32 %0
  ret i32 %tmp41
}
