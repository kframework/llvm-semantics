...
define %struct.list* @f(%struct.list** %p) #0 {
  ...
  %2 = load %struct.list*** %1, align 8
  %3 = load %struct.list** %2, align 8
  %4 = getelementptr inbounds %struct.list* %3, i32 0, i32 1
...
define i32 @main(i32 %argc, i8** %argv) #0 {
  ...
  %4 = getelementptr inbounds %struct.list* %l, i32 0, i32 1
  store %struct.list* %l, %struct.list** %4, align 8
  %5 = getelementptr inbounds %struct.list* %l, i32 0, i32 1
  %6 = call %struct.list* @f(%struct.list** %5)
  %7 = getelementptr inbounds %struct.list* %l, i32 0, i32 1
  %8 = load %struct.list** %7, align 8
  %9 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([21 x i8]* @.str, i32 0, i32 0), %struct.list* %8)
  %10 = getelementptr inbounds %struct.list* %l, i32 0, i32 1
  %11 = load %struct.list** %10, align 8
  %12 = icmp ne %struct.list* %11, null
  br i1 %12, label %13, label %15

; <label>:13                                      ; preds = %0
  %14 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.str1, i32 0, i32 0))
  br label %15
