...
define void @f(i64 %r.coerce0, i64 %r.coerce1) #0 {
  ...
  %4 = getelementptr inbounds %struct.R* %r, i32 0, i32 0
  %5 = getelementptr inbounds %struct.A* %4, i32 0, i32 0
  %6 = load i64* %5, align 8
  %7 = load i64* getelementptr inbounds (%struct.R* @R, i32 0, i32 0, i32 0), align 8
  %8 = icmp ne i64 %6, %7
  br i1 %8, label %15, label %9

; <label>:9                                       ; preds = %0
  %10 = getelementptr inbounds %struct.R* %r, i32 0, i32 1
  %11 = getelementptr inbounds %struct.A* %10, i32 0, i32 0
  %12 = load i64* %11, align 8
  %13 = load i64* getelementptr inbounds (%struct.R* @R, i32 0, i32 1, i32 0), align 8
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %3 = load i64* getelementptr ({ i64, i64 }* bitcast (%struct.R* @R to { i64, i64 }*), i32 0, i32 0), align 1
  %4 = load i64* getelementptr ({ i64, i64 }* bitcast (%struct.R* @R to { i64, i64 }*), i32 0, i32 1), align 1
  ...
  %13 = getelementptr inbounds %struct.R* %r, i32 0, i32 0
  %14 = getelementptr inbounds %struct.A* %13, i32 0, i32 0
  %15 = load i64* %14, align 8
  %16 = load i64* getelementptr inbounds (%struct.R* @R, i32 0, i32 0, i32 0), align 8
  %17 = icmp ne i64 %15, %16
  br i1 %17, label %24, label %18

; <label>:18                                      ; preds = %0
  %19 = getelementptr inbounds %struct.R* %r, i32 0, i32 1
  %20 = getelementptr inbounds %struct.A* %19, i32 0, i32 0
  %21 = load i64* %20, align 8
  %22 = load i64* getelementptr inbounds (%struct.R* @R, i32 0, i32 1, i32 0), align 8
