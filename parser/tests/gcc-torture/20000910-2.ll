; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20000910-2.c'
...
for.body:                                         ; preds = %for.cond
  ...
  %tmp4 = load i8** %arrayidx, align 8
  store i8* %tmp4, i8** %fmt, align 8
  %tmp5 = load i8** %fmt, align 8
  %call = call i32 @bar(i8* %tmp5)
