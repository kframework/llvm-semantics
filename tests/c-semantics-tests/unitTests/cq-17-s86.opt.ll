...
entry:
  %arraydecay = getelementptr inbounds %struct.defs* %pd0, i64 0, i32 15, i64 0
  %incdec.ptr2 = getelementptr inbounds %struct.defs* %pd0, i64 0, i32 15, i64 1
  store i8 115, i8* %arraydecay, align 1, !tbaa !0
  %incdec.ptr2.1 = getelementptr inbounds %struct.defs* %pd0, i64 0, i32 15, i64 2
  store i8 56, i8* %incdec.ptr2, align 1, !tbaa !0
  %incdec.ptr2.2 = getelementptr inbounds %struct.defs* %pd0, i64 0, i32 15, i64 3
  store i8 54, i8* %incdec.ptr2.1, align 1, !tbaa !0
  %incdec.ptr2.3 = getelementptr inbounds %struct.defs* %pd0, i64 0, i32 15, i64 4
  store i8 32, i8* %incdec.ptr2.2, align 1, !tbaa !0
  %incdec.ptr2.4 = getelementptr inbounds %struct.defs* %pd0, i64 0, i32 15, i64 5
  store i8 32, i8* %incdec.ptr2.3, align 1, !tbaa !0
  %incdec.ptr2.5 = getelementptr inbounds %struct.defs* %pd0, i64 0, i32 15, i64 6
  store i8 32, i8* %incdec.ptr2.4, align 1, !tbaa !0
  %incdec.ptr2.6 = getelementptr inbounds %struct.defs* %pd0, i64 0, i32 15, i64 7
  store i8 32, i8* %incdec.ptr2.5, align 1, !tbaa !0
  store i8 0, i8* %incdec.ptr2.6, align 1, !tbaa !0
  br label %for.cond41.preheader

for.cond41.preheader:                             ; preds = %for.inc63.2, %entry
  %indvars.iv = phi i64 [ 0, %entry ], [ %indvars.iv.next, %for.inc63.2 ]
  %lrc.2109 = phi i32 [ 0, %entry ], [ %lrc.4.2, %for.inc63.2 ]
  %0 = mul nsw i64 %indvars.iv, 3
  %arrayidx48 = getelementptr inbounds [4 x [3 x float]]* @sec.y2, i64 0, i64 %indvars.iv, i64 0
  %1 = load float* %arrayidx48, align 4, !tbaa !3
  %arrayidx52 = getelementptr inbounds [4 x [3 x float]]* @sec.y2, i64 0, i64 %indvars.iv, i64 0
  %2 = load float* %arrayidx52, align 4, !tbaa !3
  %cmp53 = fcmp une float %1, %2
  br i1 %cmp53, label %if.then61, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %for.cond41.preheader
  %arrayidx59 = getelementptr inbounds [12 x float]* @sec.y0, i64 0, i64 %0
  %3 = load float* %arrayidx59, align 4, !tbaa !3
  %cmp60 = fcmp une float %1, %3
  br i1 %cmp60, label %if.then61, label %for.inc63

if.then61:                                        ; preds = %lor.lhs.false, %for.cond41.preheader
  br label %for.inc63

for.inc63:                                        ; preds = %lor.lhs.false, %if.then61
  %lrc.4 = phi i32 [ 1, %if.then61 ], [ %lrc.2109, %lor.lhs.false ]
  %arrayidx48.1 = getelementptr inbounds [4 x [3 x float]]* @sec.y2, i64 0, i64 %indvars.iv, i64 1
  %4 = load float* %arrayidx48.1, align 4, !tbaa !3
  %arrayidx52.1 = getelementptr inbounds [4 x [3 x float]]* @sec.y2, i64 0, i64 %indvars.iv, i64 1
  %5 = load float* %arrayidx52.1, align 4, !tbaa !3
  %cmp53.1 = fcmp une float %4, %5
  br i1 %cmp53.1, label %if.then61.1, label %lor.lhs.false.1

for.end68:                                        ; preds = %for.inc63.2
  %cmp69 = icmp eq i32 %lrc.4.2, 0
  br i1 %cmp69, label %if.end102, label %if.then70

if.then70:                                        ; preds = %for.end68
  %flgd71 = getelementptr inbounds %struct.defs* %pd0, i64 0, i32 11
  %6 = load i32* %flgd71, align 4, !tbaa !2
  %cmp72 = icmp eq i32 %6, 0
  br i1 %cmp72, label %if.end102, label %if.then73

if.then73:                                        ; preds = %if.then70
  %call74 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s86er, i64 0, i64 0), i32 16) nounwind
  br label %if.end102

if.end102:                                        ; preds = %for.end68, %if.then70, %if.then73
  %rc.5 = phi i32 [ 0, %for.end68 ], [ 16, %if.then70 ], [ 16, %if.then73 ]
  ret i32 %rc.5

lor.lhs.false.1:                                  ; preds = %for.inc63
  %7 = add nsw i64 %0, 1
  %arrayidx59.1 = getelementptr inbounds [12 x float]* @sec.y0, i64 0, i64 %7
  %8 = load float* %arrayidx59.1, align 4, !tbaa !3
  %cmp60.1 = fcmp une float %4, %8
  br i1 %cmp60.1, label %if.then61.1, label %for.inc63.1

if.then61.1:                                      ; preds = %lor.lhs.false.1, %for.inc63
  br label %for.inc63.1

for.inc63.1:                                      ; preds = %if.then61.1, %lor.lhs.false.1
  %lrc.4.1 = phi i32 [ 1, %if.then61.1 ], [ %lrc.4, %lor.lhs.false.1 ]
  %arrayidx48.2 = getelementptr inbounds [4 x [3 x float]]* @sec.y2, i64 0, i64 %indvars.iv, i64 2
  %9 = load float* %arrayidx48.2, align 4, !tbaa !3
  %arrayidx52.2 = getelementptr inbounds [4 x [3 x float]]* @sec.y2, i64 0, i64 %indvars.iv, i64 2
  %10 = load float* %arrayidx52.2, align 4, !tbaa !3
  %cmp53.2 = fcmp une float %9, %10
  br i1 %cmp53.2, label %if.then61.2, label %lor.lhs.false.2

lor.lhs.false.2:                                  ; preds = %for.inc63.1
  %11 = add nsw i64 %0, 2
  %arrayidx59.2 = getelementptr inbounds [12 x float]* @sec.y0, i64 0, i64 %11
  %12 = load float* %arrayidx59.2, align 4, !tbaa !3
  %cmp60.2 = fcmp une float %9, %12
  br i1 %cmp60.2, label %if.then61.2, label %for.inc63.2

if.then61.2:                                      ; preds = %lor.lhs.false.2, %for.inc63.1
  br label %for.inc63.2

for.inc63.2:                                      ; preds = %if.then61.2, %lor.lhs.false.2
  %lrc.4.2 = phi i32 [ 1, %if.then61.2 ], [ %lrc.4.1, %lor.lhs.false.2 ]
  %indvars.iv.next = add i64 %indvars.iv, 1
  %lftr.wideiv = trunc i64 %indvars.iv.next to i32
  %exitcond = icmp eq i32 %lftr.wideiv, 4
  br i1 %exitcond, label %for.end68, label %for.cond41.preheader
}
