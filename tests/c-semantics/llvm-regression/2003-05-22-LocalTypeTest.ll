...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = getelementptr inbounds %struct.sometimes* %S, i32 0, i32 0
  store i32 1, i32* %2, align 4
  %3 = getelementptr inbounds %struct.sometimes* %S, i32 0, i32 0
  %4 = load i32* %3, align 4
  store i32 %4, i32* %X, align 4
  %5 = getelementptr inbounds %struct.sometimes.0* %S1, i32 0, i32 0
  store i8 -1, i8* %5, align 1
  %6 = getelementptr inbounds %struct.sometimes.0* %S1, i32 0, i32 0
  %7 = load i8* %6, align 1
  %8 = sext i8 %7 to i32
  %9 = load i32* %X, align 4
  %10 = add nsw i32 %9, %8
  store i32 %10, i32* %X, align 4
  %11 = load i16* getelementptr inbounds (%struct.sometimes.1* @Y, i32 0, i32 0), align 2
  %12 = sext i16 %11 to i32
  %13 = load i32* %X, align 4
  %14 = add nsw i32 %13, %12
  store i32 %14, i32* %X, align 4
  %15 = load i32* %X, align 4
  %16 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str, i32 0, i32 0), i32 %15)
