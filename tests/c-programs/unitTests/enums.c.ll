...
@.str.1 = private unnamed_addr constant [9 x i8] c"var==%d\0A\00", align 1
@aGlobalStruct = common global %struct.globalStruct zeroinitializer, align 4
@.str.2 = private unnamed_addr constant [21 x i8] c"aGlobalStruct.a==%d\0A\00", align 1
...
define i32 @main() #0 {
  ...
  %2 = load i32*, i32** %cp, align 8
  %3 = load i32, i32* %2, align 4
  %4 = icmp ne i32 %3, 20
  br i1 %4, label %5, label %9

; <label>:5                                       ; preds = %0
  %6 = load i32*, i32** %cp, align 8
...
; <label>:17                                      ; preds = %9
  ...
  %19 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i32 0, i32 0), i32 %18)
  br label %20

; <label>:20                                      ; preds = %17, %9
  store i32 0, i32* getelementptr inbounds (%struct.globalStruct, %struct.globalStruct* @aGlobalStruct, i32 0, i32 0), align 4
  %21 = load i32, i32* getelementptr inbounds (%struct.globalStruct, %struct.globalStruct* @aGlobalStruct, i32 0, i32 0), align 4
  %22 = icmp ne i32 %21, 0
  br i1 %22, label %23, label %26

; <label>:23                                      ; preds = %20
  %24 = load i32, i32* getelementptr inbounds (%struct.globalStruct, %struct.globalStruct* @aGlobalStruct, i32 0, i32 0), align 4
  %25 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.2, i32 0, i32 0), i32 %24)
  br label %26
