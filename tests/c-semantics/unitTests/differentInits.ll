...
define i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* getelementptr inbounds ([3 x i8]* @main.x3, i32 0, i32 0), i64 3, i32 1, i1 false)
  %3 = bitcast [2 x i8]* %x4 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %3, i8* getelementptr inbounds ([2 x i8]* @main.x4, i32 0, i32 0), i64 2, i32 1, i1 false)
  %4 = bitcast [3 x i8]* %x13 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %4, i8* getelementptr inbounds ([3 x i8]* @main.x13, i32 0, i32 0), i64 3, i32 1, i1 false)
  %5 = getelementptr inbounds %struct.anon* %x15, i32 0, i32 0
  %6 = getelementptr inbounds [2 x i8]* %5, i32 0, i64 0
  store i8 104, i8* %6, align 1
  %7 = getelementptr inbounds %struct.anon* %x15, i32 0, i32 0
  %8 = getelementptr inbounds [2 x i8]* %7, i32 0, i64 1
  store i8 105, i8* %8, align 1
  %9 = getelementptr inbounds %struct.anon* %x15, i32 0, i32 1
  %10 = getelementptr inbounds [3 x i8]* %9, i32 0, i64 0
  store i8 104, i8* %10, align 1
  %11 = getelementptr inbounds %struct.anon* %x15, i32 0, i32 1
  %12 = getelementptr inbounds [3 x i8]* %11, i32 0, i64 1
  store i8 105, i8* %12, align 1
  %13 = getelementptr inbounds %struct.anon* %x15, i32 0, i32 1
  %14 = getelementptr inbounds [3 x i8]* %13, i32 0, i64 2
  store i8 0, i8* %14, align 1
  %15 = bitcast %struct.anon.0* %x14 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %15, i8* getelementptr inbounds (%struct.anon.0* @main.x14, i32 0, i32 0, i32 0), i64 5, i32 1, i1 false)
  %16 = bitcast [3 x i8]* %x5 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %16, i8* getelementptr inbounds ([3 x i8]* @main.x5, i32 0, i32 0), i64 3, i32 1, i1 false)
  %17 = bitcast [3 x i8]* %x6 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %17, i8* getelementptr inbounds ([3 x i8]* @main.x6, i32 0, i32 0), i64 3, i32 1, i1 false)
  %18 = bitcast [2 x i8]* %x7 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %18, i8* getelementptr inbounds ([2 x i8]* @main.x7, i32 0, i32 0), i64 2, i32 1, i1 false)
  %19 = bitcast %struct.anon.1* %x11 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %19, i8* getelementptr inbounds (%struct.anon.1* @main.x11, i32 0, i32 0, i32 0), i64 3, i32 1, i1 false)
  %20 = getelementptr inbounds %struct.anon.1* %x11, i32 0, i32 0
  %21 = getelementptr inbounds [3 x i8]* %20, i32 0, i64 0
  %22 = load i8* %21, align 1
  %23 = sext i8 %22 to i32
  %24 = getelementptr inbounds %struct.anon.1* %x11, i32 0, i32 0
  %25 = getelementptr inbounds [3 x i8]* %24, i32 0, i64 1
  %26 = load i8* %25, align 1
  %27 = sext i8 %26 to i32
  %28 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0), i32 %23, i32 %27)
  ...
  %30 = getelementptr inbounds %struct.anon.2* %x12, i32 0, i32 0
  %31 = load i8** %30, align 8
  %32 = getelementptr inbounds i8* %31, i64 0
  %33 = load i8* %32, align 1
  %34 = sext i8 %33 to i32
  %35 = getelementptr inbounds %struct.anon.1* %x11, i32 0, i32 0
  %36 = getelementptr inbounds [3 x i8]* %35, i32 0, i64 1
  %37 = load i8* %36, align 1
  %38 = sext i8 %37 to i32
  %39 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0), i32 %34, i32 %38)
  %40 = bitcast [3 x i8]* %x8 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %40, i8* getelementptr inbounds ([3 x i8]* @main.x8, i32 0, i32 0), i64 3, i32 1, i1 false)
