; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20011024-1.c'
...
if.end:                                           ; preds = %entry
  %call = call i32 @strcmp(i8* getelementptr inbounds ([50 x i8]* @buf, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0)) readonly
...
declare i32 @strcmp(i8*, i8*) readonly
