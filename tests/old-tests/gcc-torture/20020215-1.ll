; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20020215-1.c'
...
lor.lhs.false:                                    ; preds = %entry
  ...
  %tmp4 = load i64* %i23, align 8
  %cmp5 = icmp ne i64 %tmp4, 2001
  br i1 %cmp5, label %if.then, label %lor.lhs.false7

lor.lhs.false7:                                   ; preds = %lor.lhs.false
  %i38 = getelementptr inbounds %struct.s* %s, i32 0, i32 2
  %tmp9 = load i16* %i38, align 2
  %conv10 = sext i16 %tmp9 to i32
  %cmp11 = icmp ne i32 %conv10, 3000
