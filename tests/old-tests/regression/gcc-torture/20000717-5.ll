; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20000717-5.c'
...
lor.lhs.false9:                                   ; preds = %lor.lhs.false6
  %tmp10 = load i32* %j.addr, align 4
  %cmp11 = icmp ne i32 %tmp10, 5
  br i1 %cmp11, label %if.then, label %lor.lhs.false12

lor.lhs.false12:                                  ; preds = %lor.lhs.false9
  %tmp13 = load i32* %k.addr, align 4
...
entry:
  ...
  %call = call i32 @bar(i32 %tmp, i32 %tmp1, i32 %tmp2, i64 %5, i32 %7)
  ret i32 %call
}
...
entry:
  ...
  %call = call i32 @foo(i64 %2, i32 %4, i32 4, i32 5, i32 6)
