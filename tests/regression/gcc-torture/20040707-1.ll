; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20040707-1.c'
...
entry:
  ...
  store i16 %s.coerce, i16* %0
  %tmp = bitcast %struct.s* %s to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* getelementptr inbounds (%struct.s* @foo.s1, i32 0, i32 0), i8* %tmp, i64 2, i32 1, i1 false)
  ret void
}
