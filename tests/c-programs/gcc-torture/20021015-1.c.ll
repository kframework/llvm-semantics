...
define void @g(i8* %p, i8* %list, i32 %length, i8** %elementPtr, i8** %nextPtr) #0 {
  ...
  %8 = icmp ne i8* %7, getelementptr inbounds ([1 x i8], [1 x i8]* @g_list, i32 0, i32 0)
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  store i8* getelementptr inbounds ([1 x i8], [1 x i8]* @g_list, i32 0, i32 0), i8** %list, align 8
  store i32 100, i32* %length, align 4
  store i32 0, i32* %i, align 4
  br label %2

; <label>:2                                       ; preds = %20, %0
  %3 = load i8*, i8** %list, align 8
...
; <label>:7                                       ; preds = %2
  ...
  %11 = load i8*, i8** %list, align 8
  %12 = load i8*, i8** %prevList, align 8
