; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith000280.c'
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [10 x i32**]* %l_2, i32 0, i64 %idxprom
  store i32** %l_3, i32*** %arrayidx, align 8
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  store i32* null, i32** getelementptr inbounds ([2 x [5 x i32*]]* @g_5, i32 0, i64 0, i64 2), align 8
