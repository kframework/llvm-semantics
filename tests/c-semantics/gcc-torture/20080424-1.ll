...
define void @bar([3 x i32]* %x, [3 x i32]* %y) #0 {
  ...
  %3 = load [3 x i32]** %1, align 8
  %4 = load i32* @bar.i, align 4
  %5 = add nsw i32 %4, 8
  %6 = sext i32 %5 to i64
  %7 = getelementptr inbounds [48 x [3 x [3 x i32]]]* @g, i32 0, i64 %6
  %8 = getelementptr inbounds [3 x [3 x i32]]* %7, i32 0, i32 0
  %9 = icmp ne [3 x i32]* %3, %8
  br i1 %9, label %18, label %10

; <label>:10                                      ; preds = %0
  %11 = load [3 x i32]** %2, align 8
  %12 = load i32* @bar.i, align 4
  %13 = add nsw i32 %12, 1
  store i32 %13, i32* @bar.i, align 4
  %14 = sext i32 %12 to i64
  %15 = getelementptr inbounds [48 x [3 x [3 x i32]]]* @g, i32 0, i64 %14
  %16 = getelementptr inbounds [3 x [3 x i32]]* %15, i32 0, i32 0
...
define i32 @main() #2 {
  ...
  store i32 0, i32* %2
  store [3 x [3 x i32]]* getelementptr inbounds ([48 x [3 x [3 x i32]]]* @g, i32 0, i32 0), [3 x [3 x i32]]** %1, align 8
...
; <label>:6                                       ; preds = %3
  %7 = load i32* %i.i, align 4
  %8 = add nsw i32 %7, 8
  store i32 %8, i32* %k.i, align 4
  %9 = load i32* %k.i, align 4
  %10 = sext i32 %9 to i64
  %11 = load [3 x [3 x i32]]** %1, align 8
  %12 = getelementptr inbounds [3 x [3 x i32]]* %11, i64 %10
  %13 = getelementptr inbounds [3 x [3 x i32]]* %12, i32 0, i32 0
  %14 = load i32* %k.i, align 4
  %15 = sub nsw i32 %14, 8
  %16 = sext i32 %15 to i64
  %17 = load [3 x [3 x i32]]** %1, align 8
  %18 = getelementptr inbounds [3 x [3 x i32]]* %17, i64 %16
  %19 = getelementptr inbounds [3 x [3 x i32]]* %18, i32 0, i32 0
