...
@a1 = global %struct.anon { i8 52, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0) }, align 8
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = load i32, i32* @basicInit, align 4
  %3 = icmp ne i32 %2, 5
...
; <label>:6                                       ; preds = %4, %0
  %7 = load i8, i8* @basicInit2, align 1
  %8 = sext i8 %7 to i32
  %9 = icmp ne i32 %8, 10
...
; <label>:12                                      ; preds = %10, %6
  %13 = load i32, i32* getelementptr inbounds ([2 x i32], [2 x i32]* @basicArr, i32 0, i64 0), align 4
...
; <label>:17                                      ; preds = %15, %12
  %18 = load i32, i32* getelementptr inbounds ([2 x i32], [2 x i32]* @basicArr, i32 0, i64 1), align 4
...
; <label>:22                                      ; preds = %20, %17
  %23 = load i8, i8* getelementptr inbounds (%struct.anon, %struct.anon* @a1, i32 0, i32 0), align 1
...
; <label>:28                                      ; preds = %26, %22
  %29 = load i8*, i8** getelementptr inbounds (%struct.anon, %struct.anon* @a1, i32 0, i32 1), align 8
...
; <label>:36                                      ; preds = %34, %28
  %37 = load i8*, i8** getelementptr inbounds (%struct.anon, %struct.anon* @a1, i32 0, i32 1), align 8
...
; <label>:44                                      ; preds = %42, %36
  %45 = load i8*, i8** getelementptr inbounds (%struct.anon, %struct.anon* @a1, i32 0, i32 1), align 8
...
; <label>:52                                      ; preds = %50, %44
  %53 = load i8, i8* getelementptr inbounds (%struct.anon.0, %struct.anon.0* @a2, i32 0, i32 0), align 1
...
; <label>:58                                      ; preds = %56, %52
  %59 = load i8, i8* getelementptr inbounds (%struct.anon.0, %struct.anon.0* @a2, i32 0, i32 1, i64 0), align 1
...
; <label>:64                                      ; preds = %62, %58
  %65 = load i8, i8* getelementptr inbounds (%struct.anon.0, %struct.anon.0* @a2, i32 0, i32 1, i64 1), align 1
  %66 = sext i8 %65 to i32
  %67 = icmp ne i32 %66, 113
  br i1 %67, label %68, label %70

; <label>:68                                      ; preds = %64
  %69 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i32 0, i32 0))
  br label %70

; <label>:70                                      ; preds = %68, %64
  %71 = load i8, i8* getelementptr inbounds (%struct.sa3b, %struct.sa3b* @a3, i32 0, i32 0, i32 0), align 1
...
; <label>:76                                      ; preds = %74, %70
  %77 = load i8, i8* getelementptr inbounds (%struct.sa3b, %struct.sa3b* @a3, i32 0, i32 1, i64 0), align 1
...
; <label>:82                                      ; preds = %80, %76
  %83 = load i8, i8* getelementptr inbounds (%struct.sa3b, %struct.sa3b* @a3, i32 0, i32 1, i64 1), align 1
...
; <label>:88                                      ; preds = %86, %82
  %89 = load i8, i8* getelementptr inbounds (%struct.anon.1, %struct.anon.1* @a4, i32 0, i32 0), align 1
...
; <label>:94                                      ; preds = %92, %88
  %95 = load i8, i8* getelementptr inbounds (%struct.anon.1, %struct.anon.1* @a4, i32 0, i32 1, i64 0), align 1
...
; <label>:100                                     ; preds = %98, %94
  %101 = load i8, i8* getelementptr inbounds (%struct.anon.1, %struct.anon.1* @a4, i32 0, i32 1, i64 1), align 1
