...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  call void @attr_eq(i8* getelementptr inbounds ([5 x i8]* @arg0, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8]* @arg1, i32 0, i32 0))
...
define internal void @attr_rtx(i8* %varg0, i8* %varg1) #0 {
  ...
  %3 = load i8** %1, align 8
  %4 = icmp ne i8* %3, getelementptr inbounds ([5 x i8]* @arg0, i32 0, i32 0)
...
; <label>:6                                       ; preds = %0
  %7 = load i8** %2, align 8
  %8 = icmp ne i8* %7, getelementptr inbounds ([5 x i8]* @arg1, i32 0, i32 0)
