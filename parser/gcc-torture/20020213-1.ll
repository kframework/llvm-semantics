; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20020213-1.c'
...
entry:
  %tmp = load float* getelementptr inbounds (%struct.A* @a, i32 0, i32 0), align 4
  %call = call i32 @bar(float %tmp)
  store i32 %call, i32* getelementptr inbounds (%struct.A* @a, i32 0, i32 1), align 4
  %tmp1 = load i32* getelementptr inbounds (%struct.A* @a, i32 0, i32 1), align 4
  %tmp2 = load i32* @b, align 4
  %sub = sub nsw i32 %tmp2, 1
  %cmp = icmp slt i32 %tmp1, %sub
  br i1 %cmp, label %cond.true, label %cond.false

cond.true:                                        ; preds = %entry
  %tmp3 = load i32* getelementptr inbounds (%struct.A* @a, i32 0, i32 1), align 4
  br label %cond.end
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %tmp3, %cond.true ], [ %sub5, %cond.false ]
  store i32 %cond, i32* getelementptr inbounds (%struct.A* @a, i32 0, i32 1), align 4
  %tmp6 = load i32* getelementptr inbounds (%struct.A* @a, i32 0, i32 1), align 4
  %tmp7 = load i32* @b, align 4
  %sub8 = sub nsw i32 %tmp7, 1
  %cmp9 = icmp sge i32 %tmp6, %sub8
