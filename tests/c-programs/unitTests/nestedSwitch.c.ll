...
@.str.2 = private unnamed_addr constant [9 x i8] c"default\0A\00", align 1
@.str.3 = private unnamed_addr constant [7 x i8] c"three\0A\00", align 1
@.str.4 = private unnamed_addr constant [13 x i8] c"sneaky four\0A\00", align 1
...
; <label>:14                                      ; preds = %8
  %15 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i32 0, i32 0))
  br label %18
...
; <label>:19                                      ; preds = %5
  %20 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.4, i32 0, i32 0))
  br label %21
