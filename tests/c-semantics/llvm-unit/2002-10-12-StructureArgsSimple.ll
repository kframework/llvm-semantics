...
define void @print(double %S.coerce0, double %S.coerce1) #0 {
  ...
  %4 = getelementptr inbounds %struct.vec2* %S, i32 0, i32 0
  %5 = load double* %4, align 8
  %6 = fmul double 1.000000e+04, %5
  %7 = fptosi double %6 to i32
  %8 = getelementptr inbounds %struct.vec2* %S, i32 0, i32 1
  %9 = load double* %8, align 8
  %10 = fmul double 1.000000e+04, %9
  %11 = fptosi double %10 to i32
  %12 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([8 x i8]* @.str, i32 0, i32 0), i32 %7, i32 %11)
  ret void
}
...
define i32 @main() #0 {
  ...
  %7 = getelementptr { double, double }* %4, i32 0, i32 1
