; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith000547.c'
...
for.body12:                                       ; preds = %for.cond9
  ...
  %arrayidx = getelementptr inbounds [8 x [2 x [1 x [6 x i32]]]]* %l_5, i32 0, i64 %idxprom19
  %arrayidx20 = getelementptr inbounds [2 x [1 x [6 x i32]]]* %arrayidx, i32 0, i64 %idxprom17
  %arrayidx21 = getelementptr inbounds [1 x [6 x i32]]* %arrayidx20, i32 0, i64 %idxprom15
  %arrayidx22 = getelementptr inbounds [6 x i32]* %arrayidx21, i32 0, i64 %idxprom
  store i32 553545266, i32* %arrayidx22, align 4
  br label %for.inc
...
for.cond36:                                       ; preds = %for.inc45, %for.end35
  %tmp37 = load i32* @g_2, align 4
  %cmp38 = icmp sle i32 %tmp37, 0
  br i1 %cmp38, label %for.body39, label %for.end48

for.body39:                                       ; preds = %for.cond36
  %arrayidx40 = getelementptr inbounds [8 x [2 x [1 x [6 x i32]]]]* %l_5, i32 0, i64 6
  %arrayidx41 = getelementptr inbounds [2 x [1 x [6 x i32]]]* %arrayidx40, i32 0, i64 0
  %arrayidx42 = getelementptr inbounds [1 x [6 x i32]]* %arrayidx41, i32 0, i64 0
  %arrayidx43 = getelementptr inbounds [6 x i32]* %arrayidx42, i32 0, i64 4
...
for.inc45:                                        ; No predecessors!
  ...
  %conv = trunc i32 %tmp46 to i16
  %call = call signext i16 @safe_sub_func_int16_t_s_s(i16 signext %conv, i16 signext 1)
  %conv47 = sext i16 %call to i32
  store i32 %conv47, i32* @g_2, align 4
  br label %for.cond36

for.end48:                                        ; preds = %for.cond36
  %tmp49 = load i32* @g_2, align 4
  store i32 %tmp49, i32* %retval
  br label %return

return:                                           ; preds = %for.end48, %for.body39
  %0 = load i32* %retval
  ret i32 %0
}
