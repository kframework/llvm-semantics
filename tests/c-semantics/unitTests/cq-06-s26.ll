...
define i32 @sec(%struct.defs* %pd0) #0 {
  ...
  %5 = getelementptr inbounds %struct.defs* %4, i32 0, i32 10
  %6 = load i32* %5, align 4
  %7 = icmp ne i32 %6, 0
  br i1 %7, label %8, label %47

; <label>:8                                       ; preds = %0
  %9 = load %struct.defs** %1, align 8
  %10 = getelementptr inbounds %struct.defs* %9, i32 0, i32 0
  %11 = load i32* %10, align 4
  %12 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @sec.s, i32 0, i32 0), i32 %11, i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0))
  %13 = load %struct.defs** %1, align 8
  %14 = getelementptr inbounds %struct.defs* %13, i32 0, i32 1
  %15 = load i32* %14, align 4
  %16 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @sec.s, i32 0, i32 0), i32 %15, i8* getelementptr inbounds ([4 x i8]* @.str1, i32 0, i32 0))
  %17 = load %struct.defs** %1, align 8
  %18 = getelementptr inbounds %struct.defs* %17, i32 0, i32 2
  %19 = load i32* %18, align 4
  %20 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @sec.s, i32 0, i32 0), i32 %19, i8* getelementptr inbounds ([6 x i8]* @.str2, i32 0, i32 0))
  %21 = load %struct.defs** %1, align 8
  %22 = getelementptr inbounds %struct.defs* %21, i32 0, i32 3
  %23 = load i32* %22, align 4
  %24 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @sec.s, i32 0, i32 0), i32 %23, i8* getelementptr inbounds ([5 x i8]* @.str3, i32 0, i32 0))
  %25 = load %struct.defs** %1, align 8
  %26 = getelementptr inbounds %struct.defs* %25, i32 0, i32 4
  %27 = load i32* %26, align 4
  %28 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @sec.s, i32 0, i32 0), i32 %27, i8* getelementptr inbounds ([9 x i8]* @.str4, i32 0, i32 0))
  %29 = load %struct.defs** %1, align 8
  %30 = getelementptr inbounds %struct.defs* %29, i32 0, i32 5
  %31 = load i32* %30, align 4
  %32 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @sec.s, i32 0, i32 0), i32 %31, i8* getelementptr inbounds ([6 x i8]* @.str5, i32 0, i32 0))
  %33 = load %struct.defs** %1, align 8
  %34 = getelementptr inbounds %struct.defs* %33, i32 0, i32 6
  %35 = load i32* %34, align 4
  %36 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @sec.s, i32 0, i32 0), i32 %35, i8* getelementptr inbounds ([7 x i8]* @.str6, i32 0, i32 0))
  %37 = load %struct.defs** %1, align 8
  %38 = getelementptr inbounds %struct.defs* %37, i32 0, i32 7
  %39 = load float* %38, align 4
  %40 = fpext float %39 to double
  %41 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([64 x i8]* @sec.s2, i32 0, i32 0), double %40, i8* getelementptr inbounds ([6 x i8]* @.str5, i32 0, i32 0))
  %42 = load %struct.defs** %1, align 8
  %43 = getelementptr inbounds %struct.defs* %42, i32 0, i32 8
  %44 = load float* %43, align 4
  %45 = fpext float %44 to double
  %46 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([64 x i8]* @sec.s2, i32 0, i32 0), double %45, i8* getelementptr inbounds ([7 x i8]* @.str6, i32 0, i32 0))
  br label %47
...
; <label>:9                                       ; preds = %0
  ...
  %11 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str7, i32 0, i32 0), i8* getelementptr inbounds (%struct.defs* @main.d0, i32 0, i32 15, i32 0), i32 %10)
  br label %12
...
; <label>:15                                      ; preds = %12
  %16 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str8, i32 0, i32 0))
  br label %19

; <label>:17                                      ; preds = %12
  %18 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str9, i32 0, i32 0))
  br label %19
