...
; <label>:15                                      ; preds = %11
  ...
  %18 = load %struct.xx** %1, align 8
  %19 = getelementptr inbounds %struct.xx* %18, i32 0, i32 2
  store i16 %17, i16* %19, align 2
  %20 = load %struct.xx** %1, align 8
  %21 = getelementptr inbounds %struct.xx* %20, i32 0, i32 0
...
; <label>:29                                      ; preds = %28, %25
  %30 = load %struct.xx** %1, align 8
  %31 = getelementptr inbounds %struct.xx* %30, i32 0, i32 2
...
; <label>:35                                      ; preds = %29
  %36 = load %struct.xx** %1, align 8
  %37 = getelementptr inbounds %struct.xx* %36, i32 0, i32 1
  %38 = load %struct.xx** %37, align 8
...
define i32 @f1(%struct.xx* %p) #0 {
  %1 = alloca %struct.xx*, align 8
  store %struct.xx* %p, %struct.xx** %1, align 8
  %2 = load i32* @f1.beenhere, align 4
  %3 = add nsw i32 %2, 1
...
; <label>:6                                       ; preds = %0
  %7 = load i32* @f1.beenhere, align 4
  %8 = icmp sgt i32 %7, 1
  %9 = zext i1 %8 to i32
  ret i32 %9
}
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = getelementptr inbounds %struct.xx* %s, i32 0, i32 0
  store i32 0, i32* %2, align 4
  %3 = getelementptr inbounds %struct.xx* %s, i32 0, i32 1
  store %struct.xx* %s, %struct.xx** %3, align 8
  %4 = getelementptr inbounds %struct.xx* %s, i32 0, i32 2
...
; <label>:7                                       ; preds = %0
  %8 = getelementptr inbounds %struct.xx* %s, i32 0, i32 0
  %9 = load i32* %8, align 4
  %10 = icmp ne i32 %9, 0
  br i1 %10, label %20, label %11

; <label>:11                                      ; preds = %7
  %12 = getelementptr inbounds %struct.xx* %s, i32 0, i32 1
  %13 = load %struct.xx** %12, align 8
  %14 = icmp ne %struct.xx* %13, %s
  br i1 %14, label %20, label %15

; <label>:15                                      ; preds = %11
  %16 = getelementptr inbounds %struct.xx* %s, i32 0, i32 2
