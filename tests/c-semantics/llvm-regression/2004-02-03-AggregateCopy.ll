...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = getelementptr inbounds %struct.agg* %A, i32 0, i32 0
  ...
  %7 = getelementptr inbounds %struct.agg* %A, i32 0, i32 0
  %8 = load i32* %7, align 4
  %9 = getelementptr inbounds %struct.agg* %B, i32 0, i32 0
  %10 = load i32* %9, align 4
  %11 = getelementptr inbounds %struct.agg* %C, i32 0, i32 0
  %12 = load i32* %11, align 4
  %13 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0), i32 %8, i32 %10, i32 %12)
  ret i32 0
}
