; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/va-arg-2.c'
...
while.body:                                       ; preds = %while.cond
  %tmp4 = load i8** %format.addr, align 8
...
vaarg.end:                                        ; preds = %vaarg.in_mem, %vaarg.in_reg
  ...
  %call7 = call i32 @to_hex(i32 %5)
  %cmp8 = icmp ne i32 %conv, %call7
