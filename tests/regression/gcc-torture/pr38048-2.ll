; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/pr38048-2.c'
...
for.body:                                         ; preds = %for.cond
  ...
  %tmp2 = load [2 x i32]** %a.addr, align 8
  %arrayidx = getelementptr inbounds [2 x i32]* %tmp2, i64 %idxprom
  %arrayidx3 = getelementptr inbounds [2 x i32]* %arrayidx, i32 0, i64 0
  %tmp4 = load i32* %arrayidx3
  %tmp5 = load i32* %j, align 4
  %idxprom6 = sext i32 %tmp5 to i64
  %tmp7 = load [2 x i32]** %a.addr, align 8
  %arrayidx8 = getelementptr inbounds [2 x i32]* %tmp7, i64 %idxprom6
  %arrayidx9 = getelementptr inbounds [2 x i32]* %arrayidx8, i32 0, i64 1
  %tmp10 = load i32* %arrayidx9
  %add = add nsw i32 %tmp4, %tmp10
  %tmp11 = load i32* %det, align 4
  %add12 = add nsw i32 %tmp11, %add
  store i32 %add12, i32* %det, align 4
  br label %for.inc
