; ModuleID = '/home/grosu/celliso2/c-semantics/tests/unitTests/cq-08-s61.c'
...
while.end:                                        ; preds = %while.cond
  ...
  %tmp5 = load i16* %from, align 2
  %conv = sext i16 %tmp5 to i64
  store i64 %conv, i64* %to, align 8
  %tmp6 = load i64* %to, align 8
  %cmp = icmp ne i64 %tmp6, -19
  br i1 %cmp, label %if.then, label %if.end14

if.then:                                          ; preds = %while.end
  %tmp8 = load i32* %rc, align 4
  %add = add nsw i32 %tmp8, 1
  store i32 %add, i32* %rc, align 4
  %tmp9 = load %struct.defs** %pd0.addr, align 8
  %flgd = getelementptr inbounds %struct.defs* %tmp9, i32 0, i32 11
  %tmp10 = load i32* %flgd, align 4
...
if.end14:                                         ; preds = %if.end, %while.end
  ...
  %arrayidx15 = getelementptr inbounds [6 x i8*]* %pc, i32 0, i64 1
  store i8* getelementptr inbounds ([27 x i8]* @sec.lower_alpha, i32 0, i32 0), i8** %arrayidx15, align 8
  %arrayidx16 = getelementptr inbounds [6 x i8*]* %pc, i32 0, i64 2
  store i8* getelementptr inbounds ([11 x i8]* @sec.numbers, i32 0, i32 0), i8** %arrayidx16, align 8
  %arrayidx17 = getelementptr inbounds [6 x i8*]* %pc, i32 0, i64 3
  store i8* getelementptr inbounds ([28 x i8]* @sec.special_characters, i32 0, i32 0), i8** %arrayidx17, align 8
  %arrayidx18 = getelementptr inbounds [6 x i8*]* %pc, i32 0, i64 4
  store i8* getelementptr inbounds ([8 x i8]* @sec.extra_special_characters, i32 0, i32 0), i8** %arrayidx18, align 8
  %arrayidx19 = getelementptr inbounds [6 x i8*]* %pc, i32 0, i64 5
  store i8* getelementptr inbounds ([3 x i8]* @sec.blank_and_NUL, i32 0, i32 0), i8** %arrayidx19, align 8
...
for.cond:                                         ; preds = %for.inc, %if.end14
  ...
  %cmp21 = icmp slt i32 %tmp20, 6
  br i1 %cmp21, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  br label %while.cond23

while.cond23:                                     ; preds = %if.end40, %for.body
  %tmp24 = load i32* %j, align 4
  %idxprom = sext i32 %tmp24 to i64
  %arrayidx25 = getelementptr inbounds [6 x i8*]* %pc, i32 0, i64 %idxprom
  %tmp26 = load i8** %arrayidx25, align 8
  %tmp27 = load i8* %tmp26
  %tobool28 = icmp ne i8 %tmp27, 0
  br i1 %tobool28, label %while.body29, label %while.end41

while.body29:                                     ; preds = %while.cond23
  %tmp30 = load i32* %j, align 4
  %idxprom31 = sext i32 %tmp30 to i64
  %arrayidx32 = getelementptr inbounds [6 x i8*]* %pc, i32 0, i64 %idxprom31
  %tmp33 = load i8** %arrayidx32, align 8
  %incdec.ptr34 = getelementptr inbounds i8* %tmp33, i32 1
  store i8* %incdec.ptr34, i8** %arrayidx32, align 8
  %tmp35 = load i8* %tmp33
...
if.end40:                                         ; preds = %if.then39, %while.body29
  br label %while.cond23

while.end41:                                      ; preds = %while.cond23
  br label %for.inc

for.inc:                                          ; preds = %while.end41
...
for.end:                                          ; preds = %for.cond
  %tmp43 = load i32* %lrc, align 4
  %cmp44 = icmp ne i32 %tmp43, 0
  br i1 %cmp44, label %if.then46, label %if.end57

if.then46:                                        ; preds = %for.end
  %tmp47 = load i32* %rc, align 4
  %add48 = add nsw i32 %tmp47, 2
  store i32 %add48, i32* %rc, align 4
  %tmp49 = load %struct.defs** %pd0.addr, align 8
  %flgd50 = getelementptr inbounds %struct.defs* %tmp49, i32 0, i32 11
  %tmp51 = load i32* %flgd50, align 4
  %cmp52 = icmp ne i32 %tmp51, 0
  br i1 %cmp52, label %if.then54, label %if.end56

if.then54:                                        ; preds = %if.then46
  %call55 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s61er, i32 0, i32 0), i32 2)
  br label %if.end56
...
if.end57:                                         ; preds = %if.end56, %for.end
  ...
  %tmp58 = load i64* %longint, align 8
  %conv59 = trunc i64 %tmp58 to i16
  store i16 %conv59, i16* %shortint, align 2
  %tmp60 = load i64* %longint, align 8
  %conv61 = trunc i64 %tmp60 to i8
  store i8 %conv61, i8* %charint, align 1
  %tmp63 = load i16* %shortint, align 2
  %conv64 = sext i16 %tmp63 to i64
  %tmp65 = load i64* %longint, align 8
  %cmp66 = icmp ne i64 %conv64, %tmp65
  br i1 %cmp66, label %land.rhs, label %land.end

land.rhs:                                         ; preds = %if.end57
  %tmp68 = load i16* %shortint, align 2
  %conv69 = sext i16 %tmp68 to i32
  %cmp70 = icmp ne i32 %conv69, 3
  br label %land.end

land.end:                                         ; preds = %land.rhs, %if.end57
  %0 = phi i1 [ false, %if.end57 ], [ %cmp70, %land.rhs ]
  %land.ext = zext i1 %0 to i32
  store i32 %land.ext, i32* %guard, align 4
  %tmp72 = load i32* %guard, align 4
  %tobool73 = icmp ne i32 %tmp72, 0
  br i1 %tobool73, label %if.end87, label %if.then74

if.then74:                                        ; preds = %land.end
  %tmp75 = load i8* %charint, align 1
  %conv76 = sext i8 %tmp75 to i64
  %tmp77 = load i64* %longint, align 8
  %cmp78 = icmp ne i64 %conv76, %tmp77
  br i1 %cmp78, label %land.rhs80, label %land.end85

land.rhs80:                                       ; preds = %if.then74
  %tmp81 = load i8* %charint, align 1
  %conv82 = sext i8 %tmp81 to i32
  %cmp83 = icmp ne i32 %conv82, 3
  br label %land.end85

land.end85:                                       ; preds = %land.rhs80, %if.then74
  %1 = phi i1 [ false, %if.then74 ], [ %cmp83, %land.rhs80 ]
  %land.ext86 = zext i1 %1 to i32
  store i32 %land.ext86, i32* %guard, align 4
  br label %if.end87

if.end87:                                         ; preds = %land.end85, %land.end
  %tmp88 = load i32* %guard, align 4
  %tobool89 = icmp ne i32 %tmp88, 0
  br i1 %tobool89, label %if.then90, label %if.end101

if.then90:                                        ; preds = %if.end87
  %tmp91 = load i32* %rc, align 4
  %add92 = add nsw i32 %tmp91, 8
  store i32 %add92, i32* %rc, align 4
  %tmp93 = load %struct.defs** %pd0.addr, align 8
  %flgd94 = getelementptr inbounds %struct.defs* %tmp93, i32 0, i32 11
  %tmp95 = load i32* %flgd94, align 4
  %cmp96 = icmp ne i32 %tmp95, 0
  br i1 %cmp96, label %if.then98, label %if.end100

if.then98:                                        ; preds = %if.then90
  %call99 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s61er, i32 0, i32 0), i32 8)
  br label %if.end100
