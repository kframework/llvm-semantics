; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/loop-11.c'
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %cmp = icmp slt i32 %tmp, 199
  br i1 %cmp, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %tmp1 = load i32* %i, align 4
  %idxprom = sext i32 %tmp1 to i64
  %arrayidx = getelementptr inbounds [199 x i32]* @a, i32 0, i64 %idxprom
