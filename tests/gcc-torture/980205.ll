; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/980205.c'
...
entry:
  ...
  store double %one, double* %one.addr, align 8
...
vaarg.end:                                        ; preds = %vaarg.in_mem, %vaarg.in_reg
  ...
  %tmp = load double* %one.addr, align 8
  %cmp = fcmp une double %tmp, 1.000000e+00
  br i1 %cmp, label %if.then, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %vaarg.end
  %tmp5 = load double* %value, align 8
  %cmp6 = fcmp une double %tmp5, 2.000000e+00
