; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith001521.ll'
...
entry:
  store i32 -3, i32* getelementptr inbounds ([4 x i32]* @g_2, i64 0, i64 0), align 16
  ret i32 -2052499604
}
...
entry:
  store i32 -3, i32* getelementptr inbounds ([4 x i32]* @g_2, i64 0, i64 0), align 16
  %call1 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str, i64 0, i64 0), i32 -3) nounwind
  ...
  %tmp8 = load i32* getelementptr inbounds ([4 x i32]* @g_2, i64 0, i64 0), align 16
  %call9 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str, i64 0, i64 0), i32 %tmp8) nounwind
  ret i32 0
}
