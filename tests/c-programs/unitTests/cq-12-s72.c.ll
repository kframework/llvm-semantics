...
define i32 @sec(%struct.defs* %pd0) #0 {
  ...
  store i8* getelementptr inbounds ([8 x i8], [8 x i8]* @sec.qs72, i32 0, i32 0), i8** %ps, align 8
...
; <label>:18                                      ; preds = %15
  ...
  %21 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @sec.s72er, i32 0, i32 0), i32 1)
  br label %22
...
; <label>:28                                      ; preds = %22
  ...
  %31 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @sec.s72er, i32 0, i32 0), i32 2)
  br label %32
...
; <label>:33                                      ; preds = %44, %32
  ...
  %35 = load %struct.defs*, %struct.defs** %1, align 8
  %36 = getelementptr inbounds %struct.defs, %struct.defs* %35, i32 0, i32 1
...
; <label>:53                                      ; preds = %47
  %54 = load i32, i32* %rc, align 4
  %55 = add nsw i32 %54, 4
  store i32 %55, i32* %rc, align 4
  %56 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @sec.s72er, i32 0, i32 0), i32 4)
  br label %57
...
; <label>:76                                      ; preds = %73, %69, %65, %61, %57
  %77 = load i32, i32* %rc, align 4
  %78 = add nsw i32 %77, 8
  store i32 %78, i32* %rc, align 4
  %79 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @sec.s72er, i32 0, i32 0), i32 8)
  br label %80
...
; <label>:100                                     ; preds = %95
  %101 = load float, float* %f, align 4
...
; <label>:133                                     ; preds = %128
  %134 = load float, float* %f, align 4
...
; <label>:161                                     ; preds = %158
  %162 = load float, float* %f, align 4
...
; <label>:188                                     ; preds = %184
  %189 = load float, float* %f, align 4
