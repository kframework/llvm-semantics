; ModuleID = '/home/grosu/celliso2/c-semantics/tests/unitTests/cq-06-s26.ll'
...
if.then:                                          ; preds = %setupTable.exit
  %call5 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @sec.s, i64 0, i64 0), i32 8, i8* getelementptr inbounds ([5 x i8]* @.str, i64 0, i64 0)) nounwind
  %tmp7 = load i32* %ibits.i, align 4
  %call8 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @sec.s, i64 0, i64 0), i32 %tmp7, i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0)) nounwind
  %tmp10 = load i32* %sbits.i, align 4
  %call11 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @sec.s, i64 0, i64 0), i32 %tmp10, i8* getelementptr inbounds ([6 x i8]* @.str2, i64 0, i64 0)) nounwind
  %tmp13 = load i32* %lbits.i, align 4
  %call14 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @sec.s, i64 0, i64 0), i32 %tmp13, i8* getelementptr inbounds ([5 x i8]* @.str3, i64 0, i64 0)) nounwind
  %tmp16 = load i32* %ubits.i, align 4
  %call17 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @sec.s, i64 0, i64 0), i32 %tmp16, i8* getelementptr inbounds ([9 x i8]* @.str4, i64 0, i64 0)) nounwind
  %tmp19 = load i32* %fbits.i, align 4
  %call20 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @sec.s, i64 0, i64 0), i32 %tmp19, i8* getelementptr inbounds ([6 x i8]* @.str5, i64 0, i64 0)) nounwind
  %tmp22 = load i32* %dbits.i, align 4
  %call23 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @sec.s, i64 0, i64 0), i32 %tmp22, i8* getelementptr inbounds ([7 x i8]* @.str6, i64 0, i64 0)) nounwind
  %tmp25 = load float* %fprec.i, align 4
  %conv = fpext float %tmp25 to double
  %call26 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([64 x i8]* @sec.s2, i64 0, i64 0), double %conv, i8* getelementptr inbounds ([6 x i8]* @.str5, i64 0, i64 0)) nounwind
  %tmp28 = load float* %dprec.i, align 4
  %conv29 = fpext float %tmp28 to double
  %call30 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([64 x i8]* @sec.s2, i64 0, i64 0), double %conv29, i8* getelementptr inbounds ([7 x i8]* @.str6, i64 0, i64 0)) nounwind
  br label %if.end
...
if.then:                                          ; preds = %entry
  %call5 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str7, i64 0, i64 0), i8* getelementptr inbounds (%struct.defs* @main.d0, i64 0, i32 15, i64 0), i32 %call) nounwind
