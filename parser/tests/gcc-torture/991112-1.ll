; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/991112-1.c'
...
entry:
  ...
  %call = call i16** @__ctype_b_loc() readnone
  %tmp1 = load i16** %call
...
entry:
  ...
  %tmp = load i32 (i32, i32)** %x, align 8
  %call = call i32 %tmp(i32 97, i32 1)
...
if.end:                                           ; preds = %entry
  %tmp1 = load i32 (i32, i32)** %x, align 8
  %call2 = call i32 %tmp1(i32 2, i32 1)
