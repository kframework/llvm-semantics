...
define i32 @main() #0 {
  ...
  %4 = load double* %sx, align 8
  %5 = load i32* %nx, align 4
  %6 = sub nsw i32 %5, 1
  %7 = sitofp i32 %6 to double
  %8 = fdiv double %4, %7
  store double %8, double* %hx, align 8
  %9 = load double* %sy, align 8
  %10 = load i32* %ny, align 4
  %11 = sub nsw i32 %10, 1
...
; <label>:27                                      ; preds = %23
  ...
  %41 = getelementptr inbounds [6 x [3 x double]]* %ck, i32 0, i64 %40
  %42 = getelementptr inbounds [3 x double]* %41, i32 0, i64 %38
  store double %36, double* %42, align 8
  %43 = load double* %h0, align 8
  %44 = load double* %ch, align 8
  %45 = load double* %pi, align 8
  %46 = load double* %x, align 8
  %47 = fmul double %45, %46
  %48 = load double* %sx, align 8
  %49 = fdiv double %47, %48
  %50 = call double @cos(double %49) #3
  %51 = fmul double %44, %50
  %52 = load double* %y, align 8
  %53 = fmul double %51, %52
  %54 = load double* %sy, align 8
  ...
  %61 = getelementptr inbounds [6 x [3 x double]]* %phi, i32 0, i64 %60
  %62 = getelementptr inbounds [3 x double]* %61, i32 0, i64 %58
  store double %56, double* %62, align 8
  %63 = load i32* %j, align 4
  %64 = sext i32 %63 to i64
  %65 = load i32* %i, align 4
  %66 = sext i32 %65 to i64
  %67 = getelementptr inbounds [6 x [3 x double]]* %sn, i32 0, i64 %66
  %68 = getelementptr inbounds [3 x double]* %67, i32 0, i64 %64
...
; <label>:85                                      ; preds = %81
  ...
  %88 = getelementptr inbounds [6 x [3 x double]]* %phi, i32 0, i64 1
  %89 = getelementptr inbounds [3 x double]* %88, i32 0, i64 %87
  %90 = load double* %89, align 8
  %91 = fmul double 4.000000e+00, %90
  %92 = load i32* %j, align 4
  %93 = sext i32 %92 to i64
  %94 = getelementptr inbounds [6 x [3 x double]]* %phi, i32 0, i64 2
  %95 = getelementptr inbounds [3 x double]* %94, i32 0, i64 %93
  %96 = load double* %95, align 8
  %97 = fsub double %91, %96
  %98 = fdiv double %97, 3.000000e+00
  %99 = load i32* %j, align 4
  %100 = sext i32 %99 to i64
  %101 = getelementptr inbounds [6 x [3 x double]]* %phi, i32 0, i64 0
  %102 = getelementptr inbounds [3 x double]* %101, i32 0, i64 %100
  store double %98, double* %102, align 8
  %103 = load i32* %j, align 4
  %104 = sext i32 %103 to i64
  %105 = load i32* %nx, align 4
  %106 = sub nsw i32 %105, 2
  %107 = sext i32 %106 to i64
  %108 = getelementptr inbounds [6 x [3 x double]]* %phi, i32 0, i64 %107
  %109 = getelementptr inbounds [3 x double]* %108, i32 0, i64 %104
  %110 = load double* %109, align 8
  %111 = fmul double 4.000000e+00, %110
  %112 = load i32* %j, align 4
  %113 = sext i32 %112 to i64
  %114 = load i32* %nx, align 4
  %115 = sub nsw i32 %114, 3
  %116 = sext i32 %115 to i64
  %117 = getelementptr inbounds [6 x [3 x double]]* %phi, i32 0, i64 %116
  %118 = getelementptr inbounds [3 x double]* %117, i32 0, i64 %113
  ...
  %127 = getelementptr inbounds [6 x [3 x double]]* %phi, i32 0, i64 %126
  %128 = getelementptr inbounds [3 x double]* %127, i32 0, i64 %123
...
; <label>:132                                     ; preds = %81
  %133 = getelementptr inbounds [6 x [3 x double]]* %phi, i32 0, i32 0
  %134 = getelementptr inbounds [6 x [3 x double]]* %ck, i32 0, i32 0
  %135 = getelementptr inbounds [6 x [3 x double]]* %sn, i32 0, i32 0
  %136 = load i32* %nx, align 4
  %137 = load i32* %ny, align 4
  %138 = load double* %p, align 8
  %139 = load double* %hx, align 8
  %140 = load double* %hy, align 8
  call void @rx2d([3 x double]* %133, [3 x double]* %134, [3 x double]* %135, i32 %136, i32 %137, double %138, double %139, double %140)
  br label %141

; <label>:141                                     ; preds = %132
  %142 = load i32* %istep, align 4
...
; <label>:158                                     ; preds = %154
  ...
  %161 = load double* %hy, align 8
  %162 = fmul double %160, %161
  store double %162, double* %y, align 8
  %163 = load double* %x, align 8
  %164 = fmul double %163, 1.000000e+01
  %165 = fptosi double %164 to i32
  %166 = load double* %y, align 8
  ...
  %173 = getelementptr inbounds [6 x [3 x double]]* %phi, i32 0, i64 %172
  %174 = getelementptr inbounds [3 x double]* %173, i32 0, i64 %170
  %175 = load double* %174, align 8
  %176 = fptosi double %175 to i32
  %177 = mul nsw i32 %176, 10
  %178 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str, i32 0, i32 0), i32 %165, i32 %168, i32 %177)
  br label %179
...
define void @rx2d([3 x double]* %fn, [3 x double]* %dn, [3 x double]* %s, i32 %nx, i32 %ny, double %p, double %hx, double %hy) #0 {
  ...
  %10 = load double* %7, align 8
  %11 = fmul double %9, %10
  store double %11, double* %hx2, align 8
  %12 = load double* %hx2, align 8
  %13 = load double* %8, align 8
  %14 = load double* %8, align 8
...
; <label>:34                                      ; preds = %29
  ...
  %39 = add nsw i32 %38, 1
  %40 = sext i32 %39 to i64
  %41 = load [3 x double]** %2, align 8
  %42 = getelementptr inbounds [3 x double]* %41, i64 %40
  %43 = getelementptr inbounds [3 x double]* %42, i32 0, i64 %37
  %44 = load double* %43, align 8
  %45 = load i32* %j, align 4
  %46 = sext i32 %45 to i64
  %47 = load i32* %i, align 4
  %48 = sext i32 %47 to i64
  %49 = load [3 x double]** %2, align 8
  ...
  %56 = load double* %b, align 8
  %57 = load i32* %j, align 4
  %58 = sext i32 %57 to i64
  %59 = load i32* %i, align 4
  %60 = sub nsw i32 %59, 1
  %61 = sext i32 %60 to i64
  %62 = load [3 x double]** %2, align 8
  %63 = getelementptr inbounds [3 x double]* %62, i64 %61
  %64 = getelementptr inbounds [3 x double]* %63, i32 0, i64 %58
  %65 = load double* %64, align 8
  %66 = load i32* %j, align 4
  %67 = sext i32 %66 to i64
  %68 = load i32* %i, align 4
  %69 = sext i32 %68 to i64
  %70 = load [3 x double]** %2, align 8
  %71 = getelementptr inbounds [3 x double]* %70, i64 %69
  %72 = getelementptr inbounds [3 x double]* %71, i32 0, i64 %67
  ...
  %85 = load [3 x double]** %2, align 8
  %86 = getelementptr inbounds [3 x double]* %85, i64 %84
  %87 = getelementptr inbounds [3 x double]* %86, i32 0, i64 %82
  %88 = load double* %87, align 8
  %89 = load i32* %j, align 4
  %90 = sext i32 %89 to i64
  %91 = load i32* %i, align 4
  %92 = sext i32 %91 to i64
  %93 = load [3 x double]** %2, align 8
  %94 = getelementptr inbounds [3 x double]* %93, i64 %92
  %95 = getelementptr inbounds [3 x double]* %94, i32 0, i64 %90
  %96 = load double* %95, align 8
  ...
  %107 = sext i32 %106 to i64
  %108 = load [3 x double]** %2, align 8
  %109 = getelementptr inbounds [3 x double]* %108, i64 %107
  %110 = getelementptr inbounds [3 x double]* %109, i32 0, i64 %105
  %111 = load double* %110, align 8
  %112 = load i32* %j, align 4
  %113 = sext i32 %112 to i64
  %114 = load i32* %i, align 4
  %115 = sext i32 %114 to i64
  %116 = load [3 x double]** %2, align 8
  %117 = getelementptr inbounds [3 x double]* %116, i64 %115
  %118 = getelementptr inbounds [3 x double]* %117, i32 0, i64 %113
  %119 = load double* %118, align 8
  ...
  %123 = load double* %q, align 8
  %124 = load i32* %j, align 4
  %125 = sext i32 %124 to i64
  %126 = load i32* %i, align 4
  %127 = sext i32 %126 to i64
  %128 = load [3 x double]** %1, align 8
  %129 = getelementptr inbounds [3 x double]* %128, i64 %127
  %130 = getelementptr inbounds [3 x double]* %129, i32 0, i64 %125
  %131 = load double* %130, align 8
  %132 = fmul double %123, %131
  %133 = load double* %6, align 8
  %134 = load double* %cip, align 8
  %135 = load i32* %j, align 4
  %136 = sext i32 %135 to i64
  %137 = load i32* %i, align 4
  %138 = add nsw i32 %137, 1
  %139 = sext i32 %138 to i64
  %140 = load [3 x double]** %1, align 8
  %141 = getelementptr inbounds [3 x double]* %140, i64 %139
  %142 = getelementptr inbounds [3 x double]* %141, i32 0, i64 %136
  %143 = load double* %142, align 8
  %144 = fmul double %134, %143
  %145 = load double* %cim, align 8
  %146 = load i32* %j, align 4
  %147 = sext i32 %146 to i64
  %148 = load i32* %i, align 4
  %149 = sub nsw i32 %148, 1
  %150 = sext i32 %149 to i64
  %151 = load [3 x double]** %1, align 8
  %152 = getelementptr inbounds [3 x double]* %151, i64 %150
  %153 = getelementptr inbounds [3 x double]* %152, i32 0, i64 %147
  %154 = load double* %153, align 8
  %155 = fmul double %145, %154
  %156 = fadd double %144, %155
  %157 = load double* %cjp, align 8
  %158 = load i32* %j, align 4
  %159 = add nsw i32 %158, 1
  %160 = sext i32 %159 to i64
  %161 = load i32* %i, align 4
  %162 = sext i32 %161 to i64
  %163 = load [3 x double]** %1, align 8
  %164 = getelementptr inbounds [3 x double]* %163, i64 %162
  %165 = getelementptr inbounds [3 x double]* %164, i32 0, i64 %160
  %166 = load double* %165, align 8
  %167 = fmul double %157, %166
  %168 = fadd double %156, %167
  %169 = load double* %cjm, align 8
  %170 = load i32* %j, align 4
  %171 = sub nsw i32 %170, 1
  %172 = sext i32 %171 to i64
  %173 = load i32* %i, align 4
  %174 = sext i32 %173 to i64
  %175 = load [3 x double]** %1, align 8
  %176 = getelementptr inbounds [3 x double]* %175, i64 %174
  %177 = getelementptr inbounds [3 x double]* %176, i32 0, i64 %172
  %178 = load double* %177, align 8
  %179 = fmul double %169, %178
  %180 = fadd double %168, %179
  %181 = load double* %hx2, align 8
  %182 = load i32* %j, align 4
  %183 = sext i32 %182 to i64
  %184 = load i32* %i, align 4
  %185 = sext i32 %184 to i64
  %186 = load [3 x double]** %3, align 8
  %187 = getelementptr inbounds [3 x double]* %186, i64 %185
  %188 = getelementptr inbounds [3 x double]* %187, i32 0, i64 %183
  ...
  %198 = load [3 x double]** %1, align 8
  %199 = getelementptr inbounds [3 x double]* %198, i64 %197
  %200 = getelementptr inbounds [3 x double]* %199, i32 0, i64 %195
