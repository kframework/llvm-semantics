...
define i32 @main() #0 {
  ...
  call void @g(i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0), double 1.000000e+00, double 2.000000e+00, i32 %2, i32 %3)
