; ModuleID = '/home/grosu/celliso2/c-semantics/tests/unitTests/challenge04.c'
...
entry:
  ...
  call void @f(i64 %0)
  %tmp = load i32* getelementptr inbounds (%struct.t* @s, i32 0, i32 0, i64 1), align 4
  store i32 %tmp, i32* %x, align 4
  call void @g(i32* getelementptr inbounds (%struct.t* @s, i32 0, i32 0, i32 0))
  %tmp2 = load i32* getelementptr inbounds (%struct.t* @s, i32 0, i32 0, i64 1), align 4
