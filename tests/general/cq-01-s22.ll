; ModuleID = '/home/grosu/celliso2/c-semantics/tests/unitTests/cq-01-s22.c'
...
@sec.s22er = internal global [10 x i8] c"s22,er%d\0A\00", align 1
@sec.qs22 = internal global [8 x i8] c"s22    \00", align 1
...
entry:
  %pd0.addr = alloca %struct.defs*, align 8
  %a234 = alloca i32, align 4
  %a = alloca i32, align 4
  %_ = alloca i32, align 4
  %_234 = alloca i32, align 4
  %A = alloca i32, align 4
  %rc = alloca i32, align 4
  %ps = alloca i8*, align 8
  %pt = alloca i8*, align 8
  store %struct.defs* %pd0, %struct.defs** %pd0.addr, align 8
  store i32 0, i32* %rc, align 4
  store i8* getelementptr inbounds ([8 x i8]* @sec.qs22, i32 0, i32 0), i8** %ps, align 8
  %tmp = load %struct.defs** %pd0.addr, align 8
  %rfs = getelementptr inbounds %struct.defs* %tmp, i32 0, i32 15
  %arraydecay = getelementptr inbounds [8 x i8]* %rfs, i32 0, i32 0
  store i8* %arraydecay, i8** %pt, align 8
...
while.end:                                        ; preds = %while.cond
  ...
  store i32 2, i32* %_, align 4
  store i32 3, i32* %_234, align 4
  store i32 4, i32* %a234, align 4
  %tmp5 = load i32* %a, align 4
  %tmp6 = load i32* %_, align 4
  %add = add nsw i32 %tmp5, %tmp6
  %tmp7 = load i32* %_234, align 4
  %add8 = add nsw i32 %add, %tmp7
  %tmp9 = load i32* %a234, align 4
  %add10 = add nsw i32 %add8, %tmp9
  %cmp = icmp ne i32 %add10, 10
  br i1 %cmp, label %if.then, label %if.end17

if.then:                                          ; preds = %while.end
  %tmp11 = load i32* %rc, align 4
  %add12 = add nsw i32 %tmp11, 1
  store i32 %add12, i32* %rc, align 4
  %tmp13 = load %struct.defs** %pd0.addr, align 8
  %flgd = getelementptr inbounds %struct.defs* %tmp13, i32 0, i32 11
  %tmp14 = load i32* %flgd, align 4
  %cmp15 = icmp ne i32 %tmp14, 0
  br i1 %cmp15, label %if.then16, label %if.end

if.then16:                                        ; preds = %if.then
  %call = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s22er, i32 0, i32 0), i32 1)
  br label %if.end
...
if.end17:                                         ; preds = %if.end, %while.end
  ...
  %cmp20 = icmp eq i32 %tmp18, %tmp19
  br i1 %cmp20, label %if.then21, label %if.end31

if.then21:                                        ; preds = %if.end17
  %tmp22 = load i32* %rc, align 4
  %add23 = add nsw i32 %tmp22, 4
...
if.then28:                                        ; preds = %if.then21
  %call29 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s22er, i32 0, i32 0), i32 4)
  br label %if.end30
