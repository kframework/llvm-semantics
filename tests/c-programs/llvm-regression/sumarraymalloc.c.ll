...
; <label>:12                                      ; preds = %7, %6
  ...
  %19 = load i32*, i32** %MyArray, align 8
  %20 = load i32, i32* %size, align 4
  call void @FillArray(i32* %19, i32 %20)
  %21 = load i32*, i32** %MyArray, align 8
  %22 = call i32 @SumArray(i32* %21, i32 10)
  %23 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), i32 %22)
  %24 = load i32*, i32** %MyArray, align 8
  %25 = call i32 @SumArray2(i32* %24, i32 10)
  %26 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i32 %25)
  %27 = load i32*, i32** %MyArray, align 8
