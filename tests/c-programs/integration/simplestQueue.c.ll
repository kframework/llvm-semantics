...
@.str.1 = private unnamed_addr constant [11 x i8] c"emtpy==%d\0A\00", align 1
@.str.2 = private unnamed_addr constant [10 x i8] c"full==%d\0A\00", align 1
@.str.3 = private unnamed_addr constant [11 x i8] c"qents==%d\0A\00", align 1
...
; <label>:6                                       ; preds = %0
  ...
  %9 = sext i32 %8 to i64
  %10 = getelementptr inbounds [16 x i32], [16 x i32]* @q, i32 0, i64 %9
...
; <label>:6                                       ; preds = %0
  ...
  %8 = sext i32 %7 to i64
  %9 = getelementptr inbounds [16 x i32], [16 x i32]* @q, i32 0, i64 %8
...
define void @printdeq() #0 {
  ...
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i32 0, i32 0), i32 %2, i32 %3)
  ret void
}
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = call i32 @mt()
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i32 %2)
  %4 = call i32 @full()
...
; <label>:16                                      ; preds = %6
  %17 = call i32 @mt()
  %18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i32 %17)
  %19 = call i32 @full()
  %20 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i32 0, i32 0), i32 %19)
  %21 = call i32 @qents()
  %22 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.3, i32 0, i32 0), i32 %21)
...
; <label>:30                                      ; preds = %23
  %31 = call i32 @mt()
  %32 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i32 %31)
  %33 = call i32 @full()
  %34 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i32 0, i32 0), i32 %33)
  %35 = call i32 @qents()
...
; <label>:47                                      ; preds = %37
  %48 = call i32 @mt()
  %49 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i32 %48)
  %50 = call i32 @full()
  %51 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i32 0, i32 0), i32 %50)
  %52 = call i32 @qents()
  %53 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.3, i32 0, i32 0), i32 %52)
  br label %54
