...
define i32 @bar(i32 %i, i32 %j, i32 %k, i64 %t.coerce0, i32 %t.coerce1) #0 {
  ...
  %9 = getelementptr inbounds %struct.trio, %struct.trio* %t, i32 0, i32 0
  %10 = load i32, i32* %9, align 4
  %11 = icmp ne i32 %10, 1
  br i1 %11, label %29, label %12

; <label>:12                                      ; preds = %0
  %13 = getelementptr inbounds %struct.trio, %struct.trio* %t, i32 0, i32 1
  %14 = load i32, i32* %13, align 4
  %15 = icmp ne i32 %14, 2
  br i1 %15, label %29, label %16

; <label>:16                                      ; preds = %12
  %17 = getelementptr inbounds %struct.trio, %struct.trio* %t, i32 0, i32 2
...
define i32 @foo(i64 %t.coerce0, i32 %t.coerce1, i32 %i, i32 %j, i32 %k) #0 {
  ...
  %15 = getelementptr { i64, i32 }, { i64, i32 }* %5, i32 0, i32 0
  %16 = load i64, i64* %15, align 1
  %17 = getelementptr { i64, i32 }, { i64, i32 }* %5, i32 0, i32 1
