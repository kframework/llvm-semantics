; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/931004-8.ll'
...
vaarg.end:                                        ; preds = %vaarg.in_mem, %vaarg.in_reg
  ...
  %5 = load i8* %vaarg.addr.in, align 1
...
vaarg.in_reg17:                                   ; preds = %for.end
  ...
  %7 = getelementptr i8* %reg_save_area18, i64 %6
...
vaarg.end23:                                      ; preds = %vaarg.in_mem19, %vaarg.in_reg17
  %vaarg.addr24.in = phi i8* [ %7, %vaarg.in_reg17 ], [ %overflow_arg_area21, %vaarg.in_mem19 ]
  %vaarg.addr24 = bitcast i8* %vaarg.addr24.in to i64*
  %9 = load i64* %vaarg.addr24, align 8
  %cmp26 = icmp eq i64 %9, 123
