...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = call i32 @bug(i16 zeroext 512, i16* getelementptr inbounds ([5 x i16], [5 x i16]* @buf, i32 0, i32 0), i16* getelementptr inbounds ([5 x i16], [5 x i16]* @buf, i32 0, i64 3))
  %3 = icmp ne i32 %2, 491
...
; <label>:5                                       ; preds = %17, %0
  %6 = load i16*, i16** %tmp, align 8
  %7 = load i16*, i16** %3, align 8
  %8 = icmp ult i16* %6, %7
  br i1 %8, label %9, label %20

; <label>:9                                       ; preds = %5
  %10 = load i16*, i16** %tmp, align 8
