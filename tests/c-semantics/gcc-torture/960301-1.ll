...
define i32 @bar(i32 %k) #0 {
  ...
  %3 = load i16* bitcast (%struct.foo* @foo to i16*), align 4
  %4 = lshr i16 %3, 12
  %5 = zext i16 %4 to i32
  store i32 %5, i32* @oldfoo, align 4
  %6 = load i32* %2, align 4
  %7 = trunc i32 %6 to i16
  %8 = load i16* bitcast (%struct.foo* @foo to i16*), align 4
  %9 = and i16 %7, 15
  %10 = shl i16 %9, 12
  %11 = and i16 %8, 4095
  %12 = or i16 %11, %10
  store i16 %12, i16* bitcast (%struct.foo* @foo to i16*), align 4
