...
while.body:                                       ; preds = %while.cond
  ...
  %5 = va_arg %struct.__va_list_tag* %arraydecay2, i32
  %call3 = call i32 @to_hex(i32 %5)
  %cmp4 = icmp ne i32 %conv, %call3
