; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/920929-1.c'
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds double* %tmp2, i64 %idxprom
...
for.end:                                          ; preds = %for.cond
  %tmp7 = load i8** %saved_stack
  call void @llvm.stackrestore(i8* %tmp7)
  ret void
}
