...
define %struct.delay_block* @time_enqueue(%struct.delay_block* %d) #0 {
  ...
  %2 = load %struct.delay_block*, %struct.delay_block** getelementptr inbounds (%struct.delay_block, %struct.delay_block* @Timer_Queue, i32 0, i32 0), align 8
  store %struct.delay_block* %2, %struct.delay_block** %q, align 8
  %3 = load %struct.delay_block*, %struct.delay_block** %1, align 8
  %4 = getelementptr inbounds %struct.delay_block, %struct.delay_block* %3, i32 0, i32 0
  store %struct.delay_block* null, %struct.delay_block** %4, align 8
  %5 = load %struct.delay_block*, %struct.delay_block** getelementptr inbounds (%struct.delay_block, %struct.delay_block* @Timer_Queue, i32 0, i32 0), align 8
