...
; <label>:2                                       ; preds = %12, %0
  %3 = load %struct.foo*, %struct.foo** %1, align 8
...
; <label>:12                                      ; preds = %8, %5
  %13 = load %struct.foo*, %struct.foo** %1, align 8
  %14 = getelementptr inbounds %struct.foo, %struct.foo* %13, i32 0, i32 0
  %15 = load %struct.foo*, %struct.foo** %14, align 8
  store %struct.foo* %15, %struct.foo** %1, align 8
  br label %2

; <label>:16                                      ; preds = %11, %2
  %17 = load %struct.foo*, %struct.foo** %1, align 8
  ret %struct.foo* %17
}
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = getelementptr inbounds %struct.foo, %struct.foo* %a, i32 0, i32 0
  store %struct.foo* %b, %struct.foo** %2, align 8
  %3 = getelementptr inbounds %struct.foo, %struct.foo* %b, i32 0, i32 0
  store %struct.foo* null, %struct.foo** %3, align 8
  %4 = call %struct.foo* @test(%struct.foo* %a)
  store %struct.foo* %4, %struct.foo** %c, align 8
  %5 = load %struct.foo*, %struct.foo** %c, align 8
