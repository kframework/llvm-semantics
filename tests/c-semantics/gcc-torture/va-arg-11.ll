...
; <label>:29                                      ; preds = %4
  %30 = getelementptr inbounds [1 x %struct.__va_list_tag]* %va, i32 0, i32 0
...
; <label>:45                                      ; preds = %40, %34
  ...
  %48 = getelementptr inbounds [1 x %struct.__va_list_tag]* %va, i32 0, i32 0
  %49 = bitcast %struct.__va_list_tag* %48 to i8*
  call void @llvm.va_end(i8* %49)
  %50 = load i32* %res, align 4
  ret i32 %50
}
