; ModuleID = '/home/david/src/c-semantics/tests/gcc-torture/20020226-1.c'
...
if.end12:                                         ; preds = %if.end
  ...
  %cmp21 = icmp ne i32 %or20, 19087651
...
if.end33:                                         ; preds = %if.end24
  ...
  %cmp40 = icmp ne i32 %or39, 1073742115
...
if.end43:                                         ; preds = %if.end33
  ...
  %cmp47 = icmp ne i32 %or46, 1073742115
...
if.end50:                                         ; preds = %if.end43
  ...
  %cmp57 = icmp ne i64 %or56, -9223372036835687065
...
if.end60:                                         ; preds = %if.end50
  ...
  %cmp64 = icmp ne i64 %or63, -9223372036835687065
...
if.end67:                                         ; preds = %if.end60
  ...
  %cmp74 = icmp ne i64 %or73, 5124095577148911
...
if.end77:                                         ; preds = %if.end67
  ...
  %cmp81 = icmp ne i64 %or80, 5124095577148911
...
if.end84:                                         ; preds = %if.end77
  ...
  %cmp91 = icmp ne i64 %or90, 1311768467750121216
...
if.end94:                                         ; preds = %if.end84
  ...
  %cmp98 = icmp ne i64 %or97, 1311768467750121216
...
if.end122:                                        ; preds = %if.end113
  ...
  %cmp131 = icmp ne i32 %or130, 74561
...
if.end134:                                        ; preds = %if.end122
  ...
  %cmp140 = icmp ne i32 %or139, 74561
...
if.end143:                                        ; preds = %if.end134
  ...
  %cmp150 = icmp ne i32 %or149, 74560
...
if.end153:                                        ; preds = %if.end143
  ...
  %cmp157 = icmp ne i32 %or156, 74560
...
if.end160:                                        ; preds = %if.end153
  ...
  %cmp167 = icmp ne i64 %or166, 4886718336
...
if.end170:                                        ; preds = %if.end160
  ...
  %cmp174 = icmp ne i64 %or173, 4886718336
...
if.end177:                                        ; preds = %if.end170
  ...
  %cmp184 = icmp ne i64 %or183, 1311768467750121216
...
if.end187:                                        ; preds = %if.end177
  ...
  %cmp191 = icmp ne i64 %or190, 1311768467750121216
...
if.end194:                                        ; preds = %if.end187
  ...
  %cmp201 = icmp ne i64 %or200, 5124095577148911
...
if.end204:                                        ; preds = %if.end194
  ...
  %cmp208 = icmp ne i64 %or207, 5124095577148911
