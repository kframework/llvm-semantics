...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = load i64, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @aa, i32 0, i32 0), align 8
  %3 = load i64, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @bb, i32 0, i32 0), align 8
  %4 = call i32 @seqgt(i64 %2, i16 zeroext 4096, i64 %3)
  %5 = icmp ne i32 %4, 0
  br i1 %5, label %6, label %11

; <label>:6                                       ; preds = %0
  %7 = load i64, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @aa, i32 0, i32 0), align 8
  %8 = load i64, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @bb, i32 0, i32 0), align 8
