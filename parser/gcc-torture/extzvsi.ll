; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/extzvsi.c'
...
if.else:                                          ; preds = %entry
  %tmp1 = load i32* %exponent, align 4
  %cmp2 = icmp ugt i32 %tmp1, 1
