; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/loop-4b.c'
...
do.body:                                          ; preds = %do.cond, %entry
  ...
  %add = add nsw i64 %tmp1, 268435456
  store i64 %add, i64* %i, align 8
  br label %do.cond

do.cond:                                          ; preds = %do.body
  %tmp2 = load i64* %i, align 8
  %cmp = icmp slt i64 %tmp2, -1610612736
