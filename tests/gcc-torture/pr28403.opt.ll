; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/pr28403.ll'
...
entry:
  ...
  %add7 = add i32 %add5, %x5
  %add9 = add i32 %add7, %x6
  %add11 = add i32 %add9, %x7
  %add13 = add i32 %add11, %x8
