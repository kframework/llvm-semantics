; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/931004-4.c'
...
vaarg.end:                                        ; preds = %vaarg.in_mem, %vaarg.in_reg
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %tmp4, i8* %tmp5, i64 2, i32 2, i1 false)
  %c = getelementptr inbounds %struct.tiny* %x, i32 0, i32 0
  %tmp6 = load i16* %c, align 2
...
entry:
  ...
  call void (i32, ...)* @f(i32 3, i16 %0, i16 %1, i16 %2, i64 123)
