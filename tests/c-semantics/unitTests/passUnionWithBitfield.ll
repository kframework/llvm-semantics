...
define i32 @f1(i32 %u.coerce) #0 {
  ...
  store i32 %u.coerce, i32* %2, align 1
...
define i32 @f3(i32 %u.coerce) #0 {
  ...
  %2 = getelementptr %union.U3* %u, i32 0, i32 0
  store i32 %u.coerce, i32* %2
  %3 = bitcast %union.U3* %1 to i8*
  %4 = bitcast %union.U3* %u to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %3, i8* %4, i64 4, i32 4, i1 false)
  %5 = getelementptr %union.U3* %1, i32 0, i32 0
  %6 = load i32* %5
  ret i32 %6
}
...
define i32 @main() #0 {
  ...
  %4 = load i32* bitcast ({ i8, i8, [2 x i8] }* @u1 to i32*), align 1
  %5 = call i32 @f1(i32 %4)
  ...
  %13 = load i32* bitcast ({ i8, i8, [2 x i8] }* @u2 to i32*), align 1
  ...
  %22 = load i32* getelementptr (%union.U3* bitcast ({ i8, i8, [2 x i8] }* @u3 to %union.U3*), i32 0, i32 0)
  %23 = call i32 @f3(i32 %22)
  %24 = getelementptr %union.U3* %3, i32 0, i32 0
  store i32 %23, i32* %24
  %25 = bitcast %union.U3* %3 to i16*
  %26 = load i16* %25, align 4
  %27 = shl i16 %26, 3
  %28 = ashr i16 %27, 3
