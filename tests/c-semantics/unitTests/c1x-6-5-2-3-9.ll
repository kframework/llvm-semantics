...
define i32 @main() #0 {
  ...
  %2 = load i32* getelementptr inbounds (%struct.anon* bitcast (%union.anon* @u to %struct.anon*), i32 0, i32 0), align 4
  %3 = icmp eq i32 %2, 1
  br i1 %3, label %4, label %9

; <label>:4                                       ; preds = %0
  %5 = load double* getelementptr inbounds (%union.anon* @u, i32 0, i32 0, i32 1), align 8
