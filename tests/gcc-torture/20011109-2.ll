; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20011109-2.c'
...
for.body:                                         ; preds = %for.cond
  ...
  %tmp2 = load i8** %c1, align 8
  %arrayidx = getelementptr inbounds i8* %tmp2, i64 %idxprom
  %tmp3 = load i8* %arrayidx
  %conv = sext i8 %tmp3 to i32
  %tmp4 = load i32* %i, align 4
  %idxprom5 = sext i32 %tmp4 to i64
  %tmp6 = load i8** %c2, align 8
