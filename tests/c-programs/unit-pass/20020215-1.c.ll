...
define i32 @main() #0 {
  ...
  %9 = getelementptr inbounds %struct.s, %struct.s* %s, i32 0, i32 0
...
; <label>:13                                      ; preds = %0
  %14 = getelementptr inbounds %struct.s, %struct.s* %s, i32 0, i32 1
  %15 = load i64, i64* %14, align 8
  %16 = icmp ne i64 %15, 2001
  br i1 %16, label %22, label %17

; <label>:17                                      ; preds = %13
  %18 = getelementptr inbounds %struct.s, %struct.s* %s, i32 0, i32 2
