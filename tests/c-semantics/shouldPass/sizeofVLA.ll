...
define i32 @main() #0 {
  ...
  %16 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @.str, i32 0, i32 0), i32 %14, i32 %15)
  %17 = load i32* %n, align 4
  %18 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @.str1, i32 0, i32 0), i32 %17)
  ...
  %27 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str2, i32 0, i32 0), i32 %26)
  %28 = mul nuw i64 %7, %9
  %29 = mul nuw i64 4, %28
  ...
  %33 = mul nsw i64 %32, %9
  %34 = getelementptr inbounds i32* %11, i64 %33
  %35 = mul nuw i64 4, %9
  %36 = udiv i64 %29, %35
  %37 = trunc i64 %36 to i32
  %38 = load i32* %x, align 4
  %39 = add nsw i32 %38, 1
  %40 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @.str, i32 0, i32 0), i32 %37, i32 %39)
  %41 = load i32* %n, align 4
  %42 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str2, i32 0, i32 0), i32 %41)
  ...
  %48 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([21 x i8]* @.str3, i32 0, i32 0), i32 %47)
  %49 = load i32* %n, align 4
  %50 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str2, i32 0, i32 0), i32 %49)
  %51 = load i8** %1
