; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/pr24141.c'
...
if.end15:                                         ; preds = %if.then2, %if.then14, %if.end11
  ret void
}
