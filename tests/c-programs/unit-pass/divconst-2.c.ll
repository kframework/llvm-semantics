...
; <label>:6                                       ; preds = %2
  ...
  %8 = sext i32 %7 to i64
  %9 = getelementptr inbounds [3 x i64], [3 x i64]* @nums, i32 0, i64 %8
  %10 = load i64, i64* %9, align 8
  %11 = load i32, i32* %i, align 4
  %12 = sext i32 %11 to i64
  %13 = getelementptr inbounds [3 x i64], [3 x i64]* @nums, i32 0, i64 %12
  %14 = load i64, i64* %13, align 8
  %15 = call i64 @f(i64 %14)
  %16 = load i32, i32* %i, align 4
  %17 = sext i32 %16 to i64
  %18 = getelementptr inbounds [3 x i64], [3 x i64]* @nums, i32 0, i64 %17
