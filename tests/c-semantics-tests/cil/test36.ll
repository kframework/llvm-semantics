...
entry:
  ...
  %0 = load i64* bitcast (%struct.a* @z to i64*), align 1
  %call = call i64 @g(i64 %0)
  %1 = bitcast %struct.a* %coerce to i64*
  store i64 %call, i64* %1, align 1
  %2 = bitcast %struct.a* %coerce to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* bitcast (%struct.a* @z to i8*), i8* %2, i64 8, i32 4, i1 false)
  ret void
}
