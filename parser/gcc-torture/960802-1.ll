; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/960802-1.c'
...
entry:
  ...
  %tmp = load i64* %v, align 8
  %and = and i64 %tmp, 16777215
  %tmp2 = load i64* %o, align 8
  %and3 = and i64 %tmp2, 4278190080
  %or = or i64 %and, %and3
  store i64 %or, i64* %v, align 8
  %tmp4 = load i64* %v, align 8
  call void @f3(i64 %tmp4)
  ret void
}
...
entry:
  ...
  call void @f4()
  %tmp = load i64* @val, align 8
  %cmp = icmp ne i64 %tmp, 1577058610
