; ModuleID = '/home/david/src/c-semantics/tests/csmith/smith001609.c'
...
; <label>:4                                       ; preds = %3, %0
  ...
  %8 = call i32 @safe_add_func_int32_t_s_s(i32 %6, i32 %7)
  %9 = icmp ne i32 %8, 0
...
; <label>:11                                      ; preds = %10, %4
  %12 = phi i1 [ true, %4 ], [ true, %10 ]
  %13 = zext i1 %12 to i32
  %14 = load volatile i32** @g_7, align 8
  store i32 %13, i32* %14
  %15 = load i32* @g_8, align 4
