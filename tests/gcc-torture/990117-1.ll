; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/990117-1.c'
...
entry:
  ...
  %conv7 = sitofp i32 %tmp6 to double
  %tmp8 = load i32* %j.addr, align 4
  %conv9 = sitofp i32 %tmp8 to double
  %div10 = fdiv double %conv7, %conv9
  store double %div10, double* %tmp25, align 8
  %tmp11 = load double* %tmp1, align 8
  %tmp12 = load double* %tmp25, align 8
  %cmp = fcmp olt double %tmp11, %tmp12
