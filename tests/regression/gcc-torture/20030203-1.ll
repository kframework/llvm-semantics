; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20030203-1.c'
...
entry:
  ...
  %tmp = load i32* %single.addr, align 4
...
if.end:                                           ; preds = %if.else, %if.then
  %tmp1 = load i32* %single.addr, align 4
  call void @f(i32 %tmp1)
  %tmp2 = load i32* %stereo1, align 4
  ret i32 %tmp2
}
