; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20030914-2.c'
...
entry:
  ...
  %call = call i32 (%struct.s*, i32, ...)* @f(%struct.s* byval align 8 @gs, i32 4660)
