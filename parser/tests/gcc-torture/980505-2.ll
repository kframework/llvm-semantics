; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/980505-2.c'
...
entry:
  ...
  %tmp = load i16* getelementptr inbounds ([1 x i16]* @f.values, i32 0, i64 0), align 2
  store i16 %tmp, i16* %token, align 2
  %tmp1 = load i16* %token, align 2
