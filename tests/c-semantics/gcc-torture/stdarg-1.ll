...
; <label>:4                                       ; preds = %0
  %5 = load i32* getelementptr inbounds ([1 x %struct.__va_list_tag]* @gap, i32 0, i32 0, i32 1)
...
; <label>:7                                       ; preds = %4
  ...
  %11 = add i32 %5, 16
  store i32 %11, i32* getelementptr inbounds ([1 x %struct.__va_list_tag]* @gap, i32 0, i32 0, i32 1)
  br label %16
...
; <label>:20                                      ; preds = %16
  %21 = load i32* getelementptr inbounds ([1 x %struct.__va_list_tag]* @gap, i32 0, i32 0, i32 0)
...
; <label>:23                                      ; preds = %20
  ...
  %27 = add i32 %21, 8
  store i32 %27, i32* getelementptr inbounds ([1 x %struct.__va_list_tag]* @gap, i32 0, i32 0, i32 0)
  br label %32
...
; <label>:41                                      ; preds = %38
  %42 = load [1 x %struct.__va_list_tag]** @pap, align 8
...
; <label>:62                                      ; preds = %58
  %63 = load [1 x %struct.__va_list_tag]** @pap, align 8
  %64 = getelementptr inbounds [1 x %struct.__va_list_tag]* %63, i32 0, i32 0
  %65 = getelementptr inbounds %struct.__va_list_tag* %64, i32 0, i32 2
  %66 = load i8** %65
  %67 = getelementptr i8* %66, i64 15
  %68 = ptrtoint i8* %67 to i64
  %69 = and i64 %68, -16
  %70 = inttoptr i64 %69 to i8*
  %71 = bitcast i8* %70 to x86_fp80*
  %72 = getelementptr i8* %70, i32 16
  store i8* %72, i8** %65
  %73 = load x86_fp80* %71
...
; <label>:75                                      ; preds = %62
  %76 = load [1 x %struct.__va_list_tag]** @pap, align 8
  %77 = getelementptr inbounds [1 x %struct.__va_list_tag]* %76, i32 0, i32 0
...
; <label>:81                                      ; preds = %75
  %82 = getelementptr inbounds %struct.__va_list_tag* %77, i32 0, i32 3
  %83 = load i8** %82
  %84 = getelementptr i8* %83, i32 %79
...
; <label>:87                                      ; preds = %75
  %88 = getelementptr inbounds %struct.__va_list_tag* %77, i32 0, i32 2
  %89 = load i8** %88
  %90 = bitcast i8* %89 to i32*
  %91 = getelementptr i8* %89, i32 8
  store i8* %91, i8** %88
  br label %92
