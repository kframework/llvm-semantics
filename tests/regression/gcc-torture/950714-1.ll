; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/950714-1.c'
...
for.cond1:                                        ; preds = %for.inc, %for.body
  ...
  %cmp3 = icmp ne i32* %tmp2, getelementptr inbounds ([10 x i32]* @array, i32 0, i64 9)
...
label:                                            ; preds = %for.end12, %if.then
  %tmp13 = load i32* %i, align 4
  %cmp14 = icmp ne i32 %tmp13, 1
  br i1 %cmp14, label %if.then15, label %if.end16

if.then15:                                        ; preds = %label
