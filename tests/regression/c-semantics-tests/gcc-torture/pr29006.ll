...
entry:
  ...
  %x = getelementptr inbounds %struct.s* %0, i32 0, i32 1
...
entry:
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %0, i8* getelementptr inbounds (%struct.s* @main.s, i32 0, i32 0), i64 9, i32 1, i1 false)
  call void @foo(%struct.s* %s)
  %x = getelementptr inbounds %struct.s* %s, i32 0, i32 1
  %1 = load i64* %x, align 1
  %cmp = icmp ne i64 %1, 0
