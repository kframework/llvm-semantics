...
define { i8, i64 } @foo(i8 %x.coerce0, i64 %x.coerce1, i8 %y.coerce0, i64 %y.coerce1) #0 {
  ...
  %7 = getelementptr { i8, i64 }* %5, i32 0, i32 1
  store i64 %y.coerce1, i64* %7
  %8 = getelementptr inbounds %struct.S* %x, i32 0, i32 1
  %9 = load i64* %8, align 8
  %10 = getelementptr inbounds %struct.S* %y, i32 0, i32 1
  %11 = load i64* %10, align 8
  %12 = sdiv i64 %9, %11
  %13 = getelementptr inbounds %struct.S* %z, i32 0, i32 1
  store i64 %12, i64* %13, align 8
  %14 = bitcast %struct.S* %1 to i8*
  %15 = bitcast %struct.S* %z to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %14, i8* %15, i64 16, i32 8, i1 false)
  %16 = bitcast %struct.S* %1 to { i8, i64 }*
  %17 = load { i8, i64 }* %16, align 1
  ret { i8, i64 } %17
}
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %4 = getelementptr inbounds %struct.S* %a, i32 0, i32 1
...
; <label>:26                                      ; preds = %0
  %27 = getelementptr inbounds %struct.S* %a, i32 0, i32 1
  store i64 -8, i64* %27, align 8
  %28 = getelementptr inbounds %struct.S* %b, i32 0, i32 1
  store i64 -2, i64* %28, align 8
  %29 = bitcast %struct.S* %a to { i8, i64 }*
  %30 = getelementptr { i8, i64 }* %29, i32 0, i32 0
  %31 = load i8* %30, align 1
  %32 = getelementptr { i8, i64 }* %29, i32 0, i32 1
  %33 = load i64* %32, align 1
  %34 = bitcast %struct.S* %b to { i8, i64 }*
  %35 = getelementptr { i8, i64 }* %34, i32 0, i32 0
  %36 = load i8* %35, align 1
  %37 = getelementptr { i8, i64 }* %34, i32 0, i32 1
  %38 = load i64* %37, align 1
  %39 = call { i8, i64 } @foo(i8 %31, i64 %33, i8 %36, i64 %38)
  %40 = bitcast %struct.S* %3 to { i8, i64 }*
  %41 = getelementptr { i8, i64 }* %40, i32 0, i32 0
  %42 = extractvalue { i8, i64 } %39, 0
  store i8 %42, i8* %41, align 1
  %43 = getelementptr { i8, i64 }* %40, i32 0, i32 1
  %44 = extractvalue { i8, i64 } %39, 1
  store i64 %44, i64* %43, align 1
  %45 = getelementptr inbounds %struct.S* %3, i32 0, i32 1
