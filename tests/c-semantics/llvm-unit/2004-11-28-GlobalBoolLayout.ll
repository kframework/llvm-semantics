...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = call i64 @strlen(i8* getelementptr inbounds (%struct.S* @G, i32 0, i32 2, i32 0)) #3
...
; <label>:6                                       ; preds = %0
  %7 = call i32 (i8*, ...)* @__isoc99_scanf(i8* getelementptr inbounds ([8 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds (%struct.S* @G, i32 0, i32 0), i8* getelementptr inbounds (%struct.S* @G, i32 0, i32 1))
  br label %8

; <label>:8                                       ; preds = %6, %0
  %9 = load i8* getelementptr inbounds (%struct.S* @G, i32 0, i32 0), align 1
  %10 = trunc i8 %9 to i1
  %11 = zext i1 %10 to i32
  %12 = load i8* getelementptr inbounds (%struct.S* @G, i32 0, i32 1), align 1
  %13 = trunc i8 %12 to i1
  %14 = zext i1 %13 to i32
  %15 = load i32* %X, align 4
  %16 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str1, i32 0, i32 0), i32 %11, i32 %14, i32 %15)
