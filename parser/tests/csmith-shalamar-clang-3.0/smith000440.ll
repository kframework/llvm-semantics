; ModuleID = '/home/david/src/c-semantics/tests/csmith/smith000440.c'
...
; <label>:5                                       ; preds = %2
  ...
  br label %10
                                                  ; No predecessors!
  %7 = load i32* @g_2, align 4
  %8 = call i32 @safe_add_func_int32_t_s_s(i32 %7, i32 8)
  store i32 %8, i32* @g_2, align 4
  br label %2
