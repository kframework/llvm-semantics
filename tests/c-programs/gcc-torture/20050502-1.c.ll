...
define i32 @main() #1 {
  ...
  %p = alloca i8*, align 8
  store i32 0, i32* %1
  store i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i32 0, i32 0), i8** %p, align 8
  %2 = getelementptr inbounds [64 x i8], [64 x i8]* %buf, i32 0, i32 0
  call void @foo(i8** %p, i8* %2, i1 zeroext true, i1 zeroext false)
  %3 = load i8*, i8** %p, align 8
  %4 = call i32 @strcmp(i8* %3, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i32 0, i32 0))
  %5 = icmp ne i32 %4, 0
  br i1 %5, label %10, label %6

; <label>:6                                       ; preds = %0
  %7 = getelementptr inbounds [64 x i8], [64 x i8]* %buf, i32 0, i32 0
  %8 = call i32 @strcmp(i8* %7, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i32 0, i32 0))
  %9 = icmp ne i32 %8, 0
...
; <label>:11                                      ; preds = %6
  store i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.3, i32 0, i32 0), i8** %p, align 8
  %12 = getelementptr inbounds [64 x i8], [64 x i8]* %buf, i32 0, i32 0
  call void @foo(i8** %p, i8* %12, i1 zeroext false, i1 zeroext true)
  %13 = load i8*, i8** %p, align 8
  %14 = call i32 @strcmp(i8* %13, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.4, i32 0, i32 0))
  %15 = icmp ne i32 %14, 0
  br i1 %15, label %20, label %16

; <label>:16                                      ; preds = %11
  %17 = getelementptr inbounds [64 x i8], [64 x i8]* %buf, i32 0, i32 0
  %18 = call i32 @strcmp(i8* %17, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i32 0, i32 0))
  %19 = icmp ne i32 %18, 0
...
; <label>:21                                      ; preds = %16
  store i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.6, i32 0, i32 0), i8** %p, align 8
  %22 = getelementptr inbounds [64 x i8], [64 x i8]* %buf, i32 0, i32 0
  call void @foo(i8** %p, i8* %22, i1 zeroext true, i1 zeroext true)
  %23 = load i8*, i8** %p, align 8
  %24 = call i32 @strcmp(i8* %23, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.7, i32 0, i32 0))
  %25 = icmp ne i32 %24, 0
  br i1 %25, label %30, label %26

; <label>:26                                      ; preds = %21
  %27 = getelementptr inbounds [64 x i8], [64 x i8]* %buf, i32 0, i32 0
  %28 = call i32 @strcmp(i8* %27, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.8, i32 0, i32 0))
  %29 = icmp ne i32 %28, 0
...
; <label>:31                                      ; preds = %26
  store i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.9, i32 0, i32 0), i8** %p, align 8
  %32 = getelementptr inbounds [64 x i8], [64 x i8]* %buf, i32 0, i32 0
  call void @foo(i8** %p, i8* %32, i1 zeroext true, i1 zeroext true)
  %33 = load i8*, i8** %p, align 8
  %34 = call i32 @strcmp(i8* %33, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.10, i32 0, i32 0))
  %35 = icmp ne i32 %34, 0
  br i1 %35, label %40, label %36

; <label>:36                                      ; preds = %31
  %37 = getelementptr inbounds [64 x i8], [64 x i8]* %buf, i32 0, i32 0
  %38 = call i32 @strcmp(i8* %37, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.11, i32 0, i32 0))
  %39 = icmp ne i32 %38, 0
...
; <label>:41                                      ; preds = %36
  store i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.12, i32 0, i32 0), i8** %p, align 8
  %42 = getelementptr inbounds [64 x i8], [64 x i8]* %buf, i32 0, i32 0
  call void @foo(i8** %p, i8* %42, i1 zeroext false, i1 zeroext false)
  %43 = load i8*, i8** %p, align 8
  %44 = call i32 @strcmp(i8* %43, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.13, i32 0, i32 0))
  %45 = icmp ne i32 %44, 0
  br i1 %45, label %50, label %46

; <label>:46                                      ; preds = %41
  %47 = getelementptr inbounds [64 x i8], [64 x i8]* %buf, i32 0, i32 0
  %48 = call i32 @strcmp(i8* %47, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.14, i32 0, i32 0))
  %49 = icmp ne i32 %48, 0
