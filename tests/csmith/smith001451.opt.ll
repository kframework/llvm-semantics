; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith001451.ll'
...
entry:
  store i32* @g_7, i32** @g_12, align 8
  ret i64 2127307843
}

define i32* @func_2(i16 signext %p_3, i8 zeroext %p_4, i8 signext %p_5) nounwind uwtable readnone {
entry:
  ret i32* @g_7
}
