...
if.then6:                                         ; preds = %if.then
  %call7 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @sec.s4er, i32 0, i32 0), i32 1)
  br label %if.end
...
if.then11:                                        ; preds = %for.end
  ...
  %11 = load %struct.defs** %pd0.addr, align 8
  %flgd12 = getelementptr inbounds %struct.defs* %11, i32 0, i32 11
  %12 = load i32* %flgd12, align 4
  %cmp13 = icmp ne i32 %12, 0
  br i1 %cmp13, label %if.then14, label %if.end16

if.then14:                                        ; preds = %if.then11
  %call15 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @sec.s4er, i32 0, i32 0), i32 2)
  br label %if.end16
...
for.cond18:                                       ; preds = %for.inc23, %if.end17
  %13 = load i32* %j, align 4
  %conv = sext i32 %13 to i64
  %14 = load %struct.defs** %pd0.addr, align 8
  %cbits = getelementptr inbounds %struct.defs* %14, i32 0, i32 0
  %15 = load i32* %cbits, align 4
  %conv19 = sext i32 %15 to i64
  %mul = mul i64 4, %conv19
  %cmp20 = icmp ult i64 %conv, %mul
  br i1 %cmp20, label %for.body22, label %for.end25

for.body22:                                       ; preds = %for.cond18
  %16 = load i32* %mask, align 4
...
if.then30:                                        ; preds = %lor.lhs.false, %for.end25
  %22 = load i32* %rc, align 4
  %add31 = add nsw i32 %22, 8
  store i32 %add31, i32* %rc, align 4
  %23 = load %struct.defs** %pd0.addr, align 8
  %flgd32 = getelementptr inbounds %struct.defs* %23, i32 0, i32 11
  %24 = load i32* %flgd32, align 4
  %cmp33 = icmp ne i32 %24, 0
  br i1 %cmp33, label %if.then35, label %if.end37

if.then35:                                        ; preds = %if.then30
  %call36 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @sec.s4er, i32 0, i32 0), i32 8)
  br label %if.end37
