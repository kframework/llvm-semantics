; ModuleID = '/home/david/src/c-semantics/tests/mustPass/xrealloc2.c'
...
entry:
  ...
  %call2 = call i8* @realloc(i8* %2, i64 5) nounwind
  store i8* %call2, i8** %p3, align 8
  %3 = load i8** %p3, align 8
  %arrayidx3 = getelementptr inbounds i8* %3, i64 3
