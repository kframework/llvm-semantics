; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/960311-2.c'
...
if.end:                                           ; preds = %if.then, %entry
  %tmp1 = load i16* %data.addr, align 2
  %conv2 = zext i16 %tmp1 to i32
  %shl = shl i32 %conv2, 1
  %conv3 = trunc i32 %shl to i16
  store i16 %conv3, i16* %data.addr, align 2
  %tmp4 = load i16* %data.addr, align 2
...
if.end9:                                          ; preds = %if.then8, %if.end
  %tmp10 = load i16* %data.addr, align 2
  %conv11 = zext i16 %tmp10 to i32
  %shl12 = shl i32 %conv11, 1
  %conv13 = trunc i32 %shl12 to i16
  store i16 %conv13, i16* %data.addr, align 2
  %tmp14 = load i16* %data.addr, align 2
