...
@.str.1 = private unnamed_addr constant [25 x i8] c"array after bubblesort: \00", align 1
...
; <label>:17                                      ; preds = %13
  ...
  %30 = load i32 (i8*, i8*)*, i32 (i8*, i8*)** %4, align 8
  %31 = load i8*, i8** %pc_at_i, align 8
  %32 = load i8*, i8** %pc_at_j, align 8
...
define i32 @int_cmp_fun(i8* %v1, i8* %v2) #0 {
  ...
  %7 = load i32*, i32** %i1, align 8
  %8 = load i32, i32* %7, align 4
  %9 = load i32*, i32** %i2, align 8
...
; <label>:13                                      ; preds = %0
  %14 = load i32*, i32** %i1, align 8
  %15 = load i32, i32* %14, align 4
  %16 = load i32*, i32** %i2, align 8
...
define i32 @main() #0 {
  ...
  %4 = getelementptr inbounds [7 x i32], [7 x i32]* %arr, i32 0, i32 0
  call void @print_int_arr(i32* %4, i64 7)
  %5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.1, i32 0, i32 0))
  %6 = getelementptr inbounds [7 x i32], [7 x i32]* %arr, i32 0, i32 0
  %7 = bitcast i32* %6 to i8*
  call void @bubble_sort(i8* %7, i64 7, i64 4, i32 (i8*, i8*)* @int_cmp_fun)
  %8 = getelementptr inbounds [7 x i32], [7 x i32]* %arr, i32 0, i32 0
