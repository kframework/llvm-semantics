; ModuleID = '/home/david/src/c-semantics/tests/unitTests/cq-10-s71.c'
...
@str4 = private unnamed_addr constant [9 x i8] c"\0AFailed.\00"
...
setupTable.exit:                                  ; preds = %while.body48.i
  ...
  store i8 32, i8* %incdec.ptr1.5, align 1, !tbaa !0
  store i8 0, i8* %incdec.ptr1.6, align 1, !tbaa !0
  %call25 = tail call i32 @McCarthy(i32 -5)
  %cmp26 = icmp eq i32 %call25, 91
  br i1 %cmp26, label %if.end51, label %if.then28

if.then28:                                        ; preds = %setupTable.exit
  %flgd30 = getelementptr inbounds %struct.defs* %pd0, i64 0, i32 11
  %1 = load i32* %flgd30, align 4, !tbaa !2
  %cmp31 = icmp eq i32 %1, 0
  br i1 %cmp31, label %if.end51, label %if.then33

if.then33:                                        ; preds = %if.then28
  %call34 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s71er, i64 0, i64 0), i32 8) nounwind
  br label %if.end51

if.end51:                                         ; preds = %if.then33, %setupTable.exit, %if.then28
  %rc.2 = phi i32 [ 8, %if.then33 ], [ 8, %if.then28 ], [ 0, %setupTable.exit ]
  %2 = load float* %dprec.i, align 4, !tbaa !3
  %cmp53 = fcmp uno float %2, 0.000000e+00
  br i1 %cmp53, label %if.then55, label %if.end63

if.then55:                                        ; preds = %if.end51
  %add5665 = or i32 %rc.2, 32
  %flgd57 = getelementptr inbounds %struct.defs* %pd0, i64 0, i32 11
  %3 = load i32* %flgd57, align 4, !tbaa !2
  %cmp58 = icmp eq i32 %3, 0
  br i1 %cmp58, label %if.end63, label %if.then60

if.then60:                                        ; preds = %if.then55
  %call61 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @sec.s71er, i64 0, i64 0), i32 32) nounwind
  br label %if.end63

if.end63:                                         ; preds = %if.then55, %if.then60, %if.end51
  %rc.4 = phi i32 [ %add5665, %if.then60 ], [ %add5665, %if.then55 ], [ %rc.2, %if.end51 ]
  ret i32 %rc.4
}
...
if.then:                                          ; preds = %entry
  %call1 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds (%struct.defs* @main.d0, i64 0, i32 15, i64 0), i32 %call) nounwind
...
if.else:                                          ; preds = %if.end
  %puts7 = tail call i32 @puts(i8* getelementptr inbounds ([9 x i8]* @str4, i64 0, i64 0))
  br label %if.end6
