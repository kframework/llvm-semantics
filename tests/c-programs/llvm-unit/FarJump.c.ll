...
define void @quux(%struct.__jmp_buf_tag* %buf) #0 {
  ...
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.1, i32 0, i32 0))
  %4 = load %struct.__jmp_buf_tag*, %struct.__jmp_buf_tag** %1, align 8
...
define void @qux(%struct.__jmp_buf_tag* %buf) #0 {
  ...
  store %struct.__jmp_buf_tag* %buf, %struct.__jmp_buf_tag** %1, align 8
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.2, i32 0, i32 0))
  %3 = getelementptr inbounds [1 x %struct.__jmp_buf_tag], [1 x %struct.__jmp_buf_tag]* %local_buf, i32 0, i32 0
  %4 = call i32 @_setjmp(%struct.__jmp_buf_tag* %3) #5
  %5 = icmp ne i32 %4, 0
  br i1 %5, label %8, label %6

; <label>:6                                       ; preds = %0
  %7 = load %struct.__jmp_buf_tag*, %struct.__jmp_buf_tag** %1, align 8
  call void @quux(%struct.__jmp_buf_tag* %7)
  br label %10

; <label>:8                                       ; preds = %0
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.3, i32 0, i32 0))
  br label %10
...
; <label>:8                                       ; preds = %0
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.5, i32 0, i32 0))
  br label %10
...
define void @bar(%struct.__jmp_buf_tag* %buf) #0 {
  %1 = alloca %struct.__jmp_buf_tag*, align 8
  store %struct.__jmp_buf_tag* %buf, %struct.__jmp_buf_tag** %1, align 8
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.6, i32 0, i32 0))
...
define void @foo() #0 {
  ...
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.7, i32 0, i32 0))
...
; <label>:5                                       ; preds = %0
  %6 = getelementptr inbounds [1 x %struct.__jmp_buf_tag], [1 x %struct.__jmp_buf_tag]* %buf, i32 0, i32 0
  call void @bar(%struct.__jmp_buf_tag* %6)
  br label %9

; <label>:7                                       ; preds = %0
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.8, i32 0, i32 0))
  br label %9
