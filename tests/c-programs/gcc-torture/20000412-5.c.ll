...
define i32 @main() #0 {
  ...
  %3 = getelementptr inbounds [1 x %struct.anon], [1 x %struct.anon]* %lastglob, i32 0, i64 0
...
; <label>:7                                       ; preds = %0
  %8 = getelementptr inbounds [1 x %struct.anon], [1 x %struct.anon]* %lastglob, i32 0, i64 0
