; ModuleID = '/home/grosu/celliso2/c-semantics/tests/unitTests/realloc3.ll'
...
entry:
  ...
  %call3 = tail call noalias i8* @realloc(i8* %call, i64 10) nounwind
  %arrayidx5 = getelementptr inbounds i8* %call3, i64 3
