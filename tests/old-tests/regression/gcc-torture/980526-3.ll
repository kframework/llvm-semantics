; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/980526-3.c'
...
lor.lhs.false:                                    ; preds = %entry
  ...
  %tmp3 = load i32* %l, align 4
  %neg4 = xor i32 %tmp3, -1
  %rem5 = urem i32 %tmp2, %neg4
  %call6 = call i32 (...)* bitcast (i32 (i32, i32)* @compare to i32 (...)*)(i32 0, i32 %rem5)
