; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith001467.ll'
...
entry:
  ...
  %call5 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([19 x i8]* @.str2, i64 0, i64 0), i32 %conv) nounwind
  ret i32 0
}
