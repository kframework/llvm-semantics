...
; <label>:7                                       ; preds = %4, %0
  %8 = phi i1 [ true, %0 ], [ %6, %4 ]
  %9 = zext i1 %8 to i32
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str, i32 0, i32 0), i32 %9)
  %11 = load i8*, i8** getelementptr inbounds ([255 x i8*], [255 x i8*]* @a, i32 0, i64 16), align 8
  %12 = icmp ne i8* %11, null
  br i1 %12, label %16, label %13

; <label>:13                                      ; preds = %7
  %14 = load i8*, i8** getelementptr inbounds ([255 x i8*], [255 x i8*]* @a, i32 0, i64 8), align 8
...
; <label>:17                                      ; preds = %13
  ...
  %18 = load i8*, i8** getelementptr inbounds ([255 x i8*], [255 x i8*]* @a, i32 0, i64 16), align 8
  %19 = icmp ne i8* %18, null
  br i1 %19, label %23, label %20

; <label>:20                                      ; preds = %17
  %21 = load i8*, i8** getelementptr inbounds ([255 x i8*], [255 x i8*]* @a, i32 0, i64 8), align 8
...
; <label>:23                                      ; preds = %20, %17
  ...
  %26 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str, i32 0, i32 0), i32 %25)
  %27 = load i8*, i8** getelementptr inbounds ([255 x i8*], [255 x i8*]* @a, i32 0, i64 16), align 8
  %28 = icmp ne i8* %27, null
  br i1 %28, label %29, label %32

; <label>:29                                      ; preds = %23
  %30 = load i8*, i8** getelementptr inbounds ([255 x i8*], [255 x i8*]* @a, i32 0, i64 8), align 8
