; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20020321-1.c'
...
entry:
  ...
  %tmp3 = load float* %d.addr, align 4
  %call = call float @g(i8* %tmp, i8* %tmp1, i32 0, i32 %tmp2, float %tmp3)
  ret float %call
}
