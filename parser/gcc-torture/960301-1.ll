; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/960301-1.c'
...
entry:
  ...
  %bf.value = and i32 %tmp, 15
  %2 = and i32 %bf.value, 15
  %3 = shl i32 %2, 12
  %4 = load i32* bitcast (%struct.foo* @foo to i32*), align 4
  %5 = and i32 %4, -61441
  %6 = or i32 %5, %3
  store i32 %6, i32* bitcast (%struct.foo* @foo to i32*), align 4
  %tmp1 = load i32* %k.addr, align 4
