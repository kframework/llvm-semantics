; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/vrp-7.ll'
...
entry:
  %and = lshr i32 %f, 4
  %0 = and i32 %and, 1
  %1 = load i32* bitcast (%struct.T* @t to i32*), align 4
  %2 = and i32 %1, -2
  %3 = or i32 %2, %0
  store i32 %3, i32* bitcast (%struct.T* @t to i32*), align 4
  ret void
}
