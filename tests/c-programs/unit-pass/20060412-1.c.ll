...
define i32 @main() #0 {
  ...
  %5 = getelementptr inbounds [82 x %struct.S], [82 x %struct.S]* %4, i32 0, i64 0
  store %struct.S* %5, %struct.S** %p, align 8
  %6 = load %struct.S*, %struct.S** %p, align 8
  %7 = getelementptr inbounds %struct.S, %struct.S* %6, i64 82
  store %struct.S* %7, %struct.S** %q, align 8
  br label %8

; <label>:8                                       ; preds = %13, %0
  %9 = load %struct.S*, %struct.S** %q, align 8
  %10 = getelementptr inbounds %struct.S, %struct.S* %9, i32 -1
...
; <label>:16                                      ; preds = %8
  %17 = load %struct.S*, %struct.S** %q, align 8
  %18 = getelementptr inbounds %struct.S, %struct.S* %17, i32 0, i32 0
  store i64 0, i64* %18, align 8
  %19 = load %struct.S*, %struct.S** %q, align 8
  %20 = load %struct.S*, %struct.S** %p, align 8
...
; <label>:23                                      ; preds = %16
  %24 = load %struct.S*, %struct.S** %q, align 8
  %25 = load %struct.S*, %struct.S** %p, align 8
