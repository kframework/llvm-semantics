...
@r = global i64* getelementptr inbounds ([32 x i64], [32 x i64]* @b, i32 0, i32 0), align 8
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  store i64 3160194, i64* getelementptr inbounds ([32 x i64], [32 x i64]* @b, i32 0, i64 17), align 8
  store i64 6003104017374052362, i64* getelementptr inbounds ([32 x i64], [32 x i64]* @b, i32 0, i64 2), align 8
  store i64 2281701442, i64* @pars, align 8
  call void @alpha_ep_extbl_i_eq_0()
  %2 = load i64, i64* getelementptr inbounds ([32 x i64], [32 x i64]* @b, i32 0, i64 2), align 8
  %3 = icmp ne i64 %2, 77
