; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/pr19689.c'
...
entry:
  ...
  %tmp = load i16* %j.addr, align 2
  %conv = sext i16 %tmp to i32
  %bf.value = and i32 %conv, 536870911
  %0 = shl i32 %bf.value, 3
  %bf.reload.sext = ashr i32 %0, 3
  %1 = and i32 %bf.value, 536870911
  %2 = load i32* bitcast (%struct.anon* @f to i32*), align 4
  %3 = and i32 %2, -536870912
  %4 = or i32 %3, %1
  store i32 %4, i32* bitcast (%struct.anon* @f to i32*), align 4
  ret void
}
