; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/931102-2.c'
...
while.body:                                       ; preds = %while.cond
  %tmp6 = load i32* %num, align 4
  %inc = add nsw i32 %tmp6, 1
  store i32 %inc, i32* %num, align 4
  %b7 = bitcast %union.T* %reg to %struct.anon*
  %l8 = getelementptr inbounds %struct.anon* %b7, i32 0, i32 1
  %tmp9 = load i16* %l8, align 2
  %conv10 = sext i16 %tmp9 to i32
  %shr = ashr i32 %conv10, 1
  %conv11 = trunc i32 %shr to i16
  store i16 %conv11, i16* %l8, align 2
  br label %while.cond

while.end:                                        ; preds = %while.cond
  %tmp12 = load i32* %num, align 4
  ret i32 %tmp12
}
