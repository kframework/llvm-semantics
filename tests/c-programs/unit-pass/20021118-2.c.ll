...
define i32 @t1(float* %f, i32 %i, void (double)* %f1, void (float, float)* %f2) #0 {
  ...
  %5 = load void (double)*, void (double)** %3, align 8
  ...
  %16 = load void (float, float)*, void (float, float)** %4, align 8
...
define i32 @t2(float* %f, i32 %i, void (double)* %f1, void (float, float)* %f2, void (float)* %f3) #0 {
  ...
  %6 = load void (float)*, void (float)** %5, align 8
  call void %6(float 6.000000e+00)
  %7 = load void (double)*, void (double)** %3, align 8
  ...
  %18 = load void (float, float)*, void (float, float)** %4, align 8
...
define i32 @main() #0 {
  ...
  %3 = getelementptr inbounds [3 x float], [3 x float]* %f, i32 0, i32 0
  %4 = call i32 @t1(float* %3, i32 0, void (double)* @f1, void (float, float)* @f2)
  %5 = getelementptr inbounds [3 x float], [3 x float]* %f, i32 0, i32 0
  %6 = call i32 @t2(float* %5, i32 1, void (double)* @f1, void (float, float)* @f2, void (float)* @f3)
  %7 = getelementptr inbounds [3 x float], [3 x float]* %f, i32 0, i64 0
  %8 = load float, float* %7, align 4
  %9 = fcmp une float %8, 3.000000e+00
  br i1 %9, label %10, label %15

; <label>:10                                      ; preds = %0
  %11 = getelementptr inbounds [3 x float], [3 x float]* %f, i32 0, i64 1
