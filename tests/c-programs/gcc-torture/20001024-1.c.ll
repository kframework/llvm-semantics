...
define i32 @bar(i32 %x, %struct.b* noalias %y, %struct.b* noalias %z) #0 {
  ...
  %4 = load %struct.b*, %struct.b** %2, align 8
  %5 = getelementptr inbounds %struct.b, %struct.b* %4, i32 0, i32 0
...
; <label>:9                                       ; preds = %0
  %10 = load %struct.b*, %struct.b** %2, align 8
...
; <label>:15                                      ; preds = %9
  %16 = load %struct.b*, %struct.b** %2, align 8
...
; <label>:21                                      ; preds = %15
  %22 = load %struct.b*, %struct.b** %2, align 8
...
define void @foo() #0 {
  ...
  %1 = getelementptr inbounds %struct.b, %struct.b* %x, i32 0, i32 0
  %2 = getelementptr inbounds %struct.a, %struct.a* %1, i32 0, i32 0
  store i64 0, i64* %2, align 8
  %3 = getelementptr inbounds %struct.b, %struct.b* %x, i32 0, i32 0
  %4 = getelementptr inbounds %struct.a, %struct.a* %3, i32 0, i32 1
  store i64 250000, i64* %4, align 8
  %5 = getelementptr inbounds %struct.b, %struct.b* %x, i32 0, i32 1
  %6 = getelementptr inbounds %struct.b, %struct.b* %x, i32 0, i32 0
