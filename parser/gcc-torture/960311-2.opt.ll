; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/960311-2.ll'
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %tobool7 = icmp eq i16 %shl.mask, 0
...
if.end9:                                          ; preds = %if.end, %if.then8
  %shl12.mask = and i16 %data, 8192
  %tobool17 = icmp eq i16 %shl12.mask, 0
