...
define { i8*, i64 } @foo(i8* %x.coerce0, i64 %x.coerce1, i8* %y.coerce0, i64 %y.coerce1) #0 {
  ...
  %9 = getelementptr inbounds %struct.object, %struct.object* %x, i32 0, i32 0
  %10 = load i8*, i8** %9, align 8
  %11 = bitcast i8* %10 to %struct.object*
  %12 = bitcast %struct.object* %z to i8*
  %13 = bitcast %struct.object* %11 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %12, i8* %13, i64 16, i32 8, i1 false)
  %14 = getelementptr inbounds %struct.object, %struct.object* %z, i32 0, i32 1
...
; <label>:18                                      ; preds = %0
  %19 = getelementptr inbounds %struct.object, %struct.object* %z, i32 0, i32 0
  ...
  %25 = getelementptr inbounds %struct.object, %struct.object* %z, i32 0, i32 0
  %26 = load i8*, i8** %25, align 8
  %27 = bitcast i8* %26 to %struct.object*
  %28 = bitcast %struct.object* %z to i8*
  %29 = bitcast %struct.object* %27 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %28, i8* %29, i64 16, i32 8, i1 false)
  %30 = getelementptr inbounds %struct.object, %struct.object* %z, i32 0, i32 1
...
define i32 @main() #0 {
  ...
  %16 = getelementptr { i8*, i64 }, { i8*, i64 }* %15, i32 0, i32 0
  %17 = extractvalue { i8*, i64 } %14, 0
  store i8* %17, i8** %16, align 8
  %18 = getelementptr { i8*, i64 }, { i8*, i64 }* %15, i32 0, i32 1
