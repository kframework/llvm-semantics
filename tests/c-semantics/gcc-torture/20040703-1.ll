...
; <label>:11                                      ; preds = %0
  %12 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 2
  %13 = load i32* %12, align 4
  %14 = icmp ne i32 %13, 0
  br i1 %14, label %23, label %15

; <label>:15                                      ; preds = %11
  %16 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 1
  %17 = load i32* %16, align 4
  %18 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 0
...
; <label>:23                                      ; preds = %15, %11
  ...
  %26 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 3
  store i32 %25, i32* %26, align 4
  %27 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 1
  store i32 0, i32* %27, align 4
  %28 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 0
...
; <label>:36                                      ; preds = %29
  ...
  %41 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 1
  %42 = load i32* %41, align 4
  %43 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 0
  store i32 %42, i32* %43, align 4
  %44 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 1
...
; <label>:48                                      ; preds = %45
  %49 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 0
  %50 = load i32* %49, align 4
  %51 = load i32* %m, align 4
  %52 = shl i32 %50, %51
  %53 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 1
  ...
  %59 = lshr i32 %54, %58
  %60 = or i32 %52, %59
  %61 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 0
  store i32 %60, i32* %61, align 4
  %62 = load i32* %m, align 4
  %63 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 1
...
; <label>:66                                      ; preds = %48, %45
  ...
  %81 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 2
  %82 = load i32* %81, align 4
  %83 = icmp ne i32 %82, 0
  br i1 %83, label %84, label %86

; <label>:84                                      ; preds = %66
  %85 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 3
...
; <label>:86                                      ; preds = %66
  ...
  %96 = getelementptr { i64, i64 }* %95, i32 0, i32 0
  %97 = extractvalue { i64, i64 } %94, 0
  store i64 %97, i64* %96, align 1
  %98 = getelementptr { i64, i64 }* %95, i32 0, i32 1
  %99 = extractvalue { i64, i64 } %94, 1
  store i64 %99, i64* %98, align 1
  %100 = getelementptr inbounds %struct.cpp_num* %orig, i32 0, i32 1
  %101 = load i32* %100, align 4
  %102 = getelementptr inbounds %struct.cpp_num* %maybe_orig, i32 0, i32 1
  %103 = load i32* %102, align 4
  %104 = icmp eq i32 %101, %103
  br i1 %104, label %105, label %111

; <label>:105                                     ; preds = %86
  %106 = getelementptr inbounds %struct.cpp_num* %orig, i32 0, i32 0
  %107 = load i32* %106, align 4
  %108 = getelementptr inbounds %struct.cpp_num* %maybe_orig, i32 0, i32 0
...
; <label>:111                                     ; preds = %105, %86
  ...
  %115 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 3
...
; <label>:17                                      ; preds = %9
  ...
  %19 = shl i32 1, %18
  %20 = sub i32 %19, 1
  %21 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 0
...
; <label>:29                                      ; preds = %25
  ...
  %31 = shl i32 1, %30
  %32 = sub i32 %31, 1
  %33 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 1
...
; <label>:36                                      ; preds = %29, %25
  %37 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 0
...
define internal { i64, i64 } @num_rshift(i64 %num.coerce0, i64 %num.coerce1, i32 %precision, i32 %n) #0 {
  ...
  %15 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 2
...
; <label>:27                                      ; preds = %23
  %28 = load i32* %sign_mask, align 4
  %29 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 1
  store i32 %28, i32* %29, align 4
  %30 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 0
...
; <label>:35                                      ; preds = %31
  %36 = load i32* %sign_mask, align 4
  %37 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 0
  store i32 %36, i32* %37, align 4
  %38 = load i32* %sign_mask, align 4
...
; <label>:48                                      ; preds = %44
  %49 = load i32* %sign_mask, align 4
  %50 = load i32* %2, align 4
  %51 = zext i32 %50 to i64
  %52 = sub i64 %51, 32
  %53 = trunc i64 %52 to i32
  %54 = shl i32 %49, %53
  %55 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 0
...
; <label>:63                                      ; preds = %59
  ...
  %68 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 0
  %69 = load i32* %68, align 4
  %70 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 1
  store i32 %69, i32* %70, align 4
  %71 = load i32* %sign_mask, align 4
  %72 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 0
...
; <label>:76                                      ; preds = %73
  %77 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 1
  %78 = load i32* %77, align 4
  %79 = load i32* %3, align 4
  %80 = lshr i32 %78, %79
  %81 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 0
  %82 = load i32* %81, align 4
  ...
  %87 = shl i32 %82, %86
  %88 = or i32 %80, %87
  %89 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 1
  store i32 %88, i32* %89, align 4
  %90 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 0
  %91 = load i32* %90, align 4
  %92 = load i32* %3, align 4
  %93 = lshr i32 %91, %92
  %94 = load i32* %sign_mask, align 4
  ...
  %99 = shl i32 %94, %98
  %100 = or i32 %93, %99
  %101 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 0
...
; <label>:103                                     ; preds = %102, %27
  ...
  %108 = getelementptr { i64, i64 }* %105, i32 0, i32 1
  ...
  %118 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 3
...
define i32 @main() #0 {
  ...
  %3 = load i64* getelementptr ({ i64, i64 }* bitcast (%struct.cpp_num* @num to { i64, i64 }*), i32 0, i32 0), align 1
  %4 = load i64* getelementptr ({ i64, i64 }* bitcast (%struct.cpp_num* @num to { i64, i64 }*), i32 0, i32 1), align 1
  ...
  %11 = getelementptr inbounds %struct.cpp_num* %res, i32 0, i32 1
...
; <label>:15                                      ; preds = %0
  %16 = getelementptr inbounds %struct.cpp_num* %res, i32 0, i32 0
  %17 = load i32* %16, align 4
  %18 = icmp ne i32 %17, 0
...
; <label>:20                                      ; preds = %15
  %21 = getelementptr inbounds %struct.cpp_num* %res, i32 0, i32 3
  %22 = load i32* %21, align 4
  %23 = icmp ne i32 %22, 0
...
; <label>:9                                       ; preds = %0
  ...
  %13 = trunc i64 %12 to i32
  store i32 %13, i32* %2, align 4
  %14 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 0
...
; <label>:22                                      ; preds = %0
  %23 = getelementptr inbounds %struct.cpp_num* %num, i32 0, i32 1
