...
; <label>:20                                      ; preds = %15, %9
  ...
  %23 = load %struct.__va_list_tag*, %struct.__va_list_tag** %2, align 8
  %24 = getelementptr inbounds %struct.__va_list_tag, %struct.__va_list_tag* %23, i32 0, i32 1
  %25 = load i32, i32* %24
...
; <label>:38                                      ; preds = %33, %27
  ...
  %41 = load i32, i32* @foo_arg, align 4
  %42 = sitofp i32 %41 to double
  %43 = fadd double %42, %40
  %44 = fptosi double %43 to i32
  store i32 %44, i32* @foo_arg, align 4
  %45 = load %struct.__va_list_tag*, %struct.__va_list_tag** %2, align 8
...
; <label>:60                                      ; preds = %55, %49
  ...
  %62 = load i64, i64* %61
  %63 = load i32, i32* @foo_arg, align 4
...
; <label>:83                                      ; preds = %78, %72
  ...
  %87 = load %struct.__va_list_tag*, %struct.__va_list_tag** %2, align 8
  %88 = getelementptr inbounds %struct.__va_list_tag, %struct.__va_list_tag* %87, i32 0, i32 1
  %89 = load i32, i32* %88
...
; <label>:102                                     ; preds = %97, %91
  ...
  %105 = load i32, i32* @foo_arg, align 4
...
; <label>:109                                     ; preds = %0
  ...
  %111 = getelementptr inbounds %struct.__va_list_tag, %struct.__va_list_tag* %110, i32 0, i32 0
...
; <label>:125                                     ; preds = %120, %114
  ...
  %128 = load %struct.__va_list_tag*, %struct.__va_list_tag** %2, align 8
  %129 = getelementptr inbounds %struct.__va_list_tag, %struct.__va_list_tag* %128, i32 0, i32 2
  %130 = load i8*, i8** %129
  %131 = getelementptr i8, i8* %130, i64 15
  %132 = ptrtoint i8* %131 to i64
  %133 = and i64 %132, -16
  %134 = inttoptr i64 %133 to i8*
  %135 = bitcast i8* %134 to x86_fp80*
  %136 = getelementptr i8, i8* %134, i32 16
  store i8* %136, i8** %129
  %137 = load x86_fp80, x86_fp80* %135
  %138 = load i32, i32* @foo_arg, align 4
...
; <label>:4                                       ; preds = %0
  %5 = load i32, i32* getelementptr inbounds ([1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* @gap, i32 0, i32 0, i32 0)
  %6 = icmp ule i32 %5, 40
...
; <label>:7                                       ; preds = %4
  ...
  %11 = add i32 %5, 8
  store i32 %11, i32* getelementptr inbounds ([1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* @gap, i32 0, i32 0, i32 0)
  br label %16
...
; <label>:20                                      ; preds = %16
  %21 = load i32, i32* getelementptr inbounds ([1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* @gap, i32 0, i32 0, i32 1)
...
; <label>:23                                      ; preds = %20
  ...
  %27 = add i32 %21, 16
  store i32 %27, i32* getelementptr inbounds ([1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* @gap, i32 0, i32 0, i32 1)
  br label %32
...
define void @f1(i32 %i, ...) #0 {
  ...
  %2 = load i32, i32* getelementptr inbounds ([1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* @gap, i32 0, i32 0, i32 0)
  %3 = icmp ule i32 %2, 40
  br i1 %3, label %4, label %9

; <label>:4                                       ; preds = %0
  %5 = load i8*, i8** getelementptr inbounds ([1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* @gap, i32 0, i32 0, i32 3)
  %6 = getelementptr i8, i8* %5, i32 %2
  %7 = bitcast i8* %6 to i64*
  %8 = add i32 %2, 8
  store i32 %8, i32* getelementptr inbounds ([1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* @gap, i32 0, i32 0, i32 0)
  br label %13

; <label>:9                                       ; preds = %0
  %10 = load i8*, i8** getelementptr inbounds ([1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* @gap, i32 0, i32 0, i32 2)
  %11 = bitcast i8* %10 to i64*
  %12 = getelementptr i8, i8* %10, i32 8
  store i8* %12, i8** getelementptr inbounds ([1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* @gap, i32 0, i32 0, i32 2)
  br label %13
...
define void @f3(i32 %i, ...) #0 {
  ...
  store i32 %i, i32* %1, align 4
  %2 = getelementptr inbounds [10 x [1 x %struct.__va_list_tag]], [10 x [1 x %struct.__va_list_tag]]* %aps, i32 0, i64 4
  ...
  %5 = getelementptr inbounds [10 x [1 x %struct.__va_list_tag]], [10 x [1 x %struct.__va_list_tag]]* %aps, i32 0, i64 4
...
; <label>:21                                      ; preds = %16, %10
  ...
  %24 = getelementptr inbounds [10 x [1 x %struct.__va_list_tag]], [10 x [1 x %struct.__va_list_tag]]* %aps, i32 0, i64 4
  %25 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %24, i32 0, i32 0
...
define void @f4(i32 %i, ...) #0 {
  ...
  call void @bar(i32 %5)
  %6 = getelementptr inbounds [10 x [1 x %struct.__va_list_tag]], [10 x [1 x %struct.__va_list_tag]]* %aps, i32 0, i64 4
...
define void @f5(i32 %i, ...) #0 {
  ...
  %8 = getelementptr inbounds [10 x [1 x %struct.__va_list_tag]], [10 x [1 x %struct.__va_list_tag]]* %aps, i32 0, i64 4
...
; <label>:21                                      ; preds = %16, %10
  ...
  %23 = load i64, i64* %22
  store i64 %23, i64* @x, align 8
  %24 = getelementptr inbounds %struct.A, %struct.A* %a, i32 0, i32 1
  %25 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %24, i32 0, i32 0
  %26 = bitcast %struct.__va_list_tag* %25 to i8*
  call void @llvm.va_end(i8* %26)
  ret void
...
define void @f7(i32 %i, ...) #0 {
  ...
  %5 = load i32, i32* %1, align 4
  call void @bar(i32 %5)
  %6 = getelementptr inbounds %struct.A, %struct.A* %a, i32 0, i32 1
  %7 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %6, i32 0, i32 0
  %8 = bitcast %struct.__va_list_tag* %7 to i8*
  call void @llvm.va_end(i8* %8)
  ret void
...
define void @f8(i32 %i, ...) #0 {
  ...
  %7 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %6, i32 0, i32 0
  call void @foo(i32 %5, %struct.__va_list_tag* %7)
  %8 = getelementptr inbounds %struct.A, %struct.A* %a, i32 0, i32 1
  %9 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %8, i32 0, i32 0
  %10 = bitcast %struct.__va_list_tag* %9 to i8*
  call void @llvm.va_end(i8* %10)
  ret void
...
define void @f10(i32 %i, ...) #0 {
  ...
  %a = alloca %struct.A, align 8
  store i32 %i, i32* %1, align 4
  %2 = getelementptr inbounds %struct.A, %struct.A* %a, i32 0, i32 2
  %3 = getelementptr inbounds [2 x [1 x %struct.__va_list_tag]], [2 x [1 x %struct.__va_list_tag]]* %2, i32 0, i64 1
  %4 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %3, i32 0, i32 0
  %5 = bitcast %struct.__va_list_tag* %4 to i8*
  call void @llvm.va_start(i8* %5)
  %6 = getelementptr inbounds %struct.A, %struct.A* %a, i32 0, i32 2
  %7 = getelementptr inbounds [2 x [1 x %struct.__va_list_tag]], [2 x [1 x %struct.__va_list_tag]]* %6, i32 0, i64 1
...
; <label>:23                                      ; preds = %18, %12
  ...
  %26 = getelementptr inbounds %struct.A, %struct.A* %a, i32 0, i32 2
  %27 = getelementptr inbounds [2 x [1 x %struct.__va_list_tag]], [2 x [1 x %struct.__va_list_tag]]* %26, i32 0, i64 1
  %28 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %27, i32 0, i32 0
...
define void @f11(i32 %i, ...) #0 {
  ...
  call void @bar(i32 %6)
  %7 = getelementptr inbounds %struct.A, %struct.A* %a, i32 0, i32 2
  %8 = getelementptr inbounds [2 x [1 x %struct.__va_list_tag]], [2 x [1 x %struct.__va_list_tag]]* %7, i32 0, i64 1
  %9 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %8, i32 0, i32 0
  %10 = bitcast %struct.__va_list_tag* %9 to i8*
  call void @llvm.va_end(i8* %10)
  ret void
...
define void @f12(i32 %i, ...) #0 {
  ...
  %10 = getelementptr inbounds %struct.A, %struct.A* %a, i32 0, i32 2
  %11 = getelementptr inbounds [2 x [1 x %struct.__va_list_tag]], [2 x [1 x %struct.__va_list_tag]]* %10, i32 0, i64 1
