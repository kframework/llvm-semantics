; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20080719-1.ll'
...
sw.epilog:                                        ; preds = %entry, %sw.default, %sw.bb1
  %tmp31 = phi i32* [ getelementptr inbounds ([2 x i32]* @cfb_tab32, i64 0, i64 0), %sw.default ], [ getelementptr inbounds ([4 x i32]* @cfb_tab16_be, i64 0, i64 0), %sw.bb1 ], [ getelementptr inbounds ([16 x i32]* @cfb_tab8_be, i64 0, i64 0), %entry ]
  ret i32* %tmp31
}
