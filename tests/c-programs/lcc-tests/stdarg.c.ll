...
@.str.1 = private unnamed_addr constant [9 x i8] c"test %s\0A\00", align 1
@.str.2 = private unnamed_addr constant [2 x i8] c"2\00", align 1
@.str.3 = private unnamed_addr constant [10 x i8] c"test %d%c\00", align 1
@.str.4 = private unnamed_addr constant [10 x i8] c"%s%s %d%c\00", align 1
@.str.5 = private unnamed_addr constant [3 x i8] c"te\00", align 1
@.str.6 = private unnamed_addr constant [3 x i8] c"st\00", align 1
@.str.7 = private unnamed_addr constant [10 x i8] c"%s%s %f%c\00", align 1
@.str.8 = private unnamed_addr constant [19 x i8] c"%b %b %b %b %b %b\0A\00", align 1
@.str.9 = private unnamed_addr constant [14 x i8] c"{%d %d %d %d}\00", align 1
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  call void (i8*, ...) @print(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i32 0, i32 0))
  call void (i8*, ...) @print(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  call void (i8*, ...) @print(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.3, i32 0, i32 0), i32 3, i32 10)
  call void (i8*, ...) @print(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.6, i32 0, i32 0), i32 4, i32 10)
  call void (i8*, ...) @print(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.7, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.6, i32 0, i32 0), double 5.000000e+00, i32 10)
  %2 = load i64, i64* getelementptr ({ i64, i64 }, { i64, i64 }* bitcast (%struct.node* @x to { i64, i64 }*), i32 0, i32 0), align 1
  %3 = load i64, i64* getelementptr ({ i64, i64 }, { i64, i64 }* bitcast (%struct.node* @x to { i64, i64 }*), i32 0, i32 1), align 1
  %4 = load i64, i64* getelementptr ({ i64, i64 }, { i64, i64 }* bitcast (%struct.node* @x to { i64, i64 }*), i32 0, i32 0), align 1
  %5 = load i64, i64* getelementptr ({ i64, i64 }, { i64, i64 }* bitcast (%struct.node* @x to { i64, i64 }*), i32 0, i32 1), align 1
  call void (i8*, ...) @print(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.8, i32 0, i32 0), i64 %2, i64 %3, i64 %4, i64 %5, %struct.node* byval align 8 @x, %struct.node* byval align 8 @x, %struct.node* byval align 8 @x, %struct.node* byval align 8 @x)
  ret i32 0
}
...
; <label>:29                                      ; preds = %18
  ...
  %33 = getelementptr i8, i8* %31, i32 16
  store i8* %33, i8** %30
  br label %34
...
; <label>:34                                      ; preds = %29, %23
  ...
  %38 = getelementptr inbounds %struct.node, %struct.node* %x, i32 0, i32 0
  %39 = getelementptr inbounds [4 x i32], [4 x i32]* %38, i32 0, i64 0
  %40 = load i32, i32* %39, align 4
  %41 = getelementptr inbounds %struct.node, %struct.node* %x, i32 0, i32 0
  %42 = getelementptr inbounds [4 x i32], [4 x i32]* %41, i32 0, i64 1
  %43 = load i32, i32* %42, align 4
  %44 = getelementptr inbounds %struct.node, %struct.node* %x, i32 0, i32 0
  %45 = getelementptr inbounds [4 x i32], [4 x i32]* %44, i32 0, i64 2
  %46 = load i32, i32* %45, align 4
  %47 = getelementptr inbounds %struct.node, %struct.node* %x, i32 0, i32 0
  %48 = getelementptr inbounds [4 x i32], [4 x i32]* %47, i32 0, i64 3
  %49 = load i32, i32* %48, align 4
  %50 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.9, i32 0, i32 0), i32 %40, i32 %43, i32 %46, i32 %49)
  br label %157

; <label>:51                                      ; preds = %13
  %52 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
...
; <label>:67                                      ; preds = %62, %56
  ...
  %69 = load i32, i32* %68
  %70 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.10, i32 0, i32 0), i32 %69)
  br label %157
...
; <label>:87                                      ; preds = %82, %76
  ...
  %89 = load i32, i32* %88
  %90 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.11, i32 0, i32 0), i32 %89)
  br label %157

; <label>:91                                      ; preds = %13
  %92 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
...
; <label>:107                                     ; preds = %102, %96
  ...
  %110 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.12, i32 0, i32 0), i32 %109)
  br label %157

; <label>:111                                     ; preds = %13
  %112 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
...
; <label>:127                                     ; preds = %122, %116
  ...
  %129 = load i8*, i8** %128
  %130 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.13, i32 0, i32 0), i8* %129)
  br label %157
...
; <label>:147                                     ; preds = %142, %136
  ...
  %151 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.11, i32 0, i32 0), i32 %150)
  br label %157
...
; <label>:152                                     ; preds = %13
  ...
  %156 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.10, i32 0, i32 0), i32 %155)
  br label %157
...
; <label>:158                                     ; preds = %8
  ...
  %162 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.10, i32 0, i32 0), i32 %161)
  br label %163
