; ModuleID = '/home/grosu/celliso2/c-semantics/tests/unitTests/structInStruct.c'
...
entry:
  ...
  %tmp = bitcast %struct.str* %this1 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* bitcast (%struct.that* @globalThat to i8*), i8* %tmp, i64 48, i32 8, i1 false)
  ret i32 0
}
