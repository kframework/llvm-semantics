; ModuleID = '/home/grosu/celliso2/c-semantics/tests/csmith/smith000425.ll'
...
entry:
  store i32* @g_6, i32** @g_7, align 8
  %tmp4 = load i32* @g_6, align 4
  ret i32 %tmp4
}

define i32* @func_2(i32* %p_3, i32 %p_4) nounwind uwtable readnone {
entry:
  ret i32* %p_3
}
