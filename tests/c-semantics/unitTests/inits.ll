...
define i32 @main() #0 {
  ...
  %8 = getelementptr [4 x [3 x i32]]* %7, i32 0, i32 0
  %9 = getelementptr [3 x i32]* %8, i32 0, i32 0
  store i32 1, i32* %9
  %10 = getelementptr [4 x [3 x i32]]* %7, i32 0, i32 1
  %11 = getelementptr [3 x i32]* %10, i32 0, i32 0
  store i32 2, i32* %11
  %12 = getelementptr [4 x [3 x i32]]* %7, i32 0, i32 2
  %13 = getelementptr [3 x i32]* %12, i32 0, i32 0
  store i32 3, i32* %13
  %14 = getelementptr [4 x [3 x i32]]* %7, i32 0, i32 3
...
; <label>:23                                      ; preds = %20
  ...
  %32 = getelementptr inbounds [4 x [3 x i32]]* %y1, i32 0, i64 %31
  %33 = getelementptr inbounds [3 x i32]* %32, i32 0, i64 %29
  %34 = load i32* %33, align 4
  %35 = load i32* %j, align 4
  %36 = sext i32 %35 to i64
  %37 = load i32* %i, align 4
  %38 = sext i32 %37 to i64
  %39 = getelementptr inbounds [4 x [3 x i32]]* %y2, i32 0, i64 %38
  %40 = getelementptr inbounds [3 x i32]* %39, i32 0, i64 %36
...
; <label>:43                                      ; preds = %23
  ...
  %48 = getelementptr inbounds [4 x [3 x i32]]* %y1, i32 0, i64 %47
  %49 = getelementptr inbounds [3 x i32]* %48, i32 0, i64 %45
  %50 = load i32* %49, align 4
  %51 = load i32* %k, align 4
  %52 = sext i32 %51 to i64
  %53 = getelementptr inbounds [12 x i32]* %y0, i32 0, i64 %52
...
; <label>:56                                      ; preds = %43, %23
  ...
  %62 = getelementptr inbounds [12 x i32]* %y0, i32 0, i64 %61
  %63 = load i32* %62, align 4
  %64 = load i32* %j, align 4
  %65 = sext i32 %64 to i64
  %66 = load i32* %i, align 4
  %67 = sext i32 %66 to i64
  %68 = getelementptr inbounds [4 x [3 x i32]]* %y1, i32 0, i64 %67
  %69 = getelementptr inbounds [3 x i32]* %68, i32 0, i64 %65
  %70 = load i32* %69, align 4
  %71 = load i32* %j, align 4
  %72 = sext i32 %71 to i64
  %73 = load i32* %i, align 4
  %74 = sext i32 %73 to i64
  %75 = getelementptr inbounds [4 x [3 x i32]]* %y2, i32 0, i64 %74
  %76 = getelementptr inbounds [3 x i32]* %75, i32 0, i64 %72
  %77 = load i32* %76, align 4
  %78 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([54 x i8]* @.str, i32 0, i32 0), i32 %57, i32 %58, i32 %59, i32 %63, i32 %70, i32 %77)
  br label %79
