...
; <label>:8                                       ; preds = %0
  %9 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @.str1, i32 0, i32 0))
  store i32 0, i32* %1
  br label %10
...
; <label>:37                                      ; preds = %32, %26
  ...
  %40 = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
...
; <label>:55                                      ; preds = %50, %44
  ...
  %58 = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i32 0, i32 0
