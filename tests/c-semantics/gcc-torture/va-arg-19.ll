...
; <label>:108                                     ; preds = %103
  ...
  %110 = getelementptr inbounds %struct.__va_list_tag* %109, i32 0, i32 0
  %111 = load i32* %110
...
; <label>:129                                     ; preds = %124
  ...
  %131 = getelementptr inbounds %struct.__va_list_tag* %130, i32 0, i32 0
  %132 = load i32* %131
...
; <label>:171                                     ; preds = %166
  ...
  %173 = getelementptr inbounds %struct.__va_list_tag* %172, i32 0, i32 0
  %174 = load i32* %173
