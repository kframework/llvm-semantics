...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  call void @testit()
  %2 = load i32, i32* getelementptr inbounds ([4 x i32], [4 x i32]* @a, i32 0, i64 0), align 4
  %3 = icmp ne i32 %2, 0
...
; <label>:5                                       ; preds = %0
  %6 = load i32, i32* getelementptr inbounds ([4 x i32], [4 x i32]* @a, i32 0, i64 1), align 4
  %7 = icmp ne i32 %6, 3
...
; <label>:9                                       ; preds = %5
  %10 = load i32, i32* getelementptr inbounds ([4 x i32], [4 x i32]* @a, i32 0, i64 2), align 4
  %11 = icmp ne i32 %10, 2
...
; <label>:13                                      ; preds = %9
  %14 = load i32, i32* getelementptr inbounds ([4 x i32], [4 x i32]* @a, i32 0, i64 3), align 4
  %15 = icmp ne i32 %14, 1
...
; <label>:12                                      ; preds = %9, %8
  ...
  %16 = getelementptr inbounds [4 x i32], [4 x i32]* %ir, i32 0, i64 %15
...
; <label>:5                                       ; preds = %0
  ...
  %9 = sext i32 %7 to i64
  %10 = getelementptr inbounds [4 x i32], [4 x i32]* @a, i32 0, i64 %9
