...
; <label>:10                                      ; preds = %7
  %11 = load i32* @tok, align 4
  %12 = icmp eq i32 %11, 257
  br i1 %12, label %31, label %13

; <label>:13                                      ; preds = %10
  %14 = load i32* @tok, align 4
  %15 = icmp eq i32 %14, 258
  br i1 %15, label %31, label %16

; <label>:16                                      ; preds = %13
  %17 = load i32* @tok, align 4
  %18 = icmp eq i32 %17, 259
  br i1 %18, label %31, label %19

; <label>:19                                      ; preds = %16
  %20 = load i32* @tok, align 4
  %21 = icmp eq i32 %20, 260
  br i1 %21, label %31, label %22

; <label>:22                                      ; preds = %19
  %23 = load i32* @tok, align 4
  %24 = icmp eq i32 %23, 261
  br i1 %24, label %31, label %25

; <label>:25                                      ; preds = %22
  %26 = load i32* @tok, align 4
  %27 = icmp eq i32 %26, 262
  br i1 %27, label %31, label %28

; <label>:28                                      ; preds = %25
  %29 = load i32* @tok, align 4
