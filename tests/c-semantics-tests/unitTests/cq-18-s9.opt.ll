...
entry:
  ...
  store i8 115, i8* %arraydecay, align 1, !tbaa !0
  %incdec.ptr1.1 = getelementptr inbounds %struct.defs* %pd0, i64 0, i32 15, i64 2
  store i8 57, i8* %incdec.ptr1, align 1, !tbaa !0
  %incdec.ptr1.2 = getelementptr inbounds %struct.defs* %pd0, i64 0, i32 15, i64 3
...
if.end:
  ...
  store i8 57, i8* getelementptr inbounds (%struct.defs* @main.d0, i64 0, i32 15, i64 1), align 1, !tbaa !0
  store i8 32, i8* getelementptr inbounds (%struct.defs* @main.d0, i64 0, i32 15, i64 2), align 2, !tbaa !0
