...
; <label>:17                                      ; preds = %11
  %18 = getelementptr inbounds %struct.tiny* %y, i32 0, i32 0
...
; <label>:23                                      ; preds = %17
  %24 = getelementptr inbounds %struct.tiny* %y, i32 0, i32 1
...
; <label>:29                                      ; preds = %23
  %30 = getelementptr inbounds %struct.tiny* %z, i32 0, i32 0
...
; <label>:35                                      ; preds = %29
  %36 = getelementptr inbounds %struct.tiny* %z, i32 0, i32 1
