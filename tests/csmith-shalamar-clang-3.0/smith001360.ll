; ModuleID = '/home/david/src/c-semantics/tests/csmith/smith001360.c'
...
define i32 @main(i32 %argc, i8** %argv) nounwind uwtable {
  ...
  %5 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([19 x i8]* @.str, i32 0, i32 0), i32 50118)
