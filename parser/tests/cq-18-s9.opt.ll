; ModuleID = '/home/grosu/celliso2/c-semantics/tests/unitTests/cq-18-s9.ll'
...
while.cond:                                       ; preds = %while.cond, %entry
  ...
  %incdec.ptr2 = getelementptr [8 x i8]* @sec.qs9, i64 0, i64 %indvar
...
while.cond.i:                                     ; preds = %while.cond.i, %entry
  ...
  %incdec.ptr2.i = getelementptr [8 x i8]* @sec.qs9, i64 0, i64 %indvar.i
