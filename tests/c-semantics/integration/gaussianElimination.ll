...
define i32 @main() #0 {
  ...
  %4 = getelementptr inbounds [3 x [3 x double]]* %a, i32 0, i32 0
  %5 = load i32* %n, align 4
  %6 = getelementptr inbounds [3 x double]* %b, i32 0, i32 0
  %7 = getelementptr inbounds [3 x double]* %x, i32 0, i32 0
  %8 = getelementptr inbounds [3 x i32]* %indx, i32 0, i32 0
...
define void @legs([3 x double]* %a, i32 %n, double* %b, double* %x, i32* %indx) #0 {
  ...
  %6 = load [3 x double]** %1, align 8
  %7 = load i32* %2, align 4
  %8 = load i32** %5, align 8
...
; <label>:21                                      ; preds = %17
  ...
  %40 = getelementptr inbounds [3 x double]* %39, i64 %38
  %41 = getelementptr inbounds [3 x double]* %40, i32 0, i64 %32
  %42 = load double* %41, align 8
  %43 = load i32* %i, align 4
  %44 = sext i32 %43 to i64
  %45 = load i32** %5, align 8
...
; <label>:69                                      ; preds = %9
  ...
  %90 = load [3 x double]** %1, align 8
  %91 = getelementptr inbounds [3 x double]* %90, i64 %89
  %92 = getelementptr inbounds [3 x double]* %91, i32 0, i64 %82
...
; <label>:125                                     ; preds = %121
  ...
  %139 = load [3 x double]** %1, align 8
  %140 = getelementptr inbounds [3 x double]* %139, i64 %138
  %141 = getelementptr inbounds [3 x double]* %140, i32 0, i64 %132
  %142 = load double* %141, align 8
  %143 = load i32* %j, align 4
  %144 = sext i32 %143 to i64
  %145 = load double** %4, align 8
...
; <label>:157                                     ; preds = %121
  ...
  %160 = load double** %4, align 8
  %161 = getelementptr inbounds double* %160, i64 %159
  ...
  %171 = load [3 x double]** %1, align 8
  %172 = getelementptr inbounds [3 x double]* %171, i64 %170
  %173 = getelementptr inbounds [3 x double]* %172, i32 0, i64 %164
  %174 = load double* %173, align 8
  %175 = fdiv double %162, %174
  %176 = load i32* %i, align 4
  %177 = sext i32 %176 to i64
  %178 = load double** %4, align 8
...
; <label>:6                                       ; preds = %0
  %7 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([36 x i8]* @.str1, i32 0, i32 0))
...
; <label>:32                                      ; preds = %28
  ...
  %37 = load [3 x double]** %1, align 8
  %38 = getelementptr inbounds [3 x double]* %37, i64 %36
  %39 = getelementptr inbounds [3 x double]* %38, i32 0, i64 %34
...
; <label>:58                                      ; preds = %28
  %59 = load double* %c1, align 8
  %60 = load i32* %i, align 4
  %61 = sext i32 %60 to i64
  %62 = getelementptr inbounds [3 x double]* %c, i32 0, i64 %61
...
; <label>:78                                      ; preds = %74
  ...
  %87 = load [3 x double]** %1, align 8
  %88 = getelementptr inbounds [3 x double]* %87, i64 %86
  %89 = getelementptr inbounds [3 x double]* %88, i32 0, i64 %80
  %90 = load double* %89, align 8
  %91 = call double @fabs(double %90) #6
  %92 = load i32* %i, align 4
  %93 = sext i32 %92 to i64
  %94 = load i32** %3, align 8
  %95 = getelementptr inbounds i32* %94, i64 %93
  %96 = load i32* %95, align 4
  %97 = sext i32 %96 to i64
  %98 = getelementptr inbounds [3 x double]* %c, i32 0, i64 %97
  %99 = load double* %98, align 8
  %100 = fdiv double %91, %99
  store double %100, double* %pi, align 8
  %101 = load double* %pi, align 8
  %102 = load double* %pi1, align 8
  %103 = fcmp ogt double %101, %102
  br i1 %103, label %104, label %107

; <label>:104                                     ; preds = %78
  %105 = load double* %pi, align 8
...
; <label>:111                                     ; preds = %74
  ...
  %124 = load i32** %3, align 8
  %125 = getelementptr inbounds i32* %124, i64 %123
  store i32 %121, i32* %125, align 4
  %126 = load i32* %itmp, align 4
...
; <label>:137                                     ; preds = %133
  ...
  %142 = load i32** %3, align 8
  %143 = getelementptr inbounds i32* %142, i64 %141
  %144 = load i32* %143, align 4
  %145 = sext i32 %144 to i64
  %146 = load [3 x double]** %1, align 8
  %147 = getelementptr inbounds [3 x double]* %146, i64 %145
  %148 = getelementptr inbounds [3 x double]* %147, i32 0, i64 %139
  %149 = load double* %148, align 8
  %150 = load i32* %j, align 4
  %151 = sext i32 %150 to i64
  %152 = load i32* %j, align 4
  %153 = sext i32 %152 to i64
  %154 = load i32** %3, align 8
  %155 = getelementptr inbounds i32* %154, i64 %153
  %156 = load i32* %155, align 4
  %157 = sext i32 %156 to i64
  %158 = load [3 x double]** %1, align 8
  %159 = getelementptr inbounds [3 x double]* %158, i64 %157
  %160 = getelementptr inbounds [3 x double]* %159, i32 0, i64 %151
  %161 = load double* %160, align 8
  %162 = fdiv double %149, %161
  store double %162, double* %pj, align 8
  %163 = load double* %pj, align 8
  %164 = load i32* %j, align 4
  %165 = sext i32 %164 to i64
  %166 = load i32* %i, align 4
  %167 = sext i32 %166 to i64
  %168 = load i32** %3, align 8
  %169 = getelementptr inbounds i32* %168, i64 %167
  %170 = load i32* %169, align 4
  %171 = sext i32 %170 to i64
  %172 = load [3 x double]** %1, align 8
  %173 = getelementptr inbounds [3 x double]* %172, i64 %171
  %174 = getelementptr inbounds [3 x double]* %173, i32 0, i64 %165
...
; <label>:181                                     ; preds = %177
  ...
  %186 = load i32** %3, align 8
  %187 = getelementptr inbounds i32* %186, i64 %185
  %188 = load i32* %187, align 4
  %189 = sext i32 %188 to i64
  %190 = load [3 x double]** %1, align 8
  %191 = getelementptr inbounds [3 x double]* %190, i64 %189
  %192 = getelementptr inbounds [3 x double]* %191, i32 0, i64 %183
  %193 = load double* %192, align 8
  %194 = load double* %pj, align 8
  %195 = load i32* %k, align 4
  %196 = sext i32 %195 to i64
  %197 = load i32* %j, align 4
  %198 = sext i32 %197 to i64
  %199 = load i32** %3, align 8
  %200 = getelementptr inbounds i32* %199, i64 %198
  %201 = load i32* %200, align 4
  %202 = sext i32 %201 to i64
  %203 = load [3 x double]** %1, align 8
  %204 = getelementptr inbounds [3 x double]* %203, i64 %202
  %205 = getelementptr inbounds [3 x double]* %204, i32 0, i64 %196
  ...
  %213 = load i32** %3, align 8
  %214 = getelementptr inbounds i32* %213, i64 %212
  %215 = load i32* %214, align 4
  %216 = sext i32 %215 to i64
  %217 = load [3 x double]** %1, align 8
  %218 = getelementptr inbounds [3 x double]* %217, i64 %216
  %219 = getelementptr inbounds [3 x double]* %218, i32 0, i64 %210
  store double %208, double* %219, align 8
  br label %220

; <label>:220                                     ; preds = %181
  %221 = load i32* %k, align 4
