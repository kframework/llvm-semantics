; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20000706-1.ll'
...
define void @foo(%struct.baz* nocapture byval align 8 %x, i8** nocapture %y) nounwind uwtable {
entry:
