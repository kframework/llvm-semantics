; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/921117-1.c'
...
entry:
  ...
  %0 = load i64* getelementptr (%0* bitcast (%struct.s* @cell to %0*), i32 0, i32 0), align 1
  %1 = load i64* getelementptr (%0* bitcast (%struct.s* @cell to %0*), i32 0, i32 1), align 1
