...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = getelementptr inbounds [2 x i32], [2 x i32]* %tab, i32 0, i64 1
  store i32 0, i32* %2, align 4
  %3 = getelementptr inbounds [2 x i32], [2 x i32]* %tab, i32 0, i64 0
  store i32 0, i32* %3, align 4
  %4 = getelementptr inbounds [2 x i32], [2 x i32]* %tab, i32 0, i32 0
  call void @f(i32* %4)
  %5 = getelementptr inbounds [2 x i32], [2 x i32]* %tab, i32 0, i64 0
  %6 = load i32, i32* %5, align 4
  %7 = icmp ne i32 %6, 2
  br i1 %7, label %12, label %8

; <label>:8                                       ; preds = %0
  %9 = getelementptr inbounds [2 x i32], [2 x i32]* %tab, i32 0, i64 1
