; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/920922-1.c'
...
entry:
  ...
  %incdec.ptr = getelementptr inbounds i64* %tmp, i32 1
  store i64* %incdec.ptr, i64** %p.addr, align 8
  %tmp1 = load i64* %tmp
  %shr = lshr i64 %tmp1, 24
  store i64 %shr, i64* %a, align 8
  %tmp2 = load i64** %p.addr, align 8
  %tmp3 = load i64* %a, align 8
  %add.ptr = getelementptr inbounds i64* %tmp2, i64 %tmp3
  ret i64* %add.ptr
}
