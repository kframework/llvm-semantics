; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20030120-1.ll'
...
entry:
  %cmp4 = icmp eq i16 %w, 0
  %tmp81 = select i1 %cmp4, i16 2, i16 %w
  ret i16 %tmp81
}
