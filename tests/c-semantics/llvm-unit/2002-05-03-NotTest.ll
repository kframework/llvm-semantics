...
define void @testBitWiseNot(i32 %A, i32 %B, i32 %C, i32 %D) #0 {
  ...
  %12 = xor i32 %11, -1
  %13 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([26 x i8]* @.str, i32 0, i32 0), i32 %6, i32 %8, i32 %10, i32 %12)
  ret void
}
...
; <label>:55                                      ; preds = %52, %46
  ...
  %59 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([32 x i8]* @.str1, i32 0, i32 0), i32 %13, i32 %22, i32 %31, i32 %40, i32 %49, i32 %58)
  ret void
}
