...
define i32 @sec(%struct.defs* %pd0) #0 {
  ...
  store %struct.defs* %pd0, %struct.defs** %1, align 8
  store i8* getelementptr inbounds ([8 x i8], [8 x i8]* @sec.qs9, i32 0, i32 0), i8** %ps, align 8
  %2 = load %struct.defs*, %struct.defs** %1, align 8
  %3 = getelementptr inbounds %struct.defs, %struct.defs* %2, i32 0, i32 15
  %4 = getelementptr inbounds [8 x i8], [8 x i8]* %3, i32 0, i32 0
  store i8* %4, i8** %pt, align 8
...
; <label>:43                                      ; preds = %38
  %44 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @sec.s9er, i32 0, i32 0), i32 1)
  br label %45

; <label>:45                                      ; preds = %43, %38
  %46 = load i32, i32* %rc, align 4
  %47 = add nsw i32 %46, 1
  store i32 %47, i32* %rc, align 4
  br label %48
