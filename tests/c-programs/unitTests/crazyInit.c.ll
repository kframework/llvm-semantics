...
define i32 @main() #0 {
  ...
  %3 = getelementptr inbounds %struct.S2, %struct.S2* %s2, i32 0, i32 0
...
; <label>:9                                       ; preds = %6
  ...
  %12 = getelementptr inbounds %struct.S2, %struct.S2* %s2, i32 0, i32 0
  %13 = getelementptr inbounds %struct.S1, %struct.S1* %12, i32 0, i32 0
  %14 = getelementptr inbounds [3 x i32], [3 x i32]* %13, i32 0, i64 %11
