...
; <label>:5                                       ; preds = %2
  ...
  %9 = sext i32 %8 to i64
  %10 = getelementptr inbounds [100 x i16], [100 x i16]* %Array, i32 0, i64 %9
...
; <label>:14                                      ; preds = %2
  %15 = getelementptr inbounds [100 x i16], [100 x i16]* %Array, i32 0, i32 0
