...
; <label>:6                                       ; preds = %3
  %7 = load %struct.input_ty** %2, align 8
  %8 = getelementptr inbounds %struct.input_ty* %7, i32 0, i32 0
  %9 = load i8** %8, align 8
  %10 = load %struct.input_ty** %2, align 8
  %11 = getelementptr inbounds %struct.input_ty* %10, i32 0, i32 1
  %12 = load i8** %11, align 8
  %13 = icmp ult i8* %9, %12
  br i1 %13, label %14, label %21

; <label>:14                                      ; preds = %6
  %15 = load %struct.input_ty** %2, align 8
  %16 = getelementptr inbounds %struct.input_ty* %15, i32 0, i32 0
...
; <label>:21                                      ; preds = %6
  %22 = load %struct.input_ty** %2, align 8
...
define i32 @main() #0 {
  ...
  store i8* getelementptr inbounds (i8* getelementptr inbounds ([6 x i8]* @b, i32 0, i32 0), i64 6), i8** getelementptr inbounds (%struct.input_ty* @s, i32 0, i32 1), align 8
...
; <label>:5                                       ; preds = %0
  %6 = load i8** getelementptr inbounds (%struct.input_ty* @s, i32 0, i32 0), align 8
  %7 = load i8** getelementptr inbounds (%struct.input_ty* @s, i32 0, i32 1), align 8
  %8 = icmp ne i8* %6, %7
