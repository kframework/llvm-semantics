; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20020720-1.c'
...
entry:
  ...
  %call = call double @fabs(double %tmp) nounwind readnone
  store double %call, double* %p, align 8
  store double 0.000000e+00, double* %q, align 8
  %tmp1 = load double* %p, align 8
  %tmp2 = load double* %q, align 8
  %cmp = fcmp olt double %tmp1, %tmp2
