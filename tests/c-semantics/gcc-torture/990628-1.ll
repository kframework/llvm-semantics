...
define void @fetch() #0 {
  ...
  %1 = load i32* @fetch.fetch_count, align 4
  %2 = add nsw i32 %1, 1
  store i32 %2, i32* @fetch.fetch_count, align 4
  %3 = icmp sgt i32 %2, 1
  %4 = select i1 %3, i32 100, i32 0
  %5 = sext i32 %4 to i64
  store i64 %5, i64* getelementptr inbounds (%struct.anon* @sqlca, i32 0, i32 0), align 8
  ret void
}
...
define void @load_data() #0 {
  ...
  %7 = load %struct.data_record** @data_ptr, align 8
  ...
  call void @fetch()
  %12 = load %struct.data_record** @data_ptr, align 8
  store %struct.data_record* %12, %struct.data_record** %p, align 8
  br label %13

; <label>:13                                      ; preds = %16, %0
  %14 = load i64* getelementptr inbounds (%struct.anon* @sqlca, i32 0, i32 0), align 8
  %15 = icmp eq i64 %14, 0
  br i1 %15, label %16, label %20

; <label>:16                                      ; preds = %13
  %17 = load %struct.data_record** %p, align 8
  %18 = getelementptr inbounds %struct.data_record* %17, i32 1
...
define i32 @main() #0 {
  ...
  %3 = getelementptr inbounds %struct.data_record* %2, i64 0
  %4 = getelementptr inbounds %struct.data_record* %3, i32 0, i32 0
