; ModuleID = '/home/grosu/celliso2/c-semantics/tests/unitTests/c1x0605160106.c'
...
entry:
  ...
  %tmp = load i8*** %cpp, align 8
  store i8* %c, i8** %tmp
  %tmp1 = load i8*** %cpp, align 8
  %tmp2 = load i8** %tmp1
  %tmp3 = load i8* %tmp2
  ...
  %call8 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str1, i32 0, i32 0), i32 %conv7)
  %tmp9 = load i8* %c, align 1
  %conv10 = sext i8 %tmp9 to i32
  %call11 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @.str2, i32 0, i32 0), i32 %conv10)
  ret i32 0
}
