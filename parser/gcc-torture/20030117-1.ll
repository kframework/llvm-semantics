; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20030117-1.c'
...
entry:
  ...
  %mul4 = mul nsw i32 %tmp2, %tmp3
  %tmp5 = load i32* %z.addr, align 4
  %tmp6 = load i32* %z.addr, align 4
  %mul7 = mul nsw i32 %tmp5, %tmp6
  %call = call i32 @foo(i32 %mul, i32 %mul4, i32 %mul7)
  ret i32 %call
}
