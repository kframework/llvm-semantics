...
entry:
  %0 = load i32* bitcast (i8* getelementptr inbounds (%struct.anon.0* @c, i64 0, i32 1) to i32*), align 8
...
entry:
  %0 = load i32* bitcast (i8* getelementptr inbounds (%struct.anon.1* @d, i64 0, i32 1, i64 0) to i32*), align 8
...
entry:
  ...
  %1 = and i32 %0, -32
  %2 = or i32 %bf.value, %1
  store i32 %2, i32* bitcast (i8* getelementptr inbounds (%struct.anon.0* @c, i64 0, i32 1) to i32*), align 8
  ret void
}
...
entry:
  ...
  %3 = and i32 %0, -33
  %4 = or i32 %2, %3
  store i32 %4, i32* bitcast (i8* getelementptr inbounds (%struct.anon.0* @c, i64 0, i32 1) to i32*), align 8
  ret void
}
...
entry:
  ...
  %add1 = shl i32 %x, 6
  %1 = add i32 %0, %add1
  store i32 %1, i32* bitcast (i8* getelementptr inbounds (%struct.anon.0* @c, i64 0, i32 1) to i32*), align 8
  ret void
}
...
entry:
  ...
  %1 = and i32 %0, -65536
  %2 = or i32 %bf.value, %1
  store i32 %2, i32* bitcast (i8* getelementptr inbounds (%struct.anon.1* @d, i64 0, i32 1, i64 0) to i32*), align 8
  ret void
}
...
entry:
  ...
  %4 = or i32 %2, %3
  store i32 %4, i32* bitcast (i8* getelementptr inbounds (%struct.anon.1* @d, i64 0, i32 1, i64 0) to i32*), align 8
  ret void
}
...
entry:
  ...
  %add1 = shl i32 %x, 24
  %1 = add i32 %0, %add1
  store i32 %1, i32* bitcast (i8* getelementptr inbounds (%struct.anon.1* @d, i64 0, i32 1, i64 0) to i32*), align 8
  ret void
}
...
entry:
  ...
  %3 = or i32 %1, %2
  store i32 %3, i32* bitcast (i8* getelementptr inbounds (%struct.anon.1* @d, i64 0, i32 1, i64 0) to i32*), align 8
  ret void
}
...
entry:
  ...
  %2 = and i32 %0, -33
  %3 = or i32 %1, %2
  store i32 %3, i32* bitcast (i8* getelementptr inbounds (%struct.anon.0* @c, i64 0, i32 1) to i32*), align 8
  ret void
}
...
if.end644:
  ...
  store i32 -2147483595, i32* bitcast (i8* getelementptr inbounds (%struct.anon.0* @c, i64 0, i32 1) to i32*), align 8
  store i32 -1147377476, i32* bitcast (i8* getelementptr inbounds (%struct.anon.1* @d, i64 0, i32 1, i64 0) to i32*), align 8
  ret i32 0
}
