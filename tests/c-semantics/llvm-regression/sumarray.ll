...
define i32 @SumArray(i32* %Array, i32 %Num) #0 {
  ...
  %4 = getelementptr inbounds i32* %3, i64 34
...
; <label>:31                                      ; preds = %18
  %32 = load i32** %Array, align 8
  %33 = call i32 @SumArray(i32* %32, i32 100)
  %34 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str, i32 0, i32 0), i32 %33)
  ret i32 0
}
