; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20021010-1.c'
...
if.else:                                          ; preds = %entry
  ...
  %div3 = sdiv i32 %tmp2, 2147483647
  %div4 = sdiv i32 %div3, 16
  store i32 %div4, i32* %retval
  br label %return
