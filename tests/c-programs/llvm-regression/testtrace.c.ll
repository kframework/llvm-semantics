...
; <label>:7                                       ; preds = %0
  %8 = load %struct.DummyStruct*, %struct.DummyStruct** %1, align 8
  %9 = load %struct.DummyStruct*, %struct.DummyStruct** %2, align 8
  %10 = load %struct.DummyStruct*, %struct.DummyStruct** %3, align 8
  %11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str, i32 0, i32 0), %struct.DummyStruct* %8, %struct.DummyStruct* %9, %struct.DummyStruct* %10)
  br label %12

; <label>:12                                      ; preds = %7, %0
  %13 = load %struct.DummyStruct*, %struct.DummyStruct** %1, align 8
  %14 = getelementptr inbounds %struct.DummyStruct, %struct.DummyStruct* %13, i32 0, i32 1
  %15 = load i32, i32* %14, align 4
  %16 = load %struct.DummyStruct*, %struct.DummyStruct** %2, align 8
  %17 = getelementptr inbounds %struct.DummyStruct, %struct.DummyStruct* %16, i32 0, i32 1
  %18 = load i32, i32* %17, align 4
  %19 = add nsw i32 %15, %18
  %20 = load %struct.DummyStruct*, %struct.DummyStruct** %3, align 8
...
define void @testAllocaOrder(i32 %noPrint) #0 {
  ...
  %4 = getelementptr inbounds %struct.DummyStruct, %struct.DummyStruct* %S1, i32 0, i32 1
  store i32 %3, i32* %4, align 4
  %5 = load i32, i32* @testAllocaOrder.count, align 4
  %6 = add nsw i32 %5, 1
  store i32 %6, i32* @testAllocaOrder.count, align 4
  %7 = getelementptr inbounds %struct.DummyStruct, %struct.DummyStruct* %S2, i32 0, i32 1
  store i32 %6, i32* %7, align 4
  %8 = load i32, i32* @testAllocaOrder.count, align 4
  %9 = add nsw i32 %8, 1
  store i32 %9, i32* @testAllocaOrder.count, align 4
  %10 = getelementptr inbounds %struct.DummyStruct, %struct.DummyStruct* %S3, i32 0, i32 1
  store i32 %9, i32* %10, align 4
  %11 = load i32, i32* %1, align 4
  %12 = call i32 @AddCounts(%struct.DummyStruct* %S1, %struct.DummyStruct* %S2, %struct.DummyStruct* %S3, i32 %11)
  %13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i32 0, i32 0), i32 %12)
  ret void
}
...
; <label>:6                                       ; preds = %0
  ...
  %10 = call i32 @strcmp(i8* %9, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i32 0, i32 0))
  %11 = icmp ne i32 %10, 0
...
; <label>:17                                      ; preds = %14
  %18 = load i32, i32* %noPrint, align 4
