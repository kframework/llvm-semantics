; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20000412-2.ll'
...
define i32 @f(i32 %a, i32* %y) nounwind uwtable readonly {
entry:
...
return:                                           ; preds = %if.end, %if.then
  %storemerge = phi i32 [ %tmp3, %if.then ], [ %call, %if.end ]
  ret i32 %storemerge
}
