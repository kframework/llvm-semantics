; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20000717-1.ll'
...
entry:
  %tmp19 = trunc i64 %t.coerce0 to i32
  %tmp16 = lshr i64 %t.coerce0, 32
  %tmp17 = trunc i64 %tmp16 to i32
  %cmp = icmp eq i32 %tmp19, %tmp17
  %cmp5 = icmp eq i32 %tmp19, %t.coerce1
...
entry:
  %tmp19.i = trunc i64 %t.coerce0 to i32
  %tmp16.i = lshr i64 %t.coerce0, 32
  %tmp17.i = trunc i64 %tmp16.i to i32
  %cmp.i = icmp eq i32 %tmp19.i, %tmp17.i
  %cmp5.i = icmp eq i32 %tmp19.i, %t.coerce1
