; ModuleID = '/home/grosu/celliso2/c-semantics/tests/gcc-torture/20000722-1.c'
...
entry:
  ...
  %t = getelementptr inbounds %struct.s* %tmp, i32 0, i32 1
  %tmp1 = load i32* %t, align 4
...
if.end:                                           ; preds = %entry
  ...
  %t3 = getelementptr inbounds %struct.s* %tmp2, i32 0, i32 1
